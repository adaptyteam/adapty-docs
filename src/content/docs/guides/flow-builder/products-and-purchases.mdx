...
description: "Configure products and purchase flows. Handle purchase restoration."
metadataTitle: "Products and purchases | Flow Builder | Adapty Docs"
---
...
## Add / bind a product
Product Selection. Dropdown to select the product itself (e.g., Premium Year).
Offer Selection. Dropdown to select the specific pricing offer for this product (e.g., Trial 7 days, Discount 50%). This list is filtered based on the selected Product.More Options⋮
Context menu for secondary actions 
Remove Removes the product assignment from this screen (does not delete the product from the database).

### Product groups

## Product element presets
...
How to add a purchase button

## Integrations with other elements
...
<Zoom>
  <img src="/assets/shared/img/product-group.webp"
  style={{
    border: '1px solid #727272', /* border width and color */
    width: '700px', /* image width */
    display: 'block', /* for alignment */
