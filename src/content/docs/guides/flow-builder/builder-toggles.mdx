...
metadataTitle: "Toggles | Flows & paywalls | Adapty Docs"
---
...
Your app can also [receive the toggle state through the SDK](ios-flow-input). Each time the user flips the toggle, the SDK reports its new state as a boolean, which your app can process internally or on your back-end.
