...
metadataTitle: "Show a strikethrough price with a discount badge | Flow & Paywall Builder | Adapty Docs"
---
...
:::tip
If an inflated "before" price for the same product is enough — for example, double the current price, crossed out — add the ready-made [Old Price element](onboarding-text#add-an-old-price) instead. This recipe covers the case where the crossed-out price is another product's real price.
:::
...
4. On the **Design** tab, under **Typography**, set **Decoration** to **Strikethrough** <Inline id="strikethrough.svg" alt="Strikethrough" /> (see [Styles and appearance — Decoration](builder-styling#decoration)).
