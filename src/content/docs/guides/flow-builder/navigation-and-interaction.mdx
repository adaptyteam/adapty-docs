...
<Zoom>
  <img src="/assets/shared/img/static-navigation.webp"
  style={{
...
<Zoom>
  <img src="/assets/shared/img/dynamic-navigation.webp"
  style={{
    border: '1px solid #727272', /* border width and color */
    width: '700px', /* image width */
    display: 'block', /* for alignment */
...
<Zoom>
  <img src="/assets/shared/img/close-onboarding.webp"
  style={{
    border: '1px solid #727272', /* border width and color */
    width: '700px', /* image width */
    display: 'block', /* for alignment */
...
Makes a container part of a Selectable Group — a coordination mechanism that tracks which element is selected and stores the result in a variable.

Props:

Group — assign this element to an existing group or create a new one. All elements in the same group share the same mode and variable.
Element Title — human-readable label for this option. Used in dynamic text via {{group.selectedOptionTitle}}. Example: Option 1, Pro, Annual.
Element ID — machine identifier for this option. Used in conditions. Must be unique within the group. Only letters, numbers, and underscores. Example: option_1, pro_plan.
Set as default — this element will be pre-selected when the screen loads.