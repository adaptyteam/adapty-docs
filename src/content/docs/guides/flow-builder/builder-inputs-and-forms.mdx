...
<Zoom>
   <img src="/assets/shared/img/add-quiz.webp"
   style={{
...
1. Add a new screen and add a **Quiz** element to it.
   <Zoom>
   <img src="/assets/shared/img/onboarding-user-engagement1.webp"
   style={{
   border: '1px solid #727272', /* border width and color */
   width: '700px', /* image width */
   display: 'block', /* for alignment */
...
2. Add screens for different user groups. In our example, these will collect additional information, so they'll also contain quizzes.
   <Zoom>
   <img src="/assets/shared/img/onboarding-user-engagement2.webp"
   style={{
   border: '1px solid #727272', /* border width and color */
   width: '700px', /* image width */
   display: 'block', /* for alignment */
...
3. Add a final screen to indicate the onboarding is complete, allowing users to go straight to the app.
   <Zoom>
   <img src="/assets/shared/img/onboarding-user-engagement3.webp"
   style={{
   border: '1px solid #727272', /* border width and color */
...
:::
   ...
   <Zoom>
   <img src="/assets/shared/img/onboarding-user-engagement5.webp"
   style={{
   border: '1px solid #727272', /* border width and color */
   width: '700px', /* image width */
   display: 'block', /* for alignment */
...
<Zoom>
   <img src="/assets/shared/img/quiz-customization.webp"
   style={{
   border: '1px solid #727272', /* border width and color */
   width: '700px', /* image width */
   display: 'block', /* for alignment */
