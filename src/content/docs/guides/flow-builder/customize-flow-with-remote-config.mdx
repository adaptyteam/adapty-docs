...
:::important
This guide covers remote config for the Flow & Paywall Builder. For classic paywalls created without it, see [Design paywall with remote config](customize-paywall-with-remote-config).
:::
