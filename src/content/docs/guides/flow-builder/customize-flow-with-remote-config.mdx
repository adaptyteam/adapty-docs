...
:::warning
If the remote config contains invalid JSON, you can neither **save** nor **publish** the flow. See [Save & publish flows](builder-save-publish#troubleshooting) for the full list of issues that block preview and publish.
:::
