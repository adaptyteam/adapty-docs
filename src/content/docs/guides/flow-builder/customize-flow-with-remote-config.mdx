...
:::important
This guide covers remote config for flows. For manually implemented paywalls, see [Design paywall with remote config](customize-paywall-with-remote-config).
:::
