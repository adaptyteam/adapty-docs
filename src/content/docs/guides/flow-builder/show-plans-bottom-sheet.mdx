...
metadataTitle: "Show all plans in a bottom sheet | Flow & Paywall Builder | Adapty Docs"
---
...
3. In the **Layers** panel, select the **Terms of Use** button. Open the **Interactions** tab and paste your terms URL into the **Open URL** field.
