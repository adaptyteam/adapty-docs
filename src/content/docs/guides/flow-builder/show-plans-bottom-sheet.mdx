...
3. In the **Layers** panel, select the **Terms of Use** button (not the text element nested inside it). Open the **Interactions** tab and paste your terms URL into the **Open URL** field.
4. Repeat for the **Privacy Policy** button with your privacy URL.
