...
Your existing onboardings and paywalls keep working, but the legacy builders are deprecated: from October 1, 2026, you can't create or edit paywalls and onboardings in them, and their support stops. See [Paywall Builder and Onboarding Builder deprecation](paywall-onboarding-builder-deprecation) for what changes on that date.
...
On the **Flows** page, click **Create flow** to start [from a template or from scratch](paywall-builder-templates), recreating your onboarding and paywall as one experience. To learn more about the builder:
