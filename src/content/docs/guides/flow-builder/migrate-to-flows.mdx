...
If your paywall was built in the old Paywall Builder, you can [convert it into a flow](convert-paywall-to-flow) instead of rebuilding it manually. Otherwise, you can [use a starter template or build the flow from scratch](paywall-builder-templates). Learn more about the flow & paywall builder:

- **[Flow builder documentation](adapty-flow-builder)**: Walks you through the builder and what you can create.
