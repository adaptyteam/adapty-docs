...
You can keep A/B testing with flows: run a [Regular A/B test](ab-tests) across flow variants on a flow placement, or a [Crossplacement A/B test](ab-test-types) across several flow placements. Comparing a new flow against your old paywall is an inconclusive, cohort-based comparison. Adapty explicitly does not support such A/B tests — be they regular or crossplacement.
