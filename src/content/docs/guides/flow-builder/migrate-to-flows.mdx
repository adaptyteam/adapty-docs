...
:::important
Flows are currently supported in iOS and Android SDK v4 and up. Support for other platforms and frameworks is coming soon.
:::
...
4. **[Update the SDK](#update-the-sdk)**: Upgrade to iOS or Android SDK v4, fetch the flow from its placement, and verify a sandbox purchase. This is the main developer task.
