...
- **[Start from a template](paywall-builder-templates)**: A starter template or a blank flow in the Flow Builder, with no code.
...
Your paywall placements are read and never edited, so they keep serving while you work, and every placement ID the skill proposes waits for your approval — a placement can't be deleted once it exists.
