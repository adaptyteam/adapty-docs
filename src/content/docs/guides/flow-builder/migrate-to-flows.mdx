...
:::important
Flows are currently supported on iOS, Android, React Native, Flutter, and Capacitor SDK v4 and up. Support for other platforms and frameworks is coming soon.
:::
