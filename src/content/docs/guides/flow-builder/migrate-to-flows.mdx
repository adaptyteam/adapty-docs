...
:::warning
From October 1, 2026, you can't create new paywalls and onboardings in the legacy builders, and their support stops. Everything you already have keeps working — see [what changes on that date](paywall-onboarding-builder-deprecation).
:::
