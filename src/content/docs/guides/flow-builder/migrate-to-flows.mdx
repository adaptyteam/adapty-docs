...
metadataTitle: "Migrate paywalls to flows | Flows | Adapty Docs"
---
...
:::warning
From October 1, 2026, you can't create new paywalls and onboardings in the old Paywall Builder or the Onboarding Builder, and their support stops. Everything you already have keeps working, and you can still edit it — see [what changes on that date](paywall-onboarding-builder-deprecation).
:::
