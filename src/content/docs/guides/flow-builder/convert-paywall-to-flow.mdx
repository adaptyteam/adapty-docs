...
<Inline id="move-to-new-builder.svg" alt="Move to new builder" /> **Move to new builder** appears only on paywalls you made with the old Paywall Builder. If you built your paywall by hand with remote config, it has no builder version to convert — recreate it as a flow with [Create a flow](paywall-builder-templates).
...
Adapty converts the paywall in your browser and opens the new flow in the editor. A **Paywall imported** message confirms the flow is ready to edit.
