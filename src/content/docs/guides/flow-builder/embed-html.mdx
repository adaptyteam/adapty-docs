---
title: "Embed HTML"
description: "Embed custom HTML content in your flows."
metadataTitle: "Embed HTML | Flow Builder | Adapty Docs"
---

import Zoom from 'react-medium-image-zoom';
import 'react-medium-image-zoom/dist/styles.css';

Not included in the list of available elements. Old article below:
...
<Zoom>
  <img src="/assets/shared/img/onboarding-html.webp"
  style={{
