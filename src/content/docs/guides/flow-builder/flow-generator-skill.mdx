...
4. **Publish.** Click **Publish to Live** in the top right of the Flow & Paywall Builder. A flow that isn't in a [placement](create-placement) still reaches nobody, and a Draft flow can't be added to one — so publish first. See [Save & publish flows](builder-save-publish).
