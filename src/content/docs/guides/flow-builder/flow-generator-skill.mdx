...
metadataTitle: "Flow Generator Agent Skill | Flow & Paywall Builder | Adapty Docs"
---
...
The skill ships in the `adapty-skills` repository alongside `adapty-integration`, `flow-audit`, `migrate-placements`, `ads-manager`, `paywall-teardown`, and `onboarding-teardown`. Each of these commands installs all seven.
