...
- **Video**: {/* Upload does not yet work, check later */} an embedded video player with loop and autoplay options
...
{/* TODO: with animations removed, pulse buttons will also be removed. update screenshot */}
