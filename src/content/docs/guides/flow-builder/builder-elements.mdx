---
title: "Elements"
description: "All visual elements available in the Flow & Paywall Builder: layout containers, text, media, lists, buttons, inputs, products, and more."
metadataTitle: "Elements | Flows & paywalls | Adapty Docs"
---
...
- [Paywall & Commerce](#paywall--commerce) (products, toggles, user engagement, countdown)
...
The **Text** menu also includes the **Old Price** element — a crossed-out product price calculated automatically from a multiplier. See [Add an old price](onboarding-text#add-an-old-price).
...
Indicator icons for use inside [selectable elements](flow-selectable-elements), such as product cards. Each shape comes as an on and an off preset.
...
For a switch or checkbox the user taps directly, use the [Toggle](#toggle) elements instead.
...
:::link
Main article: [Toggles and checkboxes](builder-toggles)
:::

<ZoomImage id="toggle-template.webp" width="200px" alt="Toggle templates" float="right" />

Switches and checkboxes that users tap to turn something on or off. Each one is a [selectable element](flow-selectable-elements), so other elements can react to its state.

- **Trial toggle**: switches the displayed product between its standard price and its free trial offer
- **Checkbox**: a checkbox with a text label, prefilled with a terms-and-privacy consent line
- **Toggle**: a switch with a text label

### User engagement

:::link
Main article: [Reviews and testimonials](builder-reviews-and-testimonials)
:::
...
- **Review Carousel**: swipeable review cards with pagination dots
