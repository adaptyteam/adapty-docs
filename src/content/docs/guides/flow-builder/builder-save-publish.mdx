...
:::warning
If your flow uses [custom fonts](using-custom-fonts-in-flow-builder.md), add the font files to your app bundle before publishing. Without them, mobile users see the system fallback font instead of the font you picked.
:::
