...
flow-audit ships in the `adapty-skills` plugin ([`adaptyteam/adapty-skills`](https://github.com/adaptyteam/adapty-skills)) alongside flow-generator — one install gives you every skill in the plugin, seven now including flow-audit.
