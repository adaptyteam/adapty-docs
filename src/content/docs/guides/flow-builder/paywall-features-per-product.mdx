...
metadataTitle: "Show different features per product | Flows & paywalls | Adapty Docs"
---
...
3. Select the card you want selected by default — for example, Pro+ — and enable **Set as default** in the **Design** tab.
