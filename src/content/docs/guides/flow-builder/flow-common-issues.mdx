...
The error names a path inside the generated configuration, such as `/assets/12/value`, instead of a screen or an element, so review the hex value on every layer, style, and element you edited.
