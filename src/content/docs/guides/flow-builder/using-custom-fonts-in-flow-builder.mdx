...
:::warning
The file you upload is **for editor preview only** — Adapty doesn't push it to users' devices. To render the font on device, [include the file in your app bundle](#add-the-font-to-your-apps-bundle). Without it, the SDK falls back to SF Pro (iOS) or Roboto (Android) at runtime.
:::
