---
title: "Custom fonts in the builder"
description: "Upload and use custom fonts in the builder."
metadataTitle: "Custom fonts | Flow & Paywall Builder | Adapty Docs"
---
...
:::warning
The file you upload is **for builder preview only** — Adapty doesn't push it to users' devices. To render the font on device, [include the file in your app bundle](#add-the-font-files-to-your-apps-bundle). Without it, the SDK falls back to SF Pro (iOS) or Roboto (Android) at runtime.
:::
