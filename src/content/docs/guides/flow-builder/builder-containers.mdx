...
description: "Group elements into containers, carousels, and bottom sheets in the builder."
metadataTitle: "Layout elements: containers, carousels, bottom sheets | Flow & Paywall Builder | Adapty Docs"
---
...
:The builder includes five layout element types:
