...
- <Inline id="sparkle.svg" alt="AI Editor" /> **AI Editor**: Prompt the AI to restyle, rewrite, or rearrange a screen for you.
...
- <Inline id="sparkle.svg" alt="AI Editor" /> **[AI Editor](builder-ui#ai-editor)** — describe a change in plain language and let AI apply it to the current screen.
