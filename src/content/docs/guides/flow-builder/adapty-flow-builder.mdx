...
[Create a new flow](paywall-builder-templates) from a custom-designed gallery template or a blank canvas. Then customize it with the following capabilities:
