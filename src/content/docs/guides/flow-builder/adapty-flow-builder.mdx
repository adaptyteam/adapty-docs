...
metadataTitle: "Flows & paywalls | Adapty Docs"
---
...
- <Inline id="sparkle.svg" alt="AI Editor" /> **[AI Editor](flow-ai-editor)**: Describe a change in plain language or attach a reference screenshot. Restyle, rewrite, or rearrange the screen without editing element settings by hand.
...
- **Surveys and quizzes**: Collect goals, preferences, or experience level, then use the answers to branch the flow, tailor later screens, or [process them in your app](ios-flow-input). See [Inputs and forms](builder-inputs-and-forms).
