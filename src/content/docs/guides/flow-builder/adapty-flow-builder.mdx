...
- **Expandable plan lists**: Lead with one highlighted offer and reveal the full product list in a bottom sheet when the user wants to compare. See [the Bottom Sheet product preset](paywall-product-block#add-products).
