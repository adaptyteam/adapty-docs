...
- **Surveys and quizzes**: Collect goals, preferences, or experience level, then use the answers to branch the flow or tailor later screens. See [Inputs and forms in the Flow & Paywall Builder](builder-inputs-and-forms).
