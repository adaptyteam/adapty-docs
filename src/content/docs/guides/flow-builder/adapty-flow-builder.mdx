...
metadataTitle: "Build onboardings and paywalls in the Flow & Paywall Builder | Adapty Docs"
---
...
In Adapty, you can create flows in a visual no-code builder.
...
- **Surveys and quizzes**: Collect goals, preferences, or experience level, then use the answers to branch the flow or tailor later screens. See [Inputs and forms in the builder](builder-inputs-and-forms).
