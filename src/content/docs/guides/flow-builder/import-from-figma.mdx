...
1. Open the [Import to Adapty](https://www.figma.com/community/plugin/1674065404672377144) plugin page.
2. Click **Save**. The plugin is now in Figma's **Plugins** menu.
...
An import reproduces the look of your design and wires the basics: navigation, selectable groups, inputs, and purchase actions. These parts of a design never come across:
...
- **Typefaces**: The import assigns no font to your text. To restore your typeface, [upload the font file](using-custom-fonts-in-flow-builder) and select it for the affected text.
- **Videos**: A video exports as a placeholder. [Add the video](custom-media) in the builder afterwards.
- **Hidden layers**: A hidden layer doesn't export.
