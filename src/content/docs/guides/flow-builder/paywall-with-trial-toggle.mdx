...
metadataTitle: "Build a paywall with a trial toggle | Flows & paywalls | Adapty Docs"
---
...
1. Click **+** > **Paywall & Commerce** > **Toggle** > **Trial toggle**.
...
Leave the toggle off by default. A pre-selected trial toggle risks App Store rejection as a dark pattern — see [Toggles and checkboxes](builder-toggles).
