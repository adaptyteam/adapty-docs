...
A **Loader** indicates that work is happening — for example, while data loads after a user submits an answer. Use [conditional visibility](flow-conditional-visibility) to show the loader only when needed.
