...
This article describes the process that [Apple](https://developer.apple.com/app-store/review/guidelines/) and [Google](https://play.google/developer-content-policy/) follow when reviewing app submissions, and offers tips for faster app approval.
...
Google Play Store requires first-time publishers to [test the app](https://support.google.com/googleplay/android-developer/answer/14151465?hl=en) before submitting it. The test should involve at least 12 people, and last a minimum of 14 consecutive days. 

This requirement was introduced in 2025 to lower the number of buggy apps that reach Google's review staff.
...
The content inside your app should match its declared rating. 
...
If you already use Adapty, we recommend designing your paywalls with the [Adapty Paywall Builder](adapty-paywall-builder). The builder helps you create policy-compliant paywalls, and its templates offer a solid starting point. Additionally, Adapty's [remote paywall configurations](customize-paywall-with-remote-config) allow you to make quick changes in response to rejections.
...
The in-store billing requirement does not apply to members of the European Economic Area, South Korea, and the US:
    ...
    * The EEA [Digital Markets Act](https://www.apple.com/newsroom/2025/09/the-digital-markets-acts-impacts-on-eu-users/) took effect in 2023.
...
- **Avoid "dark patterns".** 
    ...
    Do not create a false sense of urgency or scarcity. Only use countdown timers with actual limited-time offers, and stock counters with items of limited supply.
    
    Do not force users to make purchases by intentionally making free capabilities inconvenient or hard to locate. The user should be able to skip or close your paywalls.
...
* **Access restoration**
    ...
    A user should be able to restore access to the product from a new device. The [Paywall Builder](adapty-paywall-builder) includes a restore button component for this purpose.
