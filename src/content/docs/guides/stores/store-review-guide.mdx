...
:::important
Both stores follow a similar review process. When a problem only affects one of the stores, the article mentions the store by name. 
:::
...
:::tip
Neither App Store nor Google Play Store offers a definitive list of countries that allow for alternative billing methods. As new jurisdictions pass similar laws, the availability will expand. Read the docs pertaining to your particular country before proceeding.
:::
