---
title: "Prepare your app for store review"
...
* Google is [more flexible](https://support.google.com/googleplay/android-developer/answer/9898783?hl=en), particularly if your application is in [Early Access](https://knowledge.workspace.google.com/admin/users/access/turn-early-access-apps-on-or-off-for-users).
...
* **Access restoration**
    ...
    If you built your paywall with the [Flow & Paywall Builder](adapty-flow-builder), the restore button automatically triggers the restoration process. If you [implemented a paywall manually](ios-implement-paywalls-manually), add code that fires the [restorePurchases](restore-purchase) method. Adapty will restore the user's access level, **unless** you use the SDK in [observer mode](observer-vs-full-mode).
