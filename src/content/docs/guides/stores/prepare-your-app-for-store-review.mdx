...
- **Be consistent.** 
    ...
    Paywalls built in Adapty's no-code builders automatically sync prices with your App Store Connect product. If your paywall is manually coded, you must [retrieve each product's price](fetch-paywalls-and-products) from its data array.
