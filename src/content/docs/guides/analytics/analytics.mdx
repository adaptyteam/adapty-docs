...
Read the [How Adapty Analytics Works](how-adapty-analytics-works) guide to learn more about how data is sourced and processed. For a quick reference of all available metrics and how they differ from each other, see the [Metric comparison table](metric-comparison-table).
