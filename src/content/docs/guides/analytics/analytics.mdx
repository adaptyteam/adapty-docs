...
Read the [How Adapty Analytics Works](how-adapty-analytics-works) guide to learn more about how data is sourced and processed. For a quick reference of all available metrics and how they differ from each other, see the [Metric comparison table](metric-comparison-table) article.

:::tip
Enable [Adapty Attribution](adapty-user-acquisition) to upgrade the analytics capabilities of Adapty. Adapty Attribution uses marketing data to analyze the relationship between ad campaigns and user behavior. Its charts display a complete picture of your application's economy, with ROI calculations and precise attribution data.
:::
...
## Funnels
:::link
Main article: [Funnels](analytics-funnels)
:::
...
## Retention
:::link
Main article: [Retention](analytics-retention)
:::
...
## Conversion
:::link
Main article: [Conversion](analytics-conversion)
:::
...
Within any Adapty Analytics view, you can:
    ...
    * Filter data by store, attribution, [flow](filter-flows#filter-analytics-by-flow), or other parameters.
    * Group data inside the chart by country, [user segment](segments), flow, or other criteria.
