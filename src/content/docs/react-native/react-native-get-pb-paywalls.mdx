...
| :-------- |:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Flow   | An `AdaptyFlow` object with the flow's identifiers (`id`, `variationId`), name, placement, its paywall variations (`variations`), and any remote configs (`remoteConfigs`). |
