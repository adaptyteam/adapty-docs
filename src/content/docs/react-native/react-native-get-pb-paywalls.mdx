---
title: "Get flows - React Native"
description: "Fetch paywall and onboarding flows from Adapty in your React Native app."
metadataTitle: "Get Flows - React Native | Adapty Docs"
...
:::warning
The new Paywall Builder works with React Native SDK version 3.0 or higher. For presenting paywalls in Adapty SDK v2 designed with the legacy Paywall Builder, see [Display paywalls designed with legacy Paywall Builder](react-native-legacy).
:::
