...
:::tip
Our docs are optimized for use with LLMs. Check out [this article](adapty-cursor-react-native) to learn how to get the best results when integrating the Adapty SDK using AI with our docs.
:::
