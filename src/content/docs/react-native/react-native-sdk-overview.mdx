...
:::tip
Our docs are optimized for use with LLMs. Check out [this article](adapty-cursor-react-native) to learn how to get the best results when integrating the Adapty SDK using AI with our docs. Or let the [adapty-sdk-integration skill](adapty-sdk-integration-skill-react-native) integrate the SDK for you automatically.
:::
...
2. [Enable purchases through paywalls](react-native-quickstart-paywalls): Set up the purchase flow so users can buy products.
