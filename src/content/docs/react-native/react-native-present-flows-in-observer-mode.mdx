...
- **Adapty React Native SDK 4.0 or later**: Earlier versions can't render flows. To move an existing app, see the [migration guide](migration-to-react-native-sdk-v4).
