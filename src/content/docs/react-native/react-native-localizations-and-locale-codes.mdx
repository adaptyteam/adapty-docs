...
- **Flows and paywall-builder paywalls**: Adapty resolves the localization automatically from the device and the localizations you configured in the builder. Render the flow with `createFlowView` — no locale code needed.
