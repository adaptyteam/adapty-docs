...
Locale codes come into play when Adapty picks the localization for a flow or an onboarding, and when you read a remote config for a manually implemented paywall.
