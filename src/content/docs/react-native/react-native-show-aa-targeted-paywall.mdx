...
description: "Show a paywall immediately and upgrade it for Apple Ads users once attribution is applied in React Native, using AdaptyProfile.appliedExternalAttributionProviders."
...
You need:
- Adapty React Native SDK **4.1** or later. On 3.17.1–4.0.x, the profile property is named `appliedAttributionSources` and flows are fetched with `getPaywall`.
