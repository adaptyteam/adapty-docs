...
description: "Migrate to Adapty React Native SDK v4.0 by replacing paywall APIs with flow APIs, compatible with both flows and paywall-builder paywalls."
metadataTitle: "Migrating to Adapty React Native SDK v4.0 | Adapty Docs"
---

Adapty React Native SDK 4.0 introduces flows and renames the paywall APIs accordingly. The new APIs work with both flows and paywall-builder paywalls — no setup changes are required on the Adapty Dashboard side.
