...
To be notified of profile updates, listen for profile changes as described in the [Listening for profile updates, including access levels](react-native-listen-subscription-changes) section below.
