...
- [**Manually created paywalls**](react-native-quickstart-manual): You build your own paywall UI in code but still use Adapty to fetch products and handle purchases.
...
**Guides:**
- [Enable purchases with Flow & Paywall Builder (quickstart)](react-native-quickstart-paywalls)
- [Fetch flows and their configuration](react-native-get-pb-paywalls)
- [Display flows](react-native-present-paywalls)
- [Handle flow events](react-native-handling-events-1)
...
- [Render a manual paywall with remote config](present-remote-config-paywalls-react-native)
