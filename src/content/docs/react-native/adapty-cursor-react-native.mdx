...
This page covers two ways to integrate Adapty into your React Native app. Use the SDK integration skill below for an automated end-to-end flow, or follow the manual walkthrough further down.
...
**Guides:**
- [Enable purchases using paywalls (quickstart)](react-native-quickstart-paywalls)
- [Fetch Paywall Builder paywalls and their configuration](react-native-get-pb-paywalls)
- [Display paywalls](react-native-present-paywalls)
- [Handle paywall events](react-native-handling-events-1)
- [Respond to button actions](react-native-handle-paywall-actions)
...
**Guides:**
- [Enable purchases in your custom paywall (quickstart)](react-native-quickstart-manual)
- [Fetch paywalls and products](fetch-paywalls-and-products-react-native)
- [Render paywall designed by remote config](present-remote-config-paywalls-react-native)
- [Make purchases](react-native-making-purchases)
- [Restore purchases](react-native-restore-purchase)
...
- [Implement Observer mode](implement-observer-mode-react-native)
- [Report transactions in Observer mode](report-transactions-observer-mode-react-native)
...
**Guide:** [Check subscription status](react-native-check-subscription-status)
...
**Guide:** [Identify users](react-native-quickstart-identify)
