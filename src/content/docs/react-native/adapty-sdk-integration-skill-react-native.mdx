...
:::note
The skill is in beta. If it stalls or behaves unexpectedly, follow the [step-by-step integration guide](adapty-cursor-react-native) instead — it covers every stage manually.
:::
