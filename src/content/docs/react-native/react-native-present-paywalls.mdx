...
:::note
On Android, if the paywall does not extend behind the status bar, a gradient overlay may appear at its top. See [Gradient overlay at the top of the paywall (Android)](#gradient-overlay-at-the-top-of-the-paywall-android).
:::
...
### Gradient overlay at the top of the paywall (Android)
...
If the paywall does not extend behind the status bar, a gradient overlay may still appear at its top. To remove it, add the following boolean resource to your app:
