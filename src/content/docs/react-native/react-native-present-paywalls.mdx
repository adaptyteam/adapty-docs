...
If the paywall does not extend behind the status bar, a visual overlay may still appear at its top. To remove it, add the following boolean resource to your app:
