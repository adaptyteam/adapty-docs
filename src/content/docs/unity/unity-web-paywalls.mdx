...
:::important
Before you begin, make sure you have [configured your web paywall in the dashboard](web-paywall) and installed Adapty SDK version 3.14 or later.
:::
...
In SDK v4, the `paywall` argument takes an `AdaptyFlowPaywall` — one of the paywall variations in `flow.Paywalls`. See the [migration guide](migration-to-unity-sdk-v4).
:::
