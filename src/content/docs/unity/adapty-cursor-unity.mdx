...
**Guides:**
- [Enable purchases in a manual paywall (quickstart)](unity-quickstart-manual)
...
:::tip[Checkpoint]
- **Expected:** Your own paywall displays products fetched from Adapty. Tapping a product triggers the sandbox purchase dialog.
