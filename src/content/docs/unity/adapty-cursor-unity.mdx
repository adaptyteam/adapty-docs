...
This guide walks through integrating Adapty into your Unity app step by step with an AI coding tool — you feed it the right Adapty docs in the right order.
...
- [**Adapty Flow & Paywall Builder**](adapty-flow-builder): You create flows in Adapty's no-code builder, and the SDK renders them automatically.
- [**Manually created paywalls**](unity-quickstart-manual): You build your own paywall UI in code but still use Adapty to fetch products and handle purchases.
...
**Guides:**
- [Enable purchases with Flow & Paywall Builder (quickstart)](unity-quickstart-paywalls)
- [Fetch flows and their configuration](unity-get-pb-paywalls)
- [Display flows](unity-present-paywalls)
- [Handle flow events](unity-handling-events)
...
<TabItem value="manual" label="Manually created paywalls">
...
- [Render a manual paywall with remote config](present-remote-config-paywalls-unity)
