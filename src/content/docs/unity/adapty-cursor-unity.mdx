...
This page covers two ways to integrate Adapty into your Unity app. Use the SDK integration skill below for an automated end-to-end flow, or follow the manual walkthrough further down.

## Use the SDK integration skill (beta)

The [adapty-sdk-integration skill](https://github.com/adaptyteam/adapty-sdk-integration-skill) automates the integration end to end: dashboard setup, SDK install, paywall, and per-stage verification. The manual walkthrough further down is the fallback if your tool doesn't support the Claude Skills format.

**Supported tools**: Claude Code, GitHub Copilot CLI, OpenAI Codex, Gemini CLI.

### Install

Pick the form for your tool. The full list is in the [skill README](https://github.com/adaptyteam/adapty-sdk-integration-skill).

- **Claude Code**: Run `claude plugin marketplace add adaptyteam/adapty-sdk-integration-skill` then `claude plugin install adapty-sdk-integration@adapty` from your shell.
- **GitHub Copilot CLI**: Run `gh skill install adaptyteam/adapty-sdk-integration-skill`.
- **Gemini CLI**: Run `gemini skills install https://github.com/adaptyteam/adapty-sdk-integration-skill`.
...
In your project, run `/adapty-sdk-integration`. The skill detects your platform and asks a few setup questions. It then walks through dashboard setup, SDK install, paywall, and verification — fetching the relevant Adapty docs at each stage.

:::note
The skill is in beta. If it stalls or behaves unexpectedly, the manual walkthrough below covers every stage step by step.
:::
...
- [**Manually created paywalls**](unity-making-purchases): You build your own paywall UI in code but still use Adapty to fetch products and handle purchases.
...
Not sure which one to pick? Read the [comparison table in the quickstart](unity-quickstart-paywalls).
...
**Guide:** [Install & configure Adapty SDK](sdk-installation-unity)
...
**Guides:**
- [Enable purchases using paywalls (quickstart)](unity-quickstart-paywalls)
- [Fetch Paywall Builder paywalls and their configuration](unity-get-pb-paywalls)
- [Display paywalls](unity-present-paywalls)
- [Handle paywall events](unity-handling-events)
- [Respond to button actions](unity-handle-paywall-actions)
...
**Guides:**
- [Enable purchases in your custom paywall (quickstart)](unity-quickstart-manual)
- [Fetch paywalls and products](fetch-paywalls-and-products-unity)
- [Render paywall designed by remote config](present-remote-config-paywalls-unity)
- [Make purchases](unity-making-purchases)
- [Restore purchases](unity-restore-purchase)
...
- [Implement Observer mode](implement-observer-mode-unity)
- [Report transactions in Observer mode](report-transactions-observer-mode-unity)
...
**Guide:** [Check subscription status](unity-check-subscription-status)
...
**Guide:** [Identify users](unity-quickstart-identify)
