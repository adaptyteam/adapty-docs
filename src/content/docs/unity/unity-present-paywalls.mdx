...
- For a **manually implemented paywall**, see [Render a manual paywall with remote config](present-remote-config-paywalls-unity).
...
This guide covers the **old Paywall Builder**, which requires Adapty SDK 3.3.0 or later.

To present remote config paywalls, see [Render a manual paywall with remote config](present-remote-config-paywalls).
