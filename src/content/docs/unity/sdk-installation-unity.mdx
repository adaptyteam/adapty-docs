...
1. Install the [External Dependency Manager (EDM) plugin](https://github.com/googlesamples/unity-jar-resolver#getting-started). Adapty SDK uses it to handle iOS Cocoapods dependencies and Android gradle dependencies.
...
If your app crashes on Android when a paywall is displayed, the Kotlin plugin is missing from your Gradle configuration. To add it:
