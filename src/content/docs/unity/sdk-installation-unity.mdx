...
```
https://github.com/adaptyteam/AdaptySDK-Unity.git
```
...
1. Download and import the [External Dependency Manager plugin](https://github.com/googlesamples/unity-jar-resolver).
