---
title: "Handle errors - Unity"
description: "Troubleshoot and handle errors when using the Flow Builder in your Unity app."
metadataTitle: "Handle Flow Errors - Unity | Adapty Docs"
---
