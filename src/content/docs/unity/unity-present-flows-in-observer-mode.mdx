...
:::info
This capability requires Adapty Unity SDK 4.0 or later — previously it was available only in the native iOS and Android SDKs. See the [migration guide](migration-to-unity-sdk-v4) to upgrade.
:::
