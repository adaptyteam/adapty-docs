...
description: "Fix errors when displaying paywalls built in the old Paywall Builder in the Adapty Unity SDK."
metadataTitle: "Old builder errors | Unity SDK | Adapty Docs"
---
