...
This guide describes how to integrate Adapty into your custom paywalls. Keep full control over paywall implementation, while the Adapty SDK fetches products, handles new purchases, and restores previous ones. This guide uses Adapty Unity SDK v4 APIs — if you're on v3, see the [migration guide](migration-to-unity-sdk-v4) for the corresponding method names.
