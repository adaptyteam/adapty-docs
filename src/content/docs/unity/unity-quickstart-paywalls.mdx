...
If you don't want to use the paywall builder, see the [guide for handling purchases in manually created paywalls](unity-making-purchases).
:::
...
:::info
For more details on how to display a paywall, see our [guide](unity-present-paywalls).
:::
...
Now, you need to [check the users' access level](unity-check-subscription-status) to ensure you display a paywall or give access to paid features to right users.
