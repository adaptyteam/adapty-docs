...
:::important
To get the view, you must switch on the **Show on device** toggle in the Flow & Paywall Builder. Otherwise, `CreateFlowView` will return an error, and the flow won't be displayed.
:::
