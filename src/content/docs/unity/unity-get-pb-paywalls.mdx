...
:::note
If you are using multiple languages, add a localization to your paywall and learn how to use locale codes correctly [here](localizations-and-locale-codes).
:::
