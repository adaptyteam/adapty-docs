...
The app-specific shared secret keeps validating receipts during the transfer window, but the new owner must also regenerate it and update it in Adapty after the transfer completes.
:::
...
- Purchases and renewals (the app-specific shared secret keeps validating receipts during the transfer window)
