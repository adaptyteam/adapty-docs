---
title: "Track and run campaigns in Adapty Ads Manager"
description: "Get realtime analytics from Apple Ads and optimize your campaigns"
metadataTitle: "Track and run campaigns | Adapty Ads Manager | Adapty Docs"
...
:::important
Before you start using the Ads Manager, ensure you have completed the steps from [this guide](adapty-ads-manager-get-started).
:::

Adapty Ads Manager lets you do three important things in one place:
