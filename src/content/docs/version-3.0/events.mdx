...
:::note
Adapty Attribution offers a similar feature for Meta and TikTok campaigns: [Qualified trials](ua-facebook#qualified-trial) hold a trial event for 1 to 24 hours. `trial_active` waits 1 to 90 days. Both skip the send if the user has turned auto-renewal off. You configure them in different places, and they don't affect each other.
:::
