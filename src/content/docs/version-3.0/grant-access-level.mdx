...
This behavior is normal and won't affect analytics accuracy. Read more [here](ios-quickstart-identify).
:::
...
When your app launches, [check this attribute in the user’s profile](subscription-status) to grant access automatically.
