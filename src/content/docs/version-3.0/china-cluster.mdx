...
<InlineTooltip tooltip="Install Adapty SDK as described in the installation guide">[iOS](sdk-installation-ios), [Android](sdk-installation-android), [React Native](sdk-installation-reactnative), [Flutter](sdk-installation-flutter), [Unity](sdk-installation-unity), and [Kotlin Multiplatform](sdk-installation-kotlin-multiplatform)</InlineTooltip>.
...
:::info
The China cluster requires Adapty Kotlin Multiplatform SDK 4.0 (beta) or later.
:::
