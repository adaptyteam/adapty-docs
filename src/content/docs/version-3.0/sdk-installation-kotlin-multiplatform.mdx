...
If you plan to activate the **AdaptyUI** module to use [Adapty's no-code builders](kmp-present-paywalls), make sure to set `.withActivateUI(true)` in your configuration.
