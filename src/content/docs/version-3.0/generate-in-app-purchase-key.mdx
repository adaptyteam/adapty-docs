...
:::note
To generate API keys for the App Store Server API, you must hold either an Admin role or an Account Holder role in App Store Connect. You can also read about how to generate API Keys in the [Apple Developer Documentation](https://developer.apple.com/documentation/appstoreserverapi/creating-api-keys-to-authorize-api-requests).
:::
...
:::warning
If this key is later revoked or deleted, Adapty can't sign promotional offers and those discounts stop applying at purchase. Adapty doesn't flag it — see [If updates stop arriving](store-sync#if-updates-stop-arriving).
:::
