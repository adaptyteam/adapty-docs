...
To swap a font without affecting older versions, [copy the flow](manage-flows), change the font in the copy, and restrict the copy to [app versions that include the font](segments).
