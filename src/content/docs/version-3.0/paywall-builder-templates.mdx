...
metadataTitle: "Create a flow | Flow & Paywall Builder | Adapty Docs"
...
4. Rename the flow in the builder. Click the flow name in the header and enter a new name.
...
:::link
Main article: [Custom fonts in the builder](using-custom-fonts-in-flow-builder)
:::
