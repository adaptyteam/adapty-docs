...
1. If you want to enable external payments for an existing paywall, you need to [duplicate](duplicate-paywalls) it so you can show it only to your U.S. user segment and show the old one to all the other users. If you want to start from scratch, [create](create-paywall) a new paywall.
...
:::tip
Use our [quickstart guide](web-paywall-configuration) that will help you to launch a working web paywall.
:::
