...
For more details about the method, check out [Fetch the view configuration of a paywall created with the old Paywall Builder](get-pb-paywalls#fetch-the-view-configuration-of-a-paywall-created-with-the-old-paywall-builder).
