...
If you are building flows in the Adapty Flow & Paywall Builder, it's crucial to set up buttons properly:
...
1. In the old Paywall Builder, add a button and assign it either a pre-existing action or a custom action ID.
2. Write code in your app to handle each action you've assigned.
