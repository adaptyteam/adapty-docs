...
<ZoomImage id="refund-saver-consent-policy.png" width="400px" alt="Default consent policy setting on the Apple tab of the Edit Refund saver preferences window" />
...
<ZoomImage id="refund-saver-profile-settings.png" width="400px" alt="Refund saver settings card on a user's profile in the Dashboard" />
