...
- **Prorated refunds are App Store only:** Google Play grants a refund in full or not at all. The Google tab doesn't offer the app-level option, and Adapty replaces the per-user **Grant prorated refund** preference with no preference on Google Play.