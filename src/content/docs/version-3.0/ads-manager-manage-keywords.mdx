...
- The **Bid History** tab lists each bid change: its date, type, previous and new values, and what changed it — a person or an automation rule (shown with the rule's ID).
