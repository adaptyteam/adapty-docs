...
To view bid history for a keyword, click the **Bid History** button next to it in the table. A panel opens with two tabs.
...
- The **Bid History** tab shows a table of all bid changes in reverse chronological order, with the previous and new bid values, the date of each change, and what triggered it.
