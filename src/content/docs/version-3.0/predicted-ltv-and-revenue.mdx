...
- **Insufficient time since cohort creation**: The cohort's install period hasn't fully elapsed yet, or the longest trial someone could have started during that period hasn't had time to convert. See [Availability and updates](#availability-and-updates).
