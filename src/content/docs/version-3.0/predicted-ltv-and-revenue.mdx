...
- **Data quality**: Unusual cohort behavior or cohorts with very few paying subscribers reduce accuracy. Cohorts with fewer than 30 paying subscribers are excluded from the model's training data.
