...
Consistency in visuals is key to great design. When building flows, you might want to use a custom font to match the rest of your app. Here's how to add custom fonts and use them in your flows.
...
<ZoomImage id="upload-new-font.webp" width="500px" alt="Add custom font" />
