...
1. Render [a manual paywall with remote config](present-remote-config-paywalls-unity) as usual. For flows & paywalls built in the Flow & Paywall Builder, see [Present flows in Observer mode](unity-present-flows-in-observer-mode).
