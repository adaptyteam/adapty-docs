...
|:---------------------|:----------|:---------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Attribution          | ✅         | ✅        | Filter or group metrics by Attribution fields like Status, Channel, Campaign, Adgroup, Adset, and Creative. To be able to filter/group data by **Attribution**, you need to set up the [attribution integration](attribution-integration) first.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
