...
| --- | :---: | :---: | --- |
| Attribution | ✅ | ✅ | Reported by, Status, Channel, Campaign, Ad Group, Ad Set, and Creative (Keyword). Requires the [attribution integration](attribution-integration). |
...
| Paywall (Deprecated) | ✅ | ✅ | The legacy paywall option. Visible only on accounts with data from legacy SDK versions. Use the Paywall row above for current data. |
