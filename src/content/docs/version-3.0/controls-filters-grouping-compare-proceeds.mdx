...
| Offer Type | ✅ | ✅ | The offer applied to the transaction: <ul><li>**Introductory** — an introductory offer on the initial subscription period. Use **Offer Discount Type** to distinguish between paid intros and free trials.</li><li>**Promotional** — App Store Promotional Offers and equivalents.</li><li>**Offer Code** — promo codes the customer enters in the store.</li><li>**No offer** — no offer applied.</li></ul> |
