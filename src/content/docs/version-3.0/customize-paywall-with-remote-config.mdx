...
:::important
This guide covers remote config for classic paywalls. For the Flow & Paywall Builder, see [Customize flow with remote config](customize-flow-with-remote-config).
:::
