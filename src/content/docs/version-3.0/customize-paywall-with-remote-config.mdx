...
:::important
This guide covers remote config for classic paywalls. For Flow & Paywall Builder, see [Customize flow with remote config](customize-flow-with-remote-config).
:::
