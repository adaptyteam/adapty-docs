...
- [Create virtual currency transaction](api-adapty/operations/createVirtualCurrencyTransaction)
- [List virtual currency transactions](api-adapty/operations/listVirtualCurrencyTransactions)
- [List virtual currency balances](api-adapty/operations/listVirtualCurrencyBalances)
