...
| variationId     | optional | The string identifier of the variation. You can get it using `variationId` property of the [AdaptyPaywall](https://android.adapty.io/adapty/com.adapty.models/-adapty-paywall/) object. |
