---
title: "Custom tags in the old Paywall Builder"
description: "Documentation for custom tags in the old Paywall Builder — soon to be discontinued."
metadataTitle: "Custom tags | Old builder | Adapty Docs"
keywords: ['tags', 'tag']
---
