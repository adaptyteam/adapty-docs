...
{/* TODO: Confirm how Global Pricing works with the update */}
...
- **Pricing Potential**: Real transaction data from the [Adapty Pricing Index](https://uploads.adapty.io/adapty_pricing_index.pdf) that shows how prices in different countries compare to the US benchmark
...
You can act on these recommendations directly by adding them as [geo-pricing rounds](autopilot#geo-pricing-rounds) in your growth plan.
