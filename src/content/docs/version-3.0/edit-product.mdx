...
:::warning
Changes you make in App Store Connect or Google Play Console don't sync back to Adapty. The price shown in Adapty is set when you create the product and won't update if you change the price in the store. This doesn't affect your revenue analytics, because [revenue reports use the amount the customer actually paid](store-sync#product-and-price-discrepancies).
:::
