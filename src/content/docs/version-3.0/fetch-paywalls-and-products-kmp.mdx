---
title: "Fetch a manual paywall and its products in Kotlin Multiplatform SDK"
description: "Fetch a paywall and its products in the Adapty Kotlin Multiplatform SDK when you render the screen yourself."
...
Before showcasing manually implemented paywalls, you need to fetch the information about them. Please be aware that this topic refers to manually implemented paywalls. For guidance on fetching flows or paywalls built in Adapty's no-code builders, please consult [Get flows & paywalls](kmp-get-pb-paywalls).
...
Before showcasing manually implemented paywalls, you need to fetch the information about them. Please be aware that this topic refers to manually implemented paywalls. For guidance on fetching paywalls for Paywall Builder-customized paywalls, please consult [Fetch Paywall Builder paywalls and their configuration](kmp-get-pb-paywalls).
