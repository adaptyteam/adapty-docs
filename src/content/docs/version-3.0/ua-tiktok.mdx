...
4. (Optional) To send the conversion events back to TikTok, you can also associate your pixels from TikTok with campaigns in Adapty Attribution. To do that, select one of your existing pixels in the **Pixel** dropdown.
