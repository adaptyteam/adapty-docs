...
Work through this checklist before you publish, to confirm the monetization flow works end to end in a real build.
...
- You use Adapty in the observer mode (either with a builder-made paywall or one you implement yourself)
...
<TabItem value="makepurchase" label="Manual paywall (makePurchase)" default>
