...
1. In Adapty Mail, go to **Settings → DNS**.
...
6. Return to **Settings → DNS** and click **Check Verification**.
...
- **Verification window**: 7 days. If it lapses, your DNS records stay in place — re-enter your domain in **Settings → DNS** to start a new window.
...
| Verification window expired    | Your records remain in place. Re-enter your domain in **Settings → DNS** to start a new window                  |
