...
- **FunnelFox**: In Adapty Mail, copy the secret key from **Settings** > **Project**. In FunnelFox, go to **Integrations** > **Adapty Mail**, paste the key, and save. Data starts arriving within about a minute.
