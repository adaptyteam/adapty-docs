...
:::tip
Using an AI coding agent? See [Check and grant subscription access from your backend](server-side-api-with-ai) for an end-to-end recipe on one page.
:::
...
You can [update remote configs in paywalls](api-adapty/operations/updatePaywall) to dynamically adjust your paywall appearance and behavior without redeploying your app.
