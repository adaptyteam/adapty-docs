...
Next, assign a paywall, onboarding, or A/B test to the placement. Adapty supports [audiences](audience) — user segments based on [segments](segments) — so you can show different content to different user groups. If you don't need targeting, the default *All users* audience covers everyone.
