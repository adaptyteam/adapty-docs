...
metadataTitle: "Buttons | Flows & paywalls | Adapty Docs"
---
...
:::info
This section describes the new Flow & Paywall Builder, which works with Adapty SDKs version 4.0 or higher.
:::

Buttons are the interactive elements in the Flow & Paywall Builder that respond to user taps. Use them for:
