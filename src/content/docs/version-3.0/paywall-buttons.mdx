---
title: "Buttons in the Flow & Paywall Builder"
description: "Add and configure action buttons in the Flow & Paywall Builder."
metadataTitle: "Buttons | Flow & Paywall Builder | Adapty Docs"
---
...
:::info
This section describes the new builder, which works with Adapty SDKs version 4.0 or higher.
:::

Buttons are the interactive elements in the builder that respond to user taps. Use them for:
...
:::tip
You can attract more attention to purchase buttons by animating them. The builder currently supports the **Pulse** animation type.
