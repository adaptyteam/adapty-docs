...
:::important
The **Terms of Use** and **Privacy Policy** buttons have a built-in **Open URL** action. Set the destination URL there. Empty Open URLs and [inline links](onboarding-text#inline-link) block preview and publish.
:::
