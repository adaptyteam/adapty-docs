...
In the [Meta Ads](ua-facebook) and [TikTok for Business](ua-tiktok) integrations, you can set up fallback values for deferred data parameters. If deferred data is not retrieved from the click link, these fallback values will be used instead.
