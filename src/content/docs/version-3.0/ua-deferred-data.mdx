...
metadataTitle: "Deferred deeplinks | Adapty Attribution | Adapty Docs"
...
:::important
Starting from Adapty SDK version 4.1, Adapty Attribution is disabled by default. The `onInstallationDetailsSuccess` callback fires only after you [enable Adapty Attribution when activating the SDK](user-acquisition#step-1-enable-adapty-attribution-in-the-sdk).
:::
...
1. If your campaign runs on Meta Ads or TikTok, find your tracking link in **Integrations** > **Meta Ads** or **TikTok Ads**. If your campaign targets a different platform, open **Integrations** > **Custom**. Then copy the link you want to use.
