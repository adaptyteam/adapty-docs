...
:::important
Adapty cannot automatically detect your enrollment in reduced commission programs. To ensure correct calculations, specify your [Small Business Program](app-store-small-business-program) and [Reduced Service Fee program](google-reduced-service-fee) status in your [app settings](general).
:::
