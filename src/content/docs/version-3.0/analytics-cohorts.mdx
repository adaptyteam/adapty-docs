...
These predictions are based on historical cohort retention patterns, using the app's own data when enough history is available and cross-app averages otherwise. For detailed documentation on Adapty's prediction model, please refer to our [Prediction documentation](predicted-ltv-and-revenue).
