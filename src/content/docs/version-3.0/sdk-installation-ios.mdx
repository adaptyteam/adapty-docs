...
If you plan to use [Paywall Builder](adapty-paywall-builder) and have [installed AdaptyUI module](sdk-installation-ios#install-adapty-sdk), you also need to activate AdaptyUI.
