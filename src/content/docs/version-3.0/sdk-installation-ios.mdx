...
When building with [Tuist](https://tuist.io), you may see Swift 6 strict concurrency compilation errors. Typical symptoms include `@Sendable` attribute mismatches in `AdaptyUIBuilderLogic` or similar cross-module Sendability errors.
