...
- **AdaptyUI**: This optional module renders the screens Adapty draws for you — flows built in the [Flow & Paywall Builder](adapty-flow-builder), and legacy builder paywalls.
...
Adapty iOS SDK requires iOS 15.0 or later.
...
- If you build your own paywall UI, see the [quickstart for manual paywalls](ios-quickstart-manual).
