...
- **AdaptyUI**: This optional module renders the screens Adapty draws for you — flows built in the [Flow & Paywall Builder](adapty-flow-builder), and legacy Paywall Builder paywalls.
...
- If you use the [Flow & Paywall Builder](adapty-flow-builder), first [activate the AdaptyUI module](#activate-adaptyui-module-of-adapty-sdk) below, then follow the [Paywall Builder quickstart](ios-quickstart-paywalls).
