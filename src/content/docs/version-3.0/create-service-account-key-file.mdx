---
title: "Generate service account key file in the Google Cloud Console"
...
To link your mobile app on the Play Store with Adapty, you'll need to generate special service account key files in the Google Cloud Console and upload them to Adapty. These files help secure your app and prevent unauthorized access.
...
1. Open the [**Service accounts**](https://console.cloud.google.com/iam-admin/serviceaccounts) section in the Google Cloud Console. Ensure you’ve selected the correct project.  
