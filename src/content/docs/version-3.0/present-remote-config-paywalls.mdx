---
title: "Render a manual paywall with remote config in iOS SDK"
description: "Read remote config values and render your own paywall screen in the Adapty iOS SDK."
metadataTitle: "Remote config in a manual paywall | iOS SDK | Adapty Docs"
...
To log a paywall view event, simply call `.logShowFlow(flow)`, and it will be reflected in your paywall metrics in funnels and A/B tests.
