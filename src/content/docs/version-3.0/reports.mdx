...
<ZoomImage id="bf5cdab-email_reports.webp" width="700px" alt="Email reports settings" />

2. Customize each report type by selecting the relevant apps. For this, click the **Edit** button.

<ZoomImage id="ebe22ac-email_reports_apps.webp" width="700px" alt="Per-app selection for email reports" />
...
<ZoomImage id="59ad3d8-time_zone.webp" width="700px" alt="Time zone setting on the Overview page" />
