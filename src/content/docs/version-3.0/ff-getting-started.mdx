...
To get started, just [add the Adapty library](ff-getting-started#add-the-adapty-library-as-a-dependency) to your FlutterFlow project and [initiate it](ff-getting-started#initiate-adapty-plugin) as shown below.
