---
title: "Tag variables for product info in the old Paywall Builder"
description: "Documentation for tag variables in the old Paywall Builder — soon to be discontinued."
metadataTitle: "Tag variables | Old builder | Adapty Docs"
---
