---
title: "Tag variables for product info in the legacy Paywall Builder"
description: "Fill product names, prices, and offer details into a legacy builder paywall's text, localized per store."
metadataTitle: "Tag variables | Legacy builder | Adapty Docs"
---
...
Flows handle dynamic values differently, without tags — see [Variables](onboarding-variables).
