...
Paywall timers are available in the [Paywall Builder](adapty-paywall-builder) and require Adapty SDK 3.0 or later on iOS, Android, and React Native, or 3.3.0 or later on Flutter and Unity. Earlier SDK versions don't support them.
