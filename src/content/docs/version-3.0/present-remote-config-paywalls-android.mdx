---
title: "Render a manual paywall with remote config in Android SDK"
description: "Read remote config values and render your own paywall screen in the Adapty Android SDK."
metadataTitle: "Remote config in a manual paywall | Android SDK | Adapty Docs"
