...
Before showcasing remote config and custom paywalls, you need to fetch the information about them. Please be aware that this topic refers to remote config and custom paywalls. For guidance on fetching flows or paywalls built in Adapty's no-code builders, please consult [Fetch Flow & Paywall Builder flows and Paywall Builder paywalls and their configuration](react-native-get-pb-paywalls).
