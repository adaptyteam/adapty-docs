...
- **Manually implemented paywall**: You create a paywall, attach products to it, and render the UI yourself in app code.
- **Adapty Paywall Builder (Legacy)**: No-code paywall editor.

Whichever you choose, you attach what you built to a [placement](placements). The placement is what your app calls at runtime to fetch the right content for the right user.
...
Learn more about the [Adapty Flow & Paywall Builder](adapty-flow-builder).
...
You'll render this paywall in your app code. <InlineTooltip tooltip="implementing paywalls manually">Follow the guide for your platform: [iOS](ios-implement-paywalls-manually), [Android](android-implement-paywalls-manually), [React Native](react-native-implement-paywalls-manually), [Flutter](flutter-implement-paywalls-manually), [Unity](unity-implement-paywalls-manually), [Kotlin Multiplatform](kmp-implement-paywalls-manually), [Capacitor](capacitor-implement-paywalls-manually).</InlineTooltip>
