...
:::tip
To measure a flow against the rest of your revenue, use the **Flow** and **Flow screen** attributes on the [Charts](charts) tab. They filter and group the standard metrics — Revenue, MRR, trials, refunds — the same way Country or Product do. See [Analytics controls](controls-filters-grouping-compare-proceeds#filter-and-group-data).
:::
