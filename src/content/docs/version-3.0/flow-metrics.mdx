...
:::note
The **Developer** role [excludes analytics](members-settings) — members with that role can't view flow metrics. In the [flow list](filter-flows), the metric columns stay empty.
:::
