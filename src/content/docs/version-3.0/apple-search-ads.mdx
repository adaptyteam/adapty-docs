...
[Apple Ads Manager](adapty-ads-manager) uses a separate connection. Connect your Apple Ads account in the [Apple Ads Manager settings](adapty-ads-manager-get-started).
:::
