...
1. Display [remote config paywalls](present-remote-config-paywalls-android) as usual. For flows & paywalls built in the Flow & Paywall Builder, see [Present flows in Observer mode](android-present-paywall-builder-paywalls-in-observer-mode).
