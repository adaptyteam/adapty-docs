...
<ZoomImage id="new-currency-step-1.webp" width="500px" alt="The General step of the New virtual currency drawer, with Code, Name, and Description fields" float="right" />
...
<ZoomImage id="new-currency-step-2.webp" width="500px" alt="The Link Products step, linking a one-time product and a subscription product with their credit settings" float="right"/>
...
- **Subscription products** have two credit fields:
...
- Grant, spend, and read balances at runtime through the [server-side API](virtual-currencies#example-granting-and-spending-coins).
