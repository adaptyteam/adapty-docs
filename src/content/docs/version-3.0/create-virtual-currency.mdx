...
- **Subscription products** have two credit fields:
    ...
    For subscription products, you also choose whether unused credits carry over between billing cycles — see [Credit expiration](#credit-expiration).
