...
description: "Fetch a paywall and its products in the Adapty iOS SDK when you render the screen yourself."
metadataTitle: "Fetch paywalls and products | iOS SDK | Adapty Docs"
