---
title: "Fetch a manual paywall and its products in iOS SDK"
description: "Fetch paywalls and products in Adapty iOS SDK to enhance user monetization."
metadataTitle: "Fetch a manual paywall | iOS SDK | Adapty Docs"
...
Before showcasing manually implemented paywalls, you need to fetch the information about them. Please be aware that this topic refers to manually implemented paywalls. For guidance on fetching flows or paywalls built in Adapty's no-code builders, please consult the <InlineTooltip tooltip="guides on how to fetch flows and paywalls in your app">[iOS](get-pb-paywalls), [Android](android-get-pb-paywalls), [React Native](react-native-get-pb-paywalls), [Flutter](flutter-get-pb-paywalls), and [Unity](unity-get-pb-paywalls)</InlineTooltip>.
...
Before showcasing manually implemented paywalls, you need to fetch the information about them. Please be aware that this topic refers to manually implemented paywalls. For guidance on fetching paywalls for Paywall Builder-customized paywalls, please consult the <InlineTooltip tooltip="guides on how to fetch Paywall Builder paywalls in your app">[iOS](get-pb-paywalls), [Android](android-get-pb-paywalls), [React Native](react-native-get-pb-paywalls), [Flutter](flutter-get-pb-paywalls), and [Unity](unity-get-pb-paywalls)</InlineTooltip>.
