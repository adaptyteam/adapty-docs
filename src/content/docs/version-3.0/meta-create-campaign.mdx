...
4. For [Adapty User Acquisition](adapty-user-acquisition), you won't need to complete the full installation of the pixel. So, when asked about the integration, you can just click **x** in the setup window, and your pixel will still appear on the list after you refresh the page.
...
Then, you can [explore how the campaign affects your app revenue in the Adapty User Acquisition dashboard](adapty-user-acquisition).
