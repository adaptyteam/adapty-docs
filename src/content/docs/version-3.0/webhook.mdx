...
:::tip
Setting this up with an AI coding agent? See [Handle Adapty subscription events with webhooks](handle-webhooks-with-ai) for an end-to-end guide on one page.
:::
