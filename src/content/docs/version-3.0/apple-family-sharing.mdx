...
:::important
This default is reversed for a product Adapty creates for you. If you used [Create product and push to store](create-product#create-product-and-push-to-store) instead of creating the subscription yourself in App Store Connect, Family Sharing starts **on**. As with any Family Sharing setting, you can't turn it off afterward — to keep the product from being shared, disable Family Sharing in App Store Connect before the subscription's first review, or create the subscription there yourself instead of pushing it from Adapty.
:::
