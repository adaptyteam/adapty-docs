...
import RetroactiveSettingChanges from '@site/src/components/reusable/RetroactiveSettingChanges.mdx';
...
:::warning
Configure your Reduced Service Fee status in Adapty **as soon as you enroll**. Late changes cannot rewrite delivered webhook events ([details](#retroactive-setting-changes)).
:::
