...
The Adapty pods declare `s.swift_version = '6.0'` and require Swift 6 to build. Only the Adapty pod targets (`Adapty`, `AdaptyUI`, `AdaptyUIBuilder`, `AdaptyLogger`) need to build with Swift 6 — your own app code can stay on Swift 5.
