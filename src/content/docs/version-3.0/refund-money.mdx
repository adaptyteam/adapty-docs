...
The Refund Saver answers refund requests from the App Store and Google Play automatically. It saves time and reduces revenue loss: the refunds it prevents never appear on the Refund money chart.
