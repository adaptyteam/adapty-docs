...
To register your company in the EU cluster, use https://app.adapty.io/eu-registration. Once registered, you can [add employees](members-settings#add-a-member) in the Adapty Dashboard as usual.
