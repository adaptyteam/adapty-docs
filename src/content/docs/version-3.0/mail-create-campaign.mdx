...
:::tip
The steps below create a marketing campaign. The **Transactional** tab on the **Campaigns** page holds the confirmation campaign that [double opt-in](mail-double-opt-in) writes for you.
:::
