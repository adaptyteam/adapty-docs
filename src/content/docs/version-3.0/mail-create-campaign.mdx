...
- **Saved web paywall**: Every campaign must link to a web paywall. The backend rejects campaigns without one. See [Create a web paywall](mail-get-started#5-create-a-web-paywall) if you don't have one yet.
