---
title: "Get started with Adapty Ads Manager"
description: "Import your historical data from Apple Ads and start getting real-time updates on the dashboard"
metadataTitle: "Get started | Adapty Ads Manager | Adapty Docs"
keywords: ['adapty ads manager', 'adapty search ads', 'apple ads manager', 'asa']
---
import ZoomImage from '@site/src/components/ZoomImage';

[Adapty Ads Manager](adapty-ads-manager) is your optimization and analytics platform for Apple Ads.

In this guide, you will learn how to start working with Adapty Ads Manager in two steps:

1. Install the Adapty SDK and let it track your purchase data.
2. Connect Adapty Ads Manager to your Apple Ads account to import your historical data and start tracking real-time updates.

:::note
Adapty Ads Manager does not use the [Apple Ads integration](apple-search-ads) from **App settings**.

To use Adapty Ads Manager, you only need to complete the setup described in this guide.
:::
...
Now, you need to connect your Adapty Ads Manager account to your Apple Ads account:
...
4. Select which access you want to give to Adapty Ads Manager:
