...
[Apple Ads Manager](adapty-ads-manager) is your optimization and analytics platform for Apple Ads.
...
:::note
Apple Ads Manager does not use the [Apple Ads integration](apple-search-ads) from **App settings**.
