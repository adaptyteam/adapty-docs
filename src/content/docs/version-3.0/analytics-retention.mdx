...
<ZoomImage id="86dc5ac-CleanShot_2023-01-09_at_18.56.15.webp" width="700px" alt="Retention chart" />
...
Adapty dates each subscriber by the day their subscription began — the trial start for products with a trial, the first payment for products without one. Someone who starts a trial on March 1 and pays on April 1 belongs to March, whichever way **Show trials** is set.
...
### Products with different durations

The steps on the chart are subscription periods, not fixed amounts of time. P2 means the second period for every product, so a weekly subscriber reaches it after a week and an annual subscriber after a year. Both land in the same column.

If you sell more than one duration, the default curve blends them, and it shifts whenever your product mix does. Group or filter by **Duration** or **Product** to read one at a time.

### Refund handling

Refunds are **not** excluded from retention. A refunded user stays counted on the retention curve, which can make Retention look higher than [Active subscriptions](active-subscriptions) or [Revenue](revenue) for the same cohort.
...
<ZoomImage id="e10de4a-CleanShot_2022-07-11_at_21.06.45.webp" width="700px" alt="Audience-focused retention view" />
...
<ZoomImage id="26a7026-CleanShot_2022-07-11_at_21.36.36.webp" width="700px" alt="Product-focused retention view" />
