...
If you implement your purchase screen yourself, you need to create a **paywall** in Adapty. It defines which products you sell, in what order, and with which promotional offers. Flows work differently: products attach to the flow itself. A paywall you implement yourself is also called a **custom paywall**.
