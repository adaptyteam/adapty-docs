...
The new subscriptions metric counts first-time activations during the period — both subscriptions that start from scratch and free trials that convert into paid subscriptions.
