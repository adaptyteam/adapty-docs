...
If you are not using the old Adapty Paywall Builder to design paywalls, you can still localize your custom paywalls and manage localizations without redeploying your app:
