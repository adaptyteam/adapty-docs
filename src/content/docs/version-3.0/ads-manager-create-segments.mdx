---
title: "Create segments based on Apple Ads attribution in Adapty Ads Manager"
description: "Create segments from campaigns, ad groups, and keywords in two clicks in Adapty Ads Manager."
metadataTitle: "Create segments | Adapty Ads Manager | Adapty Docs"
keywords: ['adapty ads manager', 'adapty search ads', 'apple ads', 'asa', 'apple ads segments', 'attribution segments']
---
import ZoomImage from '@site/src/components/ZoomImage';

You can create user [segments](segments) directly from [Adapty Ads Manager](adapty-ads-manager) by selecting campaigns, ad groups, or keywords and turning them into segments in a few clicks. It makes it easy to personalize paywalls and offers based on an acquisition source, without setting up segment conditions manually.
...
To create a segment from Adapty Ads Manager:
...
- Add it to a [placement](placements) to use with an existing paywall or onboarding
- Design a new [paywall](adapty-paywall-builder) or [onboarding](onboardings) that will be displayed to users in the segment
- Run an [A/B test](ab-tests)
