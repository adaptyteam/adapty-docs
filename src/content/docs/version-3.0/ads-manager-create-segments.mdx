---
title: "Create segments based on Apple Ads attribution in Adapty Search Ads"
description: "Create segments from campaigns, ad groups, and keywords in two clicks in Adapty Search Ads."
metadataTitle: "Create segments | Adapty Search Ads | Adapty Docs"
keywords: ['adapty search ads', 'apple ads', 'asa', 'apple ads segments', 'attribution segments']
---
import ZoomImage from '@site/src/components/ZoomImage';

You can create user [segments](segments) directly from [Adapty Search Ads](adapty-ads-manager) by selecting campaigns, ad groups, or keywords and turning them into segments in a few clicks. It makes it easy to personalize paywalls and offers based on an acquisition source, without setting up segment conditions manually.
...
To create a segment from Adapty Search Ads:
