...
- **No-code flows created in the builder**: If you specified a locale in the builder, Adapty applies it automatically. To force the SDK to render a specific locale, pass its code with the optional `locale` parameter.
