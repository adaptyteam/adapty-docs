...
The **Transactional** tab holds one more trigger, **Profile created**. It fires once, when a profile appears, and carries the confirmation flow that [double opt-in](mail-double-opt-in) creates.
