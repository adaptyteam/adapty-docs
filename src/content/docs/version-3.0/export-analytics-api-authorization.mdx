...
EU-hosted apps send requests to `https://api-eu-admin.adapty.io` instead of `https://api-admin.adapty.io`. If you're not sure which one applies to your app, contact [Adapty support](mailto:support@adapty.io).
