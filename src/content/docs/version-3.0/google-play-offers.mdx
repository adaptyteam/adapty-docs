...
:::important
Paywalls built in Adapty's no-code builders display only the first phase of a multi-phase Google subscription offer. When a user purchases the product, all offer phases apply as configured in Google Play.
:::
...
- If you have **apps in App Store as well**, go to the [App Store guide](app-store-offers).
