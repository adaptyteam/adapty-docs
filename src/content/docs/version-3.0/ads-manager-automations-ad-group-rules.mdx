...
6. Under **Schedule**, set how often the rule runs — from **Every hour** to **Every 90 days**, or **Once** — and its start time (UTC). To also run the rule as soon as you save it, select **Run this rule right now**.
