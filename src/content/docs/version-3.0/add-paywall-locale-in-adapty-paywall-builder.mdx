...
Localizing your flows makes them available in multiple languages. In the Flow Builder, localization is organized by screen — each screen shows a completion percentage so you can track progress per screen.
