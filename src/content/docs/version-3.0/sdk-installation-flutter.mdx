...
Adapty Flutter SDK requires **iOS 15.0+**, **Xcode 26+**, and **Flutter 3.32.0+** (Dart 3.8.0+). See [Adapty SDK 4.0: Swift Package Manager](#adapty-sdk-40-swift-package-manager) below for the installation specifics.
...
:::important
These steps require **Flutter 3.32.0+** (Dart 3.8.0+). The plugin pulls the native iOS SDK through Swift Package Manager — see [Adapty SDK 4.0: Swift Package Manager](#adapty-sdk-40-swift-package-manager) for the one-time iOS setup.
:::
