...
From 3.17.0, Adapty Flutter SDK uses Billing Library v8 by default. Versions 3.15.0 through 3.15.5 use v7, and also work when another dependency in your Android build raises the Billing Library to v8.
