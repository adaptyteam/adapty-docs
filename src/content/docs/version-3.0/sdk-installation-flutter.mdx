...
:::info
Adapty Flutter SDK 4.0 (beta) — which adds [Flow Builder](adapty-flow-builder) support — raises the minimums: **iOS 15.0+**, **Xcode 26+**, and **Flutter 3.32.0 (Dart 3.8.0)+**. See [Adapty SDK 4.0 (beta)](#adapty-sdk-40-beta-swift-package-manager) below for the installation specifics.
:::
