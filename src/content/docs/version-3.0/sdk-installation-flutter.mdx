...
The module is activated automatically with the Adapty SDK. If you do not use Adapty's no-code builders and want to deactivate the AdaptyUI module, pass `withActivateUI(false)` during activation.
