...
Adapty Flutter SDK 4.0 — which adds [Flow & Paywall Builder](adapty-flow-builder) support — raises the minimums to **iOS 15.0+**, **Xcode 26+**, and **Flutter 3.32.0+** (Dart 3.8.0+). See [Adapty SDK 4.0](#adapty-sdk-40-swift-package-manager) below for the installation specifics.
...
Add Adapty Flutter SDK 4.0 — which adds [Flow & Paywall Builder](adapty-flow-builder) support — to your `pubspec.yaml`:
...
- If you build your own paywall UI, see the [quickstart for manual paywalls](flutter-quickstart-manual).
