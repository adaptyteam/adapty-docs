...
keywords: ['adapty mail', 'checkout', 'web paywall', 'stripe', 'paddle', 'paypal']
---
...
- A web payment provider account (Stripe, Paddle, or PayPal) with your subscription products configured — connected inside the web paywall builder, not in Adapty Mail
...
3. If generating: click **Open paywall editor**. The web paywall builder opens in a new tab with you already signed in.
4. In the builder, connect your payment provider (Stripe, Paddle, or PayPal) under payment settings.
