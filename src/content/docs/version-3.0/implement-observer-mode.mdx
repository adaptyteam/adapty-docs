...
1. Display [remote config paywalls](present-remote-config-paywalls) as usual. For flows & paywalls built in the Flow & Paywall Builder, see [Present flows in Observer mode](ios-present-paywall-builder-paywalls-in-observer-mode).
