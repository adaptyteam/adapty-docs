...
If you also need flows, paywalls, and A/B testing, additional setup is required, as described below.
...
1. Render [a manual paywall with remote config](present-remote-config-paywalls) as usual. For flows & paywalls built in the Flow & Paywall Builder, see [Present flows in Observer mode](ios-present-paywall-builder-paywalls-in-observer-mode).
2. [Associate flows & paywalls](report-transactions-observer-mode) with purchase transactions.
