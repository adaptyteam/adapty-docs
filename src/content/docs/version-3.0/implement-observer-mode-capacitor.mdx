...
1. Display [remote config paywalls](present-remote-config-paywalls-capacitor) as usual. For flows & paywalls built in the Flow Builder, see [Present flows in Observer mode](capacitor-present-flows-in-observer-mode).
