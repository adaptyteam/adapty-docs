...
- [In Analytics](controls-filters-grouping-compare-proceeds#filtering-and-grouping), filter by segments to view performance for specific user groups. Group by segment to compare performance or contribution within **All users**.
...
- Changing a custom attribute after it's used in a segment may unsync the user from that segment in [analytics](controls-filters-grouping-compare-proceeds#filtering-and-grouping). Data will reflect the previous value.
:::
