...
2. Use the `.updateExternalAttribution()` method (named `.updateAttribution()` before SDK version 4.1) to save the attribution data. If you did not specify the Branch user ID in the previous step, pass it to the `networkUserId` parameter here.
