...
1. Open the [Google Play Console](https://play.google.com/console/), go to the **Users and permissions** page, and click the **Invite new users** button.
...
- [Generate the service account key file in the Google Cloud Console](create-service-account-key-file)