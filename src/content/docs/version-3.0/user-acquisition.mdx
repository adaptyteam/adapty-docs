...
:::important
User Acquisition is available with:
- iOS, Android, and Flutter SDK version 3.9.0 or higher.
...
You can check the full list of supported events [here](events).
...
In the [Adapty UA analytics dashboard](ua-analytics), you will see campaign-level metrics such as:
...
- [**Analytics in Adapty UA**](ua-analytics): See how to use the analytics dashboard effectively.
- [**Metrics in Adapty UA**](ua-metrics): Explore the metrics available for user acquisition analysis.
- [**Integrations**](ua-integrations): Review the ad platforms and integrations supported by Adapty UA.
