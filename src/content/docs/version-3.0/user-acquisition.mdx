...
Starting from SDK version 4.1, Adapty Attribution is disabled by default in the SDK. [Enable it in your app code](#step-1-enable-adapty-attribution-in-the-sdk).
:::
...
## Step 1. Enable Adapty Attribution in the SDK

Starting from Adapty SDK version 4.1, Adapty Attribution is disabled by default. To let the SDK register installs and deliver installation details to your app, enable it when activating the SDK:
...
In SDK versions below 4.1, Adapty Attribution is enabled automatically — no code changes are needed.

## Step 2. Open Adapty Attribution
...
Subscription events start flowing into Adapty Attribution automatically. Campaign data appears after you connect a data source in Step 3.
...
## Step 3. Connect your ad platform and add tracking links
...
:::important
In the **Website URL** field, paste `https://api-ua.adapty.io/api/v1/attribution/click`. Paste the rest of the link to the **URL parameters** field in the **Tracking** section. It will help your Meta ad to get approved. See [Create ads](meta-create-campaign#step-5-create-ads) in the Meta Ads guide.
:::
...
6. Copy the **Click link** field value for **one link** or for a platform-specific link. Then, in TikTok Ads Manager, when creating your ad, paste this value in the **Destination URL** field. This will allow Adapty to connect installs and purchases to ads in TikTok. See [Add ad content](tiktok-create-campaign#step-5-add-ad-content) in the TikTok Ads guide.
...
1. In the Adapty Attribution dashboard, open **Integrations** and select the **Custom** card in the **Network** group. There, click **Create link**.
...
## Step 4. Launch your web-to-app campaign and view results
