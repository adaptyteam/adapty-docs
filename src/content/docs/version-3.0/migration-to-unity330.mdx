...
For the complete code example, check out [Fetch the view configuration of a paywall created with the old Paywall Builder](unity-get-pb-paywalls#fetch-the-view-configuration-of-a-paywall-created-with-the-old-paywall-builder).
