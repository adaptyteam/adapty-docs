...
:::note
The **Buy seats** button is only active when you have a payment method attached to your account.
:::

To add a team member:

1. Click **Account** at the top right and open the **Members** tab.
2. Click **Buy seats** and select the number of seats you need.

<Zoom>
    <img src="/assets/shared/img/buy-seats.webp"
         style={{
...
5. Select a [role](#roles) from the list.
6. Select apps to provide access to.
7. (Optional) Enable **Always allow access to new apps** to automatically grant access to future apps.
8. Click **Save**.
...
To transfer account ownership, contact support.
