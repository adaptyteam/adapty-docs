...
- **ASA manager**: Members with the ASA manager role have access only to the [Adapty Ads Manager](adapty-ads-manager) dashboard.

## Add a member

In Adapty, you can invite up to 256 team members. Adding new members is free of charge.
