...
The two records don't track each other field for field. A product's review status reaches Adapty from the store, but a price change doesn't — see [Product and price discrepancies](store-sync).
