...
The two records don't track each other field for field. A product's review status reaches Adapty from the store, but [a price change doesn't](store-sync#product-and-price-discrepancies).
