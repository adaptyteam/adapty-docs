...
metadataTitle: "Build paywalls and onboardings | Paywall Builder | Adapty Docs"
keywords: ['paywall', 'paywall builder', 'flow builder', 'onboarding builder']
---

:::warning
The Paywall Builder is fully functional, but Adapty is no longer adding features or shipping updates for it. For new projects, consider the [Flow & Paywall Builder](adapty-flow-builder) — a visual no-code editor for single-screen paywalls and multi-screen onboarding flows that render natively on device:
