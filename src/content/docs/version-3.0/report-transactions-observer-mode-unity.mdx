...
If you use Adapty flows & paywalls, include the `PAYWALL_VARIATION_ID` when reporting a transaction. This links the purchase to the flow or paywall that triggered it, ensuring accurate analytics.
