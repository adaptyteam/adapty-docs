...
:::important
A **Show** or **Hide** action with no target element [blocks preview and publish](builder-save-publish#troubleshooting). Select a target or remove the action.
:::
...
:::important
A **Show alert** action with an empty or incomplete configuration [blocks preview and publish](builder-save-publish#troubleshooting). Fill in both fields or remove the action.
:::
...
:::important
A **Set variable** action with no assignment [blocks preview and publish](builder-save-publish#troubleshooting). Configure at least one assignment or remove the action.
:::
...
:::important
A **Purchase** action without a target **Product** or **Web Paywall URL** [blocks preview and publish](builder-save-publish#troubleshooting). Assign a target or remove the action.
:::
...
:::important
A **Custom** action without an **Action ID** [blocks preview and publish](builder-save-publish#troubleshooting). Assign an Action ID or remove the action.
:::
...
- An incomplete rule (no operator or value) [blocks preview and publish](builder-save-publish#troubleshooting).
:::
...
Any action with missing required fields blocks preview and publish. See [Save & publish flows](builder-save-publish#troubleshooting) for the full list.
