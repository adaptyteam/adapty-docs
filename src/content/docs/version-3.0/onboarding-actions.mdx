...
:::warning
An incomplete action configuration will prevent you from publishing the flow. See [Troubleshooting](#troubleshooting) for details.
:::
...
:::warning
A **Show** or **Hide** action with no target element [breaks the flow build](builder-save-publish#troubleshooting). Select a target or remove the action.
:::
...
:::warning
A **Show alert** action with an empty or incomplete configuration [breaks the flow build](builder-save-publish#troubleshooting). Fill in both fields or remove the action.
:::
...
:::warning
A **Set variable** action with no assignment [breaks the flow build](builder-save-publish#troubleshooting). Configure at least one assignment or remove the action.
:::
...
:::warning
A **Purchase** action without a target **Product** or **Web Paywall URL** [breaks the flow build](builder-save-publish#troubleshooting). Assign a target or remove the action.
:::
...
:::warning
A **Custom** action without an **Action ID** [breaks the flow build](builder-save-publish#troubleshooting). Assign an Action ID or remove the action.
:::
...
- An incomplete rule (no operator or value) causes the flow build to fail.
:::
...
Any action with missing required fields breaks the flow build. See [Save & publish flows](builder-save-publish#troubleshooting) for the full list of build blockers.
