...
| | [Keyword rules](ads-manager-automations-keyword-rules.md) | [Search term automations](ads-manager-automations-search-terms.md) |
|---|---|---|
| **Runs on** | Keywords | Search terms (actual user queries) |
| **Action** | Adjusts bids | Promotes terms to keywords, adds as negatives |
| **Use case** | Hit CPA and ROAS targets | Build keyword funnel from discovery traffic |
