---
title: "Automations in Adapty Search Ads"
description: "Automatically optimize your Apple Ads campaigns with keyword rules and search term automations"
metadataTitle: "Automations | Adapty Search Ads | Adapty Docs"
keywords: ['adapty search ads', 'apple ads manager', 'asa', 'automations']
---
import ZoomImage from '@site/src/components/ZoomImage';
import CustomDocCardList from '@site/src/components/CustomDocCardList';

Automation rules in Adapty Search Ads let you act on campaign performance without manual intervention. You define conditions based on performance metrics, set an action, and schedule when the rule runs — the system does the rest.
