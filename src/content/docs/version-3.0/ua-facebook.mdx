...
4. To send the conversion events back to Meta, you can also associate your pixels from Meta with campaigns in Adapty Attribution. To do that, select one of your existing pixels in the **Pixel** dropdown.
