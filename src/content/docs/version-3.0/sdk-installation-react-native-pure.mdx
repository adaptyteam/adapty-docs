...
Adapty React Native SDK v4 — which adds [Flow Builder](adapty-flow-builder) support — requires **React Native 0.75 or later**.
...
- If you use [Adapty Paywall Builder](adapty-paywall-builder), follow the [Paywall Builder quickstart](react-native-quickstart-paywalls).
