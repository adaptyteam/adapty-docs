...
Adapty SDK works with these Google Play Billing Library versions on Android:

| Adapty SDK version | Default Billing Library version | Also supported |
|---|---|---|
| 3.17.0 and later | v8 | — |
| 3.15.0–3.15.6 | v7 | v8, when another dependency in your Android build raises it |
