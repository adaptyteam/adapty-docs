...
Adapty cannot automatically detect your enrollment in reduced commission programs. To ensure correct calculations, specify these programs' status in your [app settings](general).
