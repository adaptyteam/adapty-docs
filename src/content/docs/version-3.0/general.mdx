...
Use a Public SDK key to integrate Adapty SDKs into your app, and a Secret Key to access Adapty's Server API. You can generate new keys or revoke existing ones as needed. To create tokens for the Developer CLI, go to **Settings → Developer API**. See [Authentication](developer-cli-authentication).
