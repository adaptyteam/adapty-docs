...
If you repeat testing using the same Sandbox test account, you may face unexpected behavior with [shared access levels](profiles-crm#sharing-paid-access-between-user-accounts) for the test user.
