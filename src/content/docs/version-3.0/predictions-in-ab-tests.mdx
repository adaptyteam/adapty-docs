...
:::note
A/B test winner predictions are additional paid features available starting from $50K tracked MTR. They cost 0.3% of MTR/month and also include [predictions in cohorts](predicted-ltv-and-revenue).
:::
