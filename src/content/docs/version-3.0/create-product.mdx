...
The price you enter here can't be changed after creation, and a price change in the store console [doesn't come back to Adapty](store-sync#product-and-price-discrepancies).
