...
1. Display [remote config paywalls](present-remote-config-paywalls-kmp) as usual. For flows & paywalls built in the Flow Builder, see [Present flows in Observer mode](kmp-present-flows-in-observer-mode).
