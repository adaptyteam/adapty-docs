...
Turn your onboarding into a two‑way conversation: add quizzes in Adapty's no‑code builder to collect preferences, segment users, and [branch flows](onboarding-user-engagement#onboarding-flow-branching) based on real‑time answers. You'll be gathering insights in minutes—no code required.
...
5. Configure [actions](onboarding-actions) to fire when the user selects an option.
...
:::tip
If you want to customize the onboarding itself based on the quiz answers, see the guide for [navigation](onboarding-navigation-branching#dynamic-navigation) or for [using variables](onboarding-variables).
:::
...
Beyond the basic [element layout](onboarding-layout#element-layout), you can customize quiz appearance:
