...
1. [Map your Superwall concepts to Adapty](#map-your-superwall-concepts-to-adapty) _(5 minutes)_
2. [Install the Adapty SDK](#install-the-adapty-sdk) _(15 minutes)_
3. [Replace SDK calls](#replace-sdk-calls) _(1 hour)_
4. [Switch App Store and Google Play server notifications](#switch-app-store-and-google-play-server-notifications) _(5 minutes)_
5. [Test and release](#test-and-release) _(30 minutes)_
