...
<Zoom>
  <img src="/assets/shared/img/offer-edit-product.webp"
  style={{
...
<Zoom>
  <img src="/assets/shared/img/add-offer.webp"
  style={{
    border: '1px solid #727272', /* border width and color */
    width: '700px', /* image width */
    display: 'block', /* for alignment */
...
<Zoom>
  <img src="/assets/shared/img/offers.webp"
  style={{
    border: '1px solid #727272', /* border width and color */
    width: '700px', /* image width */
    display: 'block', /* for alignment */
...
<Zoom>
  <img src="/assets/shared/img/offer-paywall.webp"
  style={{
    border: '1px solid #727272', /* border width and color */
    width: '700px', /* image width */
    display: 'block', /* for alignment */
...
<Zoom>
  <img src="/assets/shared/img/trial-toggle.webp"
  style={{
    border: '1px solid #727272', /* border width and color */
    width: '700px', /* image width */
    display: 'block', /* for alignment */
...
<Zoom>
  <img src="/assets/shared/img/button-text.webp"
  style={{
    border: '1px solid #727272', /* border width and color */
    width: '700px', /* image width */
    display: 'block', /* for alignment */
