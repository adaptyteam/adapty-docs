...
- **When you add the product**: Click **+**, select the product, and pick the offer under **Offer**. Cards that use the product afterwards get this offer pre-selected. The full steps are in [Add products in advance](paywall-product-block#add-products-in-advance).
