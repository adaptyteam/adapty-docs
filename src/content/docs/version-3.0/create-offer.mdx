...
:::warning
This guide applies to promotional offers (App Store), win-back offers (App Store), and all Google Play offers.

Introductory offers and [offer codes](app-store-offers#offer-codes) are detected automatically — you don't need to add them to Adapty.
:::
