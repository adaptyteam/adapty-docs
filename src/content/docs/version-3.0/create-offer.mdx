...
In the [builder](adapty-flow-builder), an offer is attached to a product on a Products element. First add the product element and assign products to it — see [Set up purchases](paywall-product-block).
