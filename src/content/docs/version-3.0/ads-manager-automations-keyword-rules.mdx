...
:::note
Keyword rules adjust bids only. They don't pause campaigns, change budgets, or modify keyword lists. To automatically move search terms into keywords, use [search term automations](ads-manager-automations-search-terms.md).
:::
