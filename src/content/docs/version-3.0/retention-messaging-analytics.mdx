...
| **Retained** |  Subscribers from the **Shown** cohort who aborted the cancellation, and went on to pay. Adapty matches on the subscription's original transaction rather than on the product, so a subscriber who switches to a different plan instead of cancelling also counts as retained. |
