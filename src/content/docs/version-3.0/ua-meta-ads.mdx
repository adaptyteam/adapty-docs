---
title: "Meta Ads campaigns in Adapty Attribution"
description: "See Meta Ads campaign performance and metrics in Adapty Attribution."
metadataTitle: "Meta Ads campaigns | Adapty Attribution | Adapty Docs"
keywords: ['adapty attribution', 'adapty ua', 'user acquisition', 'meta ads', 'facebook ads']
---
import ZoomImage from '@site/src/components/ZoomImage';

[Meta Ads campaigns](https://app.adapty.io/ua/meta-ads) is a section of the Adapty Attribution Dashboard that allows you to view and analyze your Meta Ads campaign performance. You can see metrics for your campaigns, ad sets, and individual ads across three dedicated tabs.
...
Meta Ads campaigns in Adapty Attribution provide comprehensive metrics to measure campaign performance and user behavior. 
...
For detailed descriptions of metrics, see [Metrics](ua-metrics).
...
On the **Meta Ads** page, you have the same main controls as in [Analytics](ua-analytics#controls):
