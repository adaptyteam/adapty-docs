...
- **`true`** — the placement is a flow or a paywall-builder paywall. Adapty renders the UI for you. Continue with the steps below to fetch the view configuration and [present the flow or paywall](ios-present-paywalls).
