---
title: "Add and style text in the Flow Builder"
...
In addition to the basic [element layout](onboarding-layout#element-layout), you can customize the appearance of text and lists:
