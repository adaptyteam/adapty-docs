...
:::important
Don't use inline links for button text. Set up the [Open URL](#open-url-action) action instead.
:::
...
2. Select the button — not the text element inside it — and open the **Interactions** tab in the right panel.

3. Set the destination for the [**Open URL**](onboarding-actions#open-url) action.

    :::warning
    The flow [fails to build](builder-save-publish#troubleshooting) if you leave the Open URL action without a URL.
    :::
