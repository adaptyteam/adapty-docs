...
- **Weight** and **size**: Set the font weight and size. For [custom fonts](using-custom-fonts-in-flow-builder#custom-font-limitations), upload a separate font file per weight instead of relying on this control.
