...
:::note
SF Pro isn't available for cross-platform use. Inter is a close alternative — add it as a [custom font](using-custom-fonts-in-flow-builder), with one file per weight.
:::
