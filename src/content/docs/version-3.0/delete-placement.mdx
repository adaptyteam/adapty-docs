...
1. Go to **[Placements](https://app.adapty.io/placements)** from the Adapty main menu. Switch to the **Flows**, **Paywalls**, or **Onboardings** tab depending on the type of placement you want to delete.
