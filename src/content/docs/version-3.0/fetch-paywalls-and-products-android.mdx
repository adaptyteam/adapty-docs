...
description: "Fetch a paywall and its products in the Adapty Android SDK when you render the screen yourself."
metadataTitle: "Fetch paywalls and products | Android SDK | Adapty Docs"
