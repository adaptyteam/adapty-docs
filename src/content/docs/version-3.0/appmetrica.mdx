...
[AppMetrica](https://appmetrica.yandex.com/about) is a free analytics tool that helps you track user behavior and analyze your mobile app's performance in real time. By integrating AppMetrica with Adapty, you can gain deeper insights into your subscription metrics and user engagement.
...
| `post_api_key`       | String  | Your AppMetrica Post API Key.                                                                                                                                                 |
| `application_id`     | String  | Your AppMetrica Application ID.                                                                                                                                               |
| `revenue_event_type` | String  | The type of revenue event (e.g., "subscription_renewed", "refund", "intro_started"). See [AppMetrica event mapping](#events-and-tags).                             |
