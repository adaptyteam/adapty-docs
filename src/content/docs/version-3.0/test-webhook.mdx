...
2. Set up the environment as described in the [Test in-app purchases in Apple App Store](test-purchases-in-sandbox) and [Test in-app purchases in Google Play Store](testing-on-android) topics. Make sure you built your test app in the sandbox environment rather than in the production one.
