...
To set up the elements themselves, continue with [Add product cards](#add-product-cards) and [Trigger a purchase](#trigger-a-purchase).
...
To add an entry, click **+** and follow the instructions in [Add products in the Products panel](#add-products-in-the-products-panel).
...
- A product or offer missing from your Dashboard. Occurs if you add a product to a flow, but then delete it from your Adapty account. Find the **Missing** product entry in the **Products** panel, and [**replace all occurrences**](#product-actions) with an existing product.
- An offer variable used with a product that has no offer. [**Set an offer**](#product-actions) for the product in the **Products** panel, or delete the variable.
