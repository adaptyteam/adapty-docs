...
description: "Assign products to screens, add product elements, and connect a purchase button in the builder."
metadataTitle: "Set up purchases | Flow & Paywall Builder | Adapty Docs"
---
...
<ZoomImage id="flow-products.webp" width="500px" alt="Products panel in the builder" />
