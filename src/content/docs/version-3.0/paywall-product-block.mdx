...
:::tip
Prompt the <Inline id="sparkle.svg" alt="AI Editor" /> [AI Editor](builder-ui#ai-editor) to change how products appear on the current screen — show or hide a plan, set the default, or highlight the best value. The changes only apply to the product cards — your product catalog or prices.
:::
