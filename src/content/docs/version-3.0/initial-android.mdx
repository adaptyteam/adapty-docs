...
- [ ] Install and configure AdaptySDKs (you may install SDKs for one or more frameworks, whatever are needed)
  ...
  - [ ] [Install Adapty SDKs for Kotlin Multiplatform](sdk-installation-kotlin-multiplatform)
