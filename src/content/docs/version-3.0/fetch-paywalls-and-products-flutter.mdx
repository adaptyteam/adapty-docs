---
title: "Fetch a manual paywall and its products in Flutter SDK"
description: "Fetch a paywall and its products in the Adapty Flutter SDK when you render the screen yourself."
metadataTitle: "Fetch paywalls and products | Flutter SDK | Adapty Docs"
...
Before showcasing manually implemented paywalls, you need to fetch the information about them. Please be aware that this topic refers to manually implemented paywalls. For guidance on fetching flows and Paywall Builder-customized paywalls, please consult [Get flows & paywalls](flutter-get-pb-paywalls).
...
Before showcasing manually implemented paywalls, you need to fetch the information about them. Please be aware that this topic refers to manually implemented paywalls. For guidance on fetching paywalls for Paywall Builder-customized paywalls, please consult [Fetch Paywall Builder paywalls and their configuration](flutter-get-pb-paywalls).
