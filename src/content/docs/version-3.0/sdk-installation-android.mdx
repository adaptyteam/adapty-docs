...
:::info
Starting from Adapty SDK version 4.1, Adapty works with Google Play Billing Library v8.0.0 by default. Earlier versions use v7.0.0 and are compatible with the Billing Library up to 8.x — to force a later version there, manually [add the dependency](https://developer.android.com/google/play/billing/integrate#dependency).
:::
