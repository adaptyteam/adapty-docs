...
:::info
Starting with Adapty SDK 3.17.3 and 4.0.2, Adapty works with Google Play Billing Library v8.
...
- If you build your own paywall UI, see the [quickstart for manual paywalls](android-quickstart-manual).
