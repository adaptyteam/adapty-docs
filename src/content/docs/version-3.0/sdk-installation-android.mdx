...
Adapty SDK works with these Google Play Billing Library versions:

| Adapty SDK version | Default Billing Library version | Also supported |
|---|---|---|
| 4.0.2 and later | v8 | — |
| 4.0.0–4.0.1 | v7 | v8, when another dependency in your build raises it |
| 3.17.3 and later on the 3.x line | v8 | — |
| 3.15.0–3.17.2 | v7 | v8, when another dependency in your build raises it |
