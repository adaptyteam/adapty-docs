...
If you're building your first iOS app with in-app purchases, you must set up your Apple Developer account and App Store Connect before you integrate Adapty.
...
:::tip
If you're enrolling as an organization, you need a **D-U-N-S Number** — a unique nine-digit business identifier from Dun & Bradstreet. You can [check if your organization already has one](https://developer.apple.com/enroll/duns-lookup/) or request a new one. It may take up to 5 business days to receive.
:::
...
4. Pay the annual fee of **$99 USD**.
...
2. Go to **Business** (in the left sidebar).
3. Find the **Paid Apps** agreement and click **Review and Agree**.
...
1. Open [App Store Connect](https://appstoreconnect.apple.com) and go to **Apps**.
2. Click **+** → **New App**.
...
- [Generate In-App Purchase Key in App Store Connect](generate-in-app-purchase-key): create the API key Adapty needs to validate purchases
