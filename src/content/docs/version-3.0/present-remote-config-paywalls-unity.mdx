---
title: "Render a manual paywall with remote config in Unity SDK"
description: "Read remote config values and render your own paywall screen in the Adapty Unity SDK."
metadataTitle: "Remote config in a manual paywall | Unity SDK | Adapty Docs"
