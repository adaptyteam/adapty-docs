...
| Glassfy                                                          | Adapty                           |
| :--------------------------------------------------------------- | :------------------------------- |
| [SKU](https://web.archive.org/web/20241103190442/https://docs.glassfy.io/docs/configure-products)           | [Product](product)           |
| [Permission](https://web.archive.org/web/20240910161841/https://docs.glassfy.io/docs/configure-permissions) | [Access level](access-level) |
| [Offering](https://web.archive.org/web/20240810193853/https://docs.glassfy.io/docs/configure-offerings)     | [Paywall](paywalls)          |
...
<Zoom>
  <img src="/assets/shared/img/aac7858-002901-August-01-5BJyKpql.webp"
  style={{
    border: 'none', /* border width and color */
    width: '700px', /* image width */
    display: 'block', /* for alignment */
