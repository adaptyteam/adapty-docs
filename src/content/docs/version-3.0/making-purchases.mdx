...
If the promoted product carries a subscription offer, the SDK applies it at purchase automatically.
...
:::info
The `didReceivePromotedPurchase` API is available starting from SDK version 4.1. SDK version 4.0 doesn't support promoted in-app purchases.
:::
