...
2. In the Flow & Paywall Builder, click **Test on device**.
...
You can preview your flow on different screen types using the preview area in the Flow & Paywall Builder. This helps ensure your flow looks great across various devices and screen sizes.
...
3. Under **Preview as**, select **Free trial**, **Pay up front**, or **Pay as you go**. This setting only applies to the current card.