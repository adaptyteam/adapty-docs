...
<ZoomImage id="flow-preview-error-app.webp" width="300px" alt="Error message in the Adapty app when a flow with an incomplete action is previewed" float="right" />
...
:::warning
A clean dashboard preview doesn't guarantee the flow will build correctly. All the flow elements need to have a complete and valid configuration. Preview the flow [on a real device](#preview-on-devices) to catch build errors.
:::
