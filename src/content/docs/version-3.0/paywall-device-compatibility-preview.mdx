---
title: "Preview flows"
description: "Preview your paywalls and onboardings on different devices before publishing."
metadataTitle: "Preview flows | Flow Builder | Adapty Docs"
---
...
- Preview [tags variables for product info](paywall-builder-tag-variables#how-to-use-tag-variables).

:::tip
Set the [maximum width](paywall-layout-and-products#content-layout) of elements to optimize layout on iPads.
:::
