...
One event can change several currencies at once — for example, a server-side API call that [converts one currency into another](virtual-currencies#example-convert-between-currencies).
