...
:::important
You can migrate only paywalls built in the Paywall Builder for Adapty SDK 3.x. To migrate a paywall built for SDK 2.x or earlier, first move it to the SDK 3.x Paywall Builder.
:::

To migrate a paywall builder configuration:

1. **For new paywall**: Start [paywall creation](create-paywall) and add products. Then, click **Build no-code paywall** to open the template library. 
