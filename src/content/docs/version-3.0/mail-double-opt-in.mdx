...
The setting applies to profiles created after you turn it on, from both [entry points](mail-entry-points). Profiles that already existed keep receiving campaigns as before. To cover your whole audience, turn double opt-in on before you [start sending](mail-get-started#6-start-sending).
