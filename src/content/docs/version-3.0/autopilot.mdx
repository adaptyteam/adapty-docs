...
4. Adapty suggests up to ten competitors based on your app's category and MRR. You can modify the list and manually add apps with an App Store link. We recommend selecting apps with higher MRR than yours.
