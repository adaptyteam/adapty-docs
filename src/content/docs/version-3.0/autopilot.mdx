...
Adapty automatically sets up several rounds to get you started.  You can change the order of growth plan rounds. Click the grid button, and drag the entries to change the order. Click the check mark button to save the changes.
