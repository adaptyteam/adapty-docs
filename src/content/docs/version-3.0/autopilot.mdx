...
3. Adapty automatically selects the top-performing live paywall for analysis. If you wish to analyze a different paywall, click the **Change Paywall** button, and pick another option. You can only select a paywall added to the placement from the previous step.
    ...
    Review the paywall data: products, conversion metrics, the revenue distribution chart by country. When you're ready to proceed to the next step, click **Go to competitors research**.
...
6. The **Global pricing opportunities** section helps you identify which countries offer the best revenue potential. Adapty analyzes your next top 5 markets (excluding your main country) and provides data-driven pricing recommendations validated by the [Adapty Pricing Index](https://uploads.adapty.io/adapty_pricing_index.pdf).
...
7. Here, you will see the overview of your growth plan. You can also click **Get more ideas** to explore global pricing recommendations and paywall design ideas. Click **Go to recommendations** to see the growth plan we've created for you. You will see several stages with different durations.
