---
title: "Render a manual paywall with remote config in React Native SDK"
description: "Read remote config values and render your own paywall screen in the Adapty React Native SDK."
metadataTitle: "Remote config in a manual paywall | React Native SDK | Adapty Docs"
