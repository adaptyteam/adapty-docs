...
Before showcasing remote config and custom paywalls, you need to fetch the information about them. Please be aware that this topic refers to remote config and custom paywalls. For guidance on fetching flows or paywalls customized in the **Flow Builder** or **Paywall Builder**, please consult [Fetch Flow Builder flows and Paywall Builder paywalls and their configuration](capacitor-get-pb-paywalls).
