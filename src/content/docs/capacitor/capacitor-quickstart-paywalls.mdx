...
To get a flow created in the Adapty Flow & Paywall Builder, get the `flow` object by the [placement](placements) ID using the `getFlow` method. The flow contains the UI elements and styling needed to display it.
