...
The `view` argument requires Capacitor SDK TBD or later. Of all the flow handlers, only `onAppeared` receives a description of the view itself — a `FlowEventView` object with these fields:
