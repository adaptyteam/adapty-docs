...
The `view` argument requires Capacitor SDK 4.0.2-beta.1 or later. Of all the flow handlers, only `onAppeared` receives a description of the view itself — a `FlowEventView` object with these fields:
