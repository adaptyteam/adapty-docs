...
If you are building flows or paywalls using the Adapty [Flow Builder](adapty-flow-builder) or [Paywall Builder](adapty-paywall-builder), it's crucial to set up buttons properly:
