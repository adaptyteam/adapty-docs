...
Once you've presented your onboarding, you'll want to [handle user interactions and events](capacitor-handling-onboarding-events). Learn how to handle onboarding events to respond to user actions and track analytics.
