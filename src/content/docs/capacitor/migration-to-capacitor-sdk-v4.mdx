...
There is one new build requirement: **Xcode 26 or later** — the native Adapty iOS SDK 4.0.2 bundled with this release uses Swift tools 6.2.

v4 bundles the native Adapty SDKs iOS 4.0.2 and Android BOM 4.0.1.
