...
:::note
Coming from the 4.0 beta? Replace the pinned beta version with the [4.1.0 install](#installation), then only four sections apply: [Adapty Attribution is disabled by default](#adapty-attribution-is-disabled-by-default), [the renamed external attribution method](#renamed-external-attribution-method), [fallback files](#fallback-files), and [App Store promoted in-app purchases](#app-store-promoted-in-app-purchases).
:::
