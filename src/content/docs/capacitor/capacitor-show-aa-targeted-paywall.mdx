...
The guide below uses the v3 method names. In SDK v4, `getPaywall` is renamed to `getFlow` (see the [migration guide](migration-to-capacitor-sdk-v4)) — the approach applies unchanged.
