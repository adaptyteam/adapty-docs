...
:::warning
This guide covers only paywalls built in the old Paywall Builder. Presenting a remote config paywall works differently — see [Render a manual paywall with remote config](present-remote-config-paywalls-capacitor).
:::
