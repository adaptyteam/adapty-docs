...
:::info
Your app can take over promoted in-app purchases from SDK version 4.1.1, on **iOS 16.4** or later. Below iOS 16.4, the event never fires and promoted purchases complete on their own. The event never fires on Android either.
:::
...
:::warning
While your listener is registered, the SDK stops completing promoted purchases for you. If your handler never calls `makePromotedPurchase`, the purchase never happens: the App Store hands the product to your app and waits.
:::
