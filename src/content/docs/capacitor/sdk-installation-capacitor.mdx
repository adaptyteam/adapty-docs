...
- **AdaptyUI**: This module renders the screens Adapty draws for you — flows built in the [Flow & Paywall Builder](adapty-flow-builder), and legacy Paywall Builder paywalls. AdaptyUI is automatically activated along with the core module.
