...
- **AdaptyUI**: This module renders the screens Adapty draws for you — flows built in the [Flow & Paywall Builder](adapty-flow-builder), and legacy builder paywalls. AdaptyUI is automatically activated along with the core module.
...
:::info
Adapty Capacitor SDK works with Google Play Billing Library v8.
...
- If you build your own paywall UI, see the [quickstart for manual paywalls](capacitor-quickstart-manual).
