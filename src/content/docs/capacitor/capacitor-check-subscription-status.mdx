...
Now, when you know how to track the subscription status, learn how to [work with user profiles](capacitor-quickstart-identify) to ensure they can access what they have paid for.