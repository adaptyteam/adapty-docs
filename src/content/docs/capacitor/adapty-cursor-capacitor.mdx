...
:::tip
The [Developer CLI](developer-cli-quickstart) lets your LLM complete most of this checklist directly — create products, paywalls, placements, and access levels after a one-time `adapty auth login`. Only the store connection in step 1 requires the Dashboard.
:::
