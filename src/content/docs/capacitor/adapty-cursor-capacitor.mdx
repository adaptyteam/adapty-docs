...
- [**Manually created paywalls**](capacitor-quickstart-manual): You build your own paywall UI in code but still use Adapty to fetch products and handle purchases.
...
- [Render a manual paywall with remote config](present-remote-config-paywalls-capacitor)
