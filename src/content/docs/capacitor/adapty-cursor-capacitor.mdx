...
:::info
This walkthrough targets Adapty Capacitor SDK v4 — the API taught by the [quickstart](capacitor-quickstart-paywalls). Make sure your LLM installs `@adapty/capacitor@4.1.0` instead of the latest stable 3.x. See the [SDK 4.1 installation section](sdk-installation-capacitor#adapty-sdk-41) and the [migration guide](migration-to-capacitor-sdk-v4).
:::
