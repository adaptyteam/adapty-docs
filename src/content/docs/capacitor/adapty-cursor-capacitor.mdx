...
This page covers two ways to integrate Adapty into your Capacitor app. Use the SDK integration skill below for an automated end-to-end flow, or follow the manual walkthrough further down.
...
**Guides:**
- [Enable purchases using paywalls (quickstart)](capacitor-quickstart-paywalls)
- [Fetch Paywall Builder paywalls and their configuration](capacitor-get-pb-paywalls)
- [Display paywalls](capacitor-present-paywalls)
- [Handle paywall events](capacitor-handling-events)
- [Respond to button actions](capacitor-handle-paywall-actions)
...
- Capacitor-specific [`capacitor-llms.txt`](https://adapty.io/docs/capacitor-llms.txt) and [`capacitor-llms-full.txt`](https://adapty.io/docs/capacitor-llms-full.txt): Platform-specific subsets that save tokens compared to the full site.
