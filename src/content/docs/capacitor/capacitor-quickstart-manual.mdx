...
Next, [check whether users have completed their purchase](capacitor-check-subscription-status) to determine whether to display the paywall or grant access to paid features.
