...
- Create flows, write their builder configs, and publish them — see [Flows](developer-cli-reference#flows) in the command reference
- Configure placements to fetch paywalls or flows via the SDK
