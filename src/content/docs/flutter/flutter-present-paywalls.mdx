...
This guide is for flows and paywalls rendered by Adapty. For a **manually implemented paywall**, see [Render a manual paywall with remote config](present-remote-config-paywalls-flutter).
...
- For presenting **remote config paywalls**, see [Render a manual paywall with remote config](present-remote-config-paywalls-flutter).
