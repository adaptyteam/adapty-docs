...
This guide walks through integrating Adapty into your Flutter app step by step with an AI coding tool — you feed it the right Adapty docs in the right order. For a fully automated flow, use the [adapty-sdk-integration skill](adapty-sdk-integration-skill-flutter) instead.
