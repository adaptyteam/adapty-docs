...
[Offer codes](app-store-offers#offer-codes) provide subscription discounts or free trials that users activate by entering a code. To display the code redemption sheet in your app:
