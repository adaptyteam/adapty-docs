...
Please be aware that this topic refers to flows and paywalls that Adapty renders. If you are implementing your paywalls manually, please refer to the [Fetch paywalls and products for remote config paywalls in your mobile app](fetch-paywalls-and-products-flutter) topic.
