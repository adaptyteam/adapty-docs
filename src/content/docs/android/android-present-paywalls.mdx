...
This guide is for **legacy builder paywalls** only which require SDK v3.0. The process for presenting paywalls differs for paywalls designed with different versions of Paywall Builde, manually implemented paywalls, and [Observer mode](observer-vs-full-mode).
