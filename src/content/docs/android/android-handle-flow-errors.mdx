---
title: "Handle errors - Android"
description: "Troubleshoot and handle errors when using the Flow Builder in your Android app."
metadataTitle: "Handle Flow Errors - Android | Adapty Docs"
---
