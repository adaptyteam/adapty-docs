...
:::tip
Our docs are optimized for use with LLMs. Check out [this article](adapty-cursor-android) to learn how to get the best results when integrating the Adapty SDK using AI with our docs. Or let the [adapty-sdk-integration skill](adapty-sdk-integration-skill-android) integrate the SDK for you automatically.
:::
...
2. [Enable purchases through paywalls](android-quickstart-paywalls): Set up the purchase flow so users can buy products.
