...
The method will not be invoked in Observer mode. Refer to the [Android - Present flows in Observer mode](android-present-paywall-builder-paywalls-in-observer-mode) topic for details.
