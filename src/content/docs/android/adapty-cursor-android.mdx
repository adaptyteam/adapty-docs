...
description: "A step-by-step guide to integrating Adapty into your Android app using Cursor, ChatGPT, Claude, or other AI tools."
metadataTitle: "Integrate Adapty with AI Assistance for Android | Adapty Docs"
...
:::tip
Copy this entire page as Markdown and paste it into your LLM to get started — click **Copy for LLM** at the top of the page or open [the .md version](https://adapty.io/docs/adapty-cursor-android.md). The LLM will use the guide links and checkpoints to walk you through each stage.
:::
...
1. **Connect your app store**: In the Adapty Dashboard, go to **App settings → General**. This is required for purchases to work.
   [Connect Google Play](integrate-payments.md)
...
- [**Manually created paywalls**](android-making-purchases.md): You build your own paywall UI in code but still use Adapty to fetch products and handle purchases.
...
Not sure which one to pick? Read the [comparison table in the quickstart](android-quickstart-paywalls.md).
...
**Guide:** [Install & configure Adapty SDK](sdk-installation-android.md)
...
**Guides:**
- [Enable purchases using paywalls (quickstart)](android-quickstart-paywalls.md)
- [Fetch Paywall Builder paywalls and their configuration](android-get-pb-paywalls.md)
- [Display paywalls](android-present-paywalls.md)
- [Handle paywall events](android-handling-events.md)
- [Respond to button actions](android-handle-paywall-actions.md)
...
**Guides:**
- [Enable purchases in your custom paywall (quickstart)](android-quickstart-manual.md)
- [Fetch paywalls and products](fetch-paywalls-and-products-android.md)
- [Render paywall designed by remote config](present-remote-config-paywalls-android.md)
- [Make purchases](android-making-purchases.md)
- [Restore purchases](android-restore-purchase.md)
...
- [Implement Observer mode](implement-observer-mode-android.md)
- [Report transactions in Observer mode](report-transactions-observer-mode-android.md)
...
**Guide:** [Check subscription status](android-check-subscription-status.md)
...
**Guide:** [Identify users](android-quickstart-identify.md)
...
You can access any Adapty doc as plain text Markdown by adding `.md` to the end of its URL or clicking **Copy for LLM** under the article title. For example: [https://adapty.io/docs/adapty-cursor-android.md](https://adapty.io/docs/adapty-cursor-android.md).
...
- Android-specific [`android-llms.txt`](https://adapty.io/docs/android-llms.txt) and [`android-llms-full.txt`](https://adapty.io/docs/android-llms-full.txt): Platform-specific subsets that save tokens compared to the full site.
...
For platform-specific development, we recommend adding the GitHub repository for the Adapty Android SDK. This gives you access to the latest code examples, changelogs, and implementation details.

Follow the same process as above, but use the SDK repository URL:

- **Android SDK**: `https://github.com/adaptyteam/AdaptySDK-Android`

Name the doc `Adapty Android SDK`.
...
- `@Adapty Android SDK show me how to handle purchase restoration with proper error handling`
