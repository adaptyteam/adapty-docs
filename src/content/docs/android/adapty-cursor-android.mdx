...
The Adapty CLI skill lets your LLM set up your app, products, access levels, paywalls, and placements directly — without opening the Dashboard for each step. You only need to [connect your store](integrate-payments.md) in the Dashboard.

```
npx skills add adaptyteam/adapty-cli --skill adapty-cli
```

Once the skill is added, tell your LLM: "Set up my app in Adapty for me." It will guide you through each step — including when to open the Dashboard to connect your store.
...
You can access any Adapty doc as plain text Markdown. Add `.md` to the end of its URL, or click **Copy for LLM** under the article title. For example: [adapty-cursor-android.md](https://adapty.io/docs/adapty-cursor-android.md).
