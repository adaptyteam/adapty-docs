...
- [**Manually created paywalls**](android-quickstart-manual): You build your own paywall UI in code but still use Adapty to fetch products and handle purchases.
...
**Guides:**
- [Enable purchases with Flow & Paywall Builder (quickstart)](android-quickstart-paywalls)
- [Fetch flows and their configuration](android-get-pb-paywalls)
- [Display flows](android-present-paywalls)
- [Handle flow events](android-handling-events)
...
- [Render a manual paywall with remote config](present-remote-config-paywalls-android)
