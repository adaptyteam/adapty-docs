...
This page covers two ways to integrate Adapty into your Android app. Use the SDK integration skill below for an automated end-to-end flow, or follow the manual walkthrough further down.
