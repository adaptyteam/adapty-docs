---
title: "Android - Use fallbacks"
description: "Handle cases when users are offline or Adapty servers aren't available."
metadataTitle: "Using Fallback Flows on Android | Adapty Docs"
---
...
2. Call the `.setFallback` method **before** you fetch the target paywall, flow, or onboarding.
...
| :----------- | :----------------------------------------------------------- |
| **location** | The [FileLocation](https://android.adapty.io/adapty/com.adapty.utils/-file-location/-companion/) object for the fallback configuration file |
