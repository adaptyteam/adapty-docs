...
This guide shows how to present that screen and handle the purchase call. If Adapty completes purchases for you, see [Display flows & paywalls](android-present-paywalls) instead.
...
:::note
Adapty Android SDK versions before 3.15.0 also passed the paywall and the paywall view to this callback. Drop those two parameters when you upgrade to 3.15.0 or later.
:::
