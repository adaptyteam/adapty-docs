---
title: "Enable purchases with Flow & Paywall Builder in Android SDK"
...
- [**Flows**](adapty-flow-builder) – screen sequences that present products to users, built in the no-code Flow & Paywall Builder. The SDK retrieves them via `getFlow`. If you'd rather build the UI in your own code, use a paywall instead — see [Implement paywalls manually](android-quickstart-manual).
