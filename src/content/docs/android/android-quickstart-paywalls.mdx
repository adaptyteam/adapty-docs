...
:::important
To get the view configuration, you must switch on the **Show on device** toggle in the Flow & Paywall Builder. Otherwise, you will get an empty view configuration, and the flow won't be displayed.
:::
