...
5. [Install and activate the Adapty SDK](sdk-installation-android) in your app code.
...
1. Get the `paywall` object by the [placement](placements) ID using the `getPaywall` method and check whether it is a paywall created in the builder.
