...
:::warning
This step produces no compile error. If you skip it, `WRONG_PARAMETER` is thrown for every placement fetch that needs a fallback — see [Handle errors in Android SDK](android-sdk-error-handling).
:::
