---
title: "Handle errors - Kotlin Multiplatform"
description: "Troubleshoot and handle errors when using the Flow Builder in your Kotlin Multiplatform app."
metadataTitle: "Handle Flow Errors - Kotlin Multiplatform | Adapty Docs"
---
