...
This guide walks through integrating Adapty into your Kotlin Multiplatform app step by step with an AI coding tool — you feed it the right Adapty docs in the right order.
...
- [**Manually created paywalls**](kmp-quickstart-manual): You build your own paywall UI in code but still use Adapty to fetch products and handle purchases.
...
**Guides:**
- [Enable purchases with Flow & Paywall Builder (quickstart)](kmp-quickstart-paywalls)
- [Fetch flows and their configuration](kmp-get-pb-paywalls)
- [Display flows](kmp-present-paywalls)
- [Handle flow events](kmp-handling-events)
...
- [Render a manual paywall with remote config](present-remote-config-paywalls-kmp)
