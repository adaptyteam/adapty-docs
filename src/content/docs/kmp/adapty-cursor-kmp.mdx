...
This page covers two ways to integrate Adapty into your Kotlin Multiplatform app. Use the SDK integration skill below for an automated end-to-end flow, or follow the manual walkthrough further down.
...
- [**Manually created paywalls**](kmp-making-purchases): You build your own paywall UI in code but still use Adapty to fetch products and handle purchases.
...
Not sure which one to pick? Read the [comparison table in the quickstart](kmp-quickstart-paywalls).
...
**Guide:** [Install & configure Adapty SDK](sdk-installation-kotlin-multiplatform)
...
**Guides:**
- [Enable purchases using paywalls (quickstart)](kmp-quickstart-paywalls)
- [Fetch Paywall Builder paywalls and their configuration](kmp-get-pb-paywalls)
- [Display paywalls](kmp-present-paywalls)
- [Handle paywall events](kmp-handling-events)
- [Respond to button actions](kmp-handle-paywall-actions)
...
**Guides:**
- [Enable purchases in your custom paywall (quickstart)](kmp-quickstart-manual)
- [Fetch paywalls and products](fetch-paywalls-and-products-kmp)
- [Render paywall designed by remote config](present-remote-config-paywalls-kmp)
- [Make purchases](kmp-making-purchases)
- [Restore purchases](kmp-restore-purchase)
...
- [Implement Observer mode](implement-observer-mode-kmp)
- [Report transactions in Observer mode](report-transactions-observer-mode-kmp)
...
**Guide:** [Check subscription status](kmp-check-subscription-status)
...
**Guide:** [Identify users](kmp-quickstart-identify)
