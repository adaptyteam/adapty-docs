...
If you don't want to use the paywall builder, see the [guide for handling purchases in manually created paywalls](kmp-making-purchases).
:::
...
:::tip
For more details on how to display a paywall, see our [guide](kmp-present-paywalls).
:::
...
Now, you need to [check the users' access level](kmp-check-subscription-status) to ensure you display a paywall or give access to paid features to right users.
