...
This guide is for **legacy builder paywalls** only. The process for presenting paywalls differs for manually implemented paywalls and [Observer mode](observer-vs-full-mode).
