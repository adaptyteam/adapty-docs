...
When using the paywall view on Android, system UI elements such as the status bar and navigation bar may appear on top of the paywall content. To prevent this, add the following boolean resource to your app:
