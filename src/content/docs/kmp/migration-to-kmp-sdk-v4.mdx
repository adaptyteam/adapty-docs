...
description: "Migrate to Adapty Kotlin Multiplatform SDK v4.0 (beta) by replacing paywall APIs with flow APIs, which render flows in addition to old builder paywalls."
metadataTitle: "Migrating to Adapty Kotlin Multiplatform SDK v4.0 (beta) | Adapty Docs"
---

Adapty Kotlin Multiplatform SDK 4.0 (beta) introduces flows and renames the paywall APIs accordingly. The new APIs work with flows, and they still work with paywalls from the old builder — no setup changes are required on the Adapty Dashboard side.
