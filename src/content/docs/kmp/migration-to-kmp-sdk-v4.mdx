...
description: "Migrate to Adapty Kotlin Multiplatform SDK v4.0 (beta) by replacing paywall APIs with flow APIs, compatible with both flows and legacy Paywall Builder paywalls."
metadataTitle: "Migrating to Adapty Kotlin Multiplatform SDK v4.0 (beta) | Adapty Docs"
---

Adapty Kotlin Multiplatform SDK 4.0 (beta) introduces flows and renames the paywall APIs accordingly. The new APIs work with both flows and legacy Paywall Builder paywalls — no setup changes are required on the Adapty Dashboard side.
