---
title: "Optimize paywall fetching in Kotlin Multiplatform SDK"
description: "Fetch Adapty paywalls reliably: timing, caching, and fallback patterns for Kotlin Multiplatform."
metadataTitle: "Optimize Paywall Fetching | Kotlin Multiplatform SDK | Adapty Docs"
---
...
The advice below uses the v3 method names. In SDK v4, `getPaywall` is renamed to `getFlow` (see the [migration guide](migration-to-kmp-sdk-v4)) — every rule applies unchanged.
