...
:::important
The skill is in beta. If it stalls or behaves unexpectedly, follow the [step-by-step integration guide](adapty-cursor-kmp) instead — it walks your AI tool through every stage with the right docs.
:::
