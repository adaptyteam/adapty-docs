...
description: "Migrate to Adapty iOS SDK v4.0 by replacing paywall APIs with flow APIs, compatible with both flows and legacy builder paywalls."
metadataTitle: "Migrating to Adapty iOS SDK v4.0 | Adapty Docs"
---

Adapty iOS SDK 4.0 introduces flows and renames the paywall APIs accordingly. The new APIs work with both flows and legacy builder paywalls — no setup changes are required on the Adapty Dashboard side.
