...
:::warning
This removal is temporary — promoted in-app purchase support will return in a later 4.x release. If your app relies on promoted in-app purchases, stay on iOS SDK 3.x until support returns.
:::

## Fetching paywalls

:::warning
The fallback file format [changed in SDK v4](fallback-flows) — v3 fallbacks are silently rejected. Re-download the file from **[Placements](https://app.adapty.io/placements)** > **Fallbacks** and bundle the new file in your app.
:::
