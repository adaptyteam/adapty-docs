...
:::note
SDK 4.1 renames this method to `updateExternalAttribution(_:provider:)` and the type to `AdaptyExternalAttributionProvider`, and adds two providers to it: `.googleODM` and `.custom`. The old names are removed in 4.1 without deprecation. If you migrate to 4.1 directly, see [Migrate to v4.1](migration-to-ios-sdk-41).
:::
