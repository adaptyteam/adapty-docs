---
title: "Handle errors - iOS"
description: "Troubleshoot and handle errors when using the Flow Builder in your iOS app."
metadataTitle: "Handle Flow Errors - iOS | Adapty Docs"
---
