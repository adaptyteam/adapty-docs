---
title: "Present flows & paywalls in Observer mode in iOS SDK"
description: "Learn how to present flows and paywalls in observer mode with the Adapty SDK."
metadataTitle: "Presenting flows & paywalls in Observer Mode | Adapty Docs"
---
...
If you've customized a paywall with the old Paywall Builder, you don't need to worry about rendering it in your mobile app code to display it to the user. Such a paywall contains both what should be shown within the paywall and how it should be shown.
