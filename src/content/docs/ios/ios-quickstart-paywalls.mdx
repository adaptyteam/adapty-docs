...
Now, you need to [check the users' access level](ios-check-subscription-status) to ensure you display a paywall or give access to paid features to right users.
