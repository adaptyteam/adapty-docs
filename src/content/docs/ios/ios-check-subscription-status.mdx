...
Now, when you know how to track the subscription status, [learn how to work with user profiles](ios-quickstart-identify) to ensure it aligns with your existing authentication system and paid access sharing permissions. 

If you don't have your own authentication system, that's not a problem at all, and Adapty will manage users for you, but you can still read the [guide](ios-quickstart-identify) to learn how Adapty works with anonymous users.