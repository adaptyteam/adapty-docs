...
This guide is for **[new Paywall Builder paywalls](adapty-paywall-builder)** . The process for presenting paywalls differs for paywalls designed with different versions of Paywall Builder, remote config paywalls, and [Observer mode](observer-vs-full-mode).
