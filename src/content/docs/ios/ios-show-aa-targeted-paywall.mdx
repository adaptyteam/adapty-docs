...
:::note
The examples below use the SDK 4.1+ property name `appliedExternalAttributionProviders`. In SDK versions 3.17.1–4.0, the property is named `appliedAttributionSources`.
:::
