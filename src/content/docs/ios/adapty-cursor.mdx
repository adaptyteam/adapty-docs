...
This guide walks through integrating Adapty into your iOS app step by step with an AI coding tool — you feed it the right Adapty docs in the right order.
...
**Guides:**
- [Enable purchases with Flow & Paywall Builder (quickstart)](ios-quickstart-paywalls)
...
**Guides:**
- [Enable purchases in a manual paywall (quickstart)](ios-quickstart-manual)
- [Fetch paywalls and products](fetch-paywalls-and-products)
- [Render a manual paywall with remote config](present-remote-config-paywalls)
