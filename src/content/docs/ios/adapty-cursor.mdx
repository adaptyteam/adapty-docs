...
description: "A step-by-step guide to integrating Adapty into your iOS app using Cursor, ChatGPT, Claude, or other AI tools."
...
You can access any Adapty doc as plain text Markdown by adding `.md` to the end of its URL or clicking **Copy for LLM** under the article title. For example: [https://adapty.io/docs/adapty-cursor.md](https://adapty.io/docs/adapty-cursor.md).
