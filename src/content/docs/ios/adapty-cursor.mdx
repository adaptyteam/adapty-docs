...
- [**Manually created paywalls**](making-purchases): You build your own paywall UI in code but still use Adapty to fetch products and handle purchases.
...
**Guides:**
- [Enable purchases using paywalls (quickstart)](ios-quickstart-paywalls)
- [Fetch Paywall Builder paywalls and their configuration](get-pb-paywalls)
- [Display paywalls](ios-present-paywalls)
- [Handle paywall events](ios-handling-events)
