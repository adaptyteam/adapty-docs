---
title: "ExpoプロジェクトへのAdapty React Native SDKのインストールと設定"
description: "サブスクリプションアプリ向けExpoプロジェクトにAdapty React Native SDKをインストールするためのステップバイステップガイド。"
metadataTitle: "Expo React NativeプロジェクトへのAdapty SDKのインストール | Adapty ドキュメント"
