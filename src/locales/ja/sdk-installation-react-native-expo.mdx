...
Billing Library のバージョンとの互換性は、Google がそのバージョンで導入したすべての機能を Adapty がサポートすることを意味しません。新しい Google Play の課金機能を導入する前に、[Play Store のプロダクト](android-products)をご確認ください。
:::
