...
description: "タイトルや価格などの Adapty プロダクトデータを、FlutterFlow でデザインしたペイウォールページにマッピングします。"
metadataTitle: "FlutterFlow ペイウォールに Adapty プロダクトデータを追加する | Adapty ドキュメント"
---

[必要なプロダクトデータをすべて取得](ff-action-flow)したら、FlutterFlow でデザインした美しいペイウォールにデータをマッピングしましょう。この例では、プロダクトのタイトルと価格をマッピングします。
