---
title: "Pushwoosh"
description: "シームレスなプッシュ通知トラッキングのために、PushwooshをAdaptyと連携しましょう。"
...
Adaptyはサブスクリプションイベントを使用して[Pushwoosh](https://www.pushwoosh.com/)のプロファイルタグを更新します。以下に説明する簡単なインテグレーション設定を行うことで、プッシュ通知を使用した顧客とのターゲットコミュニケーションを構築できます。
