...
## 1. フローを作成する \{#build-the-flow\}

1. Adaptyメインメニューの[**Flows**](https://app.adapty.io/flows)に移動します。
2. **Create flow**をクリックして、フローをデザインします。

[Adapty フロー & ペイウォールビルダー](adapty-flow-builder)について詳しく見る。

<ZoomImage id="new-flow.webp" />

以下のテンプレートガイドでは、よく使われるパターンをステップごとに説明しています：
...
フローを保存して公開したら、次はプレースメントへの組み込みに進みます。
