...
<TabItem value="flow-builder" label="フローの使用" default>

:::important
フロービルダーは現在、iOS、Android、React Native、Flutter、および Capacitor SDK v4 以降をサポートしています。他のプラットフォームへの対応は近日中に追加される予定です。
:::

フローとは、プロダクトが直接埋め込まれた 1 つ以上の画面のことです。[フロービルダー](adapty-flow-builder)でデザインでき、コーディングは不要です。
