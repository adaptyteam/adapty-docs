...
:::important
フロービルダーは現在、iOS、Android、および React Native SDK v4 以降をサポートしています。その他のプラットフォームのサポートは近日公開予定です。
:::

フローとは、プロダクトが直接埋め込まれた1つ以上の画面のことです。[フロービルダー](adapty-flow-builder)でデザインでき、コードは不要です。
