...
4. **ペイウォールとプレースメントを作成する**: Adapty ダッシュボードの **Paywalls** ページでペイウォールを作成し、**Placements** ページでプレースメントに割り当てます。コード内では、プレースメント ID は `Adapty.getFlow("YOUR_PLACEMENT_ID")` に渡す文字列です。
