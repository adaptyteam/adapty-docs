...
1. [iOS](https://apps.apple.com/us/app/adapty/id6739359219) または [Android](https://play.google.com/store/apps/details?id=io.adapty.dashboard) 向けの Adapty モバイルアプリをダウンロードします。
...
3. フローのロケールを選択します。
4. デバイスのカメラで QR コードをスキャンするか、リンクを開きます。Adapty モバイルアプリでフローが表示されます。
...
## Adapty ダッシュボードでプレビューする \{#preview-in-the-adapty-dashboard\}

:::tip
フローを公開する前に、[実機でプレビュー](#preview-on-devices)してエラーなく表示されることを確認しましょう。
:::
