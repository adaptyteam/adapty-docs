...
description: "FlutterFlow のペイウォールから Adapty を通じてユーザーがプロダクトを購入できるようにします。"
metadataTitle: "FlutterFlow のペイウォールで購入を有効にする | Adapty ドキュメント"
---

おめでとうございます！プロダクトのタイトルや価格など、[Adapty からのプロダクトデータを表示するペイウォールの設定](ff-add-variables-to-paywalls)が完了しました。

では、最終ステップに進みましょう。ペイウォールからユーザーが購入できるようにします。
