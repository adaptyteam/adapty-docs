...
フローを作成する際、アプリ全体のデザインに合わせてカスタムフォントを使いたいことがあります。カスタムフォントを追加してフローで使用する方法を説明します。

1つのアプリ内のすべてのフローは、アップロードしたフォントを共有します。[コピー](copy-flows)したフローも同様です。Adapty アカウント内の他のアプリには、それぞれ別途アップロードが必要です。
