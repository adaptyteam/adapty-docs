---
title: "UnitySDKでユーザー属性を設定する"
description: "Adapty SDKを使用して、UnityアプリでユーザーAttributesとプロファイルデータを更新する方法を学びます。"
metadataTitle: "ユーザーデータを更新する | Unity SDK | Adapty ドキュメント"
customSlug: /unity-setting-user-attributes
displayed_sidebar: sdkunity
---

メールアドレスや電話番号などのオプション属性をアプリのユーザーに設定できます。設定した属性は、ユーザー[セグメント](segments)の作成や、CRMでの閲覧に活用できます。
