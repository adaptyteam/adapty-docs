---
title: "アカウント詳細と課金"
description: "Adaptyアカウントを管理し、サブスクリプション追跡の設定を最適化しましょう。"
metadataTitle: "Adaptyアカウントの管理 | Adapty ドキュメント"
---

**Account** ページでは、プロファイル、チームメンバー、課金を管理できます。

このページには3つのタブがあります：

- [一般](#general-settings)
- [サブスクリプションと課金](#subscription--billing)
- [メンバー](#members)
