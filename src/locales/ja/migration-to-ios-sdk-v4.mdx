...
:::warning
この削除は 4.0 のみに適用されます。プロモートアプリ内課金のサポートは SDK 4.1 で新しい API とともに復活します。アプリがプロモートアプリ内課金を使用している場合は、3.x から直接 4.1 に移行してください。[App Store からのアプリ内課金](making-purchases#in-app-purchases-from-the-app-store)を参照してください。
:::
