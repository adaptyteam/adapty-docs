...
:::note
SDK 4.0 では、リスナーインターフェースが C# の I プレフィックス規約に従います。`AdaptyEventListener` の代わりに `IAdaptyEventListener` を実装してください。メソッドは変更ありません。詳細は[移行ガイド](migration-to-unity-sdk-v4)を参照してください。
:::
