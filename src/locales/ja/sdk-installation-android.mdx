...
最低SDKバージョン: `minSdkVersion 21`

:::info
Adapty SDK 3.17.3および4.0.2以降、AdaptyはGoogle Play Billing Library v8に対応しています。

特定のBilling Libraryバージョンとの互換性は、GoogleがそのバージョンでリリースしたすべてのBilling Library機能をAdaptyがサポートすることを意味するわけではありません。Google Playの新しい課金機能を導入する前に、[Play Storeのプロダクト](android-products)を参照してください。
:::
