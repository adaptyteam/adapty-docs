...
:::info
Adapty SDK 4.0.2 以降は Google Play Billing Library v8 に対応しています。

Billing Library のバージョンとの互換性は、Google がそのバージョンで導入したすべての機能を Adapty がサポートすることを意味しません。新しい Google Play の課金機能を採用する前に、[Play ストアのプロダクト](android-products)を参照してください。
:::
