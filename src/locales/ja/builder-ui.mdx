...
要素を選択すると、右パネルでスタイルとインタラクティブなプロパティを変更できます。

#### デザインプロパティ \{#design-properties\}

:::link
詳細はこちら: [要素の配置](manage-paywall-ui-elements)、[要素のスタイリング](builder-styling)
:::
...
ここでは、グローバルスタイルの編集・管理ができます。フロー内の複数の要素で同じタイポグラフィやカラーを使用している場合は、そのデータをグローバルスタイルとして保存しておきましょう。保存しておけば、ワンクリックで再利用できます。
