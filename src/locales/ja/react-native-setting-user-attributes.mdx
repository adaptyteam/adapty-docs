...
description: "Adapty SDKを使用してReact Nativeアプリでユーザーのプロフィールデータを更新する方法を学びましょう。"
metadataTitle: "ユーザーデータの更新 | React Native SDK | Adapty ドキュメント"
customSlug: /react-native-setting-user-attributes
displayed_sidebar: sdkreactnative
---

メールアドレスや電話番号など、オプションの属性をアプリのユーザーに設定できます。設定した属性を使ってユーザー[セグメント](segments)を作成したり、CRMで確認したりすることができます。
