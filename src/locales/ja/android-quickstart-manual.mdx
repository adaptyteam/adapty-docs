...
:::important
**このガイドは、カスタムペイウォールを実装する開発者向けです。** 課金を最も簡単に有効にしたい場合は、[Adapty フロー＆ペイウォールビルダー](android-quickstart-paywalls)をご利用ください。フロー＆ペイウォールビルダーでは、ノーコードのビジュアルエディタでフローを作成し、購入ロジックはすべて Adapty が自動的に処理します。また、アプリを再公開することなく、さまざまなデザインをテストできます。
:::
