---
title: "ボタン"
description: "フロー＆ペイウォールビルダーでアクションボタンを追加・設定する方法。"
metadataTitle: "ボタン | フロー＆ペイウォール | Adapty ドキュメント"
---

:::info
このセクションでは、Adapty SDK バージョン 4.0 以降で動作する新しいフロー＆ペイウォールビルダーについて説明します。
:::

ボタンは、フロー＆ペイウォールビルダーにおいてユーザーのタップに反応するインタラクティブな要素です。以下の用途に使用します：
- プロダクトに紐付けてトランザクションを自動処理する購入 CTA
- ナビゲーション — 画面間のユーザー移動（次へ、戻る、閉じる、スキップ）
- ユーティリティリンク — 購入の復元、利用規約、プライバシーポリシー

:::tip
購入 CTA、復元リンク、法的リンクは [フッター](builder-containers#footer) 内に配置してください。フッターは画面下部に固定され、スクロールする要素の下を隠します。
:::
