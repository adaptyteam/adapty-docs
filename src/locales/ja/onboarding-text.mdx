---
title: "フローBuilder でのテキストとリストの追加とスタイル設定"
description: "Adapty のフロービルダーでタイトル、サブタイトル、段落、リストを追加・スタイル設定し、ブランドに合ったユーザー体験を実現します。"
metadataTitle: "テキスト | フロービルダー | Adapty ドキュメント"
---

タイトル、段落、またはリストをワンクリックで追加し、ブランドに合わせてスタイルを整え、[動的変数](onboarding-variables)を使って各ユーザー向けにコンテンツをパーソナライズできます。
