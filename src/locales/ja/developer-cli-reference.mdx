---
title: "Adapty Developer CLI のコマンドリファレンス"
description: "アプリ、プロダクト、ペイウォール、プレースメントを設定する Adapty Developer CLI コマンドのリファレンス。"
metadataTitle: "Developer CLI コマンドリファレンス | Adapty ドキュメント"
keywords: ['cli', 'developer', 'reference', 'commands', 'mcp']
---

この記事では、アカウント（アプリ、アクセスレベル、プロダクト、ペイウォール、プレースメント、セグメント）を設定する Adapty CLI コマンドを、引数・フラグ・使用可能な値とともに説明します。Apple Ads キャンペーンについては、[Ads Manager コマンド](developer-cli-ads-manager-reference)を参照してください。
