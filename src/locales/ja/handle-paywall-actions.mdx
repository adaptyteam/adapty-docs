---
title: "フローのアクションに応答する - iOS"
description: "iOSアプリでペイウォールおよびオンボーディングフローのボタンアクションを処理し、ユーザー入力を処理します。"
metadataTitle: "フローのアクションに応答する - iOS | Adapty ドキュメント"
...
Adapty Flow & Paywall Builderでフローを構築する場合、ボタンを適切に設定することが重要です：
...
:::warning
**フロー／ペイウォールのクローズと URL のオープンのみ自動で処理されます。** その他のボタンアクションはすべて、アプリのコードで適切なレスポンス実装が必要です。
:::
...
Adapty のペイウォールビルダーを使用してペイウォールを構築する場合、ボタンを適切に設定することが重要です：
...
:::warning
**購入、復元、ペイウォールのクローズ、および URL のオープンのみが自動的に処理されます。** その他すべてのボタンアクションは、アプリのコード内で適切な処理の実装が必要です。
:::
