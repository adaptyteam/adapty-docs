...
Adapty でプロダクトを作成する方法は、すでにストアに存在するかどうかによって異なります。
- **[App Store や Google Play にプロダクトがまだ存在しない場合は、Adapty でプロダクトを作成してストアにすぐに配信します。](#create-product-and-push-to-store)**
- **[App Store や Google Play にプロダクトがすでに存在する場合は、Adapty でプロダクトを作成して既存のストアプロダクトと連携します。](#create-product-and-connect-existing-store-products)**

:::tip
[Developer CLI](developer-cli-reference#adapty-products-create) を使用してプログラムでプロダクトを作成することもできます。
:::
