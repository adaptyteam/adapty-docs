---
title: "Adapty Developer CLIの認証"
description: "Adapty Developer CLIで認証する方法。"
...
1回のログインでCLI全体をカバーできます。[Ads Managerコマンド](developer-cli-ads-manager)は別のサービスに接続しますが、同じ保存済みトークンを使用するため、2回目のログイン手順は不要です。
