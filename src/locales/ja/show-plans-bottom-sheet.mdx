...
description: "シングルCTAのヒーローペイウォールに「すべてのプランを表示」リンクとボトムシートを追加し、プロダクト一覧を表示する方法を説明します。"
metadataTitle: "すべてのプランをボトムシートに表示する | フローとペイウォール | Adapty ドキュメント"
---

このテンプレートは、まず強調表示された1つのオファーを表示し、全プラン一覧へのシンプルなリンクを用意します。**Show all plans** をタップすると、他のプロダクト・購入ボタン・フッターリンクを含むボトムシートがスライドアップして表示されます。
