...
description: "フロー＆ペイウォールビルダーで要素をコンテナ、カルーセル、ボトムシートにグループ化します。"
metadataTitle: "コンテナ、カルーセル、ボトムシート | フロー＆ペイウォール | Adapty ドキュメント"
---

レイアウト要素は、他の要素をグループ化し、画面上でのレイアウト方法を制御します。

フロー＆ペイウォールビルダーには、5種類のレイアウト要素があります：

- **コンテナ**: 子要素を縦または横の軸に沿って並べます
- **カルーセル**: 1度に1枚のスライドを表示するスワイプ可能なコンテナ
- **ボトムシート**: 画面の下部からスライドアップし、下のコンテンツの上に重なって表示されるパネル
- **フッター**: スクロールエリアの外側で画面下部に固定されるパネル
- **区切り線**: 行や列を区切る細い線
