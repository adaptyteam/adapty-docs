...
:::tip
このデータをスケジュールに沿ってレポートに取り込むには、Adapty CLI を使用すると1つのコマンドで最大5つのアプリのデータを取得できます。詳しくは[Ads Manager コマンド](developer-cli-ads-manager-reference#competitors)をご覧ください。
:::
