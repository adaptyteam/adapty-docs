---
title: "Slack"
description: "SlackとAdaptyを連携して、サブスクリプションイベントのリアルタイム通知を受け取りましょう。"
metadataTitle: "SlackとAdaptyの連携 | Adapty ドキュメント"
---

import AccessLevelUpdatedEventFeed from '@site/src/locales/ja/reusable/AccessLevelUpdatedEventFeed.mdx';


[Slack](https://slack.com/) は、説明不要のビジネス向けメッセンジャー＆生産性向上プラットフォームです。

このインテグレーションを使用すると、Adaptyが収益イベントを追跡するたびにSlackで通知を受け取ることができます。MRRが増加する瞬間を逃さず喜びたい場合や、トライアルのキャンセル、請求の問題、返金などを監視したい場合に役立ちます。
