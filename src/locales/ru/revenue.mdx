...
- ✅ Фильтрация по: атрибуции, аудитории, стране, типу офера, ID офера, типу скидки офера, пейволу, флоу, экрану флоу, A/B-тестам, плейсменту, периоду, сегменту, стору, продукту и длительности.
- ✅ Группировка по: периоду, статусу обновления, продукту, стране, стору, пейволу, флоу, экрану флоу, аудитории, плейсменту, длительности, типу офера, типу скидки офера, ID офера, сегменту и атрибуции.
