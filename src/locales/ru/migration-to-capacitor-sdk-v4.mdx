---
title: "Миграция Adapty Capacitor SDK на v4.0"
description: "Мигрируйте на Adapty Capacitor SDK v4.0 (beta): замените paywall API на flow API, совместимые с Flow Builder и Paywall Builder."
metadataTitle: "Миграция на Adapty Capacitor SDK v4.0 (beta) | Документация Adapty"
---
