...
## Promoted in-app purchases в App Store \{#app-store-promoted-in-app-purchases\}

До версии 4.1.1 [встроенная покупка, продвигаемая на странице продукта в App Store](capacitor-making-purchases#in-app-purchases-from-the-app-store), завершалась самостоятельно и Adapty фиксировал транзакцию, но у приложения не было возможности перехватить её. В версии 4.1.1 добавлен соответствующий хук — это новая возможность, а не шаг миграции: без собственного кода SDK по-прежнему самостоятельно завершает продвигаемые покупки.
