---
title: "Показ онбордингов в Capacitor SDK"
description: "Узнайте, как показывать онбординги в Capacitor для повышения конверсии и дохода."
metadataTitle: "Показ онбордингов в Capacitor | Документация Adapty"
---
