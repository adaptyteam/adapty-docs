...
:::note
В SDK 4.1 интерфейсы слушателей следуют соглашению C# с префиксом I: реализуйте `IAdaptyOnboardingsEventsListener` вместо `AdaptyOnboardingsEventsListener`. Методы остались прежними. Подробнее — в [руководстве по миграции](migration-to-unity-sdk-v4).
:::
