---
title: "Pushwoosh"
description: "Интегрируйте Pushwoosh с Adapty для отслеживания push-уведомлений."
...
Adapty использует события подписки для обновления тегов профиля в [Pushwoosh](https://www.pushwoosh.com/), что позволяет выстраивать целевые коммуникации с пользователями через push-уведомления после простой и быстрой настройки интеграции, описанной ниже.
...
### `access_level_updated` отображается как ошибка в Event Feed \{#access_level_updated-shows-as-failed-in-the-event-feed\}
