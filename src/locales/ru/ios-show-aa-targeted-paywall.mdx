---
title: "Показать пейвол с таргетингом Apple Ads при первом запуске в iOS SDK"
description: "Дождитесь атрибуции Apple Ads перед запросом пейвола на iOS, используя AdaptyProfile.appliedAttributionSources."
metadataTitle: "Показать пейвол с таргетингом Apple Ads при первом запуске | iOS SDK | Документация Adapty"
---
