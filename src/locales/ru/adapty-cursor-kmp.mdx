...
Это руководство шаг за шагом проведёт вас через интеграцию Adapty в Flutter-приложение с помощью AI-инструмента для написания кода — вы подаёте ему нужную документацию Adapty в правильном порядке. Для полностью автоматизированного флоу используйте [навык adapty-sdk-integration](adapty-sdk-integration-skill-kmp).
