...
Поля ввода и группы выбора автоматически передают свои значения. Чтобы различать их в коде, задайте каждому полю ввода осмысленный **Element ID**, а каждой группе выбора — **Group ID** в билдере.
