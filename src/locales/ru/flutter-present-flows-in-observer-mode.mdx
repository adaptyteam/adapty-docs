...
:::
:::info
Эта функциональность требует Adapty Flutter SDK версии 4.0 или выше — ранее она была доступна только в нативных iOS и Android SDK. Ознакомьтесь с [гайдом по миграции](migration-to-flutter-sdk-v4), чтобы обновиться.
:::
...
<details>
   <summary>Перед показом флоу (нажмите, чтобы развернуть)</summary>
