...
:::warning
Этот раздел относится только к [режиму Observer](observer-vs-full-mode). Если вы не используете режим Observer, обратитесь к разделу [Отображение флоу и пейволов](react-native-present-paywalls).
:::

:::info
Для этой функции требуется Adapty React Native SDK 4.0 или выше — ранее она была доступна только в нативных iOS и Android SDK. Ознакомьтесь с [гайдом по миграции](migration-to-react-native-sdk-v4), чтобы выполнить обновление.
:::
