---
title: "Использование резервных пейволов в чистом React Native проекте"
description: "Настройка резервных пейволов в чистом React Native (non-Expo) проекте."
...
:::important
Этот гайд предназначен для **чистых React Native (non-Expo) проектов**.
