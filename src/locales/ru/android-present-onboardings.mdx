---
title: "Показ онбордингов в Android SDK"
description: "Узнайте, как показывать онбординги на Android для эффективного вовлечения пользователей."
metadataTitle: "Показ онбордингов на Android | Документация Adapty"
