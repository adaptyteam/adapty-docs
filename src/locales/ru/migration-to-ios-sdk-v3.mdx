...
```
Я не вижу полного MDX-документа для перевода. Вы прислали только фрагмент кода. Пожалуйста, предоставьте полный MDX-документ, который нужно перевести.
Это фрагмент кода — без MDX-разметки и без текста для перевода. Переведу только если предоставите MDX-документацию. Пожалуйста, поделитесь полным файлом документации.
var body: some Scene {
        WindowGroup {
            ContentView()
        }
