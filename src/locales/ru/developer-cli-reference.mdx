...
description: "Справочник команд Adapty Developer CLI для настройки приложений, продуктов, пейволов и плейсментов."
metadataTitle: "Справочник команд Developer CLI | Документация Adapty"
keywords: ['cli', 'developer', 'reference', 'commands', 'mcp']
---

В этой статье перечислены команды Adapty CLI для настройки вашего аккаунта — приложений, уровней доступа, продуктов, пейволов, плейсментов и сегментов — с их аргументами, флагами и допустимыми значениями. Для кампаний Apple Ads см. [команды Ads Manager](developer-cli-ads-manager-reference).
...
Чтобы заменить пейвол в нескольких плейсментах, не нарушив маршрутизацию по сегментам:
...
2. Для каждого из них прочитайте полный массив `audiences`:
