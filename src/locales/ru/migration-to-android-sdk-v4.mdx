---
title: "Миграция Adapty Android SDK на v4.0"
description: "Перейдите на Adapty Android SDK v4.0, заменив paywall API на flow API, совместимые как с Flow Builder, так и с Paywall Builder."
metadataTitle: "Миграция на Adapty Android SDK v4.0 | Документация Adapty"
---

Adapty Android SDK 4.0 вводит флоу и соответствующим образом переименовывает paywall API. Новые API работают как с новым Flow Builder, так и с существующим Paywall Builder — никаких изменений в настройках на стороне дашборда Adapty не требуется.
