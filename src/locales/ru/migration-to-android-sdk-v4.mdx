...
Укажите версию `adapty-bom` `4.0.0-beta.2` и синхронизируйте проект. BOM автоматически подберёт совместимые версии `android-sdk` и `android-ui`. Инструкции по подключению зависимостей см. в разделе [Установка Adapty SDK](sdk-installation-android).
