...
description: "Пошаговое руководство по установке Adapty SDK на Capacitor для приложений с подписками."
...
Для сборки под iOS с Adapty SDK v4 (beta) требуется **Xcode 26** или новее — нативный iOS SDK использует Swift tools 6.2. Требования iOS 15.0+, Capacitor 8 и Android minSdk 24 остаются такими же, как для SDK 3.16+.
