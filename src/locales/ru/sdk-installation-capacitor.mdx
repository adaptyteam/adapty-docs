...
Для сборки под iOS требуется **Xcode 26** или новее — нативный iOS SDK собирается с использованием Swift Tools 6.2. На Android минимальная версия SDK — 24.
...
Совместимость с версией Billing Library не означает, что Adapty поддерживает все функции, представленные в ней Google. Прежде чем использовать новые возможности биллинга Google Play, ознакомьтесь с разделом [Продукт в Play Store](android-products).
:::
