...
Для сборки под iOS требуется **Xcode 26** или новее — нативный iOS SDK собран с помощью Swift tools 6.2. На Android минимальная версия SDK — 24.
...
|---|---|
| 3.17.0 и новее | v8 |
| 3.15.0–3.16.3 | v7 по умолчанию, v8 если другая зависимость её повышает |

:::note
Совместимость с версией Billing Library не означает, что Adapty поддерживает все функции, которые Google представила в этой версии. Прежде чем использовать новые возможности Google Play Billing, ознакомьтесь с разделом [Продукт в Play Store](android-products).
:::
