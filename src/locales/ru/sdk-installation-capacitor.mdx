...
Для сборки под iOS требуется **Xcode 26** или новее — нативный iOS SDK собирается с инструментами Swift 6.2. На Android минимальная версия SDK — 24.

:::info
Adapty Capacitor SDK работает с Google Play Billing Library v8.

Совместимость с версией Billing Library не означает, что Adapty поддерживает все функции, которые Google добавила в неё. Прежде чем использовать новую возможность Google Play Billing, ознакомьтесь с разделом [Продукт в Play Store](android-products).
:::
