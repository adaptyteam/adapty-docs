...
После того как вы [разработали флоу или пейвол в Paywall Builder](adapty-paywall-builder), вы можете отображать его в мобильном приложении. Первый шаг — получить флоу или пейвол, связанный с плейсментом, вместе с конфигурацией представления, как описано ниже.

<SampleApp />

<details>
   <summary>Перед тем как начать отображать флоу в мобильном приложении (нажмите, чтобы раскрыть)</summary>
...
Обратите внимание: этот раздел посвящён пейволам, созданным с помощью Paywall Builder. Если вы реализуете пейволы вручную, см. раздел [Получение пейволов и продуктов для пейволов с Remote Config в мобильном приложении](fetch-paywalls-and-products-kmp).
