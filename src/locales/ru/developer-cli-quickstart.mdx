...
Если вы также продаёте этот продукт в вебе через Stripe или Paddle, добавьте их ID в ту же команду. Подробнее см. [products create](developer-cli-reference#adapty-products-create) в полном справочнике.
