...
description: "Настройка резервных пейволов в проекте Expo React Native с помощью конфиг-плагина react-native-adapty."
metadataTitle: "Использование резервных флоу на React Native | Документация Adapty"
keywords: ['резервные пейволы', 'expo', 'react native', 'конфиг-плагин', 'prebuild', 'офлайн-пейволы']
---

:::important
Этот гайд предназначен для **проектов Expo**.
