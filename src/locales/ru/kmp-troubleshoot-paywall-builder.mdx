...
**Причина**: Пейвол не настроен для отображения на устройстве в Paywall Builder.

**Решение**: Включите переключатель **Show on device** в Paywall Builder. Также можно проверить, есть ли у пейвола конфигурация представления, с помощью свойства `hasViewConfiguration` объекта `AdaptyPaywall`.
