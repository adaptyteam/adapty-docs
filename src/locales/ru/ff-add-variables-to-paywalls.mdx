...
description: "Сопоставьте данные продуктов Adapty, такие как название и цена, со страницей пейвола, разработанной во FlutterFlow."
metadataTitle: "Добавление данных продуктов Adapty в пейвол FlutterFlow | Документация Adapty"
---

После того как вы [получили все необходимые данные о продуктах](ff-action-flow), пришло время сопоставить их с пейволом, который вы разработали во FlutterFlow. В этом примере мы сопоставим название продукта и его цену.
