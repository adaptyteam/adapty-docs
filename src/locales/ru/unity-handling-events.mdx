...
description: "Обрабатывайте события флоу и пейвола в вашем Unity-приложении."
...
Подробнее о том, что делать с этими событиями, — в разделе [Отслеживание просмотров экранов флоу](unity-flow-screen-views).

Флоу также сообщает о значениях, которые пользователи вводят и выбирают. Подробнее — в разделе [Обработка данных из флоу](unity-flow-input).
