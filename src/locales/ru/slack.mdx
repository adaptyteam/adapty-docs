...
[Slack](https://slack.com/) — корпоративный мессенджер и платформа для совместной работы, не нуждающаяся в представлении.

С этой интеграцией вы будете получать уведомления в Slack каждый раз, когда Adapty фиксирует событие дохода. Это удобно, если вы хотите отмечать каждый момент роста MRR или следить за отменами триалов, проблемами с оплатой, возвратами средств и другим.
