...
Ошибка с кодом 1000, `noProductIDsFound`, означает, что ни один из продуктов, запрошенных на пейволе, недоступен для покупки в App Store, хотя они там и перечислены. Иногда эта ошибка сопровождается предупреждением `InvalidProductIdentifiers`. Если предупреждение появляется без ошибки — его можно смело игнорировать.
...
4. Прокрутите вниз до раздела **Subscription Pricing** и разверните блок **Current Pricing for New Subscribers**.
    <Zoom>
...
5. Убедитесь, что все необходимые цены указаны.
    ...
    Выполнив эти шаги, вы должны устранить предупреждение `InvalidProductIdentifiers` и сделать свои продукты доступными в сторе.