...
description: "Отображение флоу и пейволов в Flutter-приложениях с помощью функций монетизации Adapty."
metadataTitle: "Отображение флоу и пейволов во Flutter | Документация Adapty"
---

<SDKv4>

Если вы разработали флоу или пейвол с помощью Flow Builder или Paywall Builder, вам не нужно беспокоиться о его отрисовке в коде мобильного приложения — всё необходимое уже включено: и что показывать, и как это показывать.

:::warning

Это руководство предназначено для флоу и пейволов, созданных в Paywall Builder. Для отображения **пейволов с Remote Config** см. [Отображение пейвола, созданного с помощью Remote Config](present-remote-config-paywalls-flutter).
