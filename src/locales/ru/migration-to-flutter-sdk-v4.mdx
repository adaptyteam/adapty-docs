...
description: "Перейдите на Adapty Flutter SDK v4.0, заменив paywall API на flow API, которые рендерят флоу наряду со старыми пейволами из конструктора."
metadataTitle: "Миграция на Adapty Flutter SDK v4.0 | Документация Adapty"
---

Adapty Flutter SDK 4.0 вводит флоу и переименовывает paywall API соответствующим образом. Новые API работают с флоу и по-прежнему совместимы с пейволами из старого конструктора — никаких изменений в настройках дашборда Adapty не требуется.
