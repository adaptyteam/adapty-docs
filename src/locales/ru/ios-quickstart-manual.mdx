...
:::important
**Этот гайд предназначен для разработчиков, которые реализуют пользовательские пейволы.** Если вы хотите самый простой способ подключить покупки, используйте [Adapty Flow & Paywall Builder](ios-quickstart-paywalls). С Flow & Paywall Builder вы создаёте флоу в визуальном редакторе без кода, Adapty автоматически управляет всей логикой покупок, а тестировать разные дизайны можно без повторной публикации приложения.
:::
