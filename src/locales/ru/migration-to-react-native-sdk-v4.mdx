---
title: "Миграция Adapty React Native SDK на v4.0"
description: "Мигрируйте на Adapty React Native SDK v4.0, заменив API пейволов на API флоу, которые отображают флоу в дополнение к старым пейволам из билдера."
metadataTitle: "Миграция на Adapty React Native SDK v4.0 | Документация Adapty"
---

Adapty React Native SDK 4.0 вводит флоу и переименовывает API пейволов соответствующим образом. Новые API работают с флоу и по-прежнему совместимы с пейволами из старого билдера — никаких изменений на стороне дашборда Adapty не требуется.
