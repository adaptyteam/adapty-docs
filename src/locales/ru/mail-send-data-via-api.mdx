...
Определите профиль по `external_profile_id`, `customer_user_id` или `email` — укажите хотя бы один из них. Удаление необратимо: повторное сохранение с теми же идентификаторами не восстановит профиль. Подробнее см. в справочнике [Удаление профиля](api-mail/operations/deleteProfile).
