...
:::info
Эта возможность требует Adapty Kotlin Multiplatform SDK 4.0 (beta) или более поздней версии — ранее она была доступна только в нативных iOS и Android SDK. Смотрите [гайд по миграции](migration-to-kmp-sdk-v4) для обновления.
:::
