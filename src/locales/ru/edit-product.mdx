...
4. Нажмите **Save**.
:::warning
Изменения, внесённые в App Store Connect или Google Play Console, не синхронизируются с Adapty. Цена, отображаемая в Adapty, устанавливается при создании продукта и не обновляется при изменении цены в сторе. Это не влияет на аналитику доходов, поскольку [в отчётах о доходах используется сумма, фактически уплаченная покупателем](store-sync#product-and-price-discrepancies).
:::

:::note
Если вы измените уровень доступа, изменение применяется только к новым подпискам. Для существующих подписчиков текущий уровень доступа остаётся прежним и обновляется автоматически при следующем продлении подписки.
:::
