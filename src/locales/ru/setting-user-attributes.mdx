...
description: "Узнайте, как задать атрибуты пользователя в Adapty для более точной сегментации аудитории."
metadataTitle: "Установка атрибутов пользователя | Документация Adapty"
keywords: ["updateProfile", "update profile", "user attributes"]
---

Вы можете задавать пользователям приложения необязательные атрибуты: email, номер телефона и другие. Атрибуты можно использовать для создания [сегментов](segments) пользователей или просто просматривать их в CRM.
