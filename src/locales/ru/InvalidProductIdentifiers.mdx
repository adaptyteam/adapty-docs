...
## Прежде чем начать: убедитесь, что к пейволу привязаны продукты \{#before-you-start-verify-the-paywall-has-products\}

Та же ошибка возникает, если в пейволе, к которому ведёт ваш плейсмент, нет привязанных продуктов — SDK тогда запрашивает пустой список, и никакая проверка в App Store это не исправит. Откройте в дашборде Adapty пейвол, отображаемый в этом плейсменте, и убедитесь, что в разделе **Products** перечислены нужные продукты. Если продукты есть — переходите к шагу 1.
