...
:::
## Получите максимум от данных Paddle \{#get-more-from-your-paddle-data\}

:::important
Чтобы события Paddle работали с интеграциями, ваши пользователи должны хотя бы раз войти в приложение через аккаунт App Store или Google Play.
:::

После интеграции с Paddle Adapty сразу готов предоставлять аналитику. Чтобы использовать данные Paddle по максимуму, вы можете настроить дополнительные интеграции Adapty для передачи событий Paddle — и собрать всю аналитику подписок в едином дашборде Adapty.

Интеграции, которые можно использовать для передачи и анализа событий Paddle:
- [Amplitude](amplitude)
- [AppsFlyer](appsflyer)
...
Amplitude, Firebase / Google Analytics и Mixpanel хранят отдельные учётные данные для каждой платформы. Заполните поля **Paddle** на странице интеграции — события Paddle не используют ваши учётные данные iOS или Android.
