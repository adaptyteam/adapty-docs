---
title: "Показ пейвола с таргетингом Apple Ads при первом запуске в Capacitor SDK"
...
metadataTitle: "Показ пейвола с таргетингом Apple Ads при первом запуске | Capacitor SDK | Документация Adapty"
---
