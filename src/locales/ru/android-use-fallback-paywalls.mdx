...
1. Переместите файл конфигурации резервного пейвола в директорию `assets` или `res/raw` вашего Android-проекта.
2. Вызовите метод `.setFallback` **до** того, как будете получать нужный флоу, пейвол или онбординг.
