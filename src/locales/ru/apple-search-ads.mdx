...
### Подключите ваше приложение к сети AdServices \{#connect-your-app-to-the-adservices-network\}

После того как вы завершите [настройку фреймворка AdServices](#connect-adapty-to-the-adservices-framework), Adapty автоматически начнёт собирать данные атрибуции Apple Search Ads. Добавлять код в SDK не нужно.

Для iOS-приложений данные этой атрибуции **всегда** имеют приоритет над данными из других источников. Если такое поведение нежелательно, *отключите* атрибуцию ASA, следуя инструкциям ниже.
