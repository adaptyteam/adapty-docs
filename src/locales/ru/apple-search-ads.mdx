...
[Apple Ads Manager](adapty-ads-manager) использует отдельное подключение. Подключите свой аккаунт Apple Ads в [настройках Apple Ads Manager](adapty-ads-manager-get-started).
:::
...
Apple Ads через [AdServices](https://developer.apple.com/documentation/adservices) требует настройки в дашборде Adapty, а также включения на стороне приложения. Чтобы настроить Apple Ads с помощью фреймворка AdServices через Adapty, выполните следующие шаги:
...
Чтобы отключить атрибуцию Apple Search Ads, откройте вкладку [**App Settings** -> **Apple Search Ads**](https://app.adapty.io/settings/apple-search-ads) и выключите переключатель **Receive Apple Search Ads attribution**.
