...
После завершения [настройки фреймворка AdServices](#connect-adapty-to-the-adservices-framework) Adapty автоматически начинает собирать данные атрибуции Apple Search Ads. Добавлять какой-либо код в SDK не нужно.
