...
description: "Узнайте, как обновлять атрибуты пользователя и данные профиля в приложении на React Native с помощью Adapty SDK."
...
Вы можете задавать необязательные атрибуты — например, email, номер телефона и другие данные — для пользователей вашего приложения. Эти атрибуты можно использовать для создания [сегментов](segments) пользователей или просматривать их в CRM.
