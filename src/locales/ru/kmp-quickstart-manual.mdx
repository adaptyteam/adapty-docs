...
:::important
**Это руководство предназначено для разработчиков, реализующих кастомные пейволы.** Если вы хотите подключить покупки максимально просто, используйте [Adapty Flow & Paywall Builder](kmp-quickstart-paywalls). С Flow & Paywall Builder вы создаёте флоу в визуальном редакторе без кода, Adapty берёт на себя всю логику покупок, а тестировать разные дизайны можно без повторной публикации приложения.
:::
