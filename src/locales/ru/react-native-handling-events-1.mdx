...
---
import PaywallAction from '@site/src/locales/ru/reusable/PaywallAction.mdx';
...
Подробнее о том, что делать с этими событиями, — в разделе [Отслеживание просмотров экранов флоу](react-native-flow-screen-views).
