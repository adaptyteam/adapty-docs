---
title: "OneSignal"
description: "Интегрируйте OneSignal с Adapty для улучшения вовлечённости пользователей через push-уведомления."
...
Важно поддерживать единый идентификатор пользователя на всех устройствах и обновлять OneSignal при каждом изменении ID пользователя. Это упрощает отслеживание активности и подписок, обеспечивает согласованность сообщений, а также позволяет получать более точную аналитику и улучшать пользовательский опыт. Подробнее см. в [документации OneSignal по внешним идентификаторам пользователей](https://documentation.onesignal.com/docs/en/users).

## Устранение неполадок \{#troubleshooting\}

### `access_level_updated` отображается как failed в Event Feed \{#access_level_updated-shows-as-failed-in-the-event-feed\}
