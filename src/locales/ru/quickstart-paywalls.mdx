...
1. Перейдите в [**Flows**](https://app.adapty.io/flows) в главном меню Adapty.
...
Гайды по шаблонам ниже описывают самые распространённые сценарии шаг за шагом:
...
Как только флоу сохранён и опубликован, переходите к привязке его к плейсменту.
