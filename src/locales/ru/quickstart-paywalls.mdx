...
:::important
Flow Builder в настоящее время поддерживает iOS, Android и React Native SDK v4 и выше. Поддержка других платформ появится позже.
:::

Флоу — это один или несколько экранов с продуктами, встроенными напрямую. Вы создаёте его в [Flow Builder](adapty-flow-builder) без написания кода.
