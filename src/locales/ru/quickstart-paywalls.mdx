...
<TabItem value="flow-builder" label="Использовать Flow Builder" default>

:::important
Flow Builder в настоящее время поддерживает iOS, Android, React Native и Capacitor SDK v4 и выше. Поддержка других платформ появится позже.
:::
