...
1. Показывайте [пейволы с Remote Config](present-remote-config-paywalls-android) как обычно. Для флоу и пейволов, созданных во Flow & Paywall Builder, смотрите [Показ флоу в режиме Observer](android-present-paywall-builder-paywalls-in-observer-mode).
