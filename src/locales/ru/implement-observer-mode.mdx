...
1. Отображайте [пейволы с Remote Config](present-remote-config-paywalls) как обычно. Для флоу и пейволов, созданных во Flow & Paywall Builder, смотрите [Отображение флоу в режиме Observer](ios-present-paywall-builder-paywalls-in-observer-mode).
2. [Свяжите флоу и пейволы](report-transactions-observer-mode) с транзакциями покупок.
