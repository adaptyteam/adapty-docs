---
title: "Реагирование на действия флоу — React Native"
description: "Обрабатывайте нажатия кнопок во флоу и пейволах в React Native с помощью Adapty для улучшения монетизации приложения."
metadataTitle: "Реагирование на действия флоу — React Native | Документация Adapty"
...
2. Напишите код в вашем приложении для обработки каждого назначенного действия.

В этом гайде показано, как обрабатывать кастомные и готовые действия в коде.

:::warning
**Покупки, восстановления, закрытие флоу/пейвола и открытие URL обрабатываются автоматически.** Вы можете настроить их поведение по умолчанию или реализовать реакцию на кастомные действия.
:::
...
1. В старом Paywall Builder добавьте кнопку и назначьте ей предустановленное или пользовательское действие с идентификатором.
2. Напишите код в своём приложении для обработки каждого назначенного действия.

Этот гайд описывает, как обрабатывать пользовательские и заранее заданные действия в коде.

:::warning
**Только покупки, восстановления, закрытие пейвола и открытие URL обрабатываются автоматически.** Все остальные действия кнопок требуют реализации соответствующей обработки в коде приложения.
:::
