...
:::info
Это руководство ориентировано на Adapty Capacitor SDK v4 (beta) — API, описанный в [быстром старте](capacitor-quickstart-paywalls). v4 — это пре-релиз, поэтому убедитесь, что ваш LLM фиксирует точную версию (`npm install @adapty/capacitor@4.0.0-beta.3`), а не устанавливает последнюю стабильную 3.x. Смотрите [раздел установки SDK 4.0](sdk-installation-capacitor#adapty-sdk-40-beta) и [руководство по миграции](migration-to-capacitor-sdk-v4).
:::
