...
:::note
В SDK 4.1 интерфейсы слушателей следуют соглашению об именовании C# с префиксом I — реализуйте `IAdaptyEventListener` вместо `AdaptyEventListener` — и интерфейс требует ещё одного метода: `OnReceivePromotedPurchase`. См. [руководство по миграции](migration-to-unity-sdk-v4).
:::
