...
:::note
В SDK 4.0 интерфейсы слушателей следуют C#-соглашению с префиксом I: реализуйте `IAdaptyEventListener` вместо `AdaptyEventListener`. Методы остались прежними. См. [руководство по миграции](migration-to-unity-sdk-v4).
:::
