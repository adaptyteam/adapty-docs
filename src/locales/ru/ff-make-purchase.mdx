...
description: "Позвольте пользователям купить продукт через пейвол FlutterFlow с помощью Adapty."
metadataTitle: "Включение покупок в пейволе FlutterFlow | Документация Adapty"
---
...
Теперь перейдём к последнему шагу — возможности совершить покупку через пейвол.
