---
title: "创建带标签页的付费墙"
description: "构建一个包含两个标签页的付费墙页面，标签页之间可切换不同的功能列表、产品组和购买操作。"
metadataTitle: "创建带标签页的付费墙 | 流程与付费墙 | Adapty 文档"
---

此模板使用标签页在单个页面上切换同一优惠的两个变体。每个标签页都包含各自的功能列表、产品列表和购买按钮。点击标签页可切换显示的内容，无需离开当前页面——非常适合按等级、计费周期或目标受众细分方案进行拆分展示。
