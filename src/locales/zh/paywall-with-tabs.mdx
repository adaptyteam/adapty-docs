...
将标题与关闭按钮编组：
1. 在 **Layers** 面板中，点击关闭按钮图层上的三点菜单 <Inline id="context.svg" alt="Context menu" />，然后选择 **Wrap** > **Wrap in Horizontal Stack**。
...
<ZoomImage id="paywall-tabs-title-aligned.webp" width="500px" alt="关闭按钮和 H1 在水平堆叠中对齐" />
