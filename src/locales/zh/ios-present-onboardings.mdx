...
description: "了解如何在 iOS 上展示用户引导，从而提升转化率和收入。"
metadataTitle: "在 iOS 上展示用户引导 | Adapty 文档"
keywords: ['getOnboardingConfiguration']
---

:::tip
**从 SDK v4 开始**，你可以构建[流程](get-pb-paywalls)，作为用户引导更强大的替代方案。与在 WebView 中运行的用户引导不同，流程直接在设备上原生渲染——带来更流畅的动画、一致的 iOS 观感、更快的加载速度，以及无需 WebView 运行时依赖。请参阅[获取流程与付费墙](get-pb-paywalls)和[展示流程与付费墙](ios-present-paywalls)以开始使用。
:::
