---
title: "OneSignal"
description: "将 OneSignal 与 Adapty 集成，提升基于推送通知的用户互动效果。"
...
在所有设备上保持用户标识符一致，并在用户 ID 发生变化时及时更新 OneSignal，这一点非常重要。这样不仅能简化用户活动和订阅的追踪，还能确保消息推送的一致性，从而实现更准确的数据分析和更好的用户体验。更多详情，请参阅 OneSignal 的[外部用户 ID 文档](https://documentation.onesignal.com/docs/en/users)。
