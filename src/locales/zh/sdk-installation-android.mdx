...
:::info
默认情况下，Adapty SDK 4.0.2 及更高版本使用 Google Play Billing Library v8。更早的 SDK 版本默认使用 v7.0.0，并兼容 Billing Library 最高至 8.x 版本——如需强制使用更高版本，请手动[添加依赖项](https://developer.android.com/google/play/billing/integrate#dependency)。

与某个 Billing Library 版本兼容，并不意味着 Adapty 支持该版本中 Google 引入的所有功能。在采用新的 Google Play 计费功能之前，请参阅 [在 Play Store 中配置产品](android-products)。
:::
