...
:::info
从 Adapty SDK 3.17.3 和 4.0.2 开始，Adapty 支持 Google Play Billing Library v8。

与某个 Billing Library 版本兼容，并不意味着 Adapty 支持 Google 在该版本中引入的所有功能。在采用新的 Google Play 计费功能之前，请参阅 [Play Store 中的产品](android-products)。
:::
