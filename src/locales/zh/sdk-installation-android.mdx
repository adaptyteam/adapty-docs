...
:::info
默认情况下，Adapty SDK 4.0.2 及更高版本使用 Google Play Billing Library v8。更早版本的 SDK 默认使用 v7.0.0，并兼容 Billing Library 8.x 及以下版本——如需强制使用更高版本，请手动[添加依赖](https://developer.android.com/google/play/billing/integrate#dependency)。
:::
