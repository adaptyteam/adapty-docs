...
:::info
从 3.x 系列的 3.17.3 版本和 4.x 系列的 4.0.2 版本起，Adapty Android SDK 默认使用 Billing Library v8。3.15.0 至 3.17.2 以及 4.0.0 至 4.0.1 版本使用 v7，同时也兼容因其他依赖项将 Billing Library 升级至 v8 的情况。
