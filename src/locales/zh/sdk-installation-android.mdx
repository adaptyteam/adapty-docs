...
从 3.x 系列的 3.17.3 版本以及 4.x 系列的 4.0.2 版本起，Adapty Android SDK 默认使用 Billing Library v8。3.15.0 至 3.17.2 以及 4.0.0 至 4.0.1 版本使用 v7，但若你的构建中有其他依赖将 Billing Library 升级到 v8，这些版本也可以正常运行。
:::

与某个 Billing Library 版本兼容，并不意味着 Adapty 支持该版本引入的所有 Google 功能。在使用新的 Google Play 计费功能之前，请参阅 [Play Store 中的产品](android-products)。
:::
