---
title: "处理流程和付费墙事件 - Unity"
description: "在您的 Unity 应用中处理流程和付费墙事件。"
...
请参阅[追踪流程屏幕浏览](unity-flow-screen-views)，了解如何处理这些事件。

流程还会上报用户输入和选择的值。请参阅[处理流程中的数据](unity-flow-input)来读取这些数据。
