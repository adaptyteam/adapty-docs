...
description: "了解如何在 Adapty 中创建用于安全 API 访问的服务账号。"
metadataTitle: "创建服务账号 | Adapty 文档"
---

Adapty 要自动访问数据，需要在 Google Cloud Console 中创建一个服务账号。

1. 打开 Google Cloud Console 的 [**IAM & Admin** -> **Service accounts**](https://console.cloud.google.com/iam-admin/serviceaccounts) 页面，确保使用了正确的项目。
