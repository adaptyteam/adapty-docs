...
要使用网页付费墙，你需要触发它，具体方式取决于你的配置：

- 如果你使用的是 Flow 编辑器，只需[添加一个新按钮](#step-2a-add-a-web-purchase-button)，该按钮将使用你提供的链接来追踪购买并将数据发送回 Adapty。
- 如果你使用的是 SDK，则必须设置 [`openWebPaywall`](#step-2b-call-the-sdk-method) 方法来处理网页付费墙。
