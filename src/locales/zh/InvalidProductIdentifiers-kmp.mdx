...
1000 错误码 `noProductIDsFound` 表示你在付费墙上请求的产品在 App Store 中无法购买，尽管它们已被列在其中。此错误有时会附带 `InvalidProductIdentifiers` 警告。如果只出现警告而没有错误，可以安全忽略。

如果你遇到了 `noProductIDsFound` 错误，请按照以下步骤解决：
