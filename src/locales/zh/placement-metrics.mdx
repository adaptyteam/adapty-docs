---
title: "版位数据指标"
description: "在 Adapty 中分析版位数据指标，提升付费墙效果。"
metadataTitle: "分析版位数据指标 | Adapty 文档"
---
...
<ZoomImage id="b1e4155-Export-1690375904086.gif" width="700px" alt="Filter metrics by install date checkbox on the placement metrics page" />
