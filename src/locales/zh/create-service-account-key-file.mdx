...
description: "了解如何为 Adapty 无缝集成创建服务账号密钥文件。"
metadataTitle: "创建服务账号密钥文件 | Adapty 文档"
---

要将 Play Store 上的移动应用与 Adapty 关联，您需要在 Google Cloud Console 中生成专用的服务账号密钥文件，并将其上传至 Adapty。这些文件有助于保护您的应用安全，防止未经授权的访问。
...
1. 在 Google Cloud Console 中打开 [**Service accounts**](https://console.cloud.google.com/iam-admin/serviceaccounts) 部分。请确保已选择正确的项目。
...
2. 在打开的窗口中，点击 **Add key**，然后从下拉菜单中选择 **Create new key**。
