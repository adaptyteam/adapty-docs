...
Adapty Flutter SDK 4.0 — 新增对[流程](adapty-flow-builder)的支持 — 将最低要求提升至 **iOS 15.0+**、**Xcode 26+** 以及 **Flutter 3.32.0+**（Dart 3.8.0+）。安装详情请参阅下方 [Adapty SDK 4.0](#adapty-sdk-40-swift-package-manager)。

:::info
Adapty Flutter SDK 4.0.4 及更高版本支持 Google Play Billing Library v8。

Adapty 与某个 Billing Library 版本兼容，并不意味着 Adapty 支持该版本中 Google 引入的所有功能。在使用新的 Google Play 计费功能之前，请参阅 [Play Store 中的产品](android-products)。
:::
