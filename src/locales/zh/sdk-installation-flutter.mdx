...
:::tip
想看看 Adapty SDK 在移动应用中的真实集成示例？不妨看看我们的[示例应用](https://github.com/adaptyteam/AdaptySDK-Flutter/tree/master/example)，其中演示了完整的配置流程，包括展示付费墙、发起购买以及其他基本功能。
:::
...
Adapty Flutter SDK 4.0 新增了 [Flow Builder](adapty-flow-builder) 支持，将最低要求提升至 **iOS 15.0+**、**Xcode 26+** 以及 **Flutter 3.32.0+**（Dart 3.8.0+）。安装详情请参阅下方 [Adapty SDK 4.0](#adapty-sdk-40-swift-package-manager)。
