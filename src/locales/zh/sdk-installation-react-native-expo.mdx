...
如果您需要一份关于如何在 React Native 应用中实现 IAP 的完整教程，请参阅[这篇文章](https://adapty.io/blog/react-native-in-app-purchases-tutorial/)。
:::tip
...
与某个 Billing Library 版本兼容，并不意味着 Adapty 支持 Google 在该版本中引入的所有功能。在采用新的 Google Play 计费功能之前，请先查阅[在 Play Store 中配置产品](android-products)。
:::
