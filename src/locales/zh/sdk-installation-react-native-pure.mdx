...
| iOS | 15.0 或更高版本 |
| Swift | 6.2 或更高版本，随 Xcode 26 捆绑提供 |

:::info
Adapty SDK 自带 Google Play Billing Library，无需在应用中单独添加。

从 3.17.0 版本起，Adapty React Native SDK 默认使用 Billing Library v8。3.15.0 至 3.15.6 版本使用 v7，当 Android 构建中的其他依赖将 Billing Library 升级至 v8 时，这些版本同样可以正常运行。

与某版本 Billing Library 兼容，并不意味着 Adapty 支持 Google 在该版本中引入的所有功能。在使用新的 Google Play 计费功能之前，请先查阅 [Play Store 中的产品](android-products)。
:::
