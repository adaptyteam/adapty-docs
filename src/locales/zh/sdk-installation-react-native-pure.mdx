...
description: "在 React Native 中安装 Adapty SDK 以构建订阅类应用的分步指南。"
rank: 60
---
...
import AndroidBackupRules from '@site/src/locales/zh/reusable/AndroidBackupRules.mdx';
...
兼容某个 Billing Library 版本并不意味着 Adapty 支持 Google 在该版本中引入的所有功能。在使用新的 Google Play 计费功能之前，请参阅 [Play Store 中的产品](android-products)。
:::
