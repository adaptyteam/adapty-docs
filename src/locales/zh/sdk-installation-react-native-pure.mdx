...
| iOS | 15.0 或更高版本 |
| Swift | 6.2 或更高版本，随 Xcode 26 一同提供 |

:::info
从 3.17.0 版本起，Adapty React Native SDK 默认使用 Billing Library v8。3.15.0 至 3.15.6 版本使用 v7，同时也兼容在 Android 构建中其他依赖将 Billing Library 升级至 v8 的情况。

与某个 Billing Library 版本兼容，并不意味着 Adapty 支持该版本中 Google 引入的所有功能。在采用新的 Google Play 计费功能之前，请参阅 [Play Store 中的产品](android-products)。
:::
