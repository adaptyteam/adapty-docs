...
:::important
从 v4 开始，Adapty React Native SDK 不再支持通过 CocoaPods 安装其原生依赖项。如果您需要 v4 或更高版本（用于 [Flow & 付费墙编辑工具](adapty-flow-builder)），请按照下方的 [Adapty SDK 4.0: 启用 Swift Package Manager](#adapty-sdk-40-enable-swift-package-manager) 操作。
:::
