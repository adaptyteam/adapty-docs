...
description: "Adapty 开发者 CLI 命令参考，涵盖应用、产品、付费墙和版位的配置。"
metadataTitle: "开发者 CLI 命令参考 | Adapty 文档"
keywords: ['cli', 'developer', 'reference', 'commands', 'mcp']
---

本文列出了用于配置您账户的 Adapty CLI 命令，包括应用、访问等级、产品、付费墙、版位和市场细分，以及各命令的参数、标志和可接受的值。关于 Apple Ads 广告系列，请参阅[广告管理器命令](developer-cli-ads-manager-reference)。
