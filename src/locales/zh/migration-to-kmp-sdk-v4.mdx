...
## App Store 内购推广 \{#app-store-promoted-in-app-purchases\}

SDK 4.1 支持将 [App Store 产品页上推广的内购项目](kmp-making-purchases#in-app-purchases-from-the-app-store)传递给 iOS 应用。早期版本会自动完成此类购买，应用无法拦截。从 4.1 版本开始，购买流程会等待您的代码介入，因此即使您从未涉及过推广内购，也需要针对此变更进行相应处理。
