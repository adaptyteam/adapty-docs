---
title: "将 Adapty React Native SDK 迁移到 v4.0"
description: "通过将付费墙 API 替换为 flow API，迁移到 Adapty React Native SDK v4.0，同时兼容 Flow Builder 和付费墙编辑工具。"
metadataTitle: "迁移到 Adapty React Native SDK v4.0 | Adapty 文档"
---

Adapty React Native SDK 4.0 引入了 flow 功能，并相应地对付费墙 API 进行了重命名。新 API 同时支持新版 Flow Builder 和现有的付费墙编辑工具——无需在 Adapty 看板侧进行任何配置变更。
