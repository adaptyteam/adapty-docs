---
title: "迁移 Adapty React Native SDK 至 v4.0"
description: "通过将付费墙 API 替换为流程 API 来迁移至 Adapty React Native SDK v4.0，流程 API 可渲染流程以及旧版编辑工具付费墙。"
metadataTitle: "迁移至 Adapty React Native SDK v4.0 | Adapty 文档"
---

Adapty React Native SDK 4.0 引入了流程功能，并对付费墙 API 进行了相应重命名。新 API 适用于流程，同时也兼容旧版编辑工具中的付费墙——Adapty 看板侧无需进行任何配置变更。
