...
description: "启用 Adapty 的开发者 API，自动化并简化应用中的订阅管理。"
...
如果您的应用不通过 Play Store 分发，可以跳过此步骤。但如果您确实通过 Play Store 销售，目前可以暂时跳过，但此步骤对 Adapty 的基本功能至关重要。完成用户引导流程后，您可以在 **App settings** 部分配置应用商店设置。

以下是在 Google Cloud Console 中启用开发者 API 的步骤：
