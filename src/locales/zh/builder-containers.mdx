...
<ZoomImage id="flow-builder/alignment-distribution-demo.webp" width="400px" alt="画布上的 Stack 及其布局设置" float="right"/>
...
### 包裹与解包 \{#wrap-and-unwrap\}

要将现有元素转换为容器，选中该元素后使用 **Wrap** [图层操作](paywall-layout-and-products#layer-actions)。从 **Layers** 面板将其他元素拖入新容器。若要移除堆叠并将其子元素提升一级，请使用 **Unwrap**。
## 轮播图 \{#carousel\}
