---
title: "构建个性化用户引导流程"
description: "通过完整示例，逐步了解如何构建多屏用户引导流程——包括页面、内容、导航和条件分支。"
metadataTitle: "构建个性化用户引导流程 | 流程与付费墙 | Adapty 文档"
---

多屏幕流程是在流程与付费墙编辑工具中，通过导航动作连接起来的一系列屏幕。流程可以保持线性结构，也可以根据用户在前面屏幕上的输入进行分支跳转。本教程以一个四屏幕用户引导流程为示例，完整演示整个操作过程——创建屏幕、构建内容、配置导航以及添加条件分支。
...
4. 点击默认产品的卡片，启用 **Set as default**，使其在屏幕加载时处于预选状态。
