---
title: "在 Flow Builder 中添加和设置文本及列表样式"
description: "在 Adapty 的流程编辑工具中添加和设置标题、副标题、段落和列表的样式，并自定义文本以打造符合品牌风格的用户体验。"
metadataTitle: "文本 | Flow Builder | Adapty 文档"
---

只需单击一下，即可添加标题、段落或列表，设置符合品牌风格的样式，并使用[动态变量](onboarding-variables)为每位用户个性化内容。
