...
在[流程编辑工具](adapty-flow-builder)中，优惠附加在 Products 元素中的产品上。请先添加产品元素并为其分配产品——详见[设置购买](paywall-product-block)。

要附加优惠：

1. 在画布上，选择需要显示优惠的产品卡片。
2. 在右侧面板的 **Product** 下，选择产品，然后从优惠下拉菜单中选取优惠。在选择之前，下拉菜单显示 **No offer**，且仅列出有优惠的产品对应的优惠项。
