...
在[流程与付费墙编辑工具](adapty-flow-builder)中，优惠附加在产品元素的产品卡片上。请先添加产品元素并为其分配产品——详见[设置购买项](paywall-product-block)。

附加优惠的步骤：

1. 在画布上，选择需要显示优惠的产品卡片。
2. 在右侧面板中，找到 **Product** 部分，选择产品，然后从优惠下拉菜单中选择优惠。下拉菜单默认显示 **No offer**，仅列出已配置优惠的产品所对应的优惠。
