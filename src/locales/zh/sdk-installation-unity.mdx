...
Adapty SDK 支持 iOS 13.0+，但使用付费墙编辑工具创建的付费墙需要 iOS 15.0+。Adapty SDK 4.1（新增[流程](adapty-flow-builder)支持）要求整个应用使用 **iOS 15.0+**：如果部署目标低于此版本，Unity Editor 中的构建验证器将阻止 iOS 构建。

:::info
Adapty Unity SDK 4.0 及更高版本适用于 Google Play Billing Library v8。
