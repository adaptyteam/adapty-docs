...
详情请参阅 Unity 关于[从 Git URL 安装 UPM 包](https://docs.unity3d.com/Manual/upm-ui-giturl.html)的指南。
...
```
我们建议调整 Script Execution Order，将 AdaptyListener 放在 Default Time 之前。这样可以确保 Adapty 尽早完成初始化。
...
接下来，在应用中配置付费墙：
- 如果您使用 [Adapty 付费墙编辑工具](adapty-paywall-builder)，请先[激活 AdaptyUI 模块](#activate-adaptyui-module-of-adapty-sdk)，然后按照[付费墙编辑工具快速入门](unity-quickstart-paywalls)操作。
