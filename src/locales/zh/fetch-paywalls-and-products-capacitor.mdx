...
在展示远程配置和自定义付费墙之前，你需要先获取相关信息。请注意，本主题涉及远程配置和自定义付费墙。如需了解如何获取流程或在 **Flow & Paywall Builder** 或 **old Paywall Builder** 中自定义的付费墙，请参阅[获取流程、付费墙及其配置](capacitor-get-pb-paywalls)。
...
3. 在 Adapty 看板中[创建版位并将您的流程或付费墙添加到版位中](create-placement)。
