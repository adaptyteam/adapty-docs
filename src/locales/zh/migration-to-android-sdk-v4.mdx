...
description: "通过将付费墙 API 替换为流程 API，迁移到 Adapty Android SDK v4.0，兼容流程编辑工具和付费墙编辑工具。"
metadataTitle: "迁移至 Adapty Android SDK v4.0 | Adapty 文档"
---

Adapty Android SDK 4.0 引入了流程功能，并相应地对付费墙 API 进行了重命名。新 API 同时兼容新版流程编辑工具和现有的付费墙编辑工具——无需在 Adapty 看板侧进行任何配置更改。
