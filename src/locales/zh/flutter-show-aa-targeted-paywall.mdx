---
title: "在 Flutter SDK 中于首次启动时展示 Apple Ads 定向付费墙"
description: "在 Flutter 首次启动时，短暂等待 Apple Ads 归因数据后再展示付费墙，若超时则回退到默认目标受众。使用 AdaptyProfile.appliedAttributionSources。"
metadataTitle: "首次启动时展示 Apple Ads 定向付费墙 | Flutter SDK | Adapty 文档"
---
