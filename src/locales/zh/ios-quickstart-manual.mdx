...
:::important
**本指南适用于需要自定义付费墙的开发者。** 如果你想以最简单的方式接入购买功能，请使用 [Adapty Flow & 付费墙编辑工具](ios-quickstart-paywalls)。使用 Flow & 付费墙编辑工具，你可以在无代码可视化编辑器中创建流程，Adapty 自动处理所有购买逻辑，且无需重新发布应用即可测试不同设计方案。
:::
