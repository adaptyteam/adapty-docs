---
title: "按钮"
description: "在流程与付费墙编辑工具中添加并配置操作按钮。"
metadataTitle: "按钮 | 流程与付费墙 | Adapty 文档"
---

:::info
本节介绍新版流程与付费墙编辑工具，该工具适用于 Adapty SDK 4.0 及更高版本。
:::

按钮是流程与付费墙编辑工具中可响应用户点击的交互元素。适用场景包括：
- 与产品关联并自动处理交易的购买 CTA
- 导航——在页面之间跳转（下一步、返回、关闭、跳过）
- 实用链接——恢复购买、服务条款和隐私政策

:::tip
将购买 CTA、恢复链接和法律链接放入 [Footer](builder-containers#footer) 中——它会固定在屏幕底部，并覆盖在滚动元素的上方。
:::
