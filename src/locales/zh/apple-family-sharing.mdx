...
:::important
此默认设置对于 Adapty 为您创建的产品是相反的。如果您使用了[创建产品并推送至商店](create-product#create-product-and-push-to-store)，而不是在 App Store Connect 中自行创建订阅，则家庭共享默认为**开启**状态。与任何家庭共享设置一样，您事后无法将其关闭——若不希望该产品被共享，请在订阅首次审核之前在 App Store Connect 中关闭家庭共享，或直接在 App Store Connect 中自行创建订阅，而不是从 Adapty 推送。
:::
