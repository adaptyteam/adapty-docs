...
metadataTitle: "标签页 | 流程与付费墙 | Adapty 文档"
---

**标签页**将屏幕的某个区域分割为可切换的内容面板——用户点击标签页标题，下方面板随之更新。
...
流程与付费墙编辑工具提供三种开箱即用的标签页模板：

- **Segment control** — 带圆角的胶囊形切换器，高亮显示当前选中的标签页。
- **Button Tabs** — 独立的按钮样式标签页。
- **Underline** — 纯文字标签，选中标签页下方显示下划线。
