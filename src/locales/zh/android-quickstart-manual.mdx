...
:::important
**本指南适用于需要自行实现自定义付费墙的开发者。** 如果您希望以最简便的方式接入购买功能，请使用 [Adapty Flow 与付费墙编辑工具](android-quickstart-paywalls)。通过 Flow 与付费墙编辑工具，您可以在无代码可视化编辑器中创建流程，Adapty 自动处理所有购买逻辑，无需重新发布应用即可测试不同设计方案。
:::
