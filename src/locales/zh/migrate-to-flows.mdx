...
本指南介绍迁移到 flow 后有哪些变化，以及如何在不影响旧版本用户的前提下平稳完成迁移。

:::important
Flow 目前支持 iOS SDK v4 及更高版本、Android SDK v4 及更高版本、React Native SDK v4 及更高版本，以及 Capacitor SDK v4 及更高版本。其他平台和框架的支持即将推出。
:::
<div style={{
    maxWidth: '560px',
    margin: '0 auto 2rem',
