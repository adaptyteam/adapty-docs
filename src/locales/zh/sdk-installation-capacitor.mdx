...
|---|---|
| 3.17.0 及以上 | v8 |
| 3.15.0–3.16.3 | 默认使用 v7，若其他依赖将其提升则使用 v8 |

:::note
兼容某个 Billing Library 版本并不意味着 Adapty 支持 Google 在该版本中引入的所有功能。在使用新的 Google Play 付费功能之前，请参阅 [Play Store 中的产品](android-products)。
:::
