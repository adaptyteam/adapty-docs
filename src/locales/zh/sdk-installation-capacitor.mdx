...
在 iOS 上，Adapty SDK 仅通过 **Swift Package Manager** 拉取原生 Adapty SDK——CocoaPods podspec 已被移除（[CocoaPods 的 spec 仓库将于 2026 年 12 月变为只读](https://blog.cocoapods.org/CocoaPods-Specs-Repo/)）。您的应用 iOS 项目必须使用 Capacitor 的 SPM 集成：
