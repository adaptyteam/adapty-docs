...
构建 iOS 应用需要 **Xcode 26** 或更高版本——原生 iOS SDK 使用 Swift tools 6.2 构建。Android 最低支持 SDK 24。

:::info
Adapty Capacitor SDK 适配 Google Play Billing Library v8。

兼容某个 Billing Library 版本并不意味着 Adapty 支持该版本引入的所有 Google 新功能。在使用新的 Google Play 结算功能之前，请参阅 [Play Store 中的产品](android-products)。
:::
