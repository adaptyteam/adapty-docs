...
## 第二步：上传账户密钥文件 \{#step-2-upload-the-account-key-file\}

1. 将您在[创建服务账户密钥文件](create-service-account-key-file)步骤中创建的 JSON 格式服务账户私钥文件，上传至 **Service account key file** 区域。
