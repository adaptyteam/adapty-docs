...
在 4.1.1 之前，[在 App Store 产品页面推广的应用内购买](capacitor-making-purchases#in-app-purchases-from-the-app-store)会自动完成，Adapty 也会记录该交易，但你的应用无法拦截它。4.1.1 新增了这个钩子，因此这是一项新功能，而非迁移步骤：即使不添加任何代码，SDK 仍会自动为你完成推广购买。
