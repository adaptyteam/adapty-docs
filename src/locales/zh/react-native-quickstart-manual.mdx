...
:::important
**本指南面向需要实现自定义付费墙的开发者。** 如果你希望以最简便的方式启用购买功能，请使用 [Adapty Flow & 付费墙编辑工具](react-native-quickstart-paywalls)。通过 Flow & 付费墙编辑工具，你可以在无代码可视化编辑器中创建流程，Adapty 自动处理所有购买逻辑，且无需重新发布应用即可测试不同设计方案。
:::
