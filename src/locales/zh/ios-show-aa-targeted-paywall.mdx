---
title: "在 iOS SDK 中首次启动时展示 AA 定向付费墙"
description: "在 iOS 上使用 AdaptyProfile.appliedAttributionSources 等待 Apple Ads 归因后再请求付费墙。"
metadataTitle: "首次启动时展示 AA 定向付费墙 | iOS SDK | Adapty 文档"
---
