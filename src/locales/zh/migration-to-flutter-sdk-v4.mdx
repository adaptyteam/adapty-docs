...
description: "通过将付费墙 API 替换为流程 API，迁移至 Adapty Flutter SDK v4.0，流程 API 在旧版编辑工具付费墙的基础上还支持渲染流程。"
metadataTitle: "迁移至 Adapty Flutter SDK v4.0 | Adapty 文档"
---

Adapty Flutter SDK 4.0 引入了流程功能，并相应地对付费墙 API 进行了重命名。新 API 可与流程配合使用，同时仍兼容旧版编辑工具中的付费墙——无需在 Adapty 看板端进行任何配置变更。
