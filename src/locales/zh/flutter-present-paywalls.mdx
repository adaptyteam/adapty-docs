...
本指南适用于由 Adapty 渲染的流程和付费墙。如需展示**远程配置付费墙**，请参阅[渲染远程配置设计的付费墙](present-remote-config-paywalls-flutter)。
...
- 如需展示**远程配置付费墙**，请参阅[展示通过远程配置设计的付费墙](present-remote-config-paywalls-flutter)。
