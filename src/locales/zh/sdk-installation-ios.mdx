...
- **AdaptyUI**：这是一个可选模块，如果您使用 [Adapty 付费墙编辑工具](adapty-paywall-builder)（一款无需编写代码即可轻松创建跨平台付费墙的工具），则需要安装此模块。

:::tip
想看看 Adapty SDK 如何集成到真实移动应用中？欢迎参考我们的[示例应用](https://github.com/adaptyteam/AdaptySDK-iOS/tree/master/Examples)，其中展示了完整的集成流程，包括显示付费墙、发起购买以及其他基础功能。
:::
