...
:::info
本指南适用于 Adapty Capacitor SDK v4（测试版）——由[快速入门](capacitor-quickstart-paywalls)介绍的 API。v4 是预发布版本，请确保你的 LLM 固定使用精确版本（`npm install @adapty/capacitor@4.0.0-beta.3`），而不是安装最新的稳定版 3.x。请参阅 [SDK 4.0 安装章节](sdk-installation-capacitor#adapty-sdk-40-beta)和[迁移指南](migration-to-capacitor-sdk-v4)。
:::
