...
针对不同语言调整付费墙，对于面向多元文化用户的产品来说至关重要。本地化功能让你能够为特定地区的用户提供量身定制的体验。你可以为每个付费墙添加多种语言版本，确保你的产品能够贴近当地受众。

如果你没有使用旧版 Adapty 付费墙编辑工具来设计付费墙，你仍然可以对自定义付费墙进行本地化，并在无需重新部署应用的情况下管理本地化内容：
