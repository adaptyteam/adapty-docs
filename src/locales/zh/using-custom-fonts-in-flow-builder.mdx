---
title: "流程编辑工具中的自定义字体"
description: "在流程编辑工具中上传并使用自定义字体。"
metadataTitle: "自定义字体 | 流程编辑工具 | Adapty 文档"
---

在构建流程时，你可能希望使用自定义字体，以便与应用的整体风格保持一致。以下是添加自定义字体并在流程中使用的方法。

同一个应用中的所有流程共享你上传的字体，包括你[复制](copy-flows)的流程。Adapty 账户中的其他应用需要各自单独上传。
