...
:::important
您只能迁移使用付费墙编辑工具为 Adapty SDK 3.x 构建的付费墙。如需迁移为 SDK 2.x 或更早版本构建的付费墙，请先将其迁移至 SDK 3.x 付费墙编辑工具。
:::

迁移付费墙编辑工具配置的步骤如下：

1. **新建付费墙**：开始[创建付费墙](create-paywall)并添加产品。然后点击 **Build no-code paywall**，打开模板库。
