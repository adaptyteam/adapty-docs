...
- [ ] 在 Adapty 创建账号并提供您的移动应用名称和类别后，我们会在 Adapty 平台内为您完成应用配置。
- [ ] 在 Google Cloud Console 中[启用开发者 API](enabling-of-devepoler-api)
- [ ] 在 Google Cloud Console 中[创建服务账号](create-service-account)
- [ ] 在 Google Play Console 中[为服务账号授予权限](grant-permissions-to-service-account)
...
- [ ] 安装并配置 Adapty SDK（可根据需要为一个或多个框架安装 SDK）
