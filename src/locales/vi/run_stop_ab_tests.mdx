...
Theo mặc định, bảng có 2 biến thể và 1 placement. Bạn có thể thêm tối đa 20 biến thể. Khi bạn thêm placement thứ hai, bài test sẽ trở thành A/B test đa placement. Lưu ý rằng A/B test đa placement chỉ khả dụng cho paywall.

   Mỗi biến thể cũng có thể có tên riêng, tên này sẽ xuất hiện trong danh sách A/B test và trong các chỉ số của bài test. Nhập tên vào cột đầu tiên của hàng biến thể đó. Nếu để trống, Adapty sẽ đặt tên biến thể theo vị trí — `Variant A`, `Variant B`, v.v.
