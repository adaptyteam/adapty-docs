...
Trong [Flow & Paywall Builder](adapty-flow-builder), ưu đãi được gắn vào một sản phẩm trên phần tử Products. Trước tiên hãy thêm phần tử sản phẩm và gán các sản phẩm vào đó — xem [Thiết lập mua hàng](paywall-product-block).

Để gắn ưu đãi:

1. Trên canvas, chọn thẻ sản phẩm cần hiển thị ưu đãi.
2. Ở bảng bên phải, trong mục **Product**, chọn sản phẩm, sau đó chọn ưu đãi từ dropdown ưu đãi. Dropdown hiển thị **No offer** cho đến khi bạn chọn, và chỉ liệt kê ưu đãi của những sản phẩm có ưu đãi.
