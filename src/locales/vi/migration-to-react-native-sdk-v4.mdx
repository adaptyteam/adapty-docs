...
description: "Migrate sang Adapty React Native SDK v4.0 bằng cách thay thế các API paywall bằng API flow, cho phép hiển thị flow cũng như các paywall từ builder cũ."
metadataTitle: "Migration lên Adapty React Native SDK v4.0 | Tài liệu Adapty"
---

Adapty React Native SDK 4.0 giới thiệu flow và đổi tên các API paywall tương ứng. Các API mới hoạt động với flow, đồng thời vẫn tương thích với các paywall từ builder cũ — không cần thay đổi cấu hình nào trên Adapty Dashboard.
