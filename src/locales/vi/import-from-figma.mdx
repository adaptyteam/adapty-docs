...
## 1. Cài đặt plugin \{#install-the-plugin\}

Để cài đặt plugin:

1. Mở trang plugin [Import to Adapty](https://www.figma.com/community/plugin/1674065404672377144).
...
- **Phông chữ**: Quá trình import không gán phông chữ nào cho văn bản của bạn. Để khôi phục phông chữ, hãy [tải file phông chữ lên](using-custom-fonts-in-flow-builder) và chọn nó cho các đoạn văn bản bị ảnh hưởng.
- **Video**: Video được export dưới dạng placeholder. Hãy [thêm video](custom-media) trong builder sau đó.
