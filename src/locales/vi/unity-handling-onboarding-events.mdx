...
:::note
Trong SDK 4.1, các giao diện listener tuân theo quy ước tiền tố I- của C#: hãy implement `IAdaptyOnboardingsEventsListener` thay vì `AdaptyOnboardingsEventsListener`. Các phương thức không thay đổi. Xem [hướng dẫn migration](migration-to-unity-sdk-v4).
:::
