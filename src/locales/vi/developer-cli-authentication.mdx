...
Một lần đăng nhập là đủ cho toàn bộ CLI. Các [lệnh Ads Manager](developer-cli-ads-manager) kết nối tới một dịch vụ khác, nhưng chúng dùng chung token đã lưu — không cần đăng nhập thêm lần nào nữa.
