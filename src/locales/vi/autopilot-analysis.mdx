...
- **Khuyến nghị theo benchmark**: Các gợi ý dựa trên dữ liệu từ những ứng dụng có hiệu suất cao nhất trong danh mục của bạn. Mỗi khuyến nghị đều có kèm chỉ số benchmark (ví dụ: "Được dùng bởi 72% ứng dụng Giáo dục có hiệu suất cao nhất") và mô tả cần thay đổi điều gì.
- **Khuyến nghị từ phân tích hình ảnh**: Các gợi ý do AI tạo ra dựa trên ảnh chụp màn hình paywall của bạn. Bao gồm: cải thiện nội dung, thay đổi bố cục, và nhiều hơn nữa.

:::tip
[Kế hoạch tăng trưởng](autopilot-growth-plan) của bạn sẽ bao gồm các giả thuyết dựa trên khuyến nghị theo benchmark. Bạn có thể thêm các gợi ý từ phân tích hình ảnh vào kế hoạch theo cách thủ công.
:::
