---
title: "Sửa lỗi Code-1000 noProductIDsFound trong Unity SDK"
description: "Giải quyết lỗi identifier sản phẩm không hợp lệ khi quản lý gói đăng ký trong Adapty."
metadataTitle: "Sửa lỗi Identifier Sản phẩm Không hợp lệ | Tài liệu Adapty"
slug: "InvalidProductIdentifiers-unity"
---

import ProvideBundleID from '@site/src/locales/vi/reusable/ProvideBundleID.md';

Lỗi mã 1000, `noProductIDsFound`, cho biết không có sản phẩm nào bạn yêu cầu trên paywall có thể mua được trong App Store, mặc dù chúng đã được liệt kê ở đó. Lỗi này đôi khi đi kèm với cảnh báo `InvalidProductIdentifiers`. Nếu cảnh báo xuất hiện mà không có lỗi, bạn có thể bỏ qua an toàn.

Nếu bạn đang gặp lỗi `noProductIDsFound`, hãy làm theo các bước sau để giải quyết:
