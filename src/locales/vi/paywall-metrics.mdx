...
description: "Theo dõi và phân tích các chỉ số hiệu suất paywall để cải thiện doanh thu từ gói đăng ký."
metadataTitle: "Phân tích Chỉ số Paywall | Tài liệu Adapty"
keywords: ['Doanh thu', 'Proceeds', 'ARPPU', 'ARPAS', 'Tỷ lệ chuyển đổi (CR) duy nhất thành mua hàng', 'CR thành mua hàng', 'CR duy nhất thành dùng thử', 'Mua hàng', 'Dùng thử', 'Dùng thử đã hủy', 'Hoàn tiền', 'Tỷ lệ hoàn tiền', 'Lượt xem', 'Lượt xem duy nhất']
---
