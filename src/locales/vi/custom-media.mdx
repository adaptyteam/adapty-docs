...
:::tip
Để hình ảnh hoặc video che phủ toàn bộ màn hình — bao gồm cả vùng phía sau notch và thanh điều hướng — hãy đặt vị trí cố định với tất cả các offset bằng 0 và chọn **Ignore safe area**. Xem [Định vị phần tử](manage-paywall-ui-elements#ignore-safe-area).
:::
## Hình ảnh \{#image\}
