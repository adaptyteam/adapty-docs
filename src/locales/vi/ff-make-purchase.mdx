...
description: "Cho phép người dùng mua sản phẩm từ paywall FlutterFlow của bạn thông qua Adapty."
metadataTitle: "Kích hoạt tính năng mua hàng trong paywall FlutterFlow | Tài liệu Adapty"
---

Chúc mừng! Bạn đã [thiết lập thành công paywall để hiển thị dữ liệu sản phẩm từ Adapty](ff-add-variables-to-paywalls), bao gồm tên sản phẩm và giá.

Bây giờ, hãy chuyển sang bước cuối cùng – cho phép người dùng thực hiện mua hàng thông qua paywall.
