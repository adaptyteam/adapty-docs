...
description: "Ánh xạ dữ liệu sản phẩm từ Adapty, như tiêu đề và giá, lên trang paywall bạn đã thiết kế trong FlutterFlow."
metadataTitle: "Thêm dữ liệu sản phẩm Adapty vào paywall FlutterFlow | Tài liệu Adapty"
---

Sau khi bạn đã [nhận được tất cả dữ liệu sản phẩm cần thiết](ff-action-flow), đã đến lúc ánh xạ chúng lên paywall đẹp mà bạn đã thiết kế trong FlutterFlow. Trong ví dụ này, chúng ta sẽ ánh xạ tiêu đề sản phẩm và giá của nó.
