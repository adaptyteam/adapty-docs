...
:::info
Tính năng này yêu cầu Adapty Kotlin Multiplatform SDK 4.0 (beta) trở lên — trước đây chỉ khả dụng trên SDK iOS và Android gốc. Xem [hướng dẫn migration](migration-to-kmp-sdk-v4) để nâng cấp.
:::
