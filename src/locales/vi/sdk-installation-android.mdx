...
:::info
Mặc định, Adapty SDK 4.0.2 trở lên hoạt động với Google Play Billing Library v8. Các phiên bản SDK cũ hơn mặc định dùng v7.0.0 và tương thích với Billing Library lên đến 8.x — để buộc dùng phiên bản mới hơn, hãy [thêm dependency](https://developer.android.com/google/play/billing/integrate#dependency) thủ công.
:::
