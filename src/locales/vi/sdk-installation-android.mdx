...
:::info
Từ phiên bản 3.17.3 trên nhánh 3.x và từ phiên bản 4.0.2 trên nhánh 4.x, Adapty Android SDK sử dụng Billing Library v8 theo mặc định. Các phiên bản từ 3.15.0 đến 3.17.2 và từ 4.0.0 đến 4.0.1 sử dụng v7, và cũng hoạt động khi một dependency khác trong build của bạn nâng Billing Library lên v8.

Tương thích với một phiên bản Billing Library không có nghĩa là Adapty hỗ trợ mọi tính năng mà Google giới thiệu trong đó. Trước khi áp dụng một tính năng thanh toán Google Play mới, hãy xem [Sản phẩm trên Play Store](android-products).
:::
