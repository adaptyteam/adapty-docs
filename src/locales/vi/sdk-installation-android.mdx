...
:::info
Adapty SDK 4.0.2 trở lên hoạt động với Google Play Billing Library v8.

Tương thích với một phiên bản Billing Library không có nghĩa là Adapty hỗ trợ mọi tính năng Google giới thiệu trong đó. Trước khi áp dụng một tính năng thanh toán Google Play mới, hãy xem [Sản phẩm trên Play Store](android-products).
:::
