...
:::info
Adapty SDK đã tích hợp sẵn Google Play Billing Library — bạn không cần thêm thư viện này vào ứng dụng.

Từ phiên bản 3.17.3 trở đi trên nhánh 3.x và từ 4.0.2 trở đi trên nhánh 4.x, Adapty Android SDK sử dụng Billing Library v8 theo mặc định. Các phiên bản 3.15.0 đến 3.17.2 và 4.0.0 đến 4.0.1 sử dụng v7, đồng thời cũng hoạt động khi một dependency khác trong build của bạn nâng Billing Library lên v8.
