...
:::note
Trong SDK 4.0, các interface listener tuân theo quy ước tiền tố I- của C#: implement `IAdaptyEventListener` thay vì `AdaptyEventListener`. Các phương thức không thay đổi. Xem [hướng dẫn migration](migration-to-unity-sdk-v4).
:::
