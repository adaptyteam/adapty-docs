...
metadataTitle: "Xây dựng flow onboarding cá nhân hóa | Flow & paywall | Tài liệu Adapty"
---

Flow nhiều màn hình trong Flow & Paywall Builder là một chuỗi màn hình được kết nối bằng các hành động điều hướng. Flow có thể đi theo đường tuyến tính, hoặc phân nhánh dựa trên dữ liệu người dùng nhập vào ở màn hình trước. Hướng dẫn này trình bày toàn bộ quy trình — tạo màn hình, xây dựng nội dung, thiết lập điều hướng và thêm phân nhánh có điều kiện — sử dụng một flow onboarding bốn màn hình làm ví dụ minh họa.

Ví dụ sử dụng:

- **Nhập tên** để lấy tên người dùng làm biến cho việc cá nhân hóa.
- **Quiz chọn một đáp án** mà câu trả lời sẽ quyết định màn hình tiếp theo người dùng thấy.
- **Hai nhánh phân tách** với nội dung riêng cho từng phân khúc đối tượng.
- **Paywall** là màn hình cuối cùng.

Cùng một cách làm này áp dụng cho bất kỳ flow nào cá nhân hóa nội dung dựa trên thông tin đầu vào của người dùng.

Thích xem video hơn? Hướng dẫn quickstart này đi qua toàn bộ quy trình từ đầu đến cuối:
...
3. Thêm sản phẩm: nhấn **+** > **Products** và chọn **Vertical List**. Gán mỗi card một sản phẩm từ dropdown trong tab **Design**.
4. Nhấn vào card của sản phẩm mặc định và bật **Set as default** để nó được chọn sẵn khi màn hình tải.
