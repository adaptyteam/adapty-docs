...
[Singular](https://www.singular.net/) là một trong những nền tảng Mobile Measurement Partner (MMP) hàng đầu, chuyên thu thập và trình bày dữ liệu từ các chiến dịch marketing, giúp các công ty theo dõi hiệu suất chiến dịch của mình.

Adapty cung cấp đầy đủ dữ liệu giúp bạn theo dõi [các sự kiện gói đăng ký](events) từ các cửa hàng tại một nơi duy nhất. Với Adapty, bạn có thể dễ dàng nắm bắt hành vi của người dùng, hiểu họ thích gì, và dùng thông tin đó để giao tiếp với họ một cách có mục tiêu và hiệu quả. Vì vậy, tích hợp này cho phép bạn theo dõi các sự kiện gói đăng ký trong Singular và phân tích chính xác doanh thu mà các chiến dịch của bạn tạo ra.

Adapty có thể gửi tất cả các sự kiện gói đăng ký đã được cấu hình trong phần tích hợp của bạn đến Singular. Nhờ đó, bạn có thể theo dõi các sự kiện này trong dashboard của Singular. Tích hợp này rất hữu ích để đánh giá hiệu quả của các chiến dịch quảng cáo.
...
| `purchase_product_id`     | String  | ID sản phẩm từ cửa hàng.              |
| `purchase_transaction_id` | String  | ID giao dịch gốc.                     |
