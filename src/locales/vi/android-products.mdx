...
description: "Quản lý sản phẩm Android với Adapty, tối ưu hóa in-app purchase và chiến lược kiếm tiền."
...
Sản phẩm là mặt hàng kỹ thuật số hoặc dịch vụ mà bạn cung cấp trong ứng dụng trên Play Store, thường có sẵn để mua. Bao gồm các in-app purchase như sản phẩm mua một lần, gói đăng ký, hoặc các hàng hóa kỹ thuật số khác mà người dùng có thể mua trong khi sử dụng ứng dụng của bạn.

Trong [hệ thống thanh toán của Google](https://developer.android.com/google/play/billing/compatibility), các gói đăng ký có thể bao gồm nhiều base plan, mỗi base plan cung cấp nhiều loại giảm giá hoặc ưu đãi khác nhau. Cấu trúc này gồm ba thành phần chính:

- **Subscriptions:** Đây là các tập hợp quyền lợi mà người dùng có thể tận hưởng trong một khoảng thời gian cụ thể (những thứ đang được bán). Ví dụ, "Gói Gold" cung cấp các tính năng cao cấp cho người đăng ký.
- **Base plans:** Đây là các cấu hình cụ thể về chu kỳ thanh toán, loại gia hạn và giá cả (cách thức bán hàng). Ví dụ như "hàng năm với tự động gia hạn" hoặc "hàng tháng trả trước."
- **Offers:** Đây là các ưu đãi dành cho người dùng đủ điều kiện, điều chỉnh giá của base plan. Ví dụ, "dùng thử miễn phí 14 ngày cho người dùng mới."

:::warning
SDK Android của Adapty được xây dựng dựa trên Google Play Billing Library 8, nhưng không sử dụng tất cả các tính năng mà thư viện này cung cấp. Trước khi áp dụng mô hình sản phẩm hoặc tính năng thanh toán mới trên Google Play, hãy gửi email đến [support@adapty.io](mailto:support@adapty.io) để xác nhận rằng Adapty hỗ trợ tính năng đó — một số thay đổi không thể hoàn tác sau khi đã lưu trong Play Console.
:::
