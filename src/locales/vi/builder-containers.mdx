...
description: "Nhóm các phần tử thành container, carousel và bottom sheet trong Flow & Paywall Builder."
metadataTitle: "Container, carousel, bottom sheet | Flow & paywall | Tài liệu Adapty"
---

Các phần tử bố cục dùng để nhóm các phần tử khác lại và kiểm soát cách chúng được sắp xếp trên màn hình.

Flow & Paywall Builder bao gồm năm loại phần tử bố cục:
...
- **Bottom Sheet**: một panel trượt lên từ phía dưới màn hình và hiển thị trên nội dung bên dưới
- **Footer**: một panel được ghim ở cuối màn hình, nằm ngoài vùng cuộn
- **Dividers**: các đường kẻ mỏng dùng để phân tách hàng hoặc cột
