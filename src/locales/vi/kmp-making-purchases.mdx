...
Nếu bạn không sử dụng Paywall Builder, bạn phải dùng một phương thức riêng gọi là `.makePurchase()` để hoàn tất giao dịch mua và mở khóa nội dung mong muốn. Phương thức này đóng vai trò là cổng để người dùng tương tác với các paywall và thực hiện giao dịch mong muốn.
