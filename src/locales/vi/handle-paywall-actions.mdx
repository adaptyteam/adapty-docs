...
description: "Xử lý các hành động nút và xử lý đầu vào của người dùng từ các flow paywall và onboarding trong ứng dụng iOS của bạn."
...
:::warning
**Chỉ việc đóng flow/paywall và mở URL được xử lý tự động.** Tất cả các action nút khác đều cần được triển khai xử lý phù hợp trong code ứng dụng.
:::
...
:::warning
**Chỉ có việc mua hàng, khôi phục, đóng paywall và mở URL được xử lý tự động.** Tất cả các hành động nút khác đều yêu cầu triển khai phản hồi phù hợp trong code ứng dụng.
:::
