...
:::warning
Phần này chỉ áp dụng cho [Observer mode](observer-vs-full-mode). Nếu bạn không làm việc ở Observer mode, hãy tham khảo chủ đề [Hiển thị flows & paywalls](react-native-present-paywalls).
:::

:::info
Tính năng này yêu cầu Adapty React Native SDK 4.0 trở lên — trước đây chỉ có trong SDK iOS và Android gốc. Xem [hướng dẫn migration](migration-to-react-native-sdk-v4) để nâng cấp.
:::
