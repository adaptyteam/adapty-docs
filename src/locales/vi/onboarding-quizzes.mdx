---
title: "Câu hỏi khảo sát trong flow"
description: "Thêm câu hỏi khảo sát tương tác vào flow Adapty của bạn để thu thập sở thích người dùng và tạo ra các flow cá nhân hóa — không cần code."
metadataTitle: "Câu hỏi khảo sát trong flow | Tài liệu Adapty"
---

Sử dụng câu hỏi khảo sát để trình bày cho người dùng các lựa chọn được định nghĩa sẵn. Khác với các trường nhập liệu, câu hỏi khảo sát không có ô gõ văn bản — người dùng chọn từ các tùy chọn bạn đã thiết lập. Dùng chúng để thu thập sở thích, phân khúc người dùng, hoặc phân nhánh flow dựa trên câu trả lời của họ.
