---
title: "Kiểm tra trạng thái đăng ký trong iOS SDK"
description: "Theo dõi và quản lý trạng thái đăng ký của người dùng trong Adapty để cải thiện khả năng giữ chân khách hàng."
metadataTitle: "Hiểu về Trạng thái Đăng ký | Tài liệu Adapty"
keywords: ['getProfile', 'cache']
---

Với Adapty, việc theo dõi trạng thái đăng ký trở nên đơn giản hơn bao giờ hết. Bạn không cần phải chèn thủ công các product ID vào code. Thay vào đó, bạn có thể dễ dàng xác nhận trạng thái đăng ký của người dùng bằng cách kiểm tra xem họ có [mức độ truy cập](access-level) đang hoạt động hay không.
