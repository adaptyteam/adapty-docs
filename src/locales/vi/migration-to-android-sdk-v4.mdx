...
Đặt phiên bản `adapty-bom` thành `4.0.0-beta.2` và đồng bộ dự án. BOM sẽ tự động xác định các phiên bản `android-sdk` và `android-ui` tương thích cho bạn. Xem [Cài đặt Adapty SDK](sdk-installation-android) để biết cách khai báo dependency.
