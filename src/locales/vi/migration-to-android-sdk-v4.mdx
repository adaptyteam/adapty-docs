...
description: "Migrate sang Adapty Android SDK v4.0 bằng cách thay thế paywall API bằng flow API, tương thích với cả Flow Builder và Paywall Builder."
metadataTitle: "Migrate sang Adapty Android SDK v4.0 | Tài liệu Adapty"
---

Adapty Android SDK 4.0 giới thiệu flow và đổi tên các paywall API tương ứng. Các API mới hoạt động với cả Flow Builder mới và Paywall Builder hiện có — không cần thay đổi cấu hình nào trên Adapty Dashboard.
