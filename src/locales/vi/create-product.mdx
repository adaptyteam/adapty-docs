---
title: "Tạo sản phẩm"
description: "Hướng dẫn từng bước tạo sản phẩm gói đăng ký mới trong Adapty để quản lý doanh thu hiệu quả hơn."
...
- **[Nếu sản phẩm chưa tồn tại trong App Store và/hoặc Google Play, hãy tạo chúng trong Adapty và đẩy lên cửa hàng ngay lập tức](#create-product-and-push-to-store)**.
- **[Nếu sản phẩm đã tồn tại trong App Store và/hoặc Google Play, hãy tạo chúng trong Adapty và kết nối với sản phẩm cửa hàng hiện có.](#create-product-and-connect-existing-store-products)**

Giá bạn nhập ở đây không thể thay đổi sau khi tạo, và việc thay đổi giá trong bảng điều khiển cửa hàng [sẽ không được đồng bộ về Adapty](store-sync#product-and-price-discrepancies).
...
2. Nhấn **Create product** ở góc trên bên phải. Adapty hỗ trợ tất cả các loại sản phẩm: gói đăng ký, non-consumable \(bao gồm quyền truy cập trọn đời\) và consumable.
...
4. Nhập các thông tin sau:
    - **Product name**: nhập tên sản phẩm sẽ dùng trên Adapty dashboard. Tên này chủ yếu để bạn tham khảo, vì vậy hãy chọn tên nào tiện nhất cho bạn khi sử dụng trong Adapty Dashboard.
    - **Access Level**: Chọn [mức độ truy cập](access-level) mà sản phẩm thuộc về. Mức độ truy cập dùng để xác định các tính năng được mở khóa sau khi mua sản phẩm. Lưu ý rằng danh sách này chỉ chứa các mức độ truy cập đã được tạo trước đó. Mức độ truy cập `premium` được tạo sẵn trong Adapty theo mặc định, nhưng bạn cũng có thể [thêm các mức độ truy cập khác](access-level).
    - **Subscription duration**: chọn thời hạn của gói đăng ký từ danh sách. Bạn không thể thay đổi sau khi sản phẩm đã được tạo.
        - **Weekly/Monthly/2 Months/3 Months/6 Months/Annual**: Thời hạn của gói đăng ký.
        - **Lifetime**: Dùng cho các sản phẩm mở khóa tính năng premium của ứng dụng vĩnh viễn.
        - **Non-Subscriptions**: Dành cho các sản phẩm mua một lần không có thời hạn. Sản phẩm mua một lần không cấp mức độ truy cập — nó xuất hiện trong mảng `nonSubscriptions` của hồ sơ người dùng, và ứng dụng của bạn tự quyết định những gì được mở khóa.
        - **Consumables**: Các mặt hàng consumable có thể được mua nhiều lần và sử dụng trong suốt vòng đời của ứng dụng. Ví dụ như tiền tệ trong game và các vật phẩm phụ trợ. Sản phẩm consumable cũng không cấp mức độ truy cập. Để cấp mức độ truy cập từ sản phẩm mua một lần, hãy dùng **Lifetime**.
    - **Price (USD)**: Giá sản phẩm tính bằng USD. Giá này sẽ được dùng làm cơ sở để tự động tính toán và thiết lập giá cho tất cả các quốc gia. Bạn có thể [tùy chỉnh giá cho từng quốc gia và khu vực](edit-product#set-country-specific-prices) sau.
...
## Tạo sản phẩm và kết nối sản phẩm hiện có trong cửa hàng \{#create-product-and-connect-existing-store-products\}
...
**Nếu bạn chưa có sản phẩm nào**, hãy xem hướng dẫn [Đẩy lên cửa hàng](#create-product-and-push-to-store) để tạo sản phẩm cùng lúc trên cả Adapty và các cửa hàng.
:::
...
2. Nhấn **Create product** ở góc trên bên phải. Adapty hỗ trợ tất cả các loại sản phẩm: gói đăng ký, non-consumable \(bao gồm cả trọn đời\), và consumable.
...
4. Nhập các thông tin sau:
    ...
    - **Product name**: nhập tên sản phẩm sẽ được sử dụng trong Adapty dashboard. Tên này chủ yếu để bạn tham khảo, vì vậy hãy chọn tên nào tiện lợi nhất cho bạn khi sử dụng trong Adapty Dashboard.
...
- **Subscription duration**: chọn thời hạn gói đăng ký từ danh sách. Bạn không thể thay đổi sau khi sản phẩm đã được tạo.
      - **Weekly/Monthly/2 Months/3 Months/6 Months/Annual**: Thời hạn gói đăng ký.
      - **Lifetime**: Dùng cho các sản phẩm cấp quyền truy cập trọn đời vào các tính năng premium của ứng dụng.
      - **Non-Subscriptions**: Dành cho sản phẩm mua một lần, không có thời hạn. Sản phẩm mua một lần dạng này không cấp mức độ truy cập — nó xuất hiện trong mảng `nonSubscriptions` của hồ sơ người dùng, và ứng dụng của bạn tự quyết định mở khóa gì.
      - **Consumables**: Consumable có thể được mua nhiều lần và sử dụng hết trong vòng đời ứng dụng. Ví dụ như tiền tệ trong game hay các vật phẩm bổ sung. Consumable cũng không cấp mức độ truy cập. Để cấp mức độ truy cập từ sản phẩm mua một lần, hãy dùng **Lifetime**.
   - **Price (USD)**: Giá sản phẩm tính bằng USD. Nếu sản phẩm của bạn đã có trên cửa hàng, giá trị này sẽ không ảnh hưởng đến giá thực tế; bạn có thể chọn bất kỳ giá trị nào trong danh sách. Sau này, bạn có thể [tùy chỉnh giá theo từng khu vực](edit-product#set-country-specific-prices) ngay trong Adapty Dashboard.
...
:::warning
Mỗi ID sản phẩm trong cửa hàng phải khớp chính xác với cửa hàng. Nếu không khớp, hệ thống sẽ không báo lỗi: giao dịch mua vẫn thành công, nhưng khách hàng sẽ không nhận được mức độ truy cập nào.
:::
