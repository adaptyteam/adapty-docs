...
Để sử dụng web paywall, bạn cần kích hoạt nó, và cách thực hiện phụ thuộc vào cài đặt của bạn:

- Nếu bạn đang dùng Flow builder, bạn chỉ cần [thêm một nút mới](#step-2a-add-a-web-purchase-button) sẽ sử dụng liên kết bạn đã cung cấp để theo dõi giao dịch mua và gửi dữ liệu về Adapty.
- Nếu bạn đang dùng SDK, bạn phải thiết lập phương thức [`openWebPaywall`](#step-2b-call-the-sdk-method) để xử lý web paywall.
