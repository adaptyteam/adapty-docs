...
Nếu bạn đang sử dụng **Flow & Paywall Builder**, bạn cần thêm nút paywall web. Nút này sẽ sử dụng liên kết bạn đã cung cấp để theo dõi các giao dịch mua và gửi dữ liệu về Adapty.

1. Mở flow và thêm một nút.

   Nếu bạn đang sử dụng template hoặc paywall hiện có, hãy thêm nút paywall web bên cạnh nút mua hàng hiện tại. Bạn có thể cấu hình nó theo cách tương tự.
