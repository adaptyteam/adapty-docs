...
:::
:::info
Tính năng này yêu cầu Adapty Flutter SDK 4.0 trở lên — trước đây chỉ có trong các SDK iOS và Android gốc. Xem [hướng dẫn migration](migration-to-flutter-sdk-v4) để nâng cấp.
:::
