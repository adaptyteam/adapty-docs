...
:::important
Flow Builder hiện hỗ trợ iOS, Android, React Native và Capacitor SDK v4 trở lên. Hỗ trợ cho các nền tảng khác sẽ sớm có.
:::

Một flow là một hoặc nhiều màn hình với các sản phẩm được nhúng trực tiếp vào. Bạn thiết kế nó trong [Flow Builder](adapty-flow-builder) — không cần viết code.
