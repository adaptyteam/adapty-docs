...
<TabItem value="flow-builder" label="Sử dụng Flow Builder" default>

:::important
Flow Builder hiện hỗ trợ iOS, Android, React Native, Flutter và Capacitor SDK v4 trở lên. Hỗ trợ cho các nền tảng khác sẽ sớm ra mắt.
:::
