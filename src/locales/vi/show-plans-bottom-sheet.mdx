---
title: "Hiển thị tất cả gói trong bottom sheet"
description: "Xây dựng paywall dạng hero với một CTA duy nhất, liên kết 'Hiển thị tất cả gói', và bottom sheet hiển thị toàn bộ danh sách sản phẩm."
metadataTitle: "Hiển thị tất cả gói trong bottom sheet | Flow & paywall | Tài liệu Adapty"
---

Template này hiển thị trước một ưu đãi nổi bật duy nhất, kèm theo liên kết kín đáo dẫn đến danh sách gói đầy đủ. Nhấn **Show all plans** sẽ trượt lên một bottom sheet chứa các sản phẩm còn lại, nút mua, và các liên kết ở phần chân trang.
