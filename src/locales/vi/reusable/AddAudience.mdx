...
3. Bây giờ hãy thêm flow, paywall, onboarding, hoặc A/B test để hiển thị cho đối tượng này.
4. Thêm bao nhiêu đối tượng tùy theo nhu cầu.
5. Nếu bạn có nhiều hơn một đối tượng, hãy kiểm tra xem các đối tượng có thứ tự ưu tiên đúng hay không.
6. Nhấp vào nút **Save and publish button**.