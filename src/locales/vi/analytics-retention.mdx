---
title: "Phân tích giữ chân người dùng"
description: "Hiểu phân tích giữ chân người dùng và tối ưu hóa chiến lược gói đăng ký của bạn."
metadataTitle: "Hiểu Phân Tích Giữ Chân Người Dùng | Tài liệu Adapty"
---

Các biểu đồ giữ chân người dùng có thể giúp bạn trả lời những câu hỏi sau:

1. Ứng dụng của bạn giữ chân khách hàng từ kỳ này sang kỳ khác như thế nào?
2. Sản phẩm nào hấp dẫn hơn và giữ chân người dùng tốt hơn?
3. Nhóm người dùng nào trung thành hơn?
4. Mức độ giữ chân nào có thể dùng làm chuẩn mực để tăng trưởng?
5. Và tất nhiên, làm thế nào để tiết kiệm chi phí bằng cách đầu tư vào tệp khách hàng đã có thay vì liên tục thu hút người dùng mới.

Bạn sẽ tìm thấy nhiều thông tin hữu ích về hành vi người dùng khi thiết lập bộ lọc và nhóm.

Tính năng Retention hoạt động dựa trên dữ liệu chúng tôi thu thập thông qua SDK và thông báo từ cửa hàng, không yêu cầu bất kỳ cấu hình bổ sung nào từ phía bạn.

<ZoomImage id="86dc5ac-CleanShot_2023-01-09_at_18.56.15.webp" width="700px" alt="Biểu đồ giữ chân người dùng" />
...
Adapty xác định ngày của mỗi người dùng dựa trên ngày họ bắt đầu gói đăng ký — ngày bắt đầu dùng thử đối với sản phẩm có dùng thử miễn phí, hoặc ngày thanh toán đầu tiên đối với sản phẩm không có dùng thử. Người dùng bắt đầu dùng thử vào ngày 1 tháng 3 và thanh toán vào ngày 1 tháng 4 sẽ thuộc về tháng 3, bất kể cài đặt **Show trials** được bật hay tắt.

:::info
Retention thay đổi hồi tố

Bất kể bạn xem biểu đồ vào thời điểm nào, con số cơ sở (100%) vẫn không thay đổi trong khoảng thời gian đã chọn. Trong khi đó, tỷ lệ giữ chân sang kỳ tiếp theo có thể tăng dần theo thời gian.
Ví dụ: với gói đăng ký hàng tháng, nếu có 20 lần mua đầu tiên trong khoảng từ ngày 1 đến ngày 31 tháng 12, tỷ lệ giữ chân sang kỳ thứ hai dự kiến sẽ tăng dần trong suốt tháng 1 (và có thể còn sau đó) khi người dùng bước vào kỳ đăng ký tiếp theo đúng hạn hoặc muộn hơn vì một số lý do (ví dụ: thời gian ân hạn).
:::

### Sản phẩm có thời hạn khác nhau \{#products-with-different-durations\}

Các bước trên biểu đồ là các chu kỳ đăng ký, không phải khoảng thời gian cố định. P2 có nghĩa là chu kỳ thứ hai của mỗi sản phẩm, vì vậy người dùng đăng ký theo tuần sẽ đến P2 sau một tuần, còn người đăng ký theo năm thì sau một năm. Cả hai đều nằm ở cùng một cột.

Nếu bạn bán nhiều hơn một thời hạn, đường cong mặc định sẽ gộp chúng lại và thay đổi mỗi khi cơ cấu sản phẩm của bạn thay đổi. Hãy nhóm hoặc lọc theo **Duration** hoặc **Product** để xem từng loại riêng lẻ.
...
Hãy kết hợp các bộ lọc và nhóm để phân tích nâng cao. Thu thập thông tin chính xác dựa trên dữ liệu.
Thay đổi theo:
...
5. Attribution.
6. Cửa hàng.
7. Flow và màn hình flow.

Sử dụng điều khiển #Absolute và %Relative để xem dữ liệu cần thiết.
