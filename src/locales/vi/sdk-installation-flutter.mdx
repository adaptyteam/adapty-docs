...
Adapty Flutter SDK 4.0 — bổ sung hỗ trợ cho [flow](adapty-flow-builder) — nâng mức tối thiểu lên **iOS 15.0+**, **Xcode 26+**, và **Flutter 3.32.0+** (Dart 3.8.0+). Xem [Adapty SDK 4.0](#adapty-sdk-40-swift-package-manager) bên dưới để biết chi tiết cài đặt.

:::info
Từ phiên bản 3.17.0, Adapty Flutter SDK sử dụng Billing Library v8 theo mặc định. Các phiên bản từ 3.15.0 đến 3.15.5 sử dụng v7, và cũng hoạt động khi một dependency khác trong bản build Android của bạn nâng Billing Library lên v8.

Khả năng tương thích với một phiên bản Billing Library không có nghĩa là Adapty hỗ trợ mọi tính năng mà Google đã giới thiệu trong đó. Trước khi bạn áp dụng một tính năng thanh toán Google Play mới, hãy xem [Sản phẩm trên Play Store](android-products).
:::
