...
Adapty Flutter SDK 4.0 — bổ sung hỗ trợ cho [flow](adapty-flow-builder) — nâng yêu cầu tối thiểu lên **iOS 15.0+**, **Xcode 26+** và **Flutter 3.32.0+** (Dart 3.8.0+). Xem [Adapty SDK 4.0](#adapty-sdk-40-swift-package-manager) bên dưới để biết thông tin cài đặt cụ thể.

:::info
Adapty Flutter SDK 4.0.4 trở lên hoạt động với Google Play Billing Library v8.

Khả năng tương thích với một phiên bản Billing Library không có nghĩa là Adapty hỗ trợ mọi tính năng mà Google đã giới thiệu trong phiên bản đó. Trước khi sử dụng một tính năng mới của Google Play billing, hãy xem [Sản phẩm trong Play Store](android-products).
:::
