...
:::info
Adapty tương thích với Google Play Billing Library lên đến phiên bản 8.x. Mặc định, Adapty hoạt động với Google Play Billing Library v7.0.0, nhưng nếu bạn muốn buộc sử dụng phiên bản mới hơn, bạn có thể thêm thủ công [dependency](https://developer.android.com/google/play/billing/integrate#dependency).

Tương thích với một phiên bản Billing Library không có nghĩa là Adapty hỗ trợ mọi tính năng mà Google giới thiệu trong đó. Trước khi áp dụng tính năng thanh toán mới của Google Play, hãy xem [Sản phẩm trên Play Store](android-products).
:::
