...
:::info
Từ phiên bản 3.17.0, Adapty Kotlin Multiplatform SDK sử dụng Billing Library v8 theo mặc định. Các phiên bản từ 3.15.0 đến 3.16.2 sử dụng v7, và cũng hoạt động khi một dependency khác trong bản build Android của bạn nâng Billing Library lên v8.
