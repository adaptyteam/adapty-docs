...
|---|---|
| 3.17.0 trở lên | v8 |
| 3.15.0–3.16.2 | v7 theo mặc định, v8 nếu một dependency khác nâng lên |
...
- Gradle tiêu chuẩn: Thêm các dependency vào **module-level** `build.gradle`
- Nếu dự án của bạn sử dụng file `.gradle.kts`, hãy thêm các dependency vào **module-level** `build.gradle.kts`
- Nếu bạn sử dụng version catalog, hãy thêm các dependency vào file `libs.versions.toml` của bạn, sau đó tham chiếu đến nó trong `build.gradle.kts`
