...
:::important
Một phần tử sản phẩm chưa được gắn sản phẩm nào sẽ [chặn việc xem trước và xuất bản](flow-common-issues#a-flow-wont-preview-or-publish). Hãy gán sản phẩm hoặc xóa phần tử đó.
:::

<ZoomImage id="product-card.webp" width="500px" alt="Adding a product element to the canvas" />

Để hiển thị giá gốc bị gạch ngang trên thẻ, hãy thêm [phần tử Old Price](onboarding-text#add-an-old-price) vào bên trong thẻ đó.
