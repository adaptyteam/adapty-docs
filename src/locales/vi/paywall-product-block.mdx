...
:::important
Một phần tử sản phẩm chưa được gắn sản phẩm sẽ [chặn việc xem trước và xuất bản](builder-save-publish#troubleshooting). Hãy gán sản phẩm hoặc xóa phần tử đó đi.
:::

<ZoomImage id="product-card.webp" width="500px" alt="Adding a product element to the canvas" />

Để hiển thị giá neo bị gạch ngang trên card, hãy thêm [phần tử Old Price](onboarding-text#add-an-old-price) vào bên trong card đó.
:::note
Bạn cũng có thể gắn trực tiếp hành động **Purchase** vào tương tác **On tap** của thẻ sản phẩm. Khi nhấn vào thẻ, hành động mua sẽ được kích hoạt ngay mà không cần nút mua riêng.
:::

:::important
Nếu bạn xóa một nhóm sản phẩm và thay thế bằng nhóm mới, hãy kiểm tra lại tất cả các action và biến để đảm bảo chúng trỏ đúng vào nhóm mới. Các tham chiếu vẫn còn trỏ vào nhóm đã xóa sẽ [chặn việc xem trước và xuất bản](builder-save-publish#troubleshooting).
:::
