...
description: "Hướng dẫn từng bước cài đặt Adapty SDK trên Capacitor cho các ứng dụng dựa trên gói đăng ký."
...
Xây dựng ứng dụng cho iOS với Adapty SDK v4 (beta) yêu cầu **Xcode 26** trở lên — SDK iOS gốc mà nó sử dụng được xây dựng bằng Swift tools 6.2. Các yêu cầu iOS 15.0+, Capacitor 8 và Android minSdk 24 giống như SDK 3.16+.

:::info
Bắt đầu từ SDK v3.17, Adapty SDK sử dụng Google Play Billing Library v8.0.0 theo mặc định.

Khả năng tương thích với một phiên bản Billing Library không có nghĩa là Adapty hỗ trợ mọi tính năng mà Google giới thiệu trong đó. Trước khi áp dụng tính năng thanh toán mới của Google Play, hãy xem [Sản phẩm trên Play Store](android-products).
:::
