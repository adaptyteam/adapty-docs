...
Để build cho iOS cần **Xcode 26** trở lên — iOS SDK gốc được build bằng Swift tools 6.2. Trên Android, SDK tối thiểu là 24.

:::info
Adapty Capacitor SDK hoạt động với Google Play Billing Library v8.

Tương thích với một phiên bản Billing Library không có nghĩa là Adapty hỗ trợ mọi tính năng Google giới thiệu trong đó. Trước khi áp dụng một tính năng thanh toán mới của Google Play, hãy xem [Sản phẩm trên Play Store](android-products).
:::
