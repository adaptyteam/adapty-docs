...
Để build cho iOS, bạn cần **Xcode 26** trở lên — SDK iOS native được build bằng Swift tools 6.2. Trên Android, SDK tối thiểu là 24.

:::info
Từ phiên bản 3.17.0, Adapty Capacitor SDK sử dụng Billing Library v8 theo mặc định. Các phiên bản 3.15.0 đến 3.16.3 dùng v7, và cũng hoạt động khi một dependency khác trong bản build Android của bạn nâng Billing Library lên v8.
