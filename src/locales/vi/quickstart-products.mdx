...
:::tip
Muốn thiết lập Adapty theo cách lập trình? Bạn có thể hoàn thành bước này bằng [Developer CLI](developer-cli-quickstart).
:::

Trước khi sử dụng các tính năng cốt lõi của Adapty, bạn cần thêm từng sản phẩm mà ứng dụng bán và liên kết chúng với mọi cửa hàng hoặc nền tảng thanh toán bạn hỗ trợ. Bước thiết lập này giúp bạn phân phối sản phẩm đến thiết bị của người dùng và theo dõi chúng trong phần analytics sau này.

Trong Adapty, bất kỳ thứ gì ứng dụng của bạn bán đều là **sản phẩm**. Nếu cùng một mặt hàng tồn tại trên App Store, Google Play hoặc Stripe, bạn có thể nhóm chúng thành một sản phẩm duy nhất trong Adapty. Thiết lập một lần và quản lý trên tất cả các nền tảng từ một nơi.
