---
title: "Các hành động và kiểu dữ liệu của plugin Adapty FlutterFlow"
description: "Tài liệu tham khảo về các hành động tùy chỉnh và kiểu dữ liệu của Adapty có trong FlutterFlow."
metadataTitle: "Các hành động và kiểu dữ liệu của plugin Adapty FlutterFlow | Tài liệu Adapty"
rank: 40
---
...
### AdaptyPeriodUnitEnum \{#adaptyperiodunitenum\}
