...
Trước khi hiển thị Remote Config và các paywall tùy chỉnh, bạn cần lấy thông tin về chúng. Lưu ý rằng chủ đề này đề cập đến Remote Config và các paywall tùy chỉnh. Để được hướng dẫn lấy thông tin về các flow hoặc paywall được tùy chỉnh trong **Flow & Paywall Builder** hoặc **old Paywall Builder**, vui lòng tham khảo [Lấy flow, paywall và cấu hình của chúng](react-native-get-pb-paywalls).

<SampleApp />

<details>
   <summary>Trước khi bắt đầu lấy flow và sản phẩm trong ứng dụng của bạn (nhấn để mở rộng)</summary>
