...
description: "Quản lý tài khoản Adapty của bạn và tối ưu cài đặt để theo dõi gói đăng ký hiệu quả hơn."
metadataTitle: "Quản lý tài khoản Adapty của bạn | Tài liệu Adapty"
---

Trang **Account** cho phép bạn quản lý hồ sơ người dùng, thành viên trong nhóm và thanh toán.

Trang này có ba tab:

- [Chung](#general-settings)
- [Gói đăng ký & Thanh toán](#subscription--billing)
- [Thành viên](#members)

Để truy cập cài đặt tài khoản, nhấn **Account** ở góc trên bên phải hoặc truy cập [app.adapty.io/account](https://app.adapty.io/account).
