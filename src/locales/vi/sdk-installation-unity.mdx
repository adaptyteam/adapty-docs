...
|---|---|
| 3.17.0 trở lên | v8 |
| 3.15.0–3.15.2 | v7 theo mặc định, v8 nếu một dependency khác nâng cấp lên |

:::note
Tương thích với một phiên bản Billing Library không có nghĩa là Adapty hỗ trợ mọi tính năng mà Google giới thiệu trong phiên bản đó. Trước khi áp dụng một tính năng thanh toán mới của Google Play, hãy xem [Sản phẩm trên Play Store](android-products).
:::
...
Chọn phương thức cài đặt bạn muốn sử dụng:
