...
SDK 4.0 — bổ sung hỗ trợ [Flow Builder](adapty-flow-builder) — là phiên bản pre-release. Để cài đặt qua Unity Package Manager, hãy sử dụng tag beta trong Git URL thay vì `#upm`:
