---
title: "Nút bấm"
description: "Thêm và cấu hình các nút hành động trong Flow & Paywall Builder."
metadataTitle: "Nút bấm | Flow & paywall | Tài liệu Adapty"
---

:::info
Phần này mô tả Flow & Paywall Builder mới, hoạt động với Adapty SDK phiên bản 4.0 trở lên.
:::

Buttons là các phần tử tương tác trong Flow & Paywall Builder, phản hồi khi người dùng nhấn. Sử dụng chúng cho:
- CTA mua hàng kết nối với sản phẩm và tự động xử lý giao dịch
- Điều hướng — chuyển người dùng giữa các màn hình (Next, Back, Close, Skip)
- Liên kết tiện ích — Restore Purchases, Terms of Service và Privacy Policy

:::tip
Đặt CTA mua hàng, liên kết khôi phục và liên kết pháp lý bên trong [Footer](builder-containers#footer) — phần tử này được ghim ở cuối màn hình và che các phần tử cuộn bên dưới.
:::
