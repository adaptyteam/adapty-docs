...
:::note
Trong SDK 4.1, các interface listener tuân theo quy ước tiền tố I- của C#: implement `IAdaptyOnboardingsEventsListener` thay vì `AdaptyOnboardingsEventsListener`. Các phương thức không thay đổi. Xem [hướng dẫn migration](migration-to-unity-sdk-v4).
:::
