---
title: "Hiển thị flow & paywall - Flutter"
description: "Hiển thị flow và paywall trong ứng dụng Flutter bằng các tính năng monetization của Adapty."
metadataTitle: "Hiển thị Flow & Paywall trong Flutter | Tài liệu Adapty"
---

<SDKv4>

Nếu bạn đã thiết kế một flow hoặc paywall bằng Flow Builder hoặc Paywall Builder, bạn không cần lo lắng về việc render nó trong code ứng dụng di động để hiển thị cho người dùng. Flow hoặc paywall như vậy đã bao gồm cả nội dung cần hiển thị lẫn cách thức hiển thị.

:::warning

Hướng dẫn này dành cho flow và paywall được tạo bằng Paywall Builder. Để hiển thị **paywall Remote Config**, xem [Hiển thị paywall được thiết kế bằng Remote Config](present-remote-config-paywalls-flutter).
