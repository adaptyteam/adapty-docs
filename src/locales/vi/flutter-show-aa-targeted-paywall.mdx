---
title: "Hiển thị paywall theo mục tiêu Apple Ads khi khởi động lần đầu trong Flutter SDK"
description: "Chờ một khoảng thời gian ngắn để nhận attribution từ Apple Ads trước khi hiển thị paywall khi khởi động lần đầu trong Flutter, sẽ hiển thị đối tượng mặc định nếu hết thời gian chờ. Sử dụng AdaptyProfile.appliedAttributionSources."
metadataTitle: "Hiển thị paywall theo mục tiêu Apple Ads khi khởi động lần đầu | Flutter SDK | Tài liệu Adapty"
---

Bài viết này áp dụng cho bản build iOS của ứng dụng. Attribution từ Apple Ads chỉ khả dụng trên iOS.
