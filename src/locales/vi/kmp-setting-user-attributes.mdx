...
description: "Tìm hiểu cách đặt thuộc tính người dùng trong Adapty để phân khúc đối tượng hiệu quả hơn."
metadataTitle: "Cài Đặt Thuộc Tính Người Dùng | Tài liệu Adapty"
