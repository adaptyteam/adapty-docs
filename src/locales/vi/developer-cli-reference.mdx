...
| `--ios-product-id` | Bắt buộc ít nhất một nền tảng | ID sản phẩm từ App Store Connect |
| `--android-product-id` | Bắt buộc ít nhất một nền tảng | ID sản phẩm từ Google Play Console |
