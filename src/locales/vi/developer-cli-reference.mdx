---
title: "Tài liệu tham khảo lệnh cho Adapty Developer CLI"
description: "Tài liệu tham khảo các lệnh Adapty Developer CLI dùng để cấu hình ứng dụng, sản phẩm, paywall và placement."
metadataTitle: "Tài liệu tham khảo lệnh Developer CLI | Tài liệu Adapty"
keywords: ['cli', 'developer', 'reference', 'commands', 'mcp']
---

Bài viết này liệt kê các lệnh Adapty CLI dùng để cấu hình tài khoản của bạn — ứng dụng, mức độ truy cập, sản phẩm, paywall, placement và phân khúc — cùng với các đối số, cờ và giá trị được chấp nhận. Đối với các chiến dịch Apple Ads, xem [Lệnh Ads Manager](developer-cli-ads-manager-reference).
