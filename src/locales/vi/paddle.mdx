...
Adapty hỗ trợ các flow web2app bằng cách theo dõi các khoản thanh toán và gói đăng ký trên web thông qua [Paddle](https://www.paddle.com/).

Tích hợp này bao gồm các giao dịch mua được khởi tạo từ web và đồng bộ hóa chúng với quyền truy cập ứng dụng di động và phân tích, cùng với các in-app purchase từ cửa hàng ứng dụng.
...
- Cấp quyền truy cập tính năng trả phí trong ứng dụng di động cho người dùng đã mua hàng trên website
- Xem analytics và dữ liệu gói đăng ký từ tất cả các kênh bán hàng trên một dashboard

:::note
Apple hiện cho phép các ứng dụng trên App Store tại Mỹ thêm liên kết đến hệ thống thanh toán bên ngoài, tuy nhiên các ứng dụng vẫn có thể cần cung cấp in-app purchase song song với các tùy chọn bên ngoài. Hãy kiểm tra hướng dẫn App Store hiện hành cho khu vực và danh mục ứng dụng của bạn.
:::

:::note
Tích hợp này tập trung vào việc theo dõi và đồng bộ các giao dịch mua hàng web qua Paddle. Nếu bạn cần chuyển hướng người dùng từ ứng dụng sang trang thanh toán web, hãy sử dụng [paywall web](web-paywall) của Adapty.
:::
...
## Khai thác tối đa dữ liệu Paddle của bạn \{#get-more-from-your-paddle-data\}
...
Sau khi tích hợp với Paddle, Adapty sẵn sàng cung cấp thông tin chi tiết ngay lập tức. Để khai thác tối đa dữ liệu Paddle, bạn có thể thiết lập thêm các tích hợp Adapty để chuyển tiếp các sự kiện Paddle—đưa toàn bộ phân tích gói đăng ký của bạn vào một Adapty Dashboard duy nhất.

Các tích hợp bạn có thể sử dụng để chuyển tiếp và phân tích các sự kiện Paddle:
- [Amplitude](amplitude)
- [AppsFlyer](appsflyer)
...
Amplitude, Firebase / Google Analytics và Mixpanel lưu thông tin xác thực riêng biệt cho từng nền tảng. Hãy điền vào các trường **Paddle** trên trang tích hợp — các sự kiện Paddle không sử dụng thông tin xác thực iOS hay Android của bạn.
