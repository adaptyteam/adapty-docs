...
description: "Hướng dẫn từng bước để tích hợp Adapty vào ứng dụng Android của bạn bằng Cursor, Context7, ChatGPT, Claude, hoặc các công cụ AI khác."
metadataTitle: "Tích hợp Adapty với sự hỗ trợ AI cho Android | Tài liệu Adapty"
displayed_sidebar: sdkandroid
---

Hướng dẫn này giúp bạn tích hợp Adapty vào ứng dụng Android theo từng bước với sự hỗ trợ của công cụ lập trình AI — bạn chỉ cần cung cấp đúng tài liệu Adapty theo đúng thứ tự.
...
3. **Tạo ít nhất một sản phẩm**: Trong Adapty Dashboard, vào trang **Products**. Bạn không tham chiếu sản phẩm trực tiếp trong code — Adapty phân phối chúng qua các paywall.
   [Thêm sản phẩm](quickstart-products)

4. **Tạo một flow hoặc paywall và một placement**: Trong Adapty Dashboard, tạo một flow (hoặc paywall nếu bạn tự xây dựng giao diện), sau đó gán nó vào một placement trên trang **Placements**. Trong code, placement ID là chuỗi bạn truyền vào `Adapty.getFlow("YOUR_PLACEMENT_ID")`.
...
Những mục này không bắt buộc để bắt đầu code, nhưng bạn sẽ cần chúng khi integration của mình trưởng thành hơn:
...
- [**Paywall tự tạo thủ công**](android-making-purchases): Bạn tự xây dựng giao diện paywall bằng code nhưng vẫn dùng Adapty để lấy sản phẩm và xử lý giao dịch mua.
...
Hãy kiểm tra từng giao dịch mua trong sandbox ngay khi thực hiện — đừng đợi đến cuối. Xem [Kiểm tra giao dịch mua trong sandbox](test-purchases-in-sandbox) để biết hướng dẫn thiết lập.
...
**Hướng dẫn:**
- [Bật mua hàng với Flow & Paywall Builder (bắt đầu nhanh)](android-quickstart-paywalls)
- [Lấy flows và cấu hình của chúng](android-get-pb-paywalls)
- [Hiển thị flows](android-present-paywalls)
- [Xử lý sự kiện flow](android-handling-events)
- [Phản hồi hành động nút bấm](android-handle-paywall-actions)
