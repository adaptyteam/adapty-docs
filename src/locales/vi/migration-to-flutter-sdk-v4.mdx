---
title: "Migrate Adapty Flutter SDK lên v4.0"
description: "Migration lên Adapty Flutter SDK v4.0 bằng cách thay thế các API paywall bằng API flow, giúp render flow cũng như các paywall từ builder cũ."
metadataTitle: "Migration lên Adapty Flutter SDK v4.0 | Tài liệu Adapty"
---
