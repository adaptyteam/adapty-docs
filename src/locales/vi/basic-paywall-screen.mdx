...
description: "Hướng dẫn từng bước để xây dựng màn hình paywall tiêu chuẩn trong Flow & Paywall Builder."
metadataTitle: "Tạo màn hình paywall cơ bản | Flow & paywall | Tài liệu Adapty"
---

Đây là mẫu paywall phổ biến nhất. Bạn có thể dùng nó như một màn hình độc lập, hoặc đặt ở cuối một [flow](adapty-flow-builder) gồm nhiều màn hình.
...
2. Chọn từng thẻ sản phẩm trên canvas và chọn một sản phẩm từ dropdown trong tab **Design**. Các sản phẩm đã được thêm vào màn hình này trong bảng **Products** sẽ hiển thị trước. Phần còn lại trong danh mục của bạn sẽ xuất hiện bên dưới mục **Other products**.
3. Để thay đổi lựa chọn mặc định, chọn thẻ bạn muốn và bật **Set as default** trong tab **Design**.
4. Để tùy chỉnh huy hiệu giảm giá, mở rộng thẻ sản phẩm trong bảng **Layers**, chọn layer huy hiệu, và chỉnh sửa văn bản trong trường **Content**. Ẩn huy hiệu trên các thẻ khác bằng cách bật/tắt biểu tượng mắt <Inline id="eye.svg" alt="Show" /> bên cạnh mỗi layer huy hiệu.
