...
Tương thích với một phiên bản Billing Library không có nghĩa là Adapty hỗ trợ mọi tính năng mà Google giới thiệu trong phiên bản đó. Trước khi áp dụng tính năng billing mới của Google Play, hãy xem [Sản phẩm trên Play Store](android-products).
:::
...
### Adapty SDK 4.0: kích hoạt Swift Package Manager \{#adapty-sdk-40-enable-swift-package-manager\}
