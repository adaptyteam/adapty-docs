...
:::important
Bắt đầu từ v4, Adapty React Native SDK không còn hỗ trợ cài đặt các dependency native qua CocoaPods. Nếu bạn cần v4 trở lên (để dùng [Flow & Paywall Builder](adapty-flow-builder)), hãy làm theo hướng dẫn [Adapty SDK 4.0: bật Swift Package Manager](#adapty-sdk-40-enable-swift-package-manager) bên dưới.
:::
...
React Native SDK 4.0 — phiên bản bổ sung hỗ trợ cho [flow](adapty-flow-builder) — yêu cầu **React Native 0.75 trở lên**. Cài đặt SDK:
