---
title: "Hướng dẫn nhanh cho Adapty Developer CLI"
description: "Thiết lập tài khoản Adapty từ đầu đến cuối bằng Developer CLI — từ tạo ứng dụng đến một placement đang hoạt động, chỉ trong vài lệnh."
metadataTitle: "Hướng dẫn nhanh Developer CLI | Tài liệu Adapty"
keywords: ['cli', 'developer cli', 'mcp']
---

:::link
Đang dùng AI assistant? Có sẵn [Adapty CLI skill](https://github.com/adaptyteam/adapty-cli/tree/main/skills/adapty-cli) để giúp LLM làm việc với CLI.
:::
...
Nếu bạn cũng bán sản phẩm này trên web thông qua Stripe hoặc Paddle, hãy thêm các ID đó vào cùng một lệnh. Xem [products create](developer-cli-reference#adapty-products-create) trong tài liệu tham khảo đầy đủ.
