---
title: "Kiểm tra trạng thái đăng ký trong React Native SDK"
description: "Theo dõi và quản lý trạng thái đăng ký người dùng trong Adapty để cải thiện khả năng giữ chân khách hàng trong ứng dụng React Native của bạn."
metadataTitle: "Tìm hiểu về Trạng thái Đăng ký | Tài liệu Adapty"
keywords: ['getProfile']
---

Với Adapty, việc theo dõi trạng thái đăng ký trở nên thật đơn giản. Bạn không cần phải chèn thủ công các ID sản phẩm vào code. Thay vào đó, bạn có thể dễ dàng xác nhận trạng thái đăng ký của người dùng bằng cách kiểm tra [mức độ truy cập](access-level) đang hoạt động.
