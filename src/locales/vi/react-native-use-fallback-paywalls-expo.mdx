...
metadataTitle: "Sử dụng Fallback Flow trên React Native | Tài liệu Adapty"
keywords: ['fallback paywalls', 'expo', 'react native', 'config plugin', 'prebuild', 'offline paywalls']
---

:::important
Hướng dẫn này áp dụng cho **dự án Expo**.
Nếu bạn đang dùng **React Native thuần (không dùng Expo)**, hãy xem [hướng dẫn fallback cho React Native thuần](react-native-use-fallback-paywalls-pure) thay thế.
:::
