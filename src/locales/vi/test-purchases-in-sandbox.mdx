...
6. [Mở ứng dụng và thực hiện giao dịch mua kiểm thử](#step-7-make-test-purchase).
...
5. [Mở ứng dụng và thực hiện giao dịch mua kiểm thử](#step-7-make-test-purchase).
