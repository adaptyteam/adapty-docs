...
## Kiểm thử trong Sandbox \{#sandbox-testing\}

<YouTube id="hq4PRU-vuik" />

:::info
Chúng tôi khuyến nghị kiểm thử in-app purchase trên thiết bị thật. Mặc dù sandbox purchase có thể chạy trên simulator, nhưng bạn cần thiết bị thật để kiểm tra đầy đủ tất cả các flow, bao gồm hộp thoại thanh toán và xác thực sinh trắc học.
:::

Có hai cách chính để kiểm thử in-app purchase:

- **Build trong Xcode và chạy trên thiết bị test**: Tiện lợi cho developer và QA engineer.
- **Dùng tài khoản test sandbox với TestFlight**: Phù hợp với những người khác.
...
1. Xóa hồ sơ gốc.
2. Gỡ ứng dụng khỏi thiết bị thử nghiệm.
...
6. [Mở ứng dụng và thực hiện giao dịch mua thử nghiệm](#step-7-make-test-purchase).
...
Nếu ứng dụng trong TestFlight đã được cập nhật:

1. Xóa ứng dụng khỏi thiết bị test.
2. [Tải ứng dụng từ TestFlight](#step-3-download-the-app-from-testflight).
3. [Chuyển sang tài khoản test Sandbox](#step-4-switch-to-sandbox-test-account).
4. [Xóa lịch sử mua hàng](#step-5-clear-purchase-history).
5. [Mở ứng dụng và thực hiện giao dịch mua test](#step-7-make-test-purchase).
