...
metadataTitle: "Tabs | Flow & paywall | Tài liệu Adapty"
---

**Tabs** chia một phần màn hình thành các bảng nội dung có thể chuyển đổi — người dùng nhấn vào tiêu đề tab và bảng bên dưới sẽ cập nhật tương ứng.
...
Flow & Paywall Builder cung cấp ba mẫu tab có sẵn:

- **Segment control** — thanh chuyển đổi hình viên thuốc với các góc bo tròn quanh tab đang chọn.
- **Button Tabs** — các tab theo kiểu nút riêng biệt.
- **Underline** — nhãn văn bản với đường gạch chân đánh dấu tab đang chọn.
