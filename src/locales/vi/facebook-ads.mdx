---
title: "Facebook Ads"
description: "Tích hợp Facebook Ads với Adapty để marketing gói đăng ký hiệu quả hơn."
...
Với tích hợp Facebook Ads, bạn có thể dễ dàng kiểm tra số liệu thống kê ứng dụng trong Meta Analytics. Adapty gửi các sự kiện đến Meta Ads Manager, giúp bạn tạo tệp đối tượng tương tự dựa trên gói đăng ký để đạt hiệu quả tốt hơn. Nhờ đó, bạn có thể theo dõi chính xác doanh thu quảng cáo từ các gói đăng ký.

Sự tích hợp giữa Adapty và Facebook Ads hoạt động theo cách sau: Adapty gửi tất cả các sự kiện gói đăng ký đã được cấu hình trong tích hợp của bạn đến Facebook Ads. Tích hợp này hữu ích để đánh giá hiệu quả của các chiến dịch quảng cáo.
