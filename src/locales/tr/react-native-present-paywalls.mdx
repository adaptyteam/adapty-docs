---
title: "Flow ve paywallları görüntüleme - React Native"
description: "React Native uygulamanızda Adapty ile kullanıcılara flow ve paywallları sunun."
metadataTitle: "React Native'de Flow ve Paywall Görüntüleme | Adapty Dokümanları"

---

<SDKv4>

<MethodPromo method="getFlow" label="Flow ve paywall görüntüleme" />
...
1. Bir [flow](paywall-builder-templates) veya bir [paywall](create-paywall) oluşturdunuz.
2. Onu bir [placement](placements)'a eklediniz.
3. [Flow'u getirdiniz ve view'ı hazırladınız](react-native-get-pb-paywalls).
...
- **Remote config paywalllarını** sunmak için bkz. [Remote config ile tasarlanan paywall'ı gösterme](present-remote-config-paywalls).
