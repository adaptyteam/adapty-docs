...
description: "Daha iyi kitle segmentasyonu sağlamak için Adapty'de kullanıcı özelliklerini nasıl ayarlayacağınızı öğrenin."
metadataTitle: "Kullanıcı Özelliklerini Ayarlama | Adapty Dokümanları"
keywords: ["updateProfile", "profil güncelleme", "kullanıcı özellikleri"]
---

E-posta, telefon numarası gibi isteğe bağlı özellikleri uygulamanızın kullanıcısına atayabilirsiniz. Bu özellikleri daha sonra kullanıcı [segmentleri](segments) oluşturmak veya CRM'de görüntülemek için kullanabilirsiniz.
