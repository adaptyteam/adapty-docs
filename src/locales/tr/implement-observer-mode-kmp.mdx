...
:::tip
SDK v4'te, Observer modunda Adapty tarafından render edilen flow'ları ve paywall'ları da sunabilirsiniz: kullanıcı satın alma veya geri yükleme düğmesine dokunduğunda, SDK eylemi kodunuza devreder, böylece satın alma veya geri yükleme işlemini kendiniz gerçekleştirebilirsiniz. Bkz. [Observer modunda flow'ları sunma](kmp-present-flows-in-observer-mode).
:::
