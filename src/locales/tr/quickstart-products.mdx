...
Adapty'nin temel özelliklerini kullanabilmek için önce sattığınız her ürünü eklemeniz ve bunu desteklediğiniz her mağaza ya da ödeme platformuna bağlamanız gerekir. Bu kurulum, ürünleri kullanıcıların cihazlarına iletmenize ve daha sonra analitiklerde takip etmenize olanak tanır.

Adapty'de uygulamanızın sattığı her şey bir **ürün**tür. Aynı öğe App Store, Google Play veya Stripe'ta mevcutsa, bunları Adapty'de tek bir ürün altında gruplayabilirsiniz. Bir kez ayarlayın ve tüm platformları tek bir yerden yönetin.
