...
description: "Uygulamanızın güncelleme sürecinin sorunsuz geçmesi için Adapty'nin yayın kontrol listesini takip edin."
metadataTitle: "Uygulama Yayın Kontrol Listesi | Adapty Dokümanları"
---

Yayınlamadan önce bu kontrol listesini gözden geçirin; böylece monetizasyon flow'unun gerçek bir derlemede uçtan uca çalıştığını doğrulayabilirsiniz.
