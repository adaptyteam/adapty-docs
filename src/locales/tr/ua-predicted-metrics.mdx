---
title: "Adapty Attribution'da Tahmin Edilen Metrikler"
description: "Adapty Attribution'da kohortlar için gelir, ROAS, reklam kârı ve LTV tahminleri yapın."
metadataTitle: "Tahmin Edilen Metrikler | Adapty Attribution | Adapty Dokümanları"
keywords: ['adapty attribution', 'adapty ua', 'user acquisition', 'predicted revenue', 'predicted roas', 'predicted ltv', 'predictions']
---

:::important
Bu makale yalnızca Adapty Attribution'daki tahminleri kapsamaktadır. Kohort analizi sayfasındaki tahmini LTV ve gelir için bkz. [Kohortlarda tahminler](predicted-ltv-and-revenue).
:::

Adapty Attribution, her kohort için gelecekteki geliri ve birim ekonomisini tahmin eder; böylece kampanyaları olgunlaşmadan önce karşılaştırabilirsiniz. Tahminler, uygulamanın kendi geçmiş kohort verilerinden üretilir ve her gün güncellenir. En çok henüz uzun abonelik döngülerini tamamlamamış yeni kohortları değerlendirmek için kullanışlıdır.
