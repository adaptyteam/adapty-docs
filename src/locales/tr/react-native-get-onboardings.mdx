---
title: "React Native SDK'da onboarding'leri getirme"
description: "React Native için Adapty'de onboarding'leri nasıl getireceğinizi öğrenin."
metadataTitle: "Adapty'de onboarding'leri getirme | Adapty Dokümanları"
...
Adapty Kontrol Paneli'ndeki builder ile [onboarding'inizin görsel kısmını tasarladıktan](design-onboarding) sonra, onu React Native uygulamanızda görüntüleyebilirsiniz. Bu süreçteki ilk adım, placement ile ilişkili onboarding'i ve view yapılandırmasını aşağıda açıklandığı gibi getirmektir.

Başlamadan önce şunlardan emin olun:

1. [Adapty React Native SDK](sdk-installation-reactnative) sürüm 3.8.0 veya üzerini yüklediniz.
