...
:::note
SDK 4.0'da listener arayüzleri C# I-prefix kuralını izler: `AdaptyEventListener` yerine `IAdaptyEventListener` kullanın. Metodlar değişmemiştir. [Geçiş kılavuzuna](migration-to-unity-sdk-v4) bakın.
:::
