...
:::note
SDK 4.1'de dinleyici arayüzleri C# I-prefix kuralını takip eder — `AdaptyEventListener` yerine `IAdaptyEventListener` uygulayın — ve arayüz bir metod daha gerektirir: `OnReceivePromotedPurchase`. [Geçiş kılavuzuna](migration-to-unity-sdk-v4) bakın.
:::
