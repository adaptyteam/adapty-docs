---
title: "Flutter SDK'da Code-1000 noProductIDsFound Hatasının Çözümü"
description: "Adapty'de abonelikleri yönetirken geçersiz ürün tanımlayıcı hatalarını çözün."
metadataTitle: "Flutter'da Code-1000 noProductIDsFound Hatasının Çözümü | Adapty Dokümanları"
slug: "InvalidProductIdentifiers-flutter"
---

import ProvideBundleID from '@site/src/locales/tr/reusable/ProvideBundleID.md';

1000 kodlu `noProductIDsFound` hatası, paywall'da talep ettiğiniz ürünlerin App Store'da listelenmiş olmasına rağmen satın alma için mevcut olmadığını gösterir. Bu hata bazen `InvalidProductIdentifiers` uyarısıyla birlikte gelebilir. Uyarı hata olmadan görünüyorsa güvenle görmezden gelebilirsiniz.

`noProductIDsFound` hatasıyla karşılaşıyorsanız çözüm için şu adımları izleyin:
...
2. Abonelik grubu adına tıklayın. Ürünlerinizi **Subscriptions** bölümünde listelenmiş olarak göreceksiniz.
...
4. Tablodaki ürün ID'sini Adapty Kontrol Paneli'ndeki [**Products**](https://app.adapty.io/products) sekmesindekiyle karşılaştırın. ID'ler eşleşmiyorsa tablodaki ürün ID'sini kopyalayın ve Adapty Kontrol Paneli'nde bu ID ile [bir ürün oluşturun](create-product).
...
4. **Availability** bölümüne kaydırın ve gerekli tüm ülke ve bölgelerin listelendiğini doğrulayın.
...
5. Gerekli tüm fiyatların listelendiğinden emin olun.
    ...
    3. Aşağı kaydırın ve **Paid Apps Agreement**, **Bank Account** ile **Tax forms** bilgilerinin tamamının **Active** olarak göründüğünü doğrulayın.
