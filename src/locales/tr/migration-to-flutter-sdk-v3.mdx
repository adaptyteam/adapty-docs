---
title: "Adapty Flutter SDK'yı v3.0'a geçirme"
description: "Daha iyi performans ve yeni para kazanma özellikleri için Adapty Flutter SDK v3.0'a geçin."
metadataTitle: "Adapty Flutter SDK v3.0'a Geçiş | Adapty Dokümanları"
---

Adapty SDK v3.0, no-code ve kullanıcı dostu bir paywall oluşturma aracının yeni sürümü olan [Adapty Paywall Builder](adapty-paywall-builder) desteğini sunuyor. Maksimum esnekliği ve zengin tasarım özellikleriyle paywalllarınız çok daha etkili ve kârlı hale gelecek.

:::info

AdaptyUI kütüphanesinin kullanımdan kaldırıldığını ve artık AdaptySDK'nın bir parçası olarak dahil edildiğini lütfen unutmayın.
...
1. AdaptyUI SDK import'unu uygulamanızdan aşağıdaki şekilde kaldırın:
