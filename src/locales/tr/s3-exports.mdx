---
title: "Amazon S3"
description: "Gelişmiş analiz ve raporlama için abonelik verilerini S3'e aktarın."
metadataTitle: "S3 Dışa Aktarımları & Veri Yönetimi | Adapty Dokümanları"
---

import UsdConversion from '@site/src/locales/tr/reusable/UsdConversion.mdx';

Adapty'nin Amazon S3 ile entegrasyonu, etkinlik ve paywall ziyareti verilerini güvenli bir şekilde tek bir merkezi konumda saklamanıza olanak tanır. [Abonelik etkinliklerinizi](events) Amazon S3 bucket'ınıza .csv dosyaları olarak kaydedebilirsiniz.

Bu entegrasyonu kurmak için AWS Console ve Adapty Kontrol Paneli'nde birkaç basit adımı takip etmeniz gerekir.
...
Her dosya, önceki tam takvim günü (UTC) boyunca oluşturulan event verilerini içerecektir. Örneğin, 8 Mart'ta 04:00 UTC'de otomatik olarak dışa aktarılan veriler, 7 Mart'ta 00:00:00 ile 23:59:59 UTC arasında oluşturulan tüm eventleri içerecektir.
:::
...
:::warning
Bu yapının zamanla büyüyebileceğini unutmayın — bizim veya birlikte çalıştığımız 3. tarafların yeni veriler eklemesiyle. Bu yapıyı işleyen kodunuzun yeterince sağlam olduğundan ve yapının tamamına değil, belirli alanlara dayandığından emin olun.
:::

İşte event'ler için tablo yapısı:
