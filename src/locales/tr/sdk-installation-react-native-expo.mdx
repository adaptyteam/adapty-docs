...
:::info
3.17.0 sürümünden itibaren Adapty React Native SDK varsayılan olarak Billing Library v8 kullanır. 3.15.0'dan 3.15.6'ya kadar olan sürümler v7 kullanır; ayrıca Android build'inizdeki başka bir bağımlılık Billing Library'yi v8'e yükselttiğinde de çalışır.

Bir Billing Library sürümüyle uyumlu olmak, Adapty'nin o sürümde Google'ın sunduğu her özelliği desteklediği anlamına gelmez. Yeni bir Google Play faturalandırma özelliği benimsemeden önce [Google Play'deki Ürünler](android-products) sayfasına bakın.
:::
