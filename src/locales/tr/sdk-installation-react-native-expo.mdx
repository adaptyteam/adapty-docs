...
:::note
Bir Billing Library sürümüyle uyumlu olmak, Adapty'nin o sürümde Google'ın sunduğu her özelliği desteklediği anlamına gelmez. Yeni bir Google Play faturalandırma özelliği benimsemeden önce [Play Store'daki Ürün](android-products) bölümüne bakın.
:::

## Adapty SDK'yı Yükleyin \{#install-adapty-sdk\}

:::important
Adapty React Native SDK v4 ve sonraki sürümleri, yerel iOS SDK'larını (`Adapty`, `AdaptyUI`, `AdaptyPlugin`) Swift paketi olarak sunar. CocoaPods hâlâ bunları bir Expo projesine yükler; ancak Swift paketleri dinamik olarak bağlandığından, derlemenizin dinamik framework'lere ihtiyacı vardır — bkz. [Adapty SDK v4 için dinamik framework'leri etkinleştirin](#enable-dynamic-frameworks).
:::
