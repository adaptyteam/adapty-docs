...
:::important
v4'ten itibaren, Adapty React Native SDK artık yerel bağımlılıklarının CocoaPods ile kurulumunu desteklememektedir. v4 veya daha sonrasına ihtiyacınız varsa ([Flow Builder](adapty-flow-builder) için), bunun yerine aşağıdaki [Adapty SDK 4.0: Swift Package Manager'ı etkinleştirin](#adapty-sdk-40-enable-swift-package-manager) bölümünü izleyin.
:::
...
### Adapty SDK 4.0: Swift Package Manager'ı etkinleştir \{#adapty-sdk-40-enable-swift-package-manager\}

React Native SDK 4.0 — [Flow Builder](adapty-flow-builder) desteği ekleyen bu sürüm — **React Native 0.75 veya üstü** gerektirir. SDK'yı yükleyin:
