...
iOS için derleme yapmak için **Swift 6.0** veya üzeri gereklidir. [Kids Mode](kids-mode-react-native), **Swift 6.1** veya üzeri gerektirir.

:::info
SDK v3.17'den itibaren Adapty SDK, varsayılan olarak Google Play Billing Library v8.0.0 kullanmaktadır.

Bir Billing Library sürümüyle uyumluluk, Adapty'nin Google'ın bu sürümde sunduğu her özelliği desteklediği anlamına gelmez. Yeni bir Google Play faturalandırma özelliğini benimsemeden önce [Product in Play Store](android-products) sayfasına bakın.
:::
