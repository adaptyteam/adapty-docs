---
title: "Adım 3. Satın almayı etkinleştirme"
description: "FlutterFlow paywall'ınızda kullanıcıların Adapty üzerinden ürün satın almasına izin verin."
metadataTitle: "FlutterFlow paywall'ında satın almaları etkinleştirme | Adapty Dokümanları"
---

Tebrikler! Ürün başlığı ve fiyatı dahil olmak üzere [paywall'ınızı Adapty'den ürün verilerini görüntüleyecek şekilde başarıyla yapılandırdınız](ff-add-variables-to-paywalls).

Şimdi son adıma geçelim: kullanıcıların paywall üzerinden satın alma yapabilmesini sağlayalım.
