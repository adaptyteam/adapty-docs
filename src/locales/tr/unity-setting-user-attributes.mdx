---
title: "Unity SDK'da kullanıcı özelliklerini ayarlama"
description: "Adapty SDK ile Unity uygulamanızda kullanıcı özelliklerini ve profil verilerini nasıl güncelleyeceğinizi öğrenin."
metadataTitle: "Kullanıcı Verilerini Güncelleme | Unity SDK | Adapty Dokümanları"
customSlug: /unity-setting-user-attributes
displayed_sidebar: sdkunity
---

Uygulamanızın kullanıcısına e-posta, telefon numarası gibi isteğe bağlı özellikler atayabilirsiniz. Bu özellikleri kullanarak kullanıcı [segmentleri](segments) oluşturabilir ya da bunları CRM'de görüntüleyebilirsiniz.
