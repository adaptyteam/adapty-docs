...
description: "Flow ve Paywall Builder'da standart bir paywall ekranı oluşturmak için adım adım kılavuz."
metadataTitle: "Temel bir paywall ekranı oluşturun | Flow'lar ve paywall'lar | Adapty Dokümanları"
---
...
1. **+** > **Products** seçeneğine tıklayın ve bir düzen ön ayarı seçin. En yaygın kullanılanı Vertical List'tir.
2. Canvas üzerindeki her ürün kartını seçin ve **Design** sekmesindeki açılır menüden bir ürün seçin. Bu ekrana **Products** panelinden zaten eklenmiş ürünler önce görüntülenir. Kataloğunuzun geri kalanı **Other products** altında listelenir.
3. Varsayılan seçimi değiştirmek için istediğiniz kartı seçin ve **Design** sekmesinde **Set as default** seçeneğini etkinleştirin.
