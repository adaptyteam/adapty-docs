---
title: "Alt sayfada tüm planları göster"
description: "Tek bir CTA, 'Tüm planları göster' bağlantısı ve ürün listesinin tamamını ortaya çıkaran bir alt sayfa içeren bir hero paywall oluşturun."
metadataTitle: "Alt sayfada tüm planları göster | Flow'lar ve paywaller | Adapty Dokümanları"
---

Bu şablon, önce tek bir öne çıkan teklifi sunar; tam plan listesine giden göze çarpmayan bir bağlantıyla birlikte. **Show all plans** butonuna dokunulduğunda, diğer ürünleri, bir satın alma düğmesini ve alt bağlantıları içeren bir alt sayfa yukarı kayar.
