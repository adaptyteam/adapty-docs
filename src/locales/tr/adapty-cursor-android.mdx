...
Bu kılavuz, bir yapay zeka kodlama aracıyla Adapty'yi Android uygulamanıza adım adım entegre etme sürecini anlatır — doğru Adapty dokümanlarını doğru sırayla beslemeniz yeterli. Tam otomatik bir flow için bunun yerine [adapty-sdk-integration skill](adapty-sdk-integration-skill-android)'i kullanın.
