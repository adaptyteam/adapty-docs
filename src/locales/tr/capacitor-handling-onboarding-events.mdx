...
description: "Capacitor'da Adapty kullanarak onboarding ile ilgili olayları yönetin."
...
Onboarding'lerde paywall'larla çalışmanın en sorunsuz yolu, aksiyon ID'sini bir paywall placement ID'sine eşit yapmaktır.
