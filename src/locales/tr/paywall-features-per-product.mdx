---
title: "Ürüne göre farklı özellikler göster"
description: "Koşullu görünürlük kullanarak kullanıcının seçtiği ürüne göre farklı bir özellik listesi göster."
metadataTitle: "Ürüne göre farklı özellikler göster | Flow'lar ve paywall'lar | Adapty Dokümanları"
---
...
## 3. Başlığı ekle ve kapat düğmesiyle eşleştir \{#add-the-title-and-pair-it-with-the-close-button\}
...
<ZoomImage id="paywall-tabs-title-aligned.webp" width="500px" alt="Yatay kapsayıcıda hizalanmış Kapat düğmesi ve H1" />

## 4. Ürün listesini ekleyin \{#add-the-product-list\}

Kullanıcının seçebileceği ürünleri ekleyin. Ekran ilk yüklendiğinde anlamlı bir durumda görünmesi için bunlardan birini varsayılan olarak işaretleyin.

Ürünleri yönetme hakkında daha fazla bilgi için bkz. [Satın almaları ayarlama](paywall-product-block).

Ürün eklemek ve yapılandırmak için:

1. **+** > **Products** seçeneğine tıklayın ve bir düzen şablonu belirleyin. Bu şablon için Vertical List iyi çalışır.
2. Tuvaldeki her ürün kartını seçin ve **Design** sekmesindeki açılır menüden bir ürün seçin.
3. Varsayılan olarak seçili olmasını istediğiniz kartı (örneğin Pro+) seçin ve **Design** sekmesinde **Set as default** seçeneğini etkinleştirin.

<ZoomImage id="paywall-features-products.webp" width="500px" alt="Ekranda biri varsayılan olarak işaretlenmiş iki ürün" />

## 5. İlk ürün için özellik listesi ekleme \{#add-the-feature-list-for-the-first-product\}

İlk özellik listesi varsayılan ürünü açıklar. Yalnızca kullanıcı birinci ürünü seçtiğinde görünür.

Koşullu görünürlük hakkında daha fazla bilgi için bkz. [Koşullu görünürlük](onboarding-element-visibility).

:::tip
İki ayrı liste kullanmak yerine tek bir liste ekleyip içindeki metin öğelerini koşullu hale getirebilirsiniz; böylece liste seçilen ürüne göre uyum sağlar. Bkz. [Koşullu metin ekleme](onboarding-text#add-conditional-text).
:::
