...
description: "Adapty'de kullanıcı abonelik durumunu takip edip yönetin; Android uygulamanızda müşteri elde tutma oranınızı artırın."
metadataTitle: "Abonelik Durumunu Anlama | Adapty Dokümanları"
keywords: ['getProfile']
---

Adapty ile abonelik durumunu takip etmek çok kolay. Ürün kimliklerini kodunuza elle girmenize gerek yok. Bunun yerine, aktif bir [access level](access-level) olup olmadığını kontrol ederek kullanıcının abonelik durumunu zahmetsizce doğrulayabilirsiniz.
