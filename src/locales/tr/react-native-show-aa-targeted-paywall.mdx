---
title: "React Native SDK'da ilk açılışta AA hedefli paywall gösterme"
description: "React Native'de attribution uygulandıktan sonra Apple Ads kullanıcıları için paywallı hemen gösterin ve yükseltin; AdaptyProfile.appliedAttributionSources kullanarak."
metadataTitle: "İlk açılışta AA hedefli paywall gösterme | React Native SDK | Adapty Dokümanları"
---
...
1. Hemen `getPaywall` çağrısı yap. Henüz hiçbir attribution uygulanmamış olduğundan, Adapty isteği varsayılan kitleye göre çözümler; böylece kullanıcı bir paywall'u anında görür.
2. `'apple_search_ads'` göründüğünde `getPaywall` çağrısını tekrarla. Adapty artık isteği Apple Ads kitlesine göre çözümler ve ilkinin yerini alan hedeflenmiş paywall'u döndürür.

`appliedAttributionSources` boş olabilir ya da hiç bulunmayabilir. Bu, şu durumlardan birinin geçerli olduğu anlamına gelir:
