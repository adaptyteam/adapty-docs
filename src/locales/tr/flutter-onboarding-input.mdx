...
Aksiyon formatını [burada](https://pub.dev/documentation/adapty_flutter/latest/adapty_flutter/AdaptyUIOnboardingPlatformView/onStateUpdatedAction.html) görebilirsiniz.

<Details>
<summary>Her params türü için özellik şekilleri (genişletmek için tıklayın)</summary>
