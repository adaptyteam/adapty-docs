...
:::note
SDK 4.0'da dinleyici arayüzleri C# I-ön eki kuralına uyar: `AdaptyEventListener` yerine `IAdaptyEventListener` arayüzünü implement edin. Metodlar değişmemiştir. [Geçiş kılavuzuna](migration-to-unity-sdk-v4) bakın.
:::
