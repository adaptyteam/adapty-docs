...
description: "Unity uygulamanızda müşteri elde tutmayı iyileştirmek için Adapty'de kullanıcı abonelik durumunu takip edin ve yönetin."
...
:::note
SDK 4.1'de listener arayüzleri C# I-ön eki kuralını takip eder — `AdaptyEventListener` yerine `IAdaptyEventListener` uygulayın — ve arayüz bir yöntem daha gerektirir: `OnReceivePromotedPurchase`. [Geçiş kılavuzuna](migration-to-unity-sdk-v4) bakın.
:::
...
Adapty, uygulama başlangıcında da bir event tetikler. Bu durumda, önbelleğe alınmış abonelik durumu iletilir.
