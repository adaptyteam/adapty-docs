...
1. Podfile'ınızı güncelleyin:
   ...
   - `post_install` bölümünüz **varsa** vurgulanan satırları mevcut bölüme ekleyin.
    ...
    post_install do |installer|
      # ... mevcut post_install içeriğinizi koruyun (Flutter otomatik olarak bir tane ekler) ...

      adapty_enable_kids_mode(installer)   # <-- Adapty Kids Mode'u etkinleştir
    end
    ```

2. Değişiklikleri şu komutu çalıştırarak uygulayın
