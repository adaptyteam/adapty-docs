...
4.1.1 öncesinde, [App Store ürün sayfanızda öne çıkan uygulama içi satın almalar](capacitor-making-purchases#in-app-purchases-from-the-app-store) kendi kendine tamamlanıyor ve Adapty işlemi kaydediyordu; ancak uygulamanızın bunu yakalayacak bir yolu yoktu. 4.1.1 bu kancayı ekliyor; bu nedenle bu bir geçiş adımı değil, yeni bir özelliktir: kendi kodunuz olmadan SDK, öne çıkan satın almaları sizin adınıza tamamlamaya devam eder.
