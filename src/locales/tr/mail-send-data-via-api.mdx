...
Profili `external_profile_id`, `customer_user_id` veya `email` ile tanımlayın — en az birini gönderin. Silme işlemi kalıcıdır: aynı tanımlayıcıları taşıyan sonraki bir kayıt profili yeniden oluşturmaz. Ayrıntılar için [Profili sil](api-mail/operations/deleteProfile) referansına bakın.
