...
description: "Adapty'nin kullanıcı profillerini nasıl oluşturduğunu, takip ettiğini ve bağladığını anlayın — anonim profiller, kimliği belirlenmiş kullanıcılar ve üst/devralınan profil ilişkileri dahil."
metadataTitle: "Adapty Profilleri Nasıl Çalışır | Adapty Dokümanları"
keywords: ['profil', 'customer_user_id', 'anonim profil', 'üst profil', 'devralınan profil', 'profil kaydı']
---
