...
:::tip
Onboarding içinde bir paywall açmak istiyorsanız bu olayı işleyin. Paywall kapatıldıktan sonra açmak istiyorsanız daha kolay bir yol var: kapat aksiyonunu işleyip olay verisine gerek kalmadan paywall'ı açın.
:::

Onboarding'lerde paywall'larla çalışmanın en kolay yolu, aksiyon ID'sini paywall placement ID'sine eşit yapmaktır.
