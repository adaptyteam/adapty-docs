...
## Yapay Zeka ile Çeviri \{#translate-with-ai\}
...
<ZoomImage id="row-context-menu.webp" width="500px" alt="Satır bağlam menüsü" />
...
<ZoomImage id="preview-locales.webp" width="500px" alt="Flow Builder'da dil önizleme" />
Flow'unuza locale ekledikten sonra, uygulamanızda locale kodlarını doğru şekilde uygulayın. Bkz. <InlineTooltip tooltip="uygulamanızda yerelleştirmeleri ve locale kodlarını nasıl kullanacağınız">[iOS](localizations-and-locale-codes), [Android](android-localizations-and-locale-codes), [React Native](react-native-localizations-and-locale-codes), [Flutter](flutter-localizations-and-locale-codes) ve [Unity](unity-localizations-and-locale-codes)</InlineTooltip>.