...
description: "İki sekme arasında geçiş yaparak farklı özellik listelerini, ürün gruplarını ve satın alma işlemlerini gösteren bir paywall ekranı oluşturun."
metadataTitle: "Sekmeli paywall oluşturma | Flow'lar ve paywall'lar | Adapty Dokümanları"
---

Bu şablon, tek bir ekranda aynı teklifin iki varyantı arasında geçiş yapmak için sekmeler kullanır. Her sekme kendi özellik listesini, ürün listesini ve satın alma düğmesini içerir. Bir sekmeye dokunmak, ekrandan çıkmadan görünen içeriği değiştirir — planları katmana, faturalama dönemine veya kitle segmentine göre ayırmak için kullanışlıdır.
