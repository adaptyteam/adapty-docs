...
<ZoomImage id="paywall-tabs-title-add.webp" width="500px" alt="Ekrana eklenen H1 ve sağda Content alanı" />
...
<ZoomImage id="paywall-tabs-title-aligned.webp" width="500px" alt="Yatay yığında hizalanmış kapatma düğmesi ve H1" />
