...
Onboarding flow'u, eklediğiniz ve tasarladığınız birkaç ekrandan oluşur.

Kullanıcılar, ekranlar arasında gezinmek için butona dokunur.

:::tip
Bazı kullanıcılarınızın biraz farklı bir flow'a ihtiyacı varsa (örneğin bir fitness uygulamasında, kullanıcının cinsiyetine göre farklı 'hedef' görselleri göstermek isteyebilirsiniz), ayrı onboarding'ler oluşturmanıza gerek yok.

Bunun yerine, bazı ekranları varsayılan olarak gizli yapabilir ve yalnızca belirli senaryolarda gösterilecek şekilde ayarlayabilirsiniz.
:::
