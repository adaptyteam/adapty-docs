...
[Paywall Builder](adapty-paywall-builder) kullanmayı planlıyorsanız ve [AdaptyUI modülünü kurduysanız](sdk-installation-flutter#install-adapty-sdk), AdaptyUI'ı da etkinleştirmeniz gerekir:

:::note
AdaptyUI ile ilgili bağımlılıklar, AdaptyUI etkinleştirilmiş olsun ya da olmasın uygulamanıza bağlıdır.
:::
...
await Adapty().activate(
  configuration: AdaptyConfiguration(apiKey: 'YOUR_PUBLIC_SDK_KEY')
    ..withActivateUI(true), // Bu otomatik olarak AdaptyUI'yi etkinleştirir
);
```
