...
[Paywall Builder](adapty-paywall-builder) kullanmayı planlıyor ve [AdaptyUI modülünü yüklediyseniz](sdk-installation-flutter#install-adapty-sdk), AdaptyUI'ı da etkinleştirmeniz gerekir:

:::important
Kodunuzda, AdaptyUI'ı etkinleştirmeden önce mutlaka çekirdek Adapty modülünü etkinleştirmelisiniz.
:::
