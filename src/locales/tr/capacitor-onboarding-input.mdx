...
description: "Adapty SDK ile Capacitor uygulamanızda onboarding verilerini kaydedin ve kullanın."
metadataTitle: "Onboardinglar | Capacitor SDK | Adapty Dokümanları"
---

<OnboardingDeprecation />

Kullanıcılarınız bir quiz sorusunu yanıtladığında veya bir giriş alanına veri girdiğinde `onStateUpdated` metodu çağrılır. Alan türünü kodunuzda kaydedebilir veya işleyebilirsiniz.
...
Aksiyon formatını [buradan](https://capacitor.adapty.io/types/onboardingstateupdatedaction) görebilirsiniz.
