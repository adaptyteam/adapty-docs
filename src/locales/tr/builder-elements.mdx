...
Düzen öğeleri, içlerindeki elemanları organize eden kaplardır.

- **Dikey Kapsayıcı**: alt öğeleri yukarıdan aşağıya doğru sıralar
- **Yatay Kapsayıcı**: alt öğeleri soldan sağa doğru sıralar
- **Ayraçlar (yatay ve dikey)**: içerik bölümlerini görsel olarak ayıran çizgiler
- **Döngü**: kaydırılabilir bir kapsayıcı
- **Alt Sayfa**: ekranın altına sabitlenen, yukarı kayan bir panel
...
Metin statik olabilir ya da [değişkenler](onboarding-variables) (örneğin, kullanıcı adı) ve [yerelleştirilmiş içerik](paywall-localization) içerebilir.


<ZoomImage id="text-templates.webp" width="400px" alt="Metin öğesi şablonları" float="right" />

Aşağıdaki metin ön ayarları standart olarak gelir. Bu listeyi değiştirmek için [kayıtlı metin stilleri](builder-styling#reusable-styles) ekleyin veya kaldırın:
