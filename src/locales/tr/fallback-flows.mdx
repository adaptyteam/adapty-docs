...
1. Flow & Paywall Builder'da bir [flow](adapty-flow-builder) oluşturun.
...
Dosyayı uygulama kodunuza ekleyin, ardından platforma özgü kurulum kılavuzunu izleyin. Paywall yedeklerini yükleyen API'ler, uygulamanız flow destekleyen bir SDK sürümüne geçtiğinde flow yedeklerini de yükler:
