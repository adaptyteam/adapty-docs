...
- **Placement başına bir varyant.** Bir placement'ın birden fazla flow'u varsa (farklı kitleler, A/B testi varyantları), yedek dosyası en yüksek ağırlığa sahip ya da en geniş kitleye sahip varyantı kullanır.
- **A/B testi yoktur.** Canlı bir flow A/B testi sunucu tarafında çözümlenir; yedek her zaman tek bir seçilmiş varyant sunar.
- **Uzaktan güncelleme yapılamaz.** Yedeği güncellemek için yeni bir uygulama sürümü gerekir. Remote config aracılığıyla yapacağınız çalışma zamanı güncellemelerini bunun yerine canlı flow üzerinden gönderin.
