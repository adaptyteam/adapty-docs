---
title: "React Native SDK'da kullanıcı niteliklerini ayarlama"
...
E-posta, telefon numarası gibi isteğe bağlı nitelikleri uygulama kullanıcınıza atayabilirsiniz. Bu nitelikleri kullanarak kullanıcı [segmentleri](segments) oluşturabilir ya da bunları CRM'de görüntüleyebilirsiniz.
