---
title: "OneSignal"
description: "Push bildirim tabanlı etkileşimi geliştirmek için OneSignal'ı Adapty ile entegre edin."
...
[OneSignal](https://onesignal.com/), push bildirimler, e-posta, SMS ve uygulama içi mesajlaşma sunan önde gelen bir müşteri etkileşim platformudur. Adapty'yi OneSignal ile entegre etmek, tüm abonelik olaylarınıza tek bir yerden erişmenizi ve bu olaylara dayalı otomatik iletişim tetiklemenizi sağlar.
Adapty ile birden fazla mağazada [abonelik olaylarını](events) takip edebilir, kullanıcı davranışlarını analiz edebilir ve bu verileri daha hedefli iletişim için kullanabilirsiniz. Bu entegrasyon, OneSignal kontrol panelinizde abonelik olaylarını izlemenize ve bunları [edinim kampanyalarınızla](https://documentation.onesignal.com/docs/en/automated-messages) eşleştirmenize yardımcı olur.

Adapty, abonelik olaylarına göre OneSignal tag'lerini güncelleyerek minimum kurulumla kişiselleştirilmiş push bildirimleri göndermenizi sağlar.
...
Tüm cihazlarda kullanıcı tanımlayıcısının tutarlılığını korumak ve bir kullanıcının kimliği değiştiğinde OneSignal'ı güncellemek önemlidir. Bu, kullanıcı etkinliğini ve abonelikleri takip etmeyi kolaylaştırırken tutarlı mesajlaşma sağlar; ayrıca daha doğru analizler ve daha iyi bir kullanıcı deneyimi sunar. Daha fazla ayrıntı için OneSignal'ın [harici kullanıcı kimliği belgelerine](https://documentation.onesignal.com/docs/en/users) bakın.
