...
description: "Kullanıcı etkileşimini ve abonelik trendlerini takip etmek için Adapty'deki analytics kohortlarını kullanın."
metadataTitle: "Analytics Kohortlarını Anlama | Adapty Dokümanları"
---

Adapty kohortları birkaç önemli soruyu yanıtlamak için tasarlanmıştır:

1. Bir kohort hangi günde kâra geçer?
...
Kohortlar, SDK ve mağaza bildirimleri aracılığıyla topladığımız uygulama verileriyle çalışır ve sizin tarafınızdan herhangi bir ek yapılandırma gerektirmez.
