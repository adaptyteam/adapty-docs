...
description: "Gelişmiş müşteri tutma oranı için Flutter uygulamanızda Adapty ile kullanıcı abonelik durumunu takip edin ve yönetin."
metadataTitle: "Abonelik Durumunu Anlama | Adapty Dokümanları"
keywords: ['getProfile']
---

Adapty ile abonelik durumunu takip etmek oldukça kolaydır. Ürün kimliklerini kodunuza manuel olarak eklemenize gerek yoktur. Bunun yerine, aktif bir [access level](access-level) olup olmadığını kontrol ederek kullanıcının abonelik durumunu zahmetsizce doğrulayabilirsiniz.
