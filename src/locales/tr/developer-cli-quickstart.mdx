...
description: "Adapty hesabınızı baştan sona Developer CLI ile kurun — uygulama oluşturmadan canlı placement'a, birkaç komutla."
...
Adapty CLI, uygulama yapılandırmanızı tamamen komut satırından yapmanızı sağlar. Terminal araçlarını veya [MCP istemcilerini](https://github.com/adaptyteam/adapty-cli/tree/main/skills/adapty-cli) tercih ediyorsanız [kontrol paneli hızlı başlangıç kılavuzu](integrate-payments) yerine bunu kullanabilirsiniz.
...
Bu kılavuzun sonunda uygulamanız, access level'ınız, ürününüz, paywall'ınız ve placement'ınız [Adapty Kontrol Paneli](https://app.adapty.io)'nde görünür hale gelecektir.
...
Tüm öğeler artık [Adapty Kontrol Paneli](https://app.adapty.io)'nde görünür durumdadır. Sonraki adımlar:

- [Paywall'ınızı tasarlayın](adapty-paywall-builder) — az önce oluşturduğunuz paywall'a görseller, düzen ve metin eklemek için kodsuz Paywall Builder'ı kullanın.
- [Adapty SDK'yı entegre edin](quickstart-sdk) — placement'ı getirip görüntülemek için SDK'yı uygulamanıza ekleyin.