...
Bu ürünü web üzerinden Stripe veya Paddle aracılığıyla da satıyorsanız, bu ID'leri aynı komuta ekleyin. Ayrıntılar için tam referanstaki [products create](developer-cli-reference#adapty-products-create) bölümüne bakın.
