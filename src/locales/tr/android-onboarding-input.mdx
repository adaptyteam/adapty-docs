...
description: "Adapty SDK ile Android uygulamanızda onboarding verilerini kaydedin ve kullanın."
metadataTitle: "Onboardings | Android SDK | Adapty Dokümanları"
---
:::tip
**SDK v4 (beta) ile başlayarak**, onboarding'lere güçlü bir alternatif olarak [flow'lar](android-get-pb-paywalls) oluşturabilirsiniz. WebView içinde çalışan onboarding'lerin aksine, flow'lar cihazda yerel olarak render edilir; bu sayede daha akıcı animasyonlar, tutarlı bir Android görünümü ve hissi, daha hızlı yükleme süreleri ve WebView bağımlılığı olmaksızın çalışma imkânı sunar. Başlamak için [Flow'ları ve paywallları edinme](android-get-pb-paywalls) ile [Flow'ları ve paywallları gösterme](android-present-paywalls) sayfalarına bakın.
:::
