...
---
:::tip
**SDK v4'ten itibaren**, onboarding'lere daha güçlü bir alternatif olarak [flow'lar](android-get-pb-paywalls) oluşturabilirsiniz. WebView içinde çalışan onboarding'lerin aksine, flow'lar cihazda yerel olarak render edilir; bu sayede daha akıcı animasyonlar, tutarlı bir Android görünümü, daha hızlı yükleme süreleri ve WebView bağımlılığı ortadan kalkar. Başlamak için [Flow'ları ve paywall'ları alma](android-get-pb-paywalls) ile [Flow'ları ve paywall'ları gösterme](android-present-paywalls) sayfalarına göz atın.
:::
