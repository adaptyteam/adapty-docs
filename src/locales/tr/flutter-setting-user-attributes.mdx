---
title: "Flutter SDK'da kullanıcı özelliklerini ayarlama"
...
Uygulamanızın kullanıcısına e-posta, telefon numarası vb. gibi isteğe bağlı özellikler atayabilirsiniz. Bu özellikleri kullanarak kullanıcı [segmentleri](segments) oluşturabilir ya da bunları CRM'de görüntüleyebilirsiniz.
