...
:::important
v4'ten itibaren, Adapty React Native SDK artık yerel bağımlılıklarının CocoaPods ile kurulumunu desteklememektedir. v4 veya sonrasına ihtiyaç duyuyorsanız ([Flow & Paywall Builder](adapty-flow-builder) için), bunun yerine aşağıdaki [Adapty SDK 4.0: Swift Package Manager'ı etkinleştir](#adapty-sdk-40-enable-swift-package-manager) bölümünü izleyin.
:::
...
React Native SDK 4.0 — [flow](adapty-flow-builder) desteği ekleyen bu sürüm — **React Native 0.75 veya üzerini** gerektirir. SDK'yı yükleyin:
