...
| `--ios-product-id` | En az bir platform gereklidir | App Store Connect'teki ürün ID'si |
| `--android-product-id` | En az bir platform gereklidir | Google Play Console'daki ürün ID'si |
| `--android-base-plan-id` | `--period lifetime` belirtilmediği sürece `--android-product-id` ile birlikte zorunludur | Google Play Console'daki base plan ID'si |
