...
description: "Uygulama, ürün, paywall ve placement yapılandıran Adapty Geliştirici CLI komutları için referans."
metadataTitle: "Geliştirici CLI Komut Referansı | Adapty Dokümanları"
keywords: ['cli', 'developer', 'reference', 'commands', 'mcp']
---

Bu makale, hesabınızı yapılandıran Adapty CLI komutlarını listeler — uygulamalar, access level'lar, ürünler, paywalllar, placementlar ve segmentler — argümanları, bayrakları ve kabul edilen değerleriyle birlikte. Apple Ads kampanyaları için [Ads Manager komutları](developer-cli-ads-manager-reference) bölümüne bakın.
...
Segment bazlı yönlendirmeyi kaybetmeden bir paywallı birden fazla placement'ta değiştirmek için:
...
4. Değiştirilen payload'ı geri yazın:
