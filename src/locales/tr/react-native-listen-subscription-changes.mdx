...
description: "Müşteri tutulumunu artırmak için React Native uygulamanızda Adapty ile kullanıcı abonelik durumunu takip edin ve yönetin."
metadataTitle: "Abonelik Durumunu Anlama | Adapty Dokümanları"
keywords: ['getProfile']
---

Adapty ile abonelik durumunu takip etmek oldukça kolaydır. Ürün ID'lerini kodunuza manuel olarak eklemenize gerek yoktur. Bunun yerine, aktif bir [access level](access-level) olup olmadığını kontrol ederek kullanıcının abonelik durumunu zahmetsizce doğrulayabilirsiniz.
