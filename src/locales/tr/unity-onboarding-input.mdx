...
:::note
SDK 4.1'de listener arayüzleri C# I-öneki kuralını takip eder: `AdaptyOnboardingsEventsListener` yerine `IAdaptyOnboardingsEventsListener` kullanın. Metodlar değişmemiştir. [Geçiş rehberine](migration-to-unity-sdk-v4) bakın.
:::
