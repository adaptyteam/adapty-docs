...
| Parametre | Açıklama                                                                                                                                                  |
| :-------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Paywall   | Şu özelliklere sahip bir [`AdaptyPaywall`](https://pub.dev/documentation/adapty_flutter/3.17.2/adapty_flutter/AdaptyPaywall-class.html) nesnesi: ürün kimliklerinin listesi, paywall tanımlayıcısı, remote config ve diğer çeşitli özellikler. |
