...
:::info
SDK v.3.17'den itibaren Adapty SDK, varsayılan olarak Google Play Billing Library v.8.0.0 kullanmaktadır.
:::
...
iOS için Capacitor uygulamanızı derlerken Adapty pod hedeflerinde Swift 6 derleme hataları görebilirsiniz. Tipik belirtiler şunlardır: `AdaptyUIBuilderLogic` içinde `@Sendable` uyumsuzlukları, Adapty türlerinde eksik `Sendable` uyumu veya actor izolasyon hataları.
