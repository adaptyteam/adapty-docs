---
title: "Android - Yedek paywall'ları kullanma"
description: "Kullanıcıların çevrimdışı olduğu veya Adapty sunucularının kullanılamadığı durumları yönetin."
metadataTitle: "Android'de Yedek Flow'ları Kullanma | Adapty Dokümanları"
---

import FallbackPaywallIntroduction from '@site/src/locales/tr/reusable/FallbackPaywallIntroduction.mdx';

:::warning
Yedek paywall'lar Android SDK v2.11 ve sonraki sürümlerde desteklenmektedir.
:::
