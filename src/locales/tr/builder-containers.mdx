...
<ZoomImage id="flow-builder/alignment-distribution-demo.webp" width="400px" alt="Tuval üzerindeki bir Stack ve Layout ayarları" float="right"/>
...
### Sarmalama ve sarmalamayı kaldırma \{#wrap-and-unwrap\}

Mevcut bir öğeyi konteynere dönüştürmek için öğeyi seçin ve **Wrap** [katman eylemini](paywall-layout-and-products#layer-actions) kullanın. Ek öğeleri **Layers** panelinden yeni konteynere sürükleyin. Bir stack'i kaldırıp alt öğelerini bir üst seviyeye taşımak için **Unwrap** seçeneğini kullanın.
## Carousel
