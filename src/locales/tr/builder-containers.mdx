---
title: "Düzen ögeleri: container'lar, carousel'lar, bottom sheet'ler"
description: "Flow Builder'da ögeleri container'lar, carousel'lar ve bottom sheet'ler halinde gruplandırın."
metadataTitle: "Düzen ögeleri: container'lar, carousel'lar, bottom sheet'ler | Flow Builder | Adapty Dokümanları"
---

Düzen ögeleri, diğer ögeleri bir araya getirir ve ekranda nasıl yerleşeceğini kontrol eder.

Flow Builder beş tür düzen ögesi içerir:
- **Containers**: çocuk öğeleri bir eksen boyunca — dikey veya yatay olarak — düzenler
- **Carousel**: bir seferde tek slayt gösteren, kaydırılabilir bir container
- **Bottom Sheet**: ekranın altından yukarı kayan ve içeriğin üzerinde görüntülenen bir panel
...
**Footer**, ekranın alt kısmını kaplayan sabit bir kapsayıcıdır. İstediğiniz yükseklikte olabilir ve tek bir düğmeden birden fazla metin satırına kadar her şeyi içerebilir. Ekranın geri kalanı kaydırılırken yerinde kalması gereken içerikler için footer'ı kullanın: CTA düğmeleri, yasal metinler, bağlantılar.

Normal öğelerin aksine, footer cihazın alt güvenli alanına kadar uzanır: arka planı ekranın alt kenarına kadar devam eder.
Ekran başına yalnızca bir alt bilgi (footer) kullanılabilir. Mevcut bir alt bilgiyi kopyalayamazsınız veya yeni bir tane ekleyemezsiniz.
### Alt Bilgi (Footer) ve Sabit Element Karşılaştırması \{#footer-vs-a-regular-fixed-element\}

Her ikisi de içerik kaydırılırken ekranda kalır. İhtiyacınıza uyan seçeneği tercih edin:
- **Alt çubuk için Footer kullanın** (CTA düğmesi, yasal metin, bağlantılar). Footer kendi yüksekliğini ayırır, böylece içerik her zaman onun altına kayar ve arkasına gizlenmez; alt güvenli alanı da otomatik olarak kapsar.
- **Kaydırılan içeriğin üzerinde yüzen veya alt kenar dışında bir kenara sabitlenen öğeler için [sabit eleman](manage-paywall-ui-elements) kullanın** — örneğin yüzen bir kapat/geri yükle düğmesi, kalıcı bir üst banner veya yukarı kaydır kontrolü. Güvenli alan boşluğunu kendiniz yönetirsiniz.
## Bölücüler \{#dividers\}
