---
title: "Düzen öğeleri: container'lar, carousel'ler, bottom sheet'ler"
description: "Öğeleri Flow & Paywall Builder'da container'lar, carousel'ler ve bottom sheet'ler içinde gruplayın."
metadataTitle: "Container'lar, carousel'ler, bottom sheet'ler | Flow'lar & paywall'lar | Adapty Dokümanları"
---

Düzen öğeleri, diğer öğeleri bir arada gruplar ve ekrandaki yerleşimlerini kontrol eder.

Flow & Paywall Builder beş farklı düzen öğesi türü içerir:

- **Containers (Kapsayıcılar)**: alt öğeleri bir eksen boyunca — dikey veya yatay olarak — düzenler
- **Carousel (Döngü)**: bir seferde tek bir slayt gösteren kaydırılabilir kapsayıcı
- **Bottom Sheet (Alt Sayfa)**: ekranın altından yukarı kayan ve alttaki içeriğin üzerinde görüntülenen panel
- **Footer (Alt Bilgi)**: ekranın altına sabitlenmiş, kaydırma alanının dışında kalan panel
- **Dividers (Ayırıcılar)**: satırları veya sütunları birbirinden ayıran ince çizgiler

:::link
**Tabs** da bu kategoriye girer, ancak ayrı bir makalede ele alınmaktadır. Ayrıntılar için [Tabs](builder-tabs) sayfasına bakın.
:::
