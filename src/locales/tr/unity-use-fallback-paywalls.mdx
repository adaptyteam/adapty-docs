---
title: "Unity - Yedek paywall'ları kullanın"
description: "Kullanıcılar çevrimdışı olduğunda veya Adapty sunucularına erişilemediğinde durumu yönetin"
metadataTitle: "Yedek flow'lar ve paywall'lar | Unity SDK | Adapty Dokümanları"
