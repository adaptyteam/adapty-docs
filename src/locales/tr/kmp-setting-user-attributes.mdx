---
title: "Kotlin Multiplatform SDK'da kullanıcı nitelikleri ayarlama"
description: "Daha iyi kitle segmentasyonu için Adapty'de kullanıcı niteliklerini nasıl ayarlayacağınızı öğrenin."
metadataTitle: "Kullanıcı Nitelikleri Ayarlama | Adapty Dokümanları"
keywords: ["updateProfile", "update profile", "kullanıcı nitelikleri"]
---
