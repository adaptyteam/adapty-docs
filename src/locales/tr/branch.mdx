...
2. Attribution verilerini kaydetmek için `.updateAttribution()` metodunu kullanın. Önceki adımda Branch kullanıcı kimliğini belirtmediyseniz, burada `networkUserId` parametresine girin.
...
```swift showLineNumbers
  class YourBranchImplementation {
      func initializeBranch() {
          // Branch iOS SDK'nın başlatma metodundan aldığınız attribution'ı Adapty'ye iletin.
