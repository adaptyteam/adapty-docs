...
Builder ile yapılandırılan onboardinglar, uygulamanızın yanıt verebileceği olaylar oluşturur. Bu olayları nasıl yöneteceğiniz, hangi sunum yaklaşımını kullandığınıza bağlıdır:
...
1. [Adapty Flutter SDK](sdk-installation-flutter) 3.8.0 veya daha yeni bir sürümünü yüklemiş olmalısınız.
