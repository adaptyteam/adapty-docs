...
Builder ile yapılandırılan onboardinglar, uygulamanızın yanıt verebileceği olaylar üretir. Bu olayları nasıl yöneteceğiniz, kullandığınız sunum yaklaşımına bağlıdır:
- **Tam ekran sunum**: Tüm onboarding görünümleri için olayları işleyen global bir olay gözlemcisi kurulumunu gerektirir
...
1. [Adapty Flutter SDK](sdk-installation-flutter) 3.8.0 veya üzerini yüklediğinizden.
2. Bir [onboarding oluşturduğunuzdan](create-onboarding).
3. Onboarding'i bir [placement](placements)'a eklediğinizden.
