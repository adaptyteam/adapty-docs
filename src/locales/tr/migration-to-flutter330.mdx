---
title: "Adapty Flutter SDK'yı v3.3'e Geçirme"
description: "Daha iyi performans ve yeni monetizasyon özellikleri için Adapty Flutter SDK v3.3'e geçiş yapın."
metadataTitle: "Adapty Flutter SDK v3.3'e Geçiş | Adapty Dokümanları"
---

Adapty SDK 3.3.0, bazı iyileştirmeler içeren önemli bir sürümdür; ancak bu iyileştirmeler sizin tarafınızdan bazı geçiş adımları gerektirebilir.
