...
---
:::tip
**SDK v4'ten (beta) itibaren**, onboarding'lere daha güçlü bir alternatif olarak [flow'lar](android-get-pb-paywalls) oluşturabilirsiniz. WebView içinde çalışan onboarding'lerin aksine, flow'lar cihazda nativ olarak render edilir; bu sayede daha akıcı animasyonlar, tutarlı bir Android görünümü, daha hızlı yükleme süreleri ve WebView runtime bağımlılığı ortadan kalkar. Başlamak için [Flow'ları ve paywall'ları alma](android-get-pb-paywalls) ve [Flow'ları ve paywall'ları görüntüleme](android-present-paywalls) sayfalarına bakın.
:::
