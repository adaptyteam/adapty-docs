...
Adapty, kullanıcıları platformlar arası tanımlamak için `customer_user_id` kullanır.

Bu ID'yi bir kez oluşturmanız ve hem mobil SDK'nıza hem de web arka ucunuza iletmeniz gerekir.
