...
Sabit konumlandırma, Absolute ile aynı kontrolleri kullanır (ofsetler, anchor grid, Z-index). Tüm ofsetler, üst öğeye değil ekranın güvenli alanına göre hesaplanır. Örneğin, alttan 0 ofset, öğeyi home indicator'ın üzerinde tutar. Ofsetleri fiziksel ekran kenarlarından ölçmek için [Güvenli alanı yoksay](#ignore-safe-area) seçeneğini etkinleştirin.

Alt kısımdaki yapışkan butonlar, kayan gezinme çubukları ve kalıcı başlıklar için sabit konumlandırmayı kullanın.
