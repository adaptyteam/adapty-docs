...
Attribution sözlüğünü `updateAttribution` metoduna aktarın. Attribution değerini bir kez ayarladıktan sonra, üzerine yazamazsınız:
   ...
   **Parametreler:**
   ...
   - `source` (zorunlu): attribution kaynağı. Attribution sağlayıcınız [entegre attribution](#integrated-attribution)'ı desteklemiyorsa `.custom` olarak ayarlayın.
