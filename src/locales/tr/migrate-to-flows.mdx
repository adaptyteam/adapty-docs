...
Bu kılavuz, flow'lara geçişte nelerin değiştiğini ve eski uygulama sürümlerindeki kullanıcıları etkilemeden bu geçişi nasıl yapacağınızı açıklar.

:::important
Flow'lar şu anda iOS, Android, React Native, Flutter ve Capacitor SDK v4 ve üzeri sürümlerde desteklenmektedir. Diğer platformlar ve framework'ler için destek yakında eklenecektir.
:::
<div style={{
    maxWidth: '560px',
    margin: '0 auto 2rem',
