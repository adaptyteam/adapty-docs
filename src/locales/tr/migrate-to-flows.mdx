...
Bu kılavuz, flow'lara geçtiğinizde nelerin değiştiğini ve bu değişikliği eski uygulama sürümlerindeki kullanıcıları etkilemeden nasıl yayına alabileceğinizi açıklar.

:::important
Flow'lar şu anda iOS SDK v4 ve üzeri, Android SDK v4 ve üzeri ve React Native SDK v4 ve üzeri sürümlerinde desteklenmektedir. Diğer platform ve framework'ler için destek yakında eklenecektir.
:::
<div style={{
    maxWidth: '560px',
    margin: '0 auto 2rem',
...
1. **[Flow'unuzu oluşturun](#build-your-flow)**: No-code editörde bir flow oluşturun; geliştirici gerekmez.
...
4. **[SDK'yı güncelleyin](#update-the-sdk)**: iOS, Android veya React Native SDK v4'e geçin, flow'u kendi placement'ından çekin ve sandbox satın almasını doğrulayın. Bu, asıl geliştirici görevidir.
...
Flow placement'ınız hazır olduğunda, uygulamayı ona yönlendirin. Flow'lar yalnızca Adapty SDK v4 ve sonrasında render edilir. SDK'yı yükseltin ve `getFlow` ile yeni placement'ınızdan flow'u çekin. Platforma özgü yükseltme adımları için v4 migration kılavuzuna bakın — [iOS](migration-to-ios-sdk-v4), [Android](migration-to-android-sdk-v4) veya [React Native](migration-to-react-native-sdk-v4).
