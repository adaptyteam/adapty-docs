...
description: "iOS, Android ve platformlar arası uygulamalar için Adapty SDK'larını yükleyin."
metadataTitle: "Adapty SDK'larını Yükleme | Adapty Dokümanları"
keywords: ['activate']
---

Tercihlerinize bağlı olarak başlamak için üç yol var:
