---
title: "Adapty React Native SDK'yı v3.14'e Taşıyın"
...
Adapty React Native SDK 3.14.0, sizin tarafınızda geçiş adımları gerektiren iyileştirmeler sunan büyük bir sürümdür:
- `registerEventHandlers` metodu, `setEventHandlers` metoduyla değiştirildi.
- `AdaptyOnboardingView` bileşeninde, event handler'lar artık bir `eventHandlers` nesnesi yerine ayrı prop'lar olarak aktarılıyor.
- UI bileşenleri için yeni, basitleştirilmiş bir import stili getirildi.
