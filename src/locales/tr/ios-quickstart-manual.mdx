...
:::important
**Bu kılavuz, özel paywall'lar uygulayan geliştiriciler içindir.** Satın alma işlemlerini etkinleştirmenin en kolay yolunu arıyorsanız, [Adapty Flow & Paywall Builder](ios-quickstart-paywalls)'ı kullanın. Flow & Paywall Builder ile flow'ları kodsuz görsel bir düzenleyicide oluşturursunuz, Adapty tüm satın alma mantığını otomatik olarak yönetir ve uygulamanızı yeniden yayınlamadan farklı tasarımları test edebilirsiniz.
:::
