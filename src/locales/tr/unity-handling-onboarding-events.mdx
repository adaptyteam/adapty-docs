...
:::note
SDK 4.1'de, listener arayüzleri C# I-prefix kuralını takip eder: `AdaptyOnboardingsEventsListener` yerine `IAdaptyOnboardingsEventsListener` uygulayın. Metodlar değişmemiştir. [Geçiş kılavuzuna](migration-to-unity-sdk-v4) bakın.
:::
