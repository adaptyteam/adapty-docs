...
Bir tahmin, bu üç kriterin en az ikisi karşılandığında güvenilir sayılır.

Yeni bir A/B testi başladığında, model her paywall için 1k başına yıllık gelir tahmini (ana A/B testi metriğimiz) sağlar. Tahminler yalnızca kesinlik kriterlerini karşıladıklarında görüntülenir. Veriler yetersizse model "tahmin için yetersiz veri" ibaresini gösterir.
