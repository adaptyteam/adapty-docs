...
La méthode ne sera pas invoquée en mode Observer. Consultez la rubrique [Android - Présenter les paywalls Paywall Builder en mode Observer](android-present-paywall-builder-paywalls-in-observer-mode) pour plus de détails.
