...
:::important
Ce guide couvre la gestion des événements pour les achats, les restaurations, la sélection de produits et le rendu des flows. Vous devez également implémenter la gestion des boutons (fermeture du flow, ouverture des liens, etc.). Consultez notre [guide sur la gestion des actions de bouton](android-handle-paywall-actions) pour plus de détails.
:::
...
Consultez [Suivre les vues d'écran de flow](android-flow-screen-views) pour savoir quoi en faire.
