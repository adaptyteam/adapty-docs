...
Le SDK Adapty prend en charge iOS 13.0+, mais nécessite iOS 15.0+ pour utiliser les paywalls créés dans le Paywall Builder. Adapty SDK 4.1 — qui ajoute la prise en charge des [flows](adapty-flow-builder) — requiert **iOS 15.0+** pour l'ensemble de l'application : un validateur de build dans Unity Editor arrête le build iOS si la cible de déploiement est inférieure.
