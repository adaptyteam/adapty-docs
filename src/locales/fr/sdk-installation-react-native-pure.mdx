...
| Prérequis | Version |
|---|---|
| React Native | 0.75 ou version ultérieure. L'[intégration SPM de React Native](https://reactnative.dev/blog/2026/08/11/react-native-0.87#experimental-swift-package-manager-support-for-ios) nécessite 0.87 ou version ultérieure. |
| iOS | 15.0 ou version ultérieure |
| Swift | 6.2 ou version ultérieure, inclus avec Xcode 26 |

:::info
À partir de la version 3.17.0, le SDK Adapty React Native utilise Billing Library v8 par défaut. Les versions 3.15.0 à 3.15.6 utilisent la v7, et fonctionnent également lorsqu'une autre dépendance de votre build Android élève la Billing Library à la v8.
