...
Le SDK React Native d'Adapty nécessite iOS 15.0+.

La compilation pour iOS requiert **Swift 6.0** ou une version ultérieure. Le [mode Enfants](kids-mode-react-native) nécessite **Swift 6.1** ou une version ultérieure.
