...
| Prérequis | Version |
|---|---|
| React Native | 0.75 ou ultérieur. L'[intégration SPM de React Native](https://reactnative.dev/blog/2026/08/11/react-native-0.87#experimental-swift-package-manager-support-for-ios) nécessite 0.87 ou ultérieur. |
| iOS | 15.0 ou ultérieur |
| Swift | 6.2 ou ultérieur, inclus avec Xcode 26 |
| Google Play Billing Library | v8 à partir du SDK Adapty React Native 4.0.3 |
