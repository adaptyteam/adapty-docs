...
- [Gérer Apple Ads avec un outil de codage IA](developer-cli-ads-manager-skill) — installez la compétence `ads-manager` pour que Claude Code, Copilot CLI, Codex ou Gemini CLI puissent exécuter ces commandes à votre place.
