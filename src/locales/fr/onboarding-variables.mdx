...
Les variables d'élément capturent les choix de l'utilisateur — ce qu'il a sélectionné dans les quiz, l'onglet sur lequel il se trouve et si le bouton de bascule d'essai est activé.
...
- **Toggle** : Bouton de bascule d'essai :
