...
Version minimale du SDK requise : `minSdkVersion 21`

<InstallationPrereqs />

## Dépendances \{#dependencies\}

Le SDK Adapty fonctionne avec ces versions de la Google Play Billing Library :

| Version du SDK Adapty | Version de la Billing Library |
|---|---|
| 4.0.2 et ultérieure | v8 |
| 4.0.0–4.0.1 | v7 par défaut, v8 si une autre dépendance l'élève |
| 3.17.3 et ultérieure sur la branche 3.x | v8 |
| 3.15.0–3.17.2 | v7 par défaut, v8 si une autre dépendance l'élève |
