...
:::info
À partir de la version 3.17.3 sur la branche 3.x et de la version 4.0.2 sur la branche 4.x, le SDK Adapty Android utilise Billing Library v8 par défaut. Les versions 3.15.0 à 3.17.2 et 4.0.0 à 4.0.1 utilisent la v7, et fonctionnent également lorsqu'une autre dépendance dans votre build fait passer la Billing Library à la v8.
