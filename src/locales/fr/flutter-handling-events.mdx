...
Un flow rapporte également les valeurs saisies et sélectionnées par les utilisateurs. Consultez [Traiter les données des flows](flutter-flow-input) pour les lire.
...
Ce guide ne couvre que les **paywalls créés dans l'ancien builder**, qui nécessitent le SDK Adapty v3.0 ou une version ultérieure.
