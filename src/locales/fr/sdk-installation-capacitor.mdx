...
Construire pour iOS avec le SDK Adapty v4 (bêta) nécessite **Xcode 26** ou une version ultérieure — le SDK iOS natif qu'il utilise est compilé avec Swift tools 6.2. Les exigences iOS 15.0+, Capacitor 8 et Android minSdk 24 sont les mêmes que pour le SDK 3.16+.
