...
La compilation pour iOS requiert **Xcode 26** ou une version ultérieure — le SDK iOS natif est construit avec Swift tools 6.2. Sur Android, le SDK minimum est 24.

:::info
Le SDK Capacitor d'Adapty fonctionne avec Google Play Billing Library v8.
