...
La construction pour iOS avec le SDK Adapty v4 (bêta) nécessite **Xcode 26** ou version ultérieure — le SDK iOS natif qu'il utilise est compilé avec Swift tools 6.2. Les prérequis iOS 15.0+, Capacitor 8 et Android minSdk 24 sont identiques à ceux du SDK 3.16+.

:::info
Le SDK Adapty Capacitor 4.0.2 et versions ultérieures fonctionne avec Google Play Billing Library v8.
