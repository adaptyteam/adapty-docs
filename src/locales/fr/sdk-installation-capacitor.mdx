...
Pour iOS, vous aurez besoin de **Xcode 26** ou version ultérieure — le SDK iOS natif est compilé avec Swift tools 6.2. Sur Android, le SDK minimum requis est 24.

:::info
À partir de la version 3.17.0, le SDK Adapty Capacitor utilise Billing Library v8 par défaut. Les versions 3.15.0 à 3.16.3 utilisent la v7, et fonctionnent également lorsqu'une autre dépendance dans votre build Android fait passer la Billing Library à la v8.
