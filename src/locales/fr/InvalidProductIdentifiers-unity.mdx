---
title: "Correction de l'erreur Code-1000 noProductIDsFound dans le SDK Unity"
...
1. Rendez-vous dans **App Store Connect** et accédez à [**Monétisation** → **Abonnements**](https://appstoreconnect.apple.com/apps/6477523342/distribution/subscriptions) dans le menu de gauche.
