...
Avant de présenter les Remote Configs et les paywalls personnalisés, vous devez récupérer les informations les concernant. Notez que cette rubrique traite des Remote Configs et des paywalls personnalisés. Pour savoir comment récupérer des flows et des paywalls personnalisés avec le Paywall Builder, consultez [Récupérer les flows et paywalls](flutter-get-pb-paywalls).
