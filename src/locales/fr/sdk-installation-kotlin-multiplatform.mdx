...
Le SDK Kotlin Multiplatform d'Adapty est compatible avec Xcode 16.2 et versions ultérieures.
...
| 3.15.0–3.16.2 | v7 par défaut, v8 si une autre dépendance la fait monter |
