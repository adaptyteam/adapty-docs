...
:::info
À partir de la version 3.17.0, le SDK Adapty Kotlin Multiplatform utilise Billing Library v8 par défaut. Les versions 3.15.0 à 3.16.2 utilisent la v7, et fonctionnent également lorsqu'une autre dépendance dans votre build Android élève la Billing Library à la v8.

La compatibilité avec une version de Billing Library ne signifie pas qu'Adapty prend en charge toutes les fonctionnalités introduites par Google dans celle-ci. Avant d'adopter une nouvelle fonctionnalité de facturation Google Play, consultez [Produit dans le Play Store](android-products).
:::
