...
Avant de présenter les Remote Configs et les paywalls personnalisés, vous devez récupérer les informations les concernant. Notez que cette rubrique concerne les Remote Configs et les paywalls personnalisés. Pour obtenir des instructions sur la récupération des flows ou des paywalls personnalisés dans le **Flow & Paywall Builder** ou l'**old Paywall Builder**, consultez [Obtenir des flows & paywalls](kmp-get-pb-paywalls).
