...
description: "Découvrez comment récupérer des onboardings dans Adapty pour Unity."
...
Après [avoir conçu la partie visuelle de votre onboarding](design-onboarding) avec le builder dans l'Adapty Dashboard, vous pouvez l'afficher dans votre application Unity. La première étape de ce processus consiste à récupérer l'onboarding associé au placement et sa configuration de vue, comme décrit ci-dessous.

Avant de commencer, assurez-vous que :

1. Vous avez installé le [SDK Unity Adapty](sdk-installation-unity) version 3.14.0 ou supérieure.
