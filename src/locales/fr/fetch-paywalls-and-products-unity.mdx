...
Avant de présenter le Remote Config et les paywalls personnalisés, vous devez récupérer les informations les concernant. Notez que cette rubrique concerne le Remote Config et les paywalls personnalisés. Pour récupérer des flows ou des paywalls personnalisés dans le **Flow & Paywall Builder** ou l'**old Paywall Builder**, consultez [Obtenir des flows et des paywalls](unity-get-pb-paywalls).
