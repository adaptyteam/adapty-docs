...
:::note
`country` et `store_country` utilisent un code [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) à deux lettres — `US`, pas `USA` ni `United States`. Toute autre valeur est rejetée.
:::
