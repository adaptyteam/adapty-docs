...
Les entrées et les groupes sélectionnables transmettent automatiquement leurs valeurs. Pour les distinguer dans votre code, attribuez à chaque entrée un **Element ID** et à chaque groupe sélectionnable un **Group ID** dans le builder.
