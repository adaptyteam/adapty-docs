...
- **Transaction ID** : l'identifiant de transaction du store associé à un achat.

La recherche porte sur la valeur exacte : les correspondances partielles ne fonctionnent pas, et les espaces superflus font échouer la recherche — collez l'identifiant complet sans espaces supplémentaires. L'identifiant utilisateur, l'adresse e-mail et l'identifiant de transaction sont également sensibles à la casse.
