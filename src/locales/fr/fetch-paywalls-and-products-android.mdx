...
Avant de présenter les Remote Config et les paywalls personnalisées, vous devez récupérer les informations les concernant. Notez que cette rubrique concerne les Remote Config et les paywalls personnalisées. Pour obtenir des conseils sur la récupération des flows ou des paywalls personnalisées dans le **Flow Builder** ou le **Paywall Builder**, consultez [Obtenir des flows et des paywalls](android-get-pb-paywalls).
