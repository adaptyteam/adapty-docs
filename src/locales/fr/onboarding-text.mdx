---
title: "Ajouter et styliser du texte et des listes dans le Flow & Paywall Builder"
description: "Ajoutez et stylisez des titres, sous-titres, paragraphes et listes dans le Flow & Paywall Builder d'Adapty, et personnalisez le texte pour des expériences utilisateur conformes à votre marque."
metadataTitle: "Texte | Flows & paywalls | Documentation Adapty"
---

Ajoutez des titres, des paragraphes ou des listes en un seul clic, stylisez-les aux couleurs de votre marque, et utilisez des [variables dynamiques](onboarding-variables) pour personnaliser le contenu pour chaque utilisateur.
...
3. Définissez la destination pour l'action [**Open URL**](onboarding-actions#open-url).
    ...
    :::important
    Une action Open URL vide [empêche la prévisualisation et la publication](flow-common-issues#a-flow-wont-preview-or-publish).
    :::
...
:::tip
Pour modifier le texte conditionnel dans une autre langue, changez la locale active en bas de l'éditeur. Ajoutez d'abord les langues dans le panneau **Localizations** — consultez [Ajouter une locale dans Flow & Paywall Builder](add-paywall-locale-in-adapty-paywall-builder).
:::
