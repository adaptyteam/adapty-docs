---
title: "Afficher les flows & paywalls - React Native"
description: "Présentez les flows et paywalls à vos utilisateurs dans votre application React Native avec Adapty."
metadataTitle: "Afficher les flows & paywalls en React Native | Documentation Adapty"
...
Si vous avez créé un flow ou un paywall dans l'ancien Paywall Builder, vous n'avez pas à vous soucier de son rendu dans le code de votre application mobile pour l'afficher à l'utilisateur. Un tel flow contient à la fois ce qui doit être affiché et comment cela doit être affiché.

Avant de commencer, assurez-vous que :

1. Vous avez créé un [flow](paywall-builder-templates) ou un [paywall](create-paywall).
...
Ce guide s'applique uniquement aux **flows et paywalls rendus par Adapty**, qui nécessitent le SDK v4.0 ou une version ultérieure. La procédure de présentation des flows diffère pour les paywalls en Remote Config.
...
Le SDK React Native d'Adapty propose deux façons de présenter les flows et paywalls :

- **Composant React** : un composant intégré que vous pouvez incorporer dans l'architecture et le système de navigation de votre application.
...
Ce guide couvre uniquement les paywalls créés dans l'ancien Paywall Builder pour **Adapty SDK 3.x**. Ils nécessitent SDK v3.0 ou une version ultérieure. La présentation d'un paywall créé pour SDK 2.x ou une version antérieure, ou d'un paywall Remote Config, fonctionne différemment.
...
Le SDK Adapty React Native offre deux façons de présenter les paywalls :

- **Composant React** : un composant intégrable qui vous permet de l'incorporer dans l'architecture et le système de navigation de votre application.
