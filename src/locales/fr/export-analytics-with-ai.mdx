...
- **Sauvegardez des prompts réutilisables ou créez un skill personnalisée** : Gardez vos questions courantes comme prompts enregistrés, ou encapsulez-les dans un skill personnalisée ou une commande slash pour que votre agent génère un rapport à la demande.
