---
title: "Migrer le SDK Adapty Unity vers la v4.0"
description: "Migrez vers le SDK Adapty Unity v4.0 (beta) en remplaçant les API paywall par des API flow, compatibles avec le Flow Builder et le Paywall Builder."
metadataTitle: "Migration vers le SDK Adapty Unity v4.0 (beta) | Documentation Adapty"
---

Le SDK Adapty Unity 4.0 (beta) introduit les flows et renomme les API paywall en conséquence. Les nouvelles API fonctionnent à la fois avec le nouveau Flow Builder et le Paywall Builder existant — aucune modification de configuration n'est requise côté Adapty Dashboard.
