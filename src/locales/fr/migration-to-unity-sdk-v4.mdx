...
:::note
`CustomTimers` existe toujours, mais il n'affecte que les paywalls créés avec le Paywall Builder hérité. Le [minuteur de compte à rebours](flow-timer) d'un flow fonctionne selon le comportement défini dans le Flow Builder, donc un flow ignore ce que vous passez ici.
:::
