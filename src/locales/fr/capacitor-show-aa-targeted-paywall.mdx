...
description: "Affichez un paywall immédiatement et mettez-le à jour pour les utilisateurs Apple Ads une fois l'attribution appliquée dans Capacitor, en utilisant AdaptyProfile.appliedExternalAttributionProviders."
