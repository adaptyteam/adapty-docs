...
Les exigences d'exécution sont inchangées depuis v3.16+ : **iOS 15.0**, **Android minSdk 24** et **Capacitor 8**. Aucune modification de la cible de déploiement n'est nécessaire.

Il y a une nouvelle exigence de build : **Xcode 26 ou version ultérieure** — le SDK iOS natif Adapty 4.0.0-beta.2 inclus dans cette version utilise Swift tools 6.2.

v4 intègre les SDK natifs Adapty iOS 4.0.0-beta.2 et Android BOM 4.0.0-beta.1.
