...
Les GIF et WEBP animés ne sont pas pris en charge. Pour ajouter du mouvement, utilisez plutôt un élément [Vidéo](#video).

:::tip
Pour placer votre contenu sur une image plein écran, [créez une image hero](paywall-head-picture#use-a-background-as-a-hero-image) à partir d'un fond d'écran et d'une feuille coulissante.
:::
