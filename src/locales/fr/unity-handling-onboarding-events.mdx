...
:::note
Dans le SDK 4.1, les interfaces de listener suivent la convention C# avec le préfixe I : implémentez `IAdaptyOnboardingsEventsListener` à la place de `AdaptyOnboardingsEventsListener`. Les méthodes restent identiques. Consultez le [guide de migration](migration-to-unity-sdk-v4).
:::
