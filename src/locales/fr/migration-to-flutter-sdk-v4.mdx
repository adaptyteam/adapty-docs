...
description: "Migrez vers Adapty Flutter SDK v4.0 en remplaçant les API paywall par des API flow, qui affichent les flows en plus des paywalls de l'ancien builder."
metadataTitle: "Migration vers Adapty Flutter SDK v4.0 | Documentation Adapty"
---

Adapty Flutter SDK 4.0 introduit les flows et renomme les API paywall en conséquence. Les nouvelles API fonctionnent avec les flows et restent compatibles avec les paywalls de l'ancien builder — aucune modification de configuration n'est requise côté Adapty Dashboard.
