...
:::info
Nous recommandons de tester les achats intégrés sur un appareil réel. Même si les achats en sandbox peuvent fonctionner sur des simulateurs, les appareils réels sont nécessaires pour tester tous les flows complets, notamment les boîtes de dialogue de paiement et les invites biométriques.
:::

Vous avez deux façons principales de tester les achats intégrés :

- **Compiler avec Xcode et exécuter sur un appareil de test** : Pratique pour les développeurs et les ingénieurs QA.
