---
title: "Éléments de mise en page : conteneurs, carrousels, feuilles basses"
description: "Regroupez des éléments dans des conteneurs, des carrousels et des feuilles basses dans le Paywall Builder et le Flow Builder."
metadataTitle: "Conteneurs, carrousels, feuilles basses | Flows & paywalls | Documentation Adapty"
---
...
:::link
**Les onglets** font également partie de cette catégorie, mais sont traités dans un article séparé. Consultez [Onglets](builder-tabs) pour plus de détails.
:::
...
### Modifier la direction du conteneur \{#change-container-direction\}
...
La direction d'un conteneur n'est pas figée. Vous pouvez à tout moment basculer entre **Vertical**, **Horizontal** et **Free** dans la section **Layout** du panneau de droite. Passer en mode **Free** convertit automatiquement chaque enfant en position [**Absolute**](manage-paywall-ui-elements#position-in-a-free-container).
...
## Feuille glissante \{#sliding-sheet\}
...
Une **feuille glissante** affiche votre contenu principal par-dessus une image hero. Le panneau recouvre la partie inférieure de l'écran et remonte sur le [fond de l'écran](paywall-head-picture#use-a-background-as-a-hero-image) lorsque l'utilisateur fait défiler. Le fond se déplace sur iOS et reste fixe sur les autres plateformes. Ce comportement ne peut pas être modifié.
...
:::tip
Vous pouvez placer un [pied de page](#footer) à l'intérieur de la feuille. Le pied de page se fixe alors au bas de la feuille plutôt qu'au bas de l'écran.
:::

### Feuille glissante vs. Feuille du bas \{#sliding-sheet-vs-bottom-sheet\}
...
- **Utilisez une [Feuille du bas](#bottom-sheet)** pour du contenu qui apparaît à la demande, comme une liste de plans accessible via un lien **Show all plans**. Vous l'affichez avec une action **Show**.
