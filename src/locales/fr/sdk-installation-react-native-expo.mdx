...
:::important
Le SDK Adapty React Native v4 et versions ultérieures embarquent leurs SDK iOS natifs (`Adapty`, `AdaptyUI`, `AdaptyPlugin`) sous forme de packages Swift. CocoaPods les installe toujours dans un projet Expo, mais les packages Swift se lient dynamiquement, donc votre build nécessite des frameworks dynamiques — voir [Activer les frameworks dynamiques pour le SDK Adapty v4](#enable-dynamic-frameworks).
:::
