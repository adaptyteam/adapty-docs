...
:::info
À partir de la version 3.17.0, le SDK React Native d'Adapty utilise la Billing Library v8 par défaut. Les versions 3.15.0 à 3.15.6 utilisent la v7, et fonctionnent également lorsqu'une autre dépendance de votre build Android fait passer la Billing Library à la v8.
