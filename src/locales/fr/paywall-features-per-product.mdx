...
## 4. Ajouter la liste de produits \{#4-add-the-product-list\}
...
<ZoomImage id="paywall-features-products.webp" width="500px" alt="Deux produits à l'écran, dont un marqué comme valeur par défaut" />
