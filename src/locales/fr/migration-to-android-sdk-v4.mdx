...
metadataTitle: "Migration vers le SDK Android Adapty v4.0 | Documentation Adapty"
---
...
Définissez la version `adapty-bom` sur `4.0.0` (ou ultérieure) et synchronisez le projet. Le BOM résout automatiquement les versions correspondantes de `android-sdk` et `android-ui`. Consultez [Installer le SDK Adapty](sdk-installation-android) pour les déclarations de dépendances.
