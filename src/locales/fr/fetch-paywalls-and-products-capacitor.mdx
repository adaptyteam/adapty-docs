...
Avant de présenter le Remote Config et les paywalls personnalisés, vous devez récupérer les informations les concernant. Notez que cette rubrique traite du Remote Config et des paywalls personnalisés. Pour obtenir des conseils sur la récupération des flows ou des paywalls personnalisés dans le **Flow & Paywall Builder** ou l'**old Paywall Builder**, consultez [Récupérer les flows et paywalls ainsi que leur configuration](capacitor-get-pb-paywalls).
