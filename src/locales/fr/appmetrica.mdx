...
val startupParamsCallback = object: StartupParamsCallback {
    override fun onReceive(result: StartupParamsCallback.Result?) {
        ...
        Adapty.setIntegrationIdentifier(AdaptyIntegrationIdentifier.appmetricaDeviceId(deviceIdHash)) { error ->
            if (error != null) {
                // handle the error
            }
        }
...
val startupParamsCallback = object: StartupParamsCallback {
    override fun onReceive(result: StartupParamsCallback.Result?) {
        ...
        Adapty.setIntegrationIdentifier(AdaptyIntegrationIdentifier.appmetricaProfileId("YOUR_ADAPTY_CUSTOMER_USER_ID")) { error ->
            if (error != null) {
                // handle the error
            }
        }
