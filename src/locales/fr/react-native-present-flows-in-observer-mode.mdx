...
:::info
Cette fonctionnalité nécessite le SDK Adapty React Native 4.0 ou une version ultérieure — auparavant, elle n'était disponible que dans les SDK natifs iOS et Android. Consultez le [guide de migration](migration-to-react-native-sdk-v4) pour effectuer la mise à jour.
:::
