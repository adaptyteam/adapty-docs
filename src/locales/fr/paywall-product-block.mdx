...
Un bouton de restauration sans action associée, ou un produit absent de votre catalogue, s'affiche exactement comme un écran fonctionnel. Avant de publier, la [skill d'audit de flow](flow-audit-skill) peut vérifier chaque écran du flow pour ces deux problèmes.
