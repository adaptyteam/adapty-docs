...
Avant de pouvoir afficher les Remote Configs et les paywalls personnalisés, vous devez récupérer les informations les concernant. Notez que cette rubrique se rapporte aux Remote Configs et aux paywalls personnalisés. Pour obtenir de l'aide sur la récupération des flows ou des paywalls personnalisés dans le **Flow & Paywall Builder** ou l'**old Paywall Builder**, consultez [Récupérer les flows et les paywalls ainsi que leur configuration](react-native-get-pb-paywalls).
