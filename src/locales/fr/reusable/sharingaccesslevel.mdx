...
Vous pouvez « dissocier » un achat en [supprimant le profil de l'utilisateur propriétaire](https://adapty.io/docs/fr/api-adapty/operations/deleteProfile). Après la suppression, le niveau d'accès devient disponible pour le premier profil utilisateur qui le réclame, qu'il soit anonyme ou identifié.
