---
title: "Éléments"
description: "Tous les éléments visuels disponibles dans le Flow & Paywall Builder : conteneurs de mise en page, texte, médias, listes, boutons, champs de saisie, produits, et plus encore."
metadataTitle: "Éléments | Flows & paywalls | Documentation Adapty"
---
...
- [Formulaires & Quiz](#forms--quiz) (boutons, champs de saisie, quiz, onglets)
- [Paywall & Commerce](#paywall--commerce) (produits, bascules, engagement utilisateur, compte à rebours)
...
Icônes indicatrices à utiliser dans les [éléments sélectionnables](flow-selectable-elements), comme les cartes de produits. Chaque forme est disponible en preset activé et désactivé.
...
Pour un interrupteur ou une case à cocher que l'utilisateur tape directement, utilisez plutôt les éléments [Toggle](#toggle).
...
:::link
Article principal : [Bascules et cases à cocher](builder-toggles)
:::

<ZoomImage id="toggle-template.webp" width="200px" alt="Modèles de bascule" float="right" />

Interrupteurs et cases à cocher que les utilisateurs appuient pour activer ou désactiver une option. Chacun est un [élément sélectionnable](flow-selectable-elements), ce qui permet à d'autres éléments de réagir à son état.
...
:::link
Article principal : [Avis et témoignages](builder-reviews-and-testimonials)
:::
