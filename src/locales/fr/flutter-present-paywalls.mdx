---
title: "Afficher des flows et des paywalls - Flutter"
description: "Présentez des flows et des paywalls dans des applications Flutter grâce aux fonctionnalités de monétisation d'Adapty."
metadataTitle: "Afficher des flows et des paywalls dans Flutter | Documentation Adapty"
---

<SDKv4>

Si vous avez conçu un flow ou un paywall avec le Flow Builder ou le Paywall Builder, vous n'avez pas à vous soucier de son rendu dans le code de votre application mobile pour l'afficher à l'utilisateur. Un tel flow ou paywall contient à la fois ce qui doit être affiché et comment l'afficher.

:::warning

Ce guide est destiné aux flows et aux paywalls Paywall Builder. Pour afficher des **paywalls Remote Config**, consultez [Afficher un paywall conçu avec Remote Config](present-remote-config-paywalls-flutter).
