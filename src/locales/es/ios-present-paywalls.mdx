...
description: "Presenta flows y paywalls a los usuarios en tu app de iOS."
metadataTitle: "Mostrar flows y paywalls - iOS | Documentación de Adapty"
---

<SDKv4>

<MethodPromo method="getFlow" label="Mostrar flows y paywalls" />

Si has creado un flow, o un paywall en el antiguo Paywall Builder, no necesitas preocuparte por renderizarlo en el código de tu app móvil para mostrárselo al usuario. Tanto el flow como el paywall contienen tanto lo que debe mostrarse como la forma en que debe mostrarse.

Para obtener el objeto `AdaptyUI.FlowConfiguration` utilizado a continuación, consulta [Obtener flows y paywalls](get-pb-paywalls).
