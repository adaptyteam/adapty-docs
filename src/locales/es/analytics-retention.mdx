...
description: "Entiende el análisis de retención de usuarios y optimiza tu estrategia de suscripción."
...
Adapty fecha a cada suscriptor por el día en que comenzó su suscripción: el inicio del periodo de prueba para los productos con prueba gratuita, y el primer pago para los productos sin ella. Alguien que comienza una prueba el 1 de marzo y paga el 1 de abril pertenece a marzo, independientemente de cómo esté configurado **Show trials**.

:::info
La retención cambia de forma retroactiva

Independientemente de cuándo consultes el gráfico, el número base (100%) sigue siendo el mismo para el período de tiempo seleccionado. Sin embargo, la retención hacia el siguiente período puede crecer con el tiempo.
Por ejemplo, para una suscripción mensual, si se realizan 20 primeras compras entre el 1 y el 31 de diciembre, se espera que la retención hacia el segundo período vaya aumentando a lo largo de enero (e incluso después) a medida que los usuarios vayan entrando en el siguiente período de suscripción, a tiempo o más tarde por diversas razones (por ejemplo, el período de gracia).
:::

### Productos con distintas duraciones \{#products-with-different-durations\}

Los escalones del gráfico son períodos de suscripción, no intervalos de tiempo fijos. P2 representa el segundo período para cada producto, así que un suscriptor semanal lo alcanza al cabo de una semana y uno anual al cabo de un año. Ambos caen en la misma columna.

Si vendes más de una duración, la curva predeterminada las combina, y se desplaza cada vez que cambia tu combinación de productos. Agrupa o filtra por **Duration** o **Product** para analizar una a la vez.
...
Combina filtros y agrupaciones para un análisis avanzado. Obtén insights reales basados en datos.
Varía por:
...
6. Store.
7. Flow y pantalla de flow.

Usa el control #Absolute y %Relative para ver los datos que necesitas.

<ZoomImage id="d891f77-CleanShot_2022-07-12_at_12.43.11.webp" width="700px" alt="Filtros de retención y el control Absoluto o Relativo" />
