...
Si has creado un flow, o un paywall en el antiguo Paywall Builder, no necesitas preocuparte por renderizarlo en el código de tu aplicación móvil para mostrárselo al usuario. Ese flow contiene tanto lo que debe mostrarse dentro de él como la forma en que debe mostrarse.

Antes de empezar, asegúrate de que:

1. Has creado un [flow](paywall-builder-templates) o un [paywall](create-paywall).
2. Lo has añadido a un [placement](placements).
3. Has [obtenido el flow y preparado la vista](capacitor-get-pb-paywalls).

:::warning

Esta guía es solo para **flows y paywalls renderizados por Adapty**, que requieren SDK v4.0 o posterior. El proceso para presentar flows difiere en el caso de los paywalls de Remote Config.

- Para presentar **paywalls de Remote Config**, consulta [Renderizar paywall diseñado con Remote Config](present-remote-config-paywalls-capacitor).
...
Si has personalizado un paywall con el Paywall Builder, no tienes que preocuparte por renderizarlo en el código de tu app para mostrárselo al usuario. Ese paywall contiene tanto lo que debe mostrarse como la forma en que debe hacerlo.

:::warning
Esta guía es exclusivamente para paywalls creados con el Paywall Builder antiguo. El proceso de presentación difiere para los paywalls de Remote Config. Para presentar **paywalls de Remote Config**, consulta [Renderizar un paywall diseñado con Remote Config](present-remote-config-paywalls-capacitor).
:::
