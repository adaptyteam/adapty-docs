...
| `--ios-product-id` | Al menos una plataforma requerida | ID del producto en App Store Connect |
| `--android-product-id` | Al menos una plataforma requerida | ID del producto en Google Play Console |
