---
title: "Referencia de comandos para la CLI de Desarrollador de Adapty"
description: "Referencia de los comandos de la CLI de Desarrollador de Adapty para configurar apps, productos, paywalls y placements."
metadataTitle: "Referencia de Comandos de la CLI de Desarrollador | Documentación de Adapty"
keywords: ['cli', 'developer', 'reference', 'commands', 'mcp']
---

Este artículo lista los comandos de la CLI de Adapty para configurar tu cuenta — apps, niveles de acceso, productos, paywalls, placements y segmentos — con sus argumentos, flags y valores aceptados. Para campañas de Apple Ads, consulta [Comandos del Ads Manager](developer-cli-ads-manager-reference).
