...
Identifica el perfil mediante `external_profile_id`, `customer_user_id` o `email` — envía al menos uno. El borrado es definitivo: guardar después con los mismos identificadores no recrea el perfil. Consulta la referencia de [Eliminar perfil](api-mail/operations/deleteProfile) para más detalles.
