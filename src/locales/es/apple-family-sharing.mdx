...
:::important
Este comportamiento predeterminado se invierte para los productos que Adapty crea por ti. Si usaste [Crear producto y publicar en el store](create-product#create-product-and-push-to-store) en lugar de crear la suscripción tú mismo en App Store Connect, Family Sharing estará **activado**. Al igual que con cualquier configuración de Family Sharing, no podrás desactivarla después — para evitar que el producto se comparta, desactiva Family Sharing en App Store Connect antes de la primera revisión de la suscripción, o crea la suscripción directamente allí en lugar de publicarla desde Adapty.
:::
