---
title: "Paso 1. Crear un flow para mostrar datos del paywall"
description: "Crea un action flow en FlutterFlow que recupere los datos del paywall y los productos de Adapty para tu propia página de paywall."
metadataTitle: "Crear un flow para mostrar datos del paywall en FlutterFlow | Documentación de Adapty"
---
...
Tras añadir la librería de Adapty como dependencia en tu proyecto de FlutterFlow, es momento de construir el flow que **obtiene los datos del paywall y los productos de Adapty y los muestra en el paywall que has diseñado en FlutterFlow**.

Primero necesitamos recibir los datos del paywall desde Adapty. Empezaremos solicitando el paywall de Adapty, luego sus productos asociados, y finalmente comprobaremos si los datos se recibieron correctamente. Si todo va bien, mostraremos el título del producto y el precio en la página del paywall. En caso contrario, mostraremos un mensaje de error.

Antes de continuar, asegúrate de haber completado lo siguiente:

1. [Creado al menos un paywall y añadido al menos un producto a él](create-paywall) en el Adapty Dashboard.
2. [Creado al menos un placement](create-placement) y [añadido tu paywall a él](add-audience-paywall-ab-test) en el Adapty Dashboard.
