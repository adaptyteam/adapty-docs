...
description: "Instala la habilidad flow-generator para que tu propia herramienta de IA pueda crear, traducir y reestructurar flows de Adapty a través del CLI de Adapty."
metadataTitle: "Habilidad de agente para generación de flows | Flow & Paywall Builder | Documentación de Adapty"
---
...
El Editor de IA es el agente de Adapty, que trabaja en la pantalla que tienes abierta. El skill es el arreglo contrario: tu agente, tu modelo, tus herramientas, y Adapty como una herramienta más que sabe cómo operar. Todo lo que tu herramienta de IA ya puede alcanzar viene con ella: tu repositorio, tus archivos de diseño, tus servidores MCP, tus propios prompts y contexto.
...
La página de vista previa del skill muestra una sola pantalla y no recorre el flow completo. No puede mostrarte ninguno de los siguientes aspectos. Prueba cada uno en un dispositivo real — [Vista previa de flows](paywall-device-compatibility-preview) explica cómo hacerlo:
...
- [Skill flow-audit](flow-audit-skill) — comprobación de solo lectura para verificar si el borrador que deja este skill está listo para producción, antes de publicarlo.
- [Guardar y publicar flows](builder-save-publish) — termina el borrador que deja el skill.
