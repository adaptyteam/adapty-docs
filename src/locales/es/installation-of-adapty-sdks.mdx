...
description: "Instala los SDK de Adapty para iOS, Android y aplicaciones multiplataforma."
metadataTitle: "Instalación de los SDK de Adapty | Documentación de Adapty"
keywords: ['activate']
---

Tienes tres opciones para empezar, según tus preferencias:
