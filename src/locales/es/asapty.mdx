...
Esta integración específica no añade datos de atribución a Adapty, ya que obtenemos todo lo que necesitamos directamente desde [ASA](apple-search-ads).
...
### Los eventos no llegan a Adapty \{#events-dont-reach-asapty\}
...
- Solo los perfiles con atribución ASA detallada y no orgánica enviarán sus eventos a Asapty. Verás "The user profile is missing the required integration data." si la atribución no es suficiente.
- Los perfiles creados antes de configurar las integraciones no podrán enviar sus eventos a Asapty.
- Si la integración con Adapty no funciona a pesar de una configuración correcta, asegúrate de que el toggle **Receive Apple Search Ads attribution in Adapty** esté habilitado en la pestaña [**App Settings** -> **Apple Search Ads**](https://app.adapty.io/settings/apple-search-ads).
