...
:::note
En el SDK 4.0, las interfaces de listener siguen la convención de prefijo I de C#: implementa `IAdaptyOnboardingsEventsListener` en lugar de `AdaptyOnboardingsEventsListener`. Los métodos no cambian. Consulta la [guía de migración](migration-to-unity-sdk-v4).
:::
