...
Si ya generaste un plan de crecimiento para el placement objetivo, este análisis generará nuevas hipótesis para elegir.
:::tip
...
### Seleccionar un paywall para análisis \{#select-a-paywall-for-analysis\}
...
2. En la página **Paywall Diagnostic**, selecciona un **Placement** y un **Paywall** en los menús desplegables. Adapty preselecciona el placement con más ingresos y su paywall principal. Para analizar un paywall diferente, cambia primero el placement.
...
Cuando seleccionas un paywall y subes una captura de pantalla, Adapty lo analiza en busca de patrones de diseño establecidos, destacando tanto los aciertos como las oportunidades de mejora.

<ZoomImage id="autopilot-paywall-diagnostic.webp" width="600px" />

#### Qué está funcionando bien \{#whats-working-well\}

Esta sección destaca el uso de patrones consolidados que maximizan la conversión. Por ejemplo: una insignia de ahorro visible, una sección de reseñas de usuarios destacada o un desglose claro de las suscripciones.

#### Qué corregir en tu paywall \{#what-to-fix-on-your-paywall\}

Adapty agrupa sus recomendaciones en dos categorías:
- **Recomendaciones basadas en benchmarks**: Sugerencias respaldadas por datos de las apps con mejor rendimiento en tu categoría. Cada recomendación incluye una estadística de referencia (por ejemplo, "Utilizada por el 72% de las apps de Educación con mejor rendimiento") y una descripción del cambio propuesto.
...
- **[El gráfico de análisis de ARPU](arpu)**: Incluye renovaciones de cohortes anteriores, por lo que el valor es varias veces superior al ARPU de activación.
- **[Gráfico de ingresos](revenue), filtro de período configurado en "Activation"**: solo cuenta el primer pago de cada usuario. No cuenta las renovaciones realizadas por la cohorte en la ventana de 90 días.
