...
metadataTitle: "Análisis de Paywall y Mercado | AI Growth Advisor | Documentación de Adapty"
keywords: ['ai growth advisor', 'autopilot', 'growth autopilot', 'diagnóstico de paywall', 'insights de mercado']
---
...
- **Recomendaciones basadas en benchmarks**: Sugerencias basadas en datos de las apps con mejor rendimiento en tu categoría. Cada recomendación incluye una estadística de referencia (por ejemplo, "Utilizado por el 72% de las apps de Educación con mejor rendimiento") y una descripción del cambio sugerido.
- **Recomendaciones de análisis visual**: Sugerencias generadas por IA a partir de una captura de pantalla de tu paywall. Incluyen: mejoras de copy, cambios de diseño y más.

:::tip
Tu [plan de crecimiento](autopilot-growth-plan) incluirá hipótesis basadas en las recomendaciones de benchmarks. Puedes añadir las sugerencias del análisis visual al plan manualmente.
:::
