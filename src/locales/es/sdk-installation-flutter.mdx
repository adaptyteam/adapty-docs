...
:::info
Adapty es compatible con Google Play Billing Library hasta la versión 8.x. Por defecto, Adapty usa Google Play Billing Library v7.0.0, pero si quieres forzar una versión posterior, puedes añadirla manualmente [como dependencia](https://developer.android.com/google/play/billing/integrate#dependency).

La compatibilidad con una versión de la Billing Library no implica que Adapty soporte todas las funciones que Google introdujo en ella. Antes de adoptar una nueva funcionalidad de facturación de Google Play, consulta [Producto en Play Store](android-products).
:::
