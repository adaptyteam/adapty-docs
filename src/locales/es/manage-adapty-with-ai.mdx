...
Si tu app ya utiliza paywalls, la [habilidad migrate-placements](migrate-placements-skill) se encarga de la migración: inventaría tus placements de paywall, los agrupa según el paywall que sirve cada uno y crea un placement de flow para cada uno junto al original.
