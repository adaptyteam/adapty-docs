...
## Crea y edita flows con una herramienta de IA \{#build-and-edit-flows-with-an-ai-coding-tool\}

El [skill flow-generator](flow-generator-skill) edita tus flows de Adapty desde la terminal — añade un locale, reescribe textos, agrega o elimina pantallas, configura ramificaciones o crea un paywall a partir de una descripción. Previsualiza y valida cada cambio en local, y luego guarda un borrador para que lo publiques.
