...
[Slack](https://slack.com/) es una plataforma de mensajería y productividad para equipos que probablemente no necesita presentación.

Con esta integración, podrás recibir notificaciones en Slack cada vez que Adapty registre un evento de ingresos. Puede ser muy útil si quieres celebrar cada momento en que tu MRR sube, o si quieres estar al tanto de cancelaciones de prueba, problemas de facturación, reembolsos y más.
