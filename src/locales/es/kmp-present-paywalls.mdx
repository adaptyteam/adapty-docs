...
Si has creado un flow o un paywall con el antiguo Paywall Builder, no tienes que preocuparte por renderizarlo en el código de tu app para mostrárselo al usuario. Ese flow o paywall ya incluye tanto el contenido que debe mostrarse como la forma en que debe presentarse.

:::warning

Esta guía cubre los flows y paywalls renderizados por Adapty. El proceso es diferente para los paywalls con Remote Config y el [modo Observer](observer-vs-full-mode).
...
Si has personalizado un paywall usando el Paywall Builder, no necesitas preocuparte por renderizarlo en el código de tu app para mostrárselo al usuario. Este tipo de paywall contiene tanto lo que debe mostrarse dentro del paywall como la forma en que debe mostrarse.

:::warning

Esta guía es solo para **paywalls creados en el builder antiguo**. El proceso para presentar paywalls es diferente para los paywalls de Remote Config y el [modo Observer](observer-vs-full-mode).
