...
Dado que los métodos predeterminados de la interfaz KMP se convierten en `@required` en Swift, no puedes implementar `AdaptyUIFlowsEventsObserver` directamente desde Swift. Declara primero una clase base abierta en `iosMain`:
...
Luego, crea una subclase en Swift y sobreescribe solo lo que necesites:
