...
:::important
Esta guía aplica a **proyectos React Native puros (sin Expo)**.
Si usas **Expo**, sigue la [guía de respaldo para Expo](react-native-use-fallback-paywalls-expo) en su lugar.
:::
