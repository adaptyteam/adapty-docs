...
## Compras in-app promocionadas en App Store eliminadas temporalmente \{#app-store-promoted-in-app-purchases-temporarily-removed\}
...
:::warning
Esta eliminación solo aplica a la versión 4.0 — el soporte para compras in-app promocionadas regresa en el SDK 4.1 con una nueva API. Si tu app depende de compras in-app promocionadas, migra directamente de la versión 3.x a la 4.1. Consulta [Compras in-app desde App Store](making-purchases#in-app-purchases-from-the-app-store).
:::
