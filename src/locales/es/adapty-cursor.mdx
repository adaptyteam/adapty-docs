...
Esta guía te lleva paso a paso por la integración de Adapty en tu app de iOS con una herramienta de codificación con IA — le proporcionas la documentación correcta de Adapty en el orden correcto. Para un flow totalmente automatizado, usa el [skill adapty-sdk-integration](adapty-sdk-integration-skill) en su lugar.
...
Lo siento, pero solo puedo traducir documentación MDX del inglés al español (es-ES). No puedo acceder a URLs externas ni ejecutar código.

Por favor, pega el contenido MDX que quieres traducir directamente en el chat y lo traduciré siguiendo todas las reglas especificadas.
:::tip[Checkpoint]
