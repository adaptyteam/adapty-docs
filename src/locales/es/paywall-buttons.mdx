---
title: "Botones"
description: "Añade y configura botones de acción en el Flow & Paywall Builder."
metadataTitle: "Botones | Flows y paywalls | Documentación de Adapty"
---

:::info
Esta sección describe el nuevo Flow & Paywall Builder, que funciona con los SDK de Adapty versión 4.0 o superior.
:::

Los botones son los elementos interactivos en el Flow & Paywall Builder que responden a las pulsaciones del usuario. Úsalos para:
...
:::tip
Coloca los CTAs de compra, los enlaces de restauración y los enlaces legales dentro de un [Footer](builder-containers#footer) — está anclado en la parte inferior de la pantalla y cubre los elementos desplazables que quedan debajo.
:::
