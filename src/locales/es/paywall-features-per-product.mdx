...
1. En el panel **Layers**, haz clic en el menú de tres puntos <Inline id="context.svg" alt="Context menu" /> del layer del botón de cerrar y elige **Wrap** > **Wrap in Horizontal Container**.
