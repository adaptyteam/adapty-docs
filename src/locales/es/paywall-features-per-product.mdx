---
title: "Mostrar diferentes funciones según el producto"
description: "Muestra una lista de funciones diferente según el producto que seleccione el usuario, usando visibilidad condicional."
metadataTitle: "Mostrar diferentes funciones según el producto | Flows y paywalls | Documentación de Adapty"
---
...
1. En el panel **Layers**, haz clic en el menú de tres puntos <Inline id="context.svg" alt="Context menu" /> sobre la capa del botón de cierre y elige **Wrap** > **Wrap in Horizontal Container**.
...
Añade los productos entre los que el usuario puede elegir. Marca uno como predeterminado para que la pantalla tenga un estado inicial con sentido cuando se cargue por primera vez.
...
1. Haz clic en **+** > **Products** y elige un preset de diseño. La lista vertical funciona bien para esta plantilla.
2. Selecciona cada tarjeta de producto en el lienzo y elige un producto en el menú desplegable de la pestaña **Design**.
3. Selecciona la tarjeta que quieras que esté seleccionada por defecto — por ejemplo, Pro+ — y activa **Set as default** en la pestaña **Design**.
...
## 5. Añade la lista de características del primer producto \{#add-the-feature-list-for-the-first-product\}
...
:::tip
En lugar de dos listas separadas, puedes añadir una única lista y hacer que los elementos de texto dentro de ella sean condicionales, de modo que una sola lista se adapte al producto seleccionado. Consulta [Añadir texto condicional](onboarding-text#add-conditional-text).
:::
...
## 8. Añadir los enlaces del pie de página \{#add-the-footer-links\}
