...
:::info
Adapty es compatible con Google Play Billing Library hasta la versión 8.x. Por defecto, Adapty utiliza Google Play Billing Library v7.0.0. Para usar una versión más reciente, [reemplaza la dependencia de Billing](https://developer.android.com/google/play/billing/integrate#dependency) en tu compilación de Android.
:::
...
SDK 4.0 — que añade soporte para [Flow Builder](adapty-flow-builder) — es una versión preliminar. Para instalarlo mediante Unity Package Manager, usa la etiqueta beta en la URL de Git en lugar de `#upm`:

```
https://github.com/adaptyteam/AdaptySDK-Unity.git?path=Packages/com.adapty.unity-sdk#4.0.0-beta.1
```

Si instalas mediante el paquete Unity, descarga `adapty-unity-plugin-4.0.0-beta.1.unitypackage` desde la carpeta [Releases](https://github.com/adaptyteam/AdaptySDK-Unity/tree/main/Releases).
