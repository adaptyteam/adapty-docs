...
El SDK de Adapty es compatible con iOS 13.0+, pero requiere iOS 15.0+ para trabajar con paywalls creados en el Paywall Builder. El SDK de Adapty 4.1 — que añade soporte para [flows](adapty-flow-builder) — requiere **iOS 15.0+** para toda la app: un validador de compilación en el Unity Editor detiene la compilación de iOS si el destino de despliegue es inferior.

:::info
El SDK de Adapty para Unity 4.0 y versiones posteriores funciona con Google Play Billing Library v8.
