...
El SDK de Adapty es compatible con iOS 13.0+, pero requiere iOS 15.0+ para trabajar con paywalls creados en el Paywall Builder. Adapty SDK 4.1 — que añade soporte para [flows](adapty-flow-builder) — requiere **iOS 15.0+** para toda la app: un validador de compilación en el Unity Editor detiene el build de iOS si el deployment target es inferior. Compilar para iOS con el SDK 4.x también requiere **Xcode 26** o posterior — el SDK nativo de iOS que añade como Swift package está compilado con Swift tools 6.2.

<InstallationPrereqs />

## Dependencias \{#dependencies\}

El SDK de Adapty funciona con las siguientes versiones de la Google Play Billing Library en Android:

| Versión del SDK de Adapty | Versión de la Billing Library |
|---|---|
| 3.17.0 y posteriores | v8 |
| 3.15.0–3.15.2 | v7 por defecto, v8 si otra dependencia la eleva |
...
Instala el SDK de Adapty a través de Unity Package Manager usando una Git URL:
