...
1. Crea un [flow](adapty-flow-builder) en el Flow & Paywall Builder.
...
- **Sin pruebas A/B.** Una prueba A/B de flow en vivo se resuelve en el servidor; el respaldo siempre muestra una única variación elegida.
