...
Cuando tus usuarios respondan a una pregunta de un cuestionario o introduzcan sus datos en un campo de texto, se invocará el método `onboardingViewOnStateUpdatedAction`. Puedes guardar o procesar el tipo de campo en tu código.
