...
:::info
Recomendamos probar las compras in-app en un dispositivo real. Aunque las compras en sandbox pueden ejecutarse en simuladores, se necesitan dispositivos reales para probar todos los flows en su totalidad, incluidos los diálogos de pago y las solicitudes biométricas.
:::

Hay dos formas principales de probar las compras in-app:

- **Compilar en Xcode y ejecutar en un dispositivo de prueba**: Ideal para desarrolladores y QA engineers.
- **Usar una cuenta de prueba de sandbox con TestFlight**: Adecuado para cualquier otra persona.
...
6. [Abre la app y realiza tu compra de prueba](#step-7-make-test-purchase).
...
3. [Cambia a la cuenta de prueba de Sandbox](#step-4-switch-to-sandbox-test-account).
4. [Borra el historial de compras](#step-5-clear-purchase-history).
5. [Abre la app y realiza tu compra de prueba](#step-7-make-test-purchase).
