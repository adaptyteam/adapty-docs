...
- **AdaptyUI**: Este módulo opcional es necesario si utilizas el [Adapty Paywall Builder](adapty-paywall-builder), una herramienta sin código y fácil de usar para crear paywalls multiplataforma.
...
Para ver una guía de implementación completa, también puedes consultar los vídeos:
