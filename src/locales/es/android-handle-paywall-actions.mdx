---
title: "Responder a las acciones de los flows - Android"
description: "Gestiona las acciones de los botones de flows y paywalls en tu app de Android."
metadataTitle: "Responder a las acciones de los flows - Android | Documentación de Adapty"
...
1. En el antiguo Paywall Builder, añade un botón y asígnale una acción predefinida o un ID de acción personalizado.
...
:::warning
**Solo las compras, restauraciones, cierres de paywall y apertura de URLs se gestionan de forma automática.** Todas las demás acciones de botón requieren una implementación adecuada en el código de la app.
:::
