...
[Mixpanel](https://mixpanel.com/home/) es un potente servicio de análisis de productos. Su solución de seguimiento basada en eventos permite a los equipos de producto obtener información valiosa sobre las estrategias óptimas de adquisición, conversión y retención de usuarios en diferentes plataformas.
...
2. Activa el toggle e introduce tu **Mixpanel Token**. Adapty gestiona tokens **Production** y **Sandbox** por separado para cada plataforma: iOS, Android, Stripe y Paddle. Rellena solo las plataformas de las que quieras recibir datos — una plataforma sin token no envía ningún evento.
3. Configura el **Mixpanel Data Residency** para que coincida con tu proyecto de Mixpanel. Este campo es obligatorio y tiene el valor predeterminado **US**. Elige **US** para el endpoint `api.mixpanel.com` o **Europe** para `api-eu.mixpanel.com`.
