...
En el [Flow & Paywall Builder](adapty-flow-builder), puedes asociar una oferta con un producto en el panel **Products** o en una tarjeta de producto.

#### En el panel Products \{#in-the-products-panel\}

- **Al añadir el producto**: Haz clic en **+**, selecciona el producto y elige la oferta en **Offer**. Las tarjetas que usen el producto después tendrán esta oferta preseleccionada. Los pasos completos están en [Añadir productos en el panel de productos](paywall-product-block#add-products-in-the-products-panel).
- **Para un producto ya en la pantalla**: Abre el menú contextual de la entrada del producto y selecciona [**Offer**](paywall-product-block#product-actions). Cada tarjeta, variable de texto y acción que use el producto cambiará a la nueva oferta.

#### En una tarjeta de producto \{#on-a-product-card\}

1. En el canvas, selecciona la tarjeta de producto que debe mostrar la oferta.
2. En el panel derecho, bajo **Product**, selecciona el producto y luego elige la oferta en el desplegable de ofertas. Si añadiste el producto con una oferta en el panel **Products**, esa oferta ya estará preseleccionada. Si eliges una oferta diferente, se añade una segunda entrada para el producto en el panel.
