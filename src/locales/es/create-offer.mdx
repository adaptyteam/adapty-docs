...
En el [Flow & Paywall Builder](adapty-flow-builder), una oferta se asocia a un producto en un elemento de Productos. Primero añade el elemento de producto y asígnale productos; consulta [Configurar compras](paywall-product-block).

Para asociar una oferta:

1. En el lienzo, selecciona la tarjeta de producto que debe mostrar la oferta.
2. En el panel derecho, bajo **Product**, selecciona el producto y elige la oferta en el desplegable de ofertas. El desplegable muestra **No offer** hasta que selecciones una, y solo lista las ofertas de los productos que las tienen.
