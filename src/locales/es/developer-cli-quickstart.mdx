...
metadataTitle: "Inicio rápido del Developer CLI | Documentación de Adapty"
keywords: ['cli', 'developer cli', 'mcp']
---

:::link
¿Usas un asistente de IA? Hay disponible un [skill de Adapty CLI](https://github.com/adaptyteam/adapty-cli/tree/main/skills/adapty-cli) para ayudar a los LLMs a trabajar con el CLI.
:::
...
Si también vendes este producto en la web a través de Stripe o Paddle, añade esos IDs al mismo comando. Consulta [products create](developer-cli-reference#adapty-products-create) en la referencia completa.
