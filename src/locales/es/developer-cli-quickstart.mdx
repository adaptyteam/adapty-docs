...
Cowork aplica esta configuración cuando comienza una tarea. Si cambias el modo de acceso o añades un dominio durante una conversación, esa conversación mantiene la configuración con la que empezó — inicia una nueva tarea.

Una tarea también comienza en una máquina limpia: sin CLI, sin token y sin configuración que provenga de una sesión anterior, por lo que los pasos de instalación e inicio de sesión se repiten al comienzo de cada una.
