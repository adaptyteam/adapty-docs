...
description: "Gestiona eventos relacionados con onboarding en Flutter usando Adapty."
...
- **Widget embebido**: Gestiona los eventos mediante parámetros de callback directamente en el widget

Antes de comenzar, asegúrate de que:

1. Tienes instalado el [SDK de Flutter de Adapty](sdk-installation-flutter) 3.8.0 o posterior.
