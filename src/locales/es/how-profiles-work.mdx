...
description: "Descubre cómo Adapty crea, rastrea y vincula perfiles de usuario, incluidos perfiles anónimos, usuarios identificados y relaciones entre perfiles padre e hijo."
