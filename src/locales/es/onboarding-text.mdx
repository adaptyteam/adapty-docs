...
description: "Añade y da estilo a títulos, subtítulos, párrafos y listas en el Flow Builder de Adapty, y personaliza el texto para experiencias de usuario acordes a tu marca."
