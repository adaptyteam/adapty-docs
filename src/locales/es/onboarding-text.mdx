---
title: "Añadir y dar estilo a textos y listas en el Flow & Paywall Builder"
description: "Añade y da estilo a títulos, subtítulos, párrafos y listas en el Flow & Paywall Builder de Adapty, y personaliza el texto para experiencias de usuario acordes con tu marca."
metadataTitle: "Texto | Flows y paywalls | Documentación de Adapty"
---
...
<AIPromo title="Reescribe tu titular con un solo prompt.">
  Pide al Editor de IA que reescriba tu copy, mencione la prueba gratuita o acorte todos los elementos de texto de la pantalla a la vez.
</AIPromo>
...
<ZoomImage id="old-price-menu.webp" width="500px" alt="Menú de elementos con la categoría Text expandida, mostrando el elemento Old Price" />
...
<ZoomImage id="old-price-result.webp" width="400px" alt="Tarjeta de producto en el lienzo mostrando un precio anterior tachado junto al precio real" />
...
3. Establece el destino para la acción [**Open URL**](onboarding-actions#open-url).
    ...
    :::important
    Una acción Open URL vacía [bloquea la previsualización y publicación](flow-common-issues#a-flow-wont-preview-or-publish).
    :::
...
:::tip
Para editar el texto condicional en otro idioma, cambia la configuración regional activa en la parte inferior del editor. Añade los idiomas en el panel **Localizations** primero — consulta [Añadir idioma en Flow y Paywall Builder](add-paywall-locale-in-adapty-paywall-builder).
:::
