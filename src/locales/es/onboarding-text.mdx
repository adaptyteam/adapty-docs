...
3. Establece el destino para la acción [**Open URL**](onboarding-actions#open-url).
    ...
    <ZoomImage id="open-url.webp" width="500px" alt="Configuración de la acción Open URL en el panel Interactions" />

   <ZoomImage id="button-selected.webp" width="500px" alt="Botón Terms of Use seleccionado en el panel Layers, con el elemento de texto anidado visible pero no seleccionado" />
