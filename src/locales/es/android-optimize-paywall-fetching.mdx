...
`preloadFlows` escribe el JSON del placement en la caché del SDK con antelación — una solicitud por placement, y nada más. A pesar del nombre, no descarga el diseño de la UI del flow ni sus archivos multimedia.
