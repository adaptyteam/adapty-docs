...
description: "Construye una pantalla de paywall con dos pestañas que alternan entre distintas listas de características, grupos de productos y acciones de compra."
metadataTitle: "Crear un paywall con pestañas | Flows y paywalls | Documentación de Adapty"
---

Esta plantilla usa pestañas para alternar entre dos variantes de la misma oferta en una sola pantalla. Cada pestaña tiene su propia lista de características, lista de productos y botón de compra. Al pulsar una pestaña, el contenido visible cambia sin salir de la pantalla — ideal para separar planes por nivel, período de facturación o segmento de audiencia.
...
1. En el panel **Layers**, haz clic en el menú de tres puntos <Inline id="context.svg" alt="Context menu" /> en la capa del botón de cerrar y elige **Wrap** > **Wrap in Horizontal Container**.
