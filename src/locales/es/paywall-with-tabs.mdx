...
1. En el panel **Layers**, haz clic en el menú de tres puntos <Inline id="context.svg" alt="Context menu" /> de la capa del botón de cierre y elige **Wrap** > **Wrap in Horizontal Stack**.

<ZoomImage id="paywall-tabs-button-stack.webp" width="500px" alt="H1 añadido a la pantalla con el campo Content a la derecha" />

2. Arrastra la capa H1 al nuevo stack horizontal.

<ZoomImage id="paywall-tabs-title-wrap.gif" width="500px" alt="Botón de cierre y H1 agrupados en un stack horizontal" />
