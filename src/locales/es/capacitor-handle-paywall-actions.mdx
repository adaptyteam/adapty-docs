...
description: "Gestiona las acciones de botones de flows y paywalls en Capacitor usando Adapty para una mejor monetización de la app."
...
Si estás creando flows en el [Flow & Paywall Builder](adapty-flow-builder) de Adapty, es fundamental configurar los botones correctamente:
...
1. En el antiguo Paywall Builder, añade un botón y asígnale una acción preexistente o un ID de acción personalizado.
