...
description: "Añade locales de Remote Config para personalizar los paywalls de Adapty."
metadataTitle: "Añadir locales de Remote Config | Documentación de Adapty"
---

Adaptar tus paywalls a diferentes idiomas es fundamental en un mundo con culturas diversas. La localización te permite crear experiencias personalizadas para usuarios de regiones específicas. Para cada paywall, puedes añadir versiones en distintos idiomas, asegurándote de que tu producto conecte con las audiencias locales.

Si no usas el antiguo Adapty Paywall Builder para diseñar paywalls, igualmente puedes localizar tus paywalls personalizados y gestionar las localizaciones sin necesidad de redesplegar tu app:
...
2. Defines los valores de las variables para cada idioma.
3. Gestionas las variables en el código de la app.
4. Cuando obtienes un paywall con productos y envías un idioma, recibes los valores de las variables correspondientes.

De este modo, las localizaciones no están hardcodeadas en el código de la app y puedes ajustarlas en cualquier momento.

Tanto en la vista de tabla como en formato JSON, puedes ajustar fácilmente la configuración de cada idioma. Por ejemplo, traducir claves de cadena, alternar valores booleanos (por ejemplo, `TRUE` para inglés, `FALSE` para italiano) o incluso cambiar imágenes de fondo.
...
Después de añadir idiomas a un paywall, asegúrate de implementar correctamente los códigos de idioma en el código de tu app. Consulta <InlineTooltip tooltip="las guías sobre cómo usar localizaciones y códigos de idioma en tu app">[iOS](localizations-and-locale-codes), [Android](android-localizations-and-locale-codes), [React Native](react-native-localizations-and-locale-codes), [Flutter](flutter-localizations-and-locale-codes), [Unity](unity-localizations-and-locale-codes), [Kotlin Multiplatform](kmp-localizations-and-locale-codes), y [Capacitor](capacitor-localizations-and-locale-codes)</InlineTooltip>