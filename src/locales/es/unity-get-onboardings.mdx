...
description: "Aprende cómo recuperar onboardings en Adapty para Unity."
...
Después de [diseñar la parte visual de tu onboarding](design-onboarding) con el editor en el Adapty Dashboard, puedes mostrarlo en tu app de Unity. El primer paso de este proceso es obtener el onboarding asociado al placement y su configuración de vista, como se describe a continuación.

Antes de comenzar, asegúrate de que:

1. Tienes instalado el [SDK de Adapty para Unity](sdk-installation-unity) en su versión 3.14.0 o superior.
