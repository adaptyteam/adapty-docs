---
title: "Inputs y formularios en el Flow & Paywall Builder"
description: "Añade elementos de formulario interactivos como campos de texto y casillas de verificación."
metadataTitle: "Inputs y formularios | Flows y paywalls | Documentación de Adapty"
---
...
## Usar valores de entrada \{#use-input-values\}

:::tip
Tu app también puede recibir valores de entrada. Para recopilarlos, [gestiona el callback de análisis del SDK](ios-flow-input). Cada vez que el usuario sale de un campo de entrada, el callback entrega su valor y tu app puede procesarlo internamente.
:::
