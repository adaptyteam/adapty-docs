...
Construir para iOS con el SDK de Adapty v4 (beta) requiere **Xcode 26** o posterior — el SDK nativo de iOS que utiliza está compilado con Swift tools 6.2. Los requisitos de iOS 15.0+, Capacitor 8 y Android minSdk 24 son los mismos que para SDK 3.16+.

:::info
Adapty Capacitor SDK 4.0.2 y versiones posteriores funcionan con Google Play Billing Library v8.
