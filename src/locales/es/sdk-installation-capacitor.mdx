...
Construir para iOS con Adapty SDK v4 (beta) requiere **Xcode 26** o posterior — el iOS SDK nativo que utiliza está compilado con Swift tools 6.2. Los requisitos de iOS 15.0+, Capacitor 8 y Android minSdk 24 son los mismos que para SDK 3.16+.

:::info
A partir de SDK v3.17, Adapty SDK utiliza Google Play Billing Library v8.0.0 por defecto.

La compatibilidad con una versión de Billing Library no significa que Adapty sea compatible con todas las funcionalidades que Google introdujo en ella. Antes de adoptar una nueva funcionalidad de facturación de Google Play, consulta [Producto en Play Store](android-products).
:::
