...
:::
:::info
Esta funcionalidad requiere el SDK de Adapty para Flutter 4.0 o posterior — antes solo estaba disponible en los SDKs nativos de iOS y Android. Consulta la [guía de migración](migration-to-flutter-sdk-v4) para actualizarte.
:::
