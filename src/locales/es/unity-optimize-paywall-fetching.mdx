...
Los consejos a continuación usan los nombres de métodos de la v3. En el SDK v4, `GetPaywall` se renombra a `GetFlow` (consulta la [guía de migración](migration-to-unity-sdk-v4)) — todas las reglas se aplican sin cambios.
