...
:::note
`CustomTimers` sigue existiendo, pero solo afecta a los paywalls del Paywall Builder heredado. El [temporizador de cuenta atrás](flow-timer) de un flow se ejecuta según el comportamiento configurado en el Flow Builder, por lo que un flow ignora lo que pases aquí.
:::
