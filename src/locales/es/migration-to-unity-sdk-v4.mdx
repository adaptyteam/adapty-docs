...
:::note
`CustomTimers` sigue existiendo, pero solo afecta a los paywalls del Paywall Builder heredado. El [temporizador de cuenta atrás](flow-timer) de un flow se rige por la configuración del Flow & Paywall Builder, por lo que un flow ignora lo que pases aquí.
:::
...
La API de onboarding heredada está en desuso en v4 en favor del [Flow & Paywall Builder](adapty-flow-builder). Sigue funcionando, pero se eliminará en una versión futura, así que planifica la migración de tus onboardings al Flow & Paywall Builder.
