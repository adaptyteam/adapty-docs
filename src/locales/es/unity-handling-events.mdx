...
description: "Gestiona eventos de flow y paywall en tu aplicación Unity."
...
Consulta [Rastrear vistas de pantallas de flow](unity-flow-screen-views) para saber qué hacer con ellos.

Un flow también reporta los valores que los usuarios escriben y seleccionan. Consulta [Procesar datos de flows](unity-flow-input) para leerlos.
