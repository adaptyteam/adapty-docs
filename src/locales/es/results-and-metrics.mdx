...
description: "Analiza resultados y métricas clave en Adapty para mejorar el rendimiento de suscripciones y el engagement de los usuarios de tu app."
...
**Ingresos**: Esta métrica muestra el importe total en USD generado por compras y renovaciones, descontando los reembolsos realizados a los usuarios. Incluye tanto la compra inicial como las renovaciones posteriores de la suscripción. Los ingresos te ayudan a entender el rendimiento financiero de cada variante de la prueba A/B y a determinar cuál genera más dinero.

Más información sobre las métricas de [paywall](paywall-metrics) y [onboarding](onboarding-metrics).
