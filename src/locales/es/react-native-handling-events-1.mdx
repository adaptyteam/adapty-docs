...
Consulta [Registrar vistas de pantallas del flow](react-native-flow-screen-views) para saber qué hacer con ellos.

Un flow también informa de los valores que los usuarios escriben y seleccionan. Consulta [Procesar datos de flows](react-native-flow-input) para leerlos.
