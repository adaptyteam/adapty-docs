...
description: "Presenta flows y paywalls a los usuarios en tu app React Native con Adapty."
...
Si has creado un flow o un paywall en el antiguo Paywall Builder, no necesitas preocuparte por renderizarlo en el código de tu aplicación móvil para mostrárselo al usuario. Un flow de este tipo contiene tanto lo que debe mostrarse dentro de él como la forma en que debe mostrarse.
...
Esta guía es solo para **flows y paywalls renderizados por Adapty**, que requieren SDK v4.0 o posterior. El proceso para presentar flows es diferente en los paywalls de Remote Config.
...
Esta guía cubre solo los paywalls creados en el antiguo Paywall Builder para **Adapty SDK 3.x**. Requieren SDK v3.0 o posterior. La presentación de un paywall creado para SDK 2.x o anterior, o un paywall de Remote Config, funciona de forma diferente.
