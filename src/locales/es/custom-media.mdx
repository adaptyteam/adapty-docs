...
:::tip
Para que una imagen o vídeo cubra toda la pantalla — incluyendo las áreas detrás del notch y el indicador de inicio — posiciónalo como fijo con todos los desplazamientos en 0 y selecciona **Ignore safe area**. Consulta [Posicionamiento de elementos](manage-paywall-ui-elements#ignore-safe-area).
:::
## Imagen \{#image\}
