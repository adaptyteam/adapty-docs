...
* El primer placement que encuentra el usuario determina qué paywall muestra Adapty. No puedes cambiar la asignación de un usuario ni inscribir al mismo usuario en más de una prueba A/B entre placements.

* Un dispositivo se entera de las asignaciones entre placements realizadas en otro lugar —por ejemplo, en otro dispositivo del mismo usuario— solo cuando la app pasa a primer plano, y como máximo una vez cada 60 segundos. Esta sincronización no se puede forzar, así que una asignación puede tardar hasta un minuto, o hasta el siguiente paso a primer plano, en llegar a una sesión en ejecución prolongada.

:::warning
Una vez que un usuario recibe un paywall de Crossplacement, lo verá durante 90 días, incluso después de que detengas la prueba. Para cambiar esta duración, en los ajustes **General**, modifica la **[Cross-placement variation stickiness](general#9-cross-placement-variation-stickiness)**.
:::
