...
Esta guía explica qué cambia al pasar a flows y cómo implementar el cambio sin interrumpir a los usuarios con versiones antiguas de la app.

:::important
Los flows solo están disponibles actualmente en iOS y Android SDK v4 y versiones superiores. La compatibilidad con otras plataformas y frameworks llegará próximamente.
:::
...
1. **[Crea tu flow](#build-your-flow)**: Diseña un flow en el editor sin código; sin necesidad de desarrolladores.
...
4. **[Actualiza el SDK](#update-the-sdk)**: Actualiza al SDK de iOS o Android v4, obtén el flow desde su placement y verifica una compra en sandbox. Esta es la tarea principal del desarrollador.
...
Con tu placement de flow listo, apunta la app hacia él. Los flows solo se renderizan en el SDK de Adapty v4 en adelante. Actualiza el SDK y obtén el flow desde tu nuevo placement con `getFlow`. Consulta la guía de migración a v4 para tu plataforma — [iOS](migration-to-ios-sdk-v4) o [Android](migration-to-android-sdk-v4) — para ver los pasos concretos de actualización.

Una vez que el flow esté integrado, verifícalo como cualquier otro flujo de compra: ejecútalo en un dispositivo o simulador y realiza una compra en sandbox ([iOS](ios-test) / [Android](testing-on-android)) para confirmar que los productos, la compra y el nivel de acceso funcionan correctamente.
:::note
