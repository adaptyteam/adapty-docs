...
Esta guía explica qué cambia al pasar a flows y cómo aplicar el cambio sin afectar a los usuarios en versiones antiguas de la app.

:::important
Los flows actualmente son compatibles con iOS SDK v4 y superior, Android SDK v4 y superior, y React Native SDK v4 y superior. La compatibilidad con otras plataformas y frameworks llegará próximamente.
:::
<div style={{
    maxWidth: '560px',
    margin: '0 auto 2rem',
...
1. **[Crea tu flow](#build-your-flow)**: Crea un flow en el editor sin código; sin necesidad de un desarrollador.
2. **[Previsualiza en el dispositivo](#preview-on-device)**: Comprueba el flow en un dispositivo real a través de la app móvil de Adapty; sin necesidad de compilar la app.
3. **[Crea un nuevo placement para tu flow](#create-a-new-placement-for-your-flow)**: Crea un nuevo placement de flow con su propio ID único y decide cómo coexiste con tus placements existentes.
4. **[Actualiza el SDK](#update-the-sdk)**: Actualiza a iOS, Android o React Native SDK v4, obtén el flow desde su placement y verifica una compra en sandbox. Esta es la tarea principal del desarrollador.
...
Con tu placement de flow listo, apunta la app hacia él. Los flows solo se renderizan en el SDK de Adapty v4 o posterior. Actualiza el SDK y obtén el flow desde tu nuevo placement con `getFlow`. Consulta la guía de migración a v4 para tu plataforma — [iOS](migration-to-ios-sdk-v4), [Android](migration-to-android-sdk-v4) o [React Native](migration-to-react-native-sdk-v4) — para ver los pasos concretos de actualización.
