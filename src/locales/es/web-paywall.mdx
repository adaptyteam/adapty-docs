...
- Si usas el Flow builder, solo necesitas [añadir un nuevo botón](#step-2a-add-a-web-purchase-button) que utilizará el enlace que has proporcionado para rastrear las compras y enviar los datos de vuelta a Adapty.
- Si usas el SDK, debes configurar el método [`openWebPaywall`](#step-2b-call-the-sdk-method) para gestionar los paywalls web.
