...
Si utilizas el **Flow & Paywall Builder**, necesitas añadir un botón de paywall web. El botón usará el enlace que has proporcionado para rastrear las compras y enviar los datos de vuelta a Adapty.
