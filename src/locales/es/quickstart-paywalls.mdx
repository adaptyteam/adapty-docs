...
El SDK de Adapty renderiza los flows de forma nativa en cada plataforma. Tu app llama a `getFlow`, y el SDK muestra las pantallas, gestiona las compras y registra los eventos. Sin código de UI adicional, sin un paywall que mantener en paralelo.
