...
<TabItem value="flow-builder" label="Usar el Flow Builder" default>

:::important
El Flow Builder actualmente es compatible con iOS, Android, React Native y Capacitor SDK v4 y versiones posteriores. La compatibilidad con otras plataformas estará disponible próximamente.
:::
