...
Obtén más información sobre el [Adapty Flow & Paywall Builder](adapty-flow-builder).

<ZoomImage id="new-flow.webp" />

Las guías de plantillas a continuación repasan los patrones más comunes paso a paso:
...
Una vez que tu flow esté guardado y publicado, continúa conectándolo a un placement.
