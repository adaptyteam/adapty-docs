...
:::info
A partir de Adapty SDK 3.17.3 y 4.0.2, Adapty funciona con Google Play Billing Library v8.

La compatibilidad con una versión de Billing Library no significa que Adapty admita todas las funciones que Google introdujo en ella. Antes de adoptar una nueva funcionalidad de facturación de Google Play, consulta [Producto en Play Store](android-products).
:::
