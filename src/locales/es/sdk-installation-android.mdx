...
:::info
Por defecto, Adapty SDK 4.0.2 y versiones posteriores funcionan con Google Play Billing Library v8. Las versiones anteriores del SDK funcionan con v7.0.0 por defecto y son compatibles con Billing Library hasta 8.x — para forzar una versión posterior, añade manualmente la [dependencia](https://developer.android.com/google/play/billing/integrate#dependency).
:::
