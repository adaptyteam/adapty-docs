...
Usa `AdaptyUI.configureMediaCache` para sobrescribir el tamaño de caché y el período de validez predeterminados. Esto es opcional: si no llamas a este método, se usarán los valores predeterminados (100 MB en disco, 7 días de validez).
