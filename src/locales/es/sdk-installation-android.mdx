...
:::info
Adapty SDK 4.0.2 y versiones posteriores funcionan con Google Play Billing Library v8.

La compatibilidad con una versión de la Billing Library no implica que Adapty sea compatible con todas las funciones que Google introdujo en ella. Antes de adoptar una nueva función de facturación de Google Play, consulta [Product in Play Store](android-products).
:::
