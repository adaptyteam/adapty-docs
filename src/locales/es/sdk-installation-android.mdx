...
Requisito mínimo de SDK: `minSdkVersion 21`

:::info
A partir de la versión 3.17.3 en la línea 3.x y de la versión 4.0.2 en la línea 4.x, el SDK de Adapty para Android utiliza Billing Library v8 por defecto. Las versiones 3.15.0 a 3.17.2 y 4.0.0 a 4.0.1 usan v7, y también funcionan cuando otra dependencia en tu build eleva la Billing Library a v8.
