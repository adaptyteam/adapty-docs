...
description: "Permite que los usuarios compren un producto desde tu paywall de FlutterFlow a través de Adapty."
metadataTitle: "Habilitar compras en un paywall de FlutterFlow | Documentación de Adapty"
---

¡Enhorabuena! Has [configurado tu paywall para mostrar los datos de producto de Adapty](ff-add-variables-to-paywalls) con éxito, incluyendo el título del producto y el precio.

Ahora pasemos al último paso: permitir que los usuarios realicen una compra a través del paywall.
