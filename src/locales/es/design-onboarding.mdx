...
- **Media & Display**: Además de imágenes y vídeos, puedes añadir gráficos animados que muestran el valor de tu app y animan a los usuarios a suscribirse.
Los **formatos de vídeo compatibles** son MP4 y WebM. El **tamaño máximo del archivo multimedia** es de 15 MB.
...
Si usas funnels web a app creados en [FunnelFox](https://funnelfox.com/) y quieres usar pantallas de esos funnels en tus onboardings, puedes hacerlo fácilmente copiando pantallas en el constructor de funnels y pegándolas en el constructor de onboardings:
