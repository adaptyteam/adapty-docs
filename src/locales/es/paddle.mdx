...
Una vez que integres Paddle, Adapty estará listo para ofrecer insights de inmediato. Para aprovechar al máximo tus datos de Paddle, puedes configurar integraciones adicionales de Adapty para reenviar eventos de Paddle, centralizando todos tus análisis de suscripciones en un único Adapty Dashboard.
...
Amplitude, Firebase / Google Analytics y Mixpanel mantienen credenciales separadas por plataforma. Rellena los campos de **Paddle** en la página de integración — los eventos de Paddle no usan tus credenciales de iOS ni de Android.
