...
3. Elige un preset de diseño: lista vertical, lista horizontal, carrusel de características, tarjetas de características, lista de banners o hoja inferior.

<ZoomImage id="product-element.webp" width="500px" alt="Añadiendo un elemento de producto al canvas" />

4. Selecciona cada tarjeta de producto y asígnale un producto en el desplegable del panel **Design**.
<ZoomImage id="product-card.webp" width="500px" alt="Añadiendo un elemento de producto al canvas" />

:::note
También puedes adjuntar directamente una acción de **Purchase** a la interacción **On tap** de una tarjeta de producto. Al tocar la tarjeta se activa la compra, sin necesidad de un botón de compra independiente.
:::
