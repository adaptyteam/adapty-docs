---
title: "Mostrar un paywall segmentado con Apple Ads en el primer lanzamiento en iOS SDK"
...
metadataTitle: "Mostrar paywall segmentado con Apple Ads en el primer lanzamiento | iOS SDK | Documentación de Adapty"
---
