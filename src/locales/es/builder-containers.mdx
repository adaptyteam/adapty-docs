...
metadataTitle: "Elementos de diseño: contenedores, carruseles y hojas inferiores | Flow Builder | Documentación de Adapty"
---
...
<ZoomImage id="flow-builder/alignment-distribution-demo.webp" width="400px" alt="Un Stack en el lienzo junto con su configuración de Layout" float="right"/>
...
- **Heading** — una pila en la parte superior del sheet, con una capa de texto **Title** y un botón **Close** <Inline id="close.svg" alt="Close" /> ya incluidos. Edítalos o elimínalos según necesites.
...
<ZoomImage id="builder-divider-demo.webp" width="300px" alt="Un divisor horizontal bajo un encabezado y divisores verticales entre tres tarjetas de características" float="right" />
