...
metadataTitle: "Usar flows de respaldo en Flutter | Documentación de Adapty"
---
...
1. Añade los archivos de configuración de respaldo al directorio `assets` de la app en la raíz del proyecto.
