...
La categoría de elementos **User Engagement** ofrece cuatro plantillas para mostrar reseñas, valoraciones y prueba social en un paywall. Cada plantilla es una composición totalmente editable: sustituye el texto de ejemplo y aplica tus [estilos de color](builder-styling) y [tipografía](onboarding-text) para que coincida con el resto del flow.
