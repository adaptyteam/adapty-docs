...
[Apple Ads Manager](adapty-ads-manager) utiliza una conexión separada. Conecta tu cuenta de Apple Ads en los [ajustes de Apple Ads Manager](adapty-ads-manager-get-started).
:::
...
Una vez que hayas configurado la integración con Apple Ads, Adapty comenzará a recibir datos de atribución de Apple Ads. Puedes acceder y consultar estos datos fácilmente en la página de perfiles.
<Zoom>
...
#### Paso 2: Configurar la gestión de usuarios en Apple Ads \{#step-2-configure-user-management-on-apple-ads\}
