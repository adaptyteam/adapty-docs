---
title: "Paso 2. Añadir datos a la página de paywall"
description: "Mapea los datos de productos de Adapty, como el título y el precio, en la página de paywall que diseñaste en FlutterFlow."
metadataTitle: "Añadir datos de productos de Adapty a un paywall de FlutterFlow | Documentación de Adapty"
---

Una vez que hayas [recibido todos los datos de producto necesarios](ff-action-flow), es momento de mapearlos en el paywall que diseñaste en FlutterFlow. En este ejemplo, mapearemos el título del producto y su precio.
