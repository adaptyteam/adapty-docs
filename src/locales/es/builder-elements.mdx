---
title: "Elementos"
description: "Todos los elementos visuales disponibles en el Flow & Paywall Builder: contenedores de diseño, texto, multimedia, listas, botones, entradas, productos y más."
metadataTitle: "Elementos | Flows y paywalls | Documentación de Adapty"
---

Para abrir la biblioteca de elementos y añadir un nuevo elemento a una pantalla, haz clic en el botón más <Inline id="plus.svg" alt="Plus" /> del panel izquierdo o encima de la vista previa del dispositivo.

Los elementos se dividen en las siguientes categorías:
- [Básicos](#basics) (contenedores de diseño, texto, medios, listas, insignias, marcas de verificación)
- [Formularios y Quiz](#forms--quiz) (botones, inputs, quizzes, pestañas)
- [Paywall y Comercio](#paywall--commerce) (productos, toggles, interacción con el usuario, cuenta regresiva)
...
<ZoomImage id="layout-element-templates.webp" width="350px" alt="Plantillas de elementos de diseño" float="left" />

Los elementos de diseño son contenedores que organizan los elementos que contienen.

- **Contenedor vertical**: organiza los elementos hijos de arriba hacia abajo
- **Contenedor horizontal**: organiza los elementos hijos de izquierda a derecha
...
- **Sliding sheet**: un panel que superpone el contenido principal sobre una imagen hero
- **Bottom Sheet**: un panel deslizante anclado a la parte inferior de la pantalla
...
Iconos de indicador para usar dentro de [elementos seleccionables](flow-selectable-elements), como tarjetas de producto. Cada forma tiene un preset de activado y otro de desactivado.
...
Para un interruptor o casilla que el usuario pulsa directamente, usa los elementos [Toggle](#toggle) en su lugar.
...
:::link
Artículo principal: [Toggles y casillas de verificación](builder-toggles)
:::

<ZoomImage id="toggle-template.webp" width="200px" alt="Plantillas de toggle" float="right" />

Interruptores y casillas de verificación que los usuarios pulsan para activar o desactivar algo. Cada uno es un [elemento seleccionable](flow-selectable-elements), por lo que otros elementos pueden reaccionar a su estado.

- **Trial toggle**: cambia el producto mostrado entre su precio estándar y su oferta de prueba gratuita
- **Checkbox**: una casilla de verificación con etiqueta de texto, prellenada con una línea de consentimiento de términos y privacidad
- **Toggle**: un interruptor con etiqueta de texto

### Participación de usuarios \{#user-engagement\}

:::link
Artículo principal: [Reseñas y testimonios](builder-reviews-and-testimonials)
:::

Bloques con estilo predefinido que incluyen valoraciones de usuarios para generar confianza y fomentar la conversión. Las plantillas son contenedores básicos con contenido de marcador de posición.

<ZoomImage id="user-engagement-templates.webp" width="400px" alt="User engagement templates" float="right" />

- **Review**: una valoración con estrellas, el texto de la reseña y el nombre del autor
- **Review Carousel**: tarjetas de reseñas deslizables con puntos de paginación
- **Rating**: una puntuación numérica con visualización de estrellas
- **App Rating**: una puntuación destacada con barra de estrellas y número de reseñas
- **Social Proof**: un grupo de avatares con el número de usuarios

### Cuenta regresiva \{#countdown\}

:::link
Artículo principal: [Temporizador de cuenta regresiva](flow-timer)
:::

<ZoomImage id="countdown-templates.webp" width="300px" alt="Plantillas de temporizador de cuenta regresiva" float="right" />

Muestra horas, minutos y segundos contando hacia atrás hasta llegar a cero. Úsalo para crear urgencia en ofertas por tiempo limitado. El temporizador puede desencadenar acciones al llegar a cero, como navegar a otra pantalla u ocultar el distintivo de descuento.
