...
### Escucha de actualizaciones del estado de suscripción \{#listening-for-subscription-status-updates\}
...
:::note
En SDK 4.0, las interfaces de listener siguen la convención de prefijo I de C#: implementa `IAdaptyEventListener` en lugar de `AdaptyEventListener`. Los métodos no cambian. Consulta la [guía de migración](migration-to-unity-sdk-v4).
:::
