...
description: "Rastrea y gestiona el estado de la suscripción de los usuarios en Adapty para mejorar la retención de clientes en tu app de Unity."
metadataTitle: "Entender el estado de la suscripción | Documentación de Adapty"
keywords: ['getProfile']
---

Con Adapty, hacer un seguimiento del estado de la suscripción es muy sencillo. No es necesario insertar manualmente los IDs de producto en tu código. En su lugar, puedes confirmar fácilmente el estado de la suscripción de un usuario comprobando si tiene un [nivel de acceso](access-level) activo.

<details>
   <summary>Antes de comenzar a verificar el estado de la suscripción (Haz clic para expandir)</summary>
