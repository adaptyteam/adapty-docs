...
### Cómo escuchar actualizaciones del estado de suscripción \{#listening-for-subscription-status-updates\}

Cada vez que cambia la suscripción del usuario, Adapty lanza un evento.

Para recibir mensajes de Adapty, es necesario realizar una configuración adicional:
...
Adapty también lanza un evento al inicio de la aplicación. En este caso, se pasará el estado de suscripción en caché.
