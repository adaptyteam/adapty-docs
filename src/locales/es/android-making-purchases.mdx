...
Mostrar paywalls en tu aplicación móvil es un paso esencial para ofrecer a los usuarios acceso a contenido o servicios premium. Sin embargo, simplemente mostrar estos paywalls solo es suficiente para gestionar compras si usas [Paywall Builder](adapty-paywall-builder) para personalizarlos.
...
:::warning
Ten en cuenta que la oferta introductoria se aplicará automáticamente solo si utilizas paywalls configurados con el Paywall Builder.
