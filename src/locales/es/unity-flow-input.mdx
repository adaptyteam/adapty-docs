...
Los inputs y los grupos seleccionables reportan sus valores automáticamente. Para distinguirlos en tu código, asigna a cada input un **Element ID** significativo y a cada grupo seleccionable un **Group ID** en el builder.
