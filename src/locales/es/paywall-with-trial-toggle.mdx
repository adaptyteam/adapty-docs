---
title: "Crear un paywall con un interruptor de prueba"
description: "Cambia un paywall entre productos con y sin prueba gratuita, y mantén el producto seleccionado sincronizado con el interruptor."
metadataTitle: "Crear un paywall con un interruptor de prueba | Flows y paywalls | Documentación de Adapty"
---
...
## 2. Añadir el interruptor de prueba \{#2-add-the-trial-toggle\}

1. Haz clic en **+** > **Paywall & Commerce** > **Toggle** > **Trial toggle**.
...
2. Asegúrate de que el interruptor pertenece a un grupo seleccionable del tipo correcto. Haz clic en un área vacía del canvas para abrir **Screen settings**. En **Selectable groups**, abre `trial_toggle`, establece **Group Type** en **Toggle** y haz clic en **Save**. El diálogo muestra la variable que usaremos para detectar si el interruptor está activado: `trial_toggle.isActive`.

<ZoomImage id="paywall-trial-toggle-group-type.webp" width="500px" alt="El cuadro de diálogo Editar grupo con el tipo de grupo establecido en Toggle y la variable de condición trial_toggle.isActive debajo" />

3. Edita la etiqueta del toggle.

Deja el toggle desactivado por defecto. Un toggle de prueba preseleccionado puede provocar el rechazo en la App Store por considerarse un dark pattern — consulta [Toggles y checkboxes](builder-toggles).
