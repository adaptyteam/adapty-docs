...
Adapty otorgará automáticamente niveles de acceso a los usuarios históricos y restaurará sus eventos de compra en cuanto abran la app con el SDK de Adapty integrado. Para este caso de uso, no es necesario importar datos históricos. Sin embargo, importar los datos garantiza unas analíticas precisas si tienes un número significativo de transacciones históricas, aunque en general no es obligatorio para la migración.
:::
