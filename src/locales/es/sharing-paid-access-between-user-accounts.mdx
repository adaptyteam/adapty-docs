...
:::
:::warning
La transferencia mueve el nivel de acceso en sí, no solo la compra de la store. Cuando una restauración transfiere el acceso a un nuevo perfil, Adapty revoca ese nivel de acceso del perfil anterior aunque haya sido otorgado por una store diferente; por ejemplo, una compra web (Stripe) asignada al mismo nivel de acceso. Si las compras web y las compras in-app deben mantenerse independientes, asigna sus productos a niveles de acceso separados.
:::
