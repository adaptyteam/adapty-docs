...
:::important
Esta guía cubre el Remote Config para paywalls clásicos. Para el Flow & Paywall Builder, consulta [Personalizar el flow con Remote Config](customize-flow-with-remote-config).
:::

El Remote Config de los paywalls es una herramienta potente que ofrece opciones de configuración flexibles. Permite usar payloads JSON personalizados para adaptar tus paywalls con precisión. Con él, puedes definir parámetros como títulos, imágenes, fuentes, colores y mucho más.
