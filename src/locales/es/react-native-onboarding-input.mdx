---
title: "Procesar datos de onboardings en React Native SDK"
description: "Guarda y usa datos de onboardings en tu aplicación React Native con el SDK de Adapty."
metadataTitle: "Onboardings | React Native SDK | Documentación de Adapty"
---

Cuando tus usuarios responden a una pregunta de un cuestionario o introducen datos en un campo de entrada, se invocará el método `onStateUpdatedAction`. Puedes guardar o procesar el tipo de campo en tu código.
