...
:::warning
Pasa el código de idioma exactamente como está configurado en el dashboard — subtags en minúsculas separados por guiones. No pases un identificador de idioma del dispositivo tal cual: `getLocales()[0].languageTag` de [`react-native-localize`](https://github.com/zoontek/react-native-localize) devuelve `pt-BR`, y recurre a la localización predeterminada. Convierte el valor en tu app antes de pasarlo.
:::
