...
Las entradas y los grupos seleccionables informan sus valores automáticamente. Para distinguir las entradas en tu código, asigna a cada entrada un **Element ID** significativo y a cada grupo seleccionable un **Group ID** en el builder.
