---
title: "Procesar datos de onboardings en el SDK de Capacitor"
description: "Guarda y usa datos de onboardings en tu app de Capacitor con el SDK de Adapty."
metadataTitle: "Onboardings | SDK de Capacitor | Documentación de Adapty"
---

<OnboardingDeprecation />

Cuando tus usuarios responden a una pregunta de un cuestionario o introducen datos en un campo de entrada, se invocará el método `onStateUpdated`. Puedes guardar o procesar el tipo de campo en tu código.
...
Consulta el formato de las acciones [aquí](https://capacitor.adapty.io/types/onboardingstateupdatedaction).
