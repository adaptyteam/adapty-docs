...
## 1. Instala el plugin \{#install-the-plugin\}

Para instalar el plugin:

1. Abre la página del plugin [Import to Adapty](https://www.figma.com/community/plugin/1674065404672377144).
...
- **Products**: La importación crea tarjetas de producto, añade acciones de compra e inserta marcadores de posición para las variables de producto. Debes vincular tus productos reales y reemplazar los marcadores tú mismo. Consulta [Configurar compras](paywall-product-block).
- **Typefaces**: La importación no asigna ninguna fuente a tu texto. Para restaurar tu tipografía, [sube el archivo de fuente](using-custom-fonts-in-flow-builder) y selecciónala para el texto afectado.
- **Videos**: Un vídeo se exporta como marcador de posición. [Añade el vídeo](custom-media) en el constructor después.
