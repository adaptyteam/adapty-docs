---
title: "Pushwoosh"
description: "Integra Pushwoosh con Adapty para un seguimiento de notificaciones push sin interrupciones."
...
Adapty utiliza eventos de suscripción para actualizar las etiquetas del perfil de [Pushwoosh](https://www.pushwoosh.com/), de modo que puedas crear comunicaciones dirigidas con tus clientes mediante notificaciones push tras una configuración de integración sencilla y rápida, tal como se describe a continuación.
