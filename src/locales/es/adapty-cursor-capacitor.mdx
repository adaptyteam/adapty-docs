...
:::info
Este tutorial está orientado al SDK de Adapty para Capacitor v4 (beta) — la API que enseña la [guía de inicio rápido](capacitor-quickstart-paywalls). La v4 es una versión preliminar, así que asegúrate de que tu LLM fije la versión exacta (`npm install @adapty/capacitor@4.0.0-beta.3`) en lugar de instalar la última versión estable 3.x. Consulta la [sección de instalación del SDK 4.0](sdk-installation-capacitor#adapty-sdk-40-beta) y la [guía de migración](migration-to-capacitor-sdk-v4).
:::
