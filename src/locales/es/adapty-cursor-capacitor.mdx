...
:::info
Este tutorial está orientado a Adapty Capacitor SDK v4 (beta) — la API que enseña la [guía de inicio rápido](capacitor-quickstart-paywalls). v4 es una versión preliminar, así que asegúrate de que tu LLM fije la versión exacta (`npm install @adapty/capacitor@4.0.1-beta.1`) en lugar de instalar la versión estable 3.x más reciente. Consulta la [sección de instalación del SDK 4.0](sdk-installation-capacitor#adapty-sdk-40-beta) y la [guía de migración](migration-to-capacitor-sdk-v4).
:::
