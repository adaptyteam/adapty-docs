...
:::important
Esta guía cubre el manejo de eventos para compras, restauraciones, selección de productos y renderizado. El cierre de la vista y la apertura de enlaces los gestiona la implementación predeterminada de `flowViewDidPerformAction`; consulta nuestra [guía sobre el manejo de acciones de botones](flutter-handle-paywall-actions) para sobreescribirla o para gestionar acciones de botones personalizadas.
:::
...
Consulta [Rastrear vistas de pantallas del flow](flutter-flow-screen-views) para saber qué hacer con ellos.

Un flow también informa los valores que los usuarios escriben y seleccionan. Consulta [Procesar datos de flows](flutter-flow-input) para leerlos.
...
Esta guía cubre únicamente **paywalls creados en el builder antiguo**, que requieren el SDK de Adapty v3.0 o posterior.
