---
title: "Establecer atributos de usuario en el SDK de iOS"
...
Puedes establecer atributos opcionales como email, número de teléfono, etc., para los usuarios de tu app. Luego puedes usar estos atributos para crear [segmentos](segments) de usuarios o simplemente visualizarlos en el CRM.
