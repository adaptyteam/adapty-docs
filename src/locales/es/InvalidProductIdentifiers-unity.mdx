---
title: "Solución para el error Code-1000 noProductIDsFound en Unity SDK"
description: "Resuelve errores de identificador de producto no válido al gestionar suscripciones en Adapty."
metadataTitle: "Cómo solucionar identificadores de producto no válidos | Documentación de Adapty"
...
Si estás viendo el error `noProductIDsFound`, sigue estos pasos para resolverlo:
