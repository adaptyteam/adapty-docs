---
title: "Migrar el SDK de Adapty para Android a la versión 4.0"
description: "Migra al SDK de Adapty para Android v4.0 reemplazando las APIs de paywall por APIs de flow, compatibles tanto con el Flow Builder como con el Paywall Builder."
metadataTitle: "Migrar al SDK de Adapty para Android v4.0 | Documentación de Adapty"
---

El SDK de Adapty para Android 4.0 introduce los flows y cambia el nombre de las APIs de paywall en consecuencia. Las nuevas APIs funcionan tanto con el nuevo Flow Builder como con el Paywall Builder existente — no se requieren cambios de configuración en el Adapty Dashboard.
