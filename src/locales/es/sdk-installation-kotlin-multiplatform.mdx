...
:::info
A partir de la versión 3.17.0, el SDK de Adapty para Kotlin Multiplatform usa Billing Library v8 por defecto. Las versiones 3.15.0 a 3.16.2 usan v7, y también funcionan cuando otra dependencia en tu compilación de Android eleva la Billing Library a v8.
