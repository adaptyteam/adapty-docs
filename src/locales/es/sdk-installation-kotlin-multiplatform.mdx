...
## Instala el SDK de Adapty con Gradle \{#install-adapty-sdk-via-gradle\}
...
- Si usas catálogos de versiones, añade las dependencias a tu archivo `libs.versions.toml` y luego referéncialas en `build.gradle.kts`
