...
Para una guía de implementación completa, también puedes ver el vídeo:
...
:::info
A partir de la versión SDK v3.17, Adapty SDK usa Google Play Billing Library v8.0.0 por defecto.

La compatibilidad con una versión de la Billing Library no significa que Adapty sea compatible con todas las funciones que Google introdujo en ella. Antes de adoptar una nueva funcionalidad de facturación de Google Play, consulta [Producto en Play Store](android-products).
:::
