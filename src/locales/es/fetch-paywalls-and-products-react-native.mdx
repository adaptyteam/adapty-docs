...
Antes de mostrar Remote Config y los paywalls personalizados, necesitas obtener la información sobre ellos. Ten en cuenta que este tema hace referencia a Remote Config y los paywalls personalizados. Para obtener orientación sobre cómo obtener flows o paywalls personalizados en el **Flow & Paywall Builder** o en el **old Paywall Builder**, consulta [Obtener flows y paywalls y su configuración](react-native-get-pb-paywalls).
