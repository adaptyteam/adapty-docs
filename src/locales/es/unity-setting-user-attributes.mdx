---
title: "Establecer atributos de usuario en Unity SDK"
description: "Aprende cómo actualizar los atributos de usuario y los datos de perfil en tu app de Unity con el SDK de Adapty."
metadataTitle: "Actualizar datos de usuario | Unity SDK | Documentación de Adapty"
customSlug: /unity-setting-user-attributes
displayed_sidebar: sdkunity
---

Puedes establecer atributos opcionales como correo electrónico, número de teléfono, etc., para los usuarios de tu app. Después puedes usar esos atributos para crear [segmentos](segments) de usuarios o simplemente verlos en el CRM.
