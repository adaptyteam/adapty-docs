...
Por defecto, la tabla tiene 2 variantes y 1 placement. Puedes añadir hasta 20 variantes. Una vez que añades un segundo placement, la prueba se convierte en una prueba A/B Crossplacement. Ten en cuenta que las pruebas A/B crossplacement solo están disponibles para paywalls.

   Cada variante también puede tener un nombre, que aparece en la lista de pruebas A/B y en las métricas de la prueba. Introdúcelo en la primera columna de la fila de la variante. Si dejas el campo en blanco, Adapty etiqueta esa variante por posición: `Variant A`, `Variant B`, etc.
