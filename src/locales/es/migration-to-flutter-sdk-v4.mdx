...
description: "Migra al SDK de Flutter de Adapty v4.0 reemplazando las APIs de paywall por APIs de flow, que renderizan flows además de los paywalls del builder anterior."
metadataTitle: "Migración al SDK de Flutter de Adapty v4.0 | Documentación de Adapty"
---

El SDK de Flutter de Adapty 4.0 introduce los flows y renombra las APIs de paywall en consecuencia. Las nuevas APIs funcionan con flows y siguen siendo compatibles con los paywalls del builder anterior — no se requieren cambios de configuración en el Adapty Dashboard.
