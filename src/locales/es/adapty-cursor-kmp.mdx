...
Esta guía te lleva paso a paso por la integración de Adapty en tu app Flutter con una herramienta de IA — solo tienes que darle la documentación de Adapty correcta en el orden adecuado. Para un flow totalmente automatizado, usa el [skill adapty-sdk-integration](adapty-sdk-integration-skill-kmp) en su lugar.
