...
metadataTitle: "Usar paywalls de respaldo y onboardings | SDK Unity | Documentación de Adapty"
customSlug: /unity-use-fallback-paywalls
displayed_sidebar: sdkunity
---

:::warning
Los paywalls de respaldo son compatibles con el SDK de Unity v2.11 y versiones posteriores.
:::
