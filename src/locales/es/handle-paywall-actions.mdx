...
description: "Gestiona acciones de botones y procesa la entrada del usuario de los flows de paywall y onboarding en tu app de iOS."
...
:::warning
**Solo el cierre del flow/paywall y la apertura de URLs se gestionan automáticamente.** El resto de acciones de los botones requieren implementación explícita en el código de la app.
:::
...
1. En el Paywall Builder antiguo, añade un botón y asígnale una acción predefinida o un ID de acción personalizada.
2. Escribe código en tu app para gestionar cada acción que hayas asignado.
