...
Cuando tus usuarios responden a una pregunta de un quiz o introducen sus datos en un campo de texto, se invocará el método `onStateUpdatedAction`. Puedes guardar o procesar el tipo de campo en tu código.
...
<Details>
<summary>Formas de las propiedades para cada tipo de params (haz clic para expandir)</summary>
