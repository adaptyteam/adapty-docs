...
:::info
Esta funcionalidad requiere Adapty Kotlin Multiplatform SDK 4.0 (beta) o posterior — anteriormente solo estaba disponible en los SDKs nativos de iOS y Android. Consulta la [guía de migración](migration-to-kmp-sdk-v4) para actualizar.
:::
