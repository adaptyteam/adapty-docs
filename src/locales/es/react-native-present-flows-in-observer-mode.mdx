...
:::warning
Esta sección se refiere únicamente al [modo Observer](observer-vs-full-mode). Si no trabajas en modo Observer, consulta el tema [Mostrar flows y paywalls](react-native-present-paywalls).
:::

:::info
Esta funcionalidad requiere Adapty React Native SDK 4.0 o posterior; anteriormente solo estaba disponible en los SDK nativos de iOS y Android. Consulta la [guía de migración](migration-to-react-native-sdk-v4) para actualizar.
:::
