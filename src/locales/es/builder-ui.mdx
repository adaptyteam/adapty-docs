...
<ZoomImage id="flow-builder/flow-builder-products-tab.webp" width="400px" alt="Panel de productos en el panel izquierdo del Flow & Paywall Builder" float="left" />

El botón de productos <Inline id="products.svg" alt="Products" /> abre la lista de productos. Muestra qué productos están asignados a cada pantalla de tu flow. Puedes usar esta vista para [gestionar los productos y ofertas del flow](paywall-product-block#manage-flow-products).
