...
Para configurar esta integración, tendrás que seguir unos sencillos pasos en Google Cloud Console y en el Adapty Attribution Dashboard.

:::note
Programación

Adapty Attribution exporta un conjunto de archivos por día natural a Google Cloud Storage. El programador de exportaciones se ejecuta tres veces al día: a las **02:00**, **04:00** y **06:00 UTC**. Cada ejecución crea el trabajo de exportación del día anterior si aún no existe, o lo reintenta si una ejecución anterior falló. Por lo general, los datos estarán disponibles tras la ejecución de las 02:00; las ejecuciones posteriores sirven para recuperarse de posibles fallos, no para añadir datos nuevos.

Cada archivo contendrá los datos de los eventos creados durante el día natural anterior completo en UTC. Por ejemplo, los datos exportados el 8 de marzo contendrán todos los eventos creados el 7 de marzo desde las 00:00:00 hasta las 23:59:59 en UTC.
:::

:::warning
La exportación programada solo se ejecuta para empresas con un plan de pago o en período de prueba. Si tu empresa no cumple ninguno de estos requisitos, el programador la omite y no escribe ningún archivo, aunque la integración siga habilitada en el dashboard. Si tu bucket está vacío y la configuración parece correcta, comprueba primero el estado de tu plan.
:::
...
| `store`                  | Store de apps (`ios`, `android`)          |
