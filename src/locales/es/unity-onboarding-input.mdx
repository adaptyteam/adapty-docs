...
description: "Guarda y utiliza datos de onboardings en tu app de Unity con el SDK de Adapty."
...
Cuando tus usuarios responden a una pregunta de un cuestionario o introducen sus datos en un campo de entrada, se invocará el método `OnboardingViewOnStateUpdatedAction`. Puedes guardar o procesar el tipo de campo en tu código.
