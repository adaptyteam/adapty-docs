...
## Antes de empezar: verifica que el paywall tenga productos \{#before-you-start-verify-the-paywall-has-products\}

El mismo error ocurre cuando el paywall al que resuelve tu placement no tiene productos asociados: el SDK solicita entonces una lista de productos vacía, y ninguna comprobación en el App Store puede corregirlo. En el Adapty Dashboard, abre el paywall que aparece en este placement y confirma que su sección **Products** lista los productos que esperas. Si es así, continúa con el Paso 1.
