...
You can "untie" a purchase by [deleting the owner’s user profile](https://adapty.io/docs/api-adapty/operations/deleteProfile). After deletion, the access level becomes available to the first user profile that claims it, whether anonymous or identified.
