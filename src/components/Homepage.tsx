...
const T = {
  ...
  fr: {
    hero: "Adapty est une plateforme d'achats in-app puissante et flexible qui vous aide à développer votre base d'abonnés. Que vous débutiez ou que vous ayez déjà des millions d'utilisateurs, Adapty vous permet de définir facilement les meilleurs prix d'abonnement, de tester différentes approches et de découvrir ce qui fonctionne le mieux pour le succès de votre app.",
    discoverTitle: "Adapty est-il fait pour moi ?",
    discoverDesc: "Trouvez votre cas d'usage — que vous lanciez une nouvelle app, optimisiez vos revenus ou migriez depuis un autre outil.",
    quickstartTitle: "Guide de démarrage rapide",
    quickstartDesc: "Connectez Adapty à vos comptes store, configurez vos produits et laissez Adapty gérer les achats dans votre app.",
    quickstartBtn: "Configurer Adapty dans mon app",
    ...
    analyticsTitle: "Explorez les analytics",
    analyticsDesc: "Analysez les métriques détaillées de la monétisation de votre app.",
    integrationsTitle: "Connectez vos intégrations",
    integrationsDesc: "Envoyez des événements aux services d'analytics et d'attribution tiers que votre équipe utilise déjà.",
    paywallTitle: "Concevez des paywalls dans le builder no-code",
    paywallDesc: "Créez des paywalls en quelques minutes avec Adapty Paywall Builder. Modifiez vos paywalls sans publier une nouvelle version de votre app.",
