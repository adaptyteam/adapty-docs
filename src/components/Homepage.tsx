    ...
    <div className="homepage-container">
      ...
      <section className="platforms-section">
        ...
        <div className="platform-cards-grid">
          {/* iOS */}
          <a href={`${base}/ios-sdk-overview`} className="platform-card">
            ...
            <div className="platform-card-content">
              ...
              <p className="platform-card-description">{t.ios}</p>
            </div>
          ...
          {/* Android */}
          <a href={`${base}/android-sdk-overview`} className="platform-card">
            ...
            <div className="platform-card-content">
              ...
              <p className="platform-card-description">{t.android}</p>
            </div>
            <svg className="platform-card-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M5 12h14M12 5l7 7-7 7" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          ...
          {/* React Native */}
          <a href={`${base}/react-native-sdk-overview`} className="platform-card">
            <div className="platform-card-icon">
            ...
            <div className="platform-card-content">
              ...
              <p className="platform-card-description">{t.reactNative}</p>
            </div>
            <svg className="platform-card-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M5 12h14M12 5l7 7-7 7" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          ...
          {/* Flutter */}
          <a href={`${base}/flutter-sdk-overview`} className="platform-card">
            <div className="platform-card-icon">
              <svg width="40" height="40" viewBox="0 0 65 65" fill="none">
            ...
            <div className="platform-card-content">
              ...
              <p className="platform-card-description">{t.flutter}</p>
            </div>
            <svg className="platform-card-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M5 12h14M12 5l7 7-7 7" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </a>
          <a href={`${base}/unity-sdk-overview`} className="platform-card">
            <div className="platform-card-icon">
            ...
            <div className="platform-card-content">
              ...
              <p className="platform-card-description">{t.unity}</p>
            </div>
            <svg className="platform-card-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M5 12h14M12 5l7 7-7 7" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </a>
          <a href={`${base}/kmp-sdk-overview`} className="platform-card">
            <div className="platform-card-icon">
            ...
            <div className="platform-card-content">
              ...
              <p className="platform-card-description">{t.kmp}</p>
            </div>
            <svg className="platform-card-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M5 12h14M12 5l7 7-7 7" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </a>
          <a href={`${base}/capacitor-sdk-overview`} className="platform-card">
            <div className="platform-card-icon">
            ...
            <div className="platform-card-content">
              ...
              <p className="platform-card-description">{t.capacitor}</p>
            </div>
            <svg className="platform-card-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M5 12h14M12 5l7 7-7 7" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
