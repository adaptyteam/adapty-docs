...
:::tip
Use [variables](onboarding-variables) for dynamic data visualization in charts.
:::
...
In addition to the basic [element layout](onboarding-layout#element-layout), you can further customize the appearance of images, videos, and charts:
