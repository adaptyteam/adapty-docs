...
<InlineTooltip tooltip="Install Adapty SDK as described in the installation guide">[iOS](sdk-installation-ios), [Android](sdk-installation-android), [Flutter](sdk-installation-flutter), [React Native](sdk-installation-react-native), and [Unity](sdk-installation-unity)</InlineTooltip>.
