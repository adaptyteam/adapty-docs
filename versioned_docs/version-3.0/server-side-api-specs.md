...
- **Authorization header**: API requests must be authenticated with your API key:
  ...
  - For access level and transaction requests, you use your secret API key. For other requests, use either the public or secret API key. Remember to keep your secret key private.
