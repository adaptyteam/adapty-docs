...
description: "Install and configure Adapty SDK in your Capacitor project using Cursor, ChatGPT, Claude, or other AI tools."
metadataTitle: "Use Adapty with LLMs | Capacitor SDK | Adapty Docs"
slug: /adapty-cursor-capacitor
...
You can use large language models (LLMs) to help you integrate Adapty into your Capacitor app. We provide a set of tools and best practices if you use LLMs during development.

## Plain text docs

You can access all of our documentation as plain text markdown files by adding `.md` to the end of any URL or clicking **View as Markdown** under article titles. To copy the whole Markdown content immediately, click **Copy for LLM**. For example, you can find the plain text version of this page itself at [https://adapty.io/docs/adapty-cursor-capacitor.md](https://adapty.io/docs/adapty-cursor-capacitor.md).
...
**Cursor**, the AI code editor, makes it easier to integrate and maintain Capacitor apps with Adapty's infrastructure. This guide shows you how to configure Cursor for better results when working with Adapty's Capacitor SDK.
...
- **Capacitor SDK**: `https://github.com/adaptyteam/AdaptySDK-Capacitor`
- **Unity SDK**: `https://github.com/adaptyteam/AdaptySDK-Unity`

Name each doc `Adapty <Platform> SDK` (e.g., `Adapty Capacitor SDK`).
...
- `@Adapty Docs help me install the Adapty Capacitor SDK`
- `Using @Adapty Capacitor SDK, show me how to handle purchase restoration with proper error handling`
- `@Adapty Docs @Adapty Capacitor SDK help me show a paywall created in the paywall builder` 
