---
title: "Kotlin Multiplatform - Handle errors"
description: "Handle errors in Kotlin Multiplatform with Adapty's SDK."
metadataTitle: "Error Handling in Kotlin Multiplatform | Adapty Docs"
---
...
adapty.makePurchase(product)
    ...
    .onError { error ->
        if (error.code == AdaptyErrorCode.PAYMENT_CANCELLED) {
            // payment cancelled
        } else {
            // other SDK errors
        }
