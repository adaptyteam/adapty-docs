...
Adapty automatically generates [JSON configuration files](/fallback-paywalls) for your fallback paywalls. Download the files from Adapty's web interface to include them in your application.
