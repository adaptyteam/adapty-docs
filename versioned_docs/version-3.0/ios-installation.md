...
You need to configure the AdaptyUI only if you plan to use [Paywall Builder](display-pb-paywalls) and have [installed AdaptyUI](sdk-installation-ios#install-sdks-via-cocoapods):
