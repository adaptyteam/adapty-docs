...
The [Adapty Capacitor SDK](https://github.com/adaptyteam/AdaptySDK-Capacitor/) requires:

- **Capacitor 8** for Adapty SDK v.3.16.0+. If you need Capacitor 7, use Adapty SDK v.3.15.
- **iOS 15.0+**
