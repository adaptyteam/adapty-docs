...
- If products don't exist in App Store and/or Google Play yet, create them in Adapty and push to the stores right away.
- If products already exist in App Store and/or Google Play, create them in Adapty and connect existing store products.
