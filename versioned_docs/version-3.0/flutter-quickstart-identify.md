...
Now, when you know how to identify users, you need to [check their access level](flutter-check-subscription-status.md) to ensure you display a paywall or give access to paid features to right users.