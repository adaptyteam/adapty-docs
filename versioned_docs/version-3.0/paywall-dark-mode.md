...
:::warning
Dark mode is supported on iOS and Android starting with version 3.1.0. Support for React Native, Flutter, and Unity is coming soon. Dark mode is also included in fallback paywalls.
:::
