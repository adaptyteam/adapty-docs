...
Retrieves the details of a specific paywall in your app. Returned objects don't contain information about placements and audiences but contain detailed paywall configuration.
