...
description: "Install and configure Adapty SDK in your Kotlin Multiplatform project using Cursor, ChatGPT, Claude, or other AI tools."
metadataTitle: "Use Adapty with LLMs | Kotlin Multiplatform SDK | Adapty Docs"
...
You can use large language models (LLMs) to help you integrate Adapty into your Kotlin Multiplatform app. We provide a set of tools and best practices if you use LLMs during development.

## Plain text docs

You can access all of our documentation as plain text markdown files by adding `.md` to the end of any URL or clicking **View as Markdown** under article titles. To copy the whole Markdown content immediately, click **Copy for LLM**. For example, you can find the plain text version of this page itself at [https://adapty.io/docs/adapty-cursor-kmp.md](https://adapty.io/docs/adapty-cursor-kmp.md).
...
**Cursor**, the AI code editor, makes it easier to integrate and maintain Kotlin Multiplatform apps with Adapty's infrastructure. This guide shows you how to configure Cursor for better results when working with Adapty's Kotlin Multiplatform SDK.
...
- `@Adapty Docs help me install the Adapty Kotlin Multiplatform SDK`
- `Using @Adapty Kotlin Multiplatform SDK, show me how to handle purchase restoration with proper error handling`
