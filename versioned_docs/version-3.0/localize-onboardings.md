...
:::important
Localizations in onboardings are supported in the [iOS](get-onboardings.md), [Android](android-get-onboardings.md), [Flutter](flutter-get-onboardings.md), [React Native](react-native-get-onboardings.md), [Unity](unity-get-onboardings.md), [Kotlin Multiplatform](kmp-get-onboardings.md), and [Capacitor](get-onboardings.md) SDKs starting from SDK version 3.11. If your SDK version is below 3.11, the default locale will be used.
:::
