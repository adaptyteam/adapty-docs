...
1. Log in to the Adapty Dashboard and go to **App Settings** to configure the required settings.
      ...
      5. Copy the URL for App Store server notifications and paste it into App Store Connect. Find directions [here](app-store-server-notifications?_gl=1*11llw9l*_gcl_au*MTU5MTMwODMxOS4xNzM4MTYyMDQw).
