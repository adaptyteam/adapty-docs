---
title: "Install & configure Kotlin Multiplatform SDK"
description: "Step-by-step guide on installing Adapty SDK on Kotlin Multiplatform for subscription-based apps."
metadataTitle: "Installing Adapty SDK on Kotlin Multiplatform | Adapty Docs"
keywords: ['install sdk', 'sdk install', 'install sdk kotlin multiplatform', 'google play billing library', 'gpbl', 'billing library', 'adaptyui']
rank: 70
...
:::tip
Want to see a real-world example of how Adapty SDK is integrated into a mobile app? Check out our [sample app](https://github.com/adaptyteam/AdaptySDK-Kotlin-Multiplatform), which demonstrates the full setup, including displaying paywalls, making purchases, and other basic functionality.
:::
...
If you plan to use [Paywall Builder](adapty-paywall-builder.md) and have [installed AdaptyUI module](sdk-installation-kotlin-multiplatform#install-adapty-sdk), you also need to activate AdaptyUI:
