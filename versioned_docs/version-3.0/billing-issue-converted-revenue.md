...
The Billing Issue Converted chart displays the revenue from [billing issue conversions](billing-issue-converted): subscriptions that entered the [Billing Issue](billing-issue) state, and were renewed before the end of the billing cycle.

TODO: Screenshot

### Calculation

The Billing Issue Converted chart displays the daily revenue from subscriptions that entered the [Billing Issue](billing-issue) state in the current billing cycle, and were renewed on the day.
