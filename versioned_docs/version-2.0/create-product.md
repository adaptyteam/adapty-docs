...
4. Next, let's configure the product information from each store:
   ...
   3. **Other app stores**: You can configure the product information from other app stores you sell the product through. If the required store is not listed, add it.
