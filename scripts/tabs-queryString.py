...
# Regular expression to find <Tabs> tags
TABS_PATTERN = re.compile(r'(<Tabs(?:\s+groupId="[^"]*")?)>')
...
def update_tabs_in_file(file_path):
    ...
    # Replace the <Tabs> occurrences
    updated_content = TABS_PATTERN.sub(r'\1 queryString>', content)
